...
public final class Initial_namedElement_name extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Initial_namedElement_name() {
   ...
   * 
   */
  public static Initial_namedElement_name instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal.Initial_namedElement_name (visibility: PUBLIC, simpleName: Initial_namedElement_name, identifier: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal.Initial_namedElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal.Initial_namedElement_name (visibility: PUBLIC, simpleName: Initial_namedElement_name, identifier: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal.Initial_namedElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.simplecore.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Initial_namedElement_name INSTANCE = new Initial_namedElement_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Initial_namedElement_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.simplecore.queries.initial_namedElement_name";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find initial_namedElement (namedElement, initial_namedElement)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_namedElement, var_initial_namedElement), Initial_namedElement.instance().getInternalQueryRepresentation());
          // 	NamedElement.name (initial_namedElement, name)
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_initial_namedElement, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdh.se/idt/benji/examples/refactorings/SimpleCore", "NamedElement", "name")));
