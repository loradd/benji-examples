 ...
 * @generated
 */
public class SimplecorePackageImpl extends EPackageImpl implements SimplecorePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see se.mdh.idt.benji.examples.refactorings.simplecore.SimplecorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SimplecorePackageImpl() {
		super(eNS_URI, SimplecoreFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static SimplecorePackage init() {
		...
		theSimplecorePackage.createPackageContents();

		// Initialize created meta-data
		theSimplecorePackage.initializePackageContents();
