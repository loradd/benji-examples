...
public final class Merge_class_reference_intersection extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Merge_class_reference_intersection() {
   ...
   * 
   */
  public static Merge_class_reference_intersection instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_reference_intersection (visibility: PUBLIC, simpleName: Merge_class_reference_intersection, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_reference_intersection, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_reference_intersection (visibility: PUBLIC, simpleName: Merge_class_reference_intersection, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_reference_intersection, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Merge_class_reference_intersection INSTANCE = new Merge_class_reference_intersection();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Merge_class_reference_intersection.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.merge_class_reference_intersection";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$right_class, var_$left_reference, var_$right_reference), Delete_class_reference_intersection.instance().getInternalQueryRepresentation());
          // 	find merge_class_reference ($left_class, $right_class, $left_reference, $right_reference, $target_class)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$right_class, var_$left_reference, var_$right_reference, var_$target_class), Merge_class_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
