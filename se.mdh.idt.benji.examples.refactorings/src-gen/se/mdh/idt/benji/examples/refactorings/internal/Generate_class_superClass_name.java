...
public final class Generate_class_superClass_name extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Generate_class_superClass_name() {
   ...
   * 
   */
  public static Generate_class_superClass_name instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Generate_class_superClass_name (visibility: PUBLIC, simpleName: Generate_class_superClass_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Generate_class_superClass_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Generate_class_superClass_name (visibility: PUBLIC, simpleName: Generate_class_superClass_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Generate_class_superClass_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Generate_class_superClass_name INSTANCE = new Generate_class_superClass_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Generate_class_superClass_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.generate_class_superClass_name";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_class, var_class_name), Preserved_class_name.instance().getInternalQueryRepresentation());
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern generate_class_superClass_name";
              }
