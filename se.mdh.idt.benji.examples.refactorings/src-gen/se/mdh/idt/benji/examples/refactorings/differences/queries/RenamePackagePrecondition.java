...
public final class RenamePackagePrecondition extends BaseGeneratedEMFQuerySpecification<RenamePackagePrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition";
    }
     ...
     * 
     */
    public static RenamePackagePrecondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public static RenamePackagePrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition pattern,
   ...
   * pattern RenamePackagePrecondition (initial_package : Package, current_package : Package) {
   * 	find preserved_package_name (initial_package, current_package, _initial_name, _current_name);
   * }
   * </pre></code>
   * 
   * @see Match
  ...
  public static class Matcher extends BaseMatcher<RenamePackagePrecondition.Match> {
     ...
     * 
     */
    public Collection<RenamePackagePrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public RenamePackagePrecondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final IMatchProcessor<? super RenamePackagePrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final IMatchProcessor<? super RenamePackagePrecondition.Match> processor) {
     ...
     * 
     */
    public RenamePackagePrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return RenamePackagePrecondition.Match.newMatch(pInitial_package, pCurrent_package);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final RenamePackagePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final RenamePackagePrecondition.Match partialMatch) {
    ...
    protected RenamePackagePrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return RenamePackagePrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_INITIAL_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_CURRENT_PACKAGE));
    ...
    protected RenamePackagePrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return RenamePackagePrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected RenamePackagePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RenamePackagePrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition pattern.
   * 
  ...
  public RenamePackagePrecondition.Match newMatch(final Object... parameters) {
    return RenamePackagePrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition (visibility: PUBLIC, simpleName: RenamePackagePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition (visibility: PUBLIC, simpleName: RenamePackagePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.RenamePackagePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_package_name (initial_package, current_package, _initial_name, _current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_package, var_current_package, var__initial_name, var__current_name), Preserved_package_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
