...
public final class Common_class_superClass extends BaseGeneratedEMFQuerySpecification<Common_class_superClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_superClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("super_class", "left_class", "right_class");
    
    private Match(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_superClass";
    }
    ...
    public Object[] toArray() {
      return new Object[]{fSuper_class, fLeft_class, fRight_class};
    }
    
    @Override
    public Common_class_superClass.Match toImmutable() {
      return isMutable() ? newMatch(fSuper_class, fLeft_class, fRight_class) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fSuper_class, fLeft_class, fRight_class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Common_class_superClass.Match)) {
          ...
          return Objects.equals(fSuper_class, other.fSuper_class) && Objects.equals(fLeft_class, other.fLeft_class) && Objects.equals(fRight_class, other.fRight_class);
      } else {
     ...
     * 
     */
    public static Common_class_superClass.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return new Mutable(pSuper_class, pLeft_class, pRight_class);
    }
     ...
     * 
     */
    public static Common_class_superClass.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return new Immutable(pSuper_class, pLeft_class, pRight_class);
    }
    
    private static final class Mutable extends Common_class_superClass.Match {
      Mutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
        super(pSuper_class, pLeft_class, pRight_class);
      }
    ...
    private static final class Immutable extends Common_class_superClass.Match {
      Immutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
        super(pSuper_class, pLeft_class, pRight_class);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_superClass pattern,
  ...
  public static class Matcher extends BaseMatcher<Common_class_superClass.Match> {
    ...
    private final static int POSITION_SUPER_CLASS = 0;
    
    private final static int POSITION_LEFT_CLASS = 1;
    
    private final static int POSITION_RIGHT_CLASS = 2;
     ...
     * 
     */
    public Collection<Common_class_superClass.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return rawGetAllMatches(new Object[]{pSuper_class, pLeft_class, pRight_class});
    }
     ...
     * 
     */
    public Common_class_superClass.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return rawGetOneArbitraryMatch(new Object[]{pSuper_class, pLeft_class, pRight_class});
    }
     ...
     * 
     */
    public boolean hasMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return rawHasMatch(new Object[]{pSuper_class, pLeft_class, pRight_class});
    }
     ...
     * 
     */
    public int countMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return rawCountMatches(new Object[]{pSuper_class, pLeft_class, pRight_class});
    }
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final IMatchProcessor<? super Common_class_superClass.Match> processor) {
      rawForEachMatch(new Object[]{pSuper_class, pLeft_class, pRight_class}, processor);
    }
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final IMatchProcessor<? super Common_class_superClass.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pSuper_class, pLeft_class, pRight_class}, processor);
    }
     ...
     * 
     */
    public Common_class_superClass.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
      return Common_class_superClass.Match.newMatch(pSuper_class, pLeft_class, pRight_class);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfleft_class(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfright_class(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class) {
    ...
    protected Common_class_superClass.Match tupleToMatch(final Tuple t) {
      try {
          return Common_class_superClass.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_SUPER_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_LEFT_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_RIGHT_CLASS));
    ...
    protected Common_class_superClass.Match arrayToMatch(final Object[] match) {
      try {
          return Common_class_superClass.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_SUPER_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS]);
      } catch(ClassCastException e) {
    ...
    protected Common_class_superClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Common_class_superClass.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_SUPER_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_superClass pattern.
   * 
  ...
  public static abstract class Processor implements IMatchProcessor<Common_class_superClass.Match> {
     ...
     * 
     */
    public abstract void process(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pSuper_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class);
    
    @Override
    public void process(final Common_class_superClass.Match match) {
      process(match.getSuper_class(), match.getLeft_class(), match.getRight_class());
    }
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_superClass (visibility: PUBLIC, simpleName: Common_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_superClass (visibility: PUBLIC, simpleName: Common_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pSuper_class, parameter_pLeft_class, parameter_pRight_class);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("super_class","left_class","right_class");
    }
