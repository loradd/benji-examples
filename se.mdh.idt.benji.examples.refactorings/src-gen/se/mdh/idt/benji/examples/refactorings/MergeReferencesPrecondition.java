...
public final class MergeReferencesPrecondition extends BaseGeneratedEMFQuerySpecification<MergeReferencesPrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition";
    }
     ...
     * 
     */
    public static MergeReferencesPrecondition.Match newMutableMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference) {
     ...
     * 
     */
    public static MergeReferencesPrecondition.Match newMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition pattern,
  ...
  public static class Matcher extends BaseMatcher<MergeReferencesPrecondition.Match> {
     ...
     * 
     */
    public Collection<MergeReferencesPrecondition.Match> getAllMatches(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference) {
     ...
     * 
     */
    public MergeReferencesPrecondition.Match getOneArbitraryMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference, final IMatchProcessor<? super MergeReferencesPrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference, final IMatchProcessor<? super MergeReferencesPrecondition.Match> processor) {
     ...
     * 
     */
    public MergeReferencesPrecondition.Match newMatch(final TraceLink p$class, final TraceLink p$left_reference, final TraceLink p$right_reference) {
      return MergeReferencesPrecondition.Match.newMatch(p$class, p$left_reference, p$right_reference);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$class(final MergeReferencesPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$left_reference(final MergeReferencesPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$right_reference(final MergeReferencesPrecondition.Match partialMatch) {
    ...
    protected MergeReferencesPrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return MergeReferencesPrecondition.Match.newMatch((TraceLink) t.get(POSITION_$CLASS), (TraceLink) t.get(POSITION_$LEFT_REFERENCE), (TraceLink) t.get(POSITION_$RIGHT_REFERENCE));
    ...
    protected MergeReferencesPrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return MergeReferencesPrecondition.Match.newMatch((TraceLink) match[POSITION_$CLASS], (TraceLink) match[POSITION_$LEFT_REFERENCE], (TraceLink) match[POSITION_$RIGHT_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected MergeReferencesPrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MergeReferencesPrecondition.Match.newMutableMatch((TraceLink) match[POSITION_$CLASS], (TraceLink) match[POSITION_$LEFT_REFERENCE], (TraceLink) match[POSITION_$RIGHT_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition pattern.
   * 
  ...
  public MergeReferencesPrecondition.Match newMatch(final Object... parameters) {
    return MergeReferencesPrecondition.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1], (se.mdh.idt.benji.trace.TraceLink) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition (visibility: PUBLIC, simpleName: MergeReferencesPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition (visibility: PUBLIC, simpleName: MergeReferencesPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.MergeReferencesPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var_$left_reference_name = body.getOrCreateVariableByName("$left_reference_name");
          PVariable var_$right_reference_name = body.getOrCreateVariableByName("$right_reference_name");
          PVariable var_$left_reference_type = body.getOrCreateVariableByName("$left_reference_type");
          PVariable var_$right_reference_type = body.getOrCreateVariableByName("$right_reference_type");
          ...
          // 	find get_class_reference ($class, $left_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$class, var_$left_reference), Get_class_reference.instance().getInternalQueryRepresentation());
          // 	find get_class_reference ($class, $right_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$class, var_$right_reference), Get_class_reference.instance().getInternalQueryRepresentation());
          // 	find get_reference_name ($left_reference, $left_reference_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_reference, var_$left_reference_name), Get_reference_name.instance().getInternalQueryRepresentation());
          // 	find get_reference_name ($right_reference, $right_reference_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$right_reference, var_$right_reference_name), Get_reference_name.instance().getInternalQueryRepresentation());
          // 	find get_reference_type ($left_reference, $left_reference_type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_reference, var_$left_reference_type), Get_reference_type.instance().getInternalQueryRepresentation());
          // 	find get_reference_type ($right_reference, $right_reference_type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$right_reference, var_$right_reference_type), Get_reference_type.instance().getInternalQueryRepresentation());
          // 	$left_reference != $right_reference
          new Inequality(body, var_$left_reference, var_$right_reference);
          // 	$left_reference_name == $right_reference_name
          new Equality(body, var_$left_reference_name, var_$right_reference_name);
          //  	find get_class_superClass_intersection ($left_reference_type, $right_reference_type, _)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_reference_type, var_$right_reference_type, var___0_), Get_class_superClass_intersection.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
