...
public final class Delete_class_reference_name extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Delete_class_reference_name() {
   ...
   * 
   */
  public static Delete_class_reference_name instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference_name (visibility: PUBLIC, simpleName: Delete_class_reference_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference_name (visibility: PUBLIC, simpleName: Delete_class_reference_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Delete_class_reference_name INSTANCE = new Delete_class_reference_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Delete_class_reference_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$class, parameter_p$reference, parameter_p$name);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.delete_class_reference_name";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$class","$reference","$name");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$reference, var_$name), Unset_reference_name.instance().getInternalQueryRepresentation());
          // 	find delete_class_reference ($class, $reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$class, var_$reference), Delete_class_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
