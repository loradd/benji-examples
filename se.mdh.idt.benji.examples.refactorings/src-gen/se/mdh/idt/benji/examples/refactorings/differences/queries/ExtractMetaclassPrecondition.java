...
public final class ExtractMetaclassPrecondition extends BaseGeneratedEMFQuerySpecification<ExtractMetaclassPrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("initial_package", "current_package", "initial_metaclass", "current_metaclass", "initial_attribute", "current_attribute");
    
    private Match(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtractMetaclassPrecondition.Match.parameterNames;
    }
    
    @Override
    public Object[] toArray() {
      return new Object[]{fInitial_package, fCurrent_package, fInitial_metaclass, fCurrent_metaclass, fInitial_attribute, fCurrent_attribute};
    }
    
    @Override
    public ExtractMetaclassPrecondition.Match toImmutable() {
      return isMutable() ? newMatch(fInitial_package, fCurrent_package, fInitial_metaclass, fCurrent_metaclass, fInitial_attribute, fCurrent_attribute) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fInitial_package, fCurrent_package, fInitial_metaclass, fCurrent_metaclass, fInitial_attribute, fCurrent_attribute);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtractMetaclassPrecondition.Match)) {
          ExtractMetaclassPrecondition.Match other = (ExtractMetaclassPrecondition.Match) obj;
          return Objects.equals(fInitial_package, other.fInitial_package) && Objects.equals(fCurrent_package, other.fCurrent_package) && Objects.equals(fInitial_metaclass, other.fInitial_metaclass) && Objects.equals(fCurrent_metaclass, other.fCurrent_metaclass) && Objects.equals(fInitial_attribute, other.fInitial_attribute) && Objects.equals(fCurrent_attribute, other.fCurrent_attribute);
      } else {
    ...
    @Override
    public ExtractMetaclassPrecondition specification() {
     ...
     * 
     */
    public static ExtractMetaclassPrecondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtractMetaclassPrecondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return new Mutable(pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute);
    }
     ...
     * 
     */
    public static ExtractMetaclassPrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return new Immutable(pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute);
    }
    
    private static final class Mutable extends ExtractMetaclassPrecondition.Match {
      Mutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
        super(pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute);
      }
    ...
    private static final class Immutable extends ExtractMetaclassPrecondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // CCAC8 - Extract Metaclass - Precondition
   * pattern ExtractMetaclassPrecondition (initial_package : Package, current_package : Package, initial_metaclass : Class, current_metaclass : Class, initial_attribute : Attribute, current_attribute : Attribute) {
   * 	find preserved_package_class (initial_package, current_package, initial_metaclass, current_metaclass); 
   * 	find preserved_class_attribute (initial_metaclass, current_metaclass, initial_attribute, current_attribute); 	
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see ExtractMetaclassPrecondition
   * 
   */
  public static class Matcher extends BaseMatcher<ExtractMetaclassPrecondition.Match> {
    /**
     ...
     * 
     */
    public static ExtractMetaclassPrecondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtractMetaclassPrecondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtractMetaclassPrecondition.Matcher.class);
     ...
     * 
     */
    public Collection<ExtractMetaclassPrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return rawGetAllMatches(new Object[]{pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute});
    }
    ...
    public boolean hasMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return rawHasMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute});
    }
    ...
    public int countMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return rawCountMatches(new Object[]{pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute});
    }
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super ExtractMetaclassPrecondition.Match> processor) {
      rawForEachMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute}, processor);
    }
    ...
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super ExtractMetaclassPrecondition.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute}, processor);
    }
     ...
     */
    public ExtractMetaclassPrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return ExtractMetaclassPrecondition.Match.newMatch(pInitial_package, pCurrent_package, pInitial_metaclass, pCurrent_metaclass, pInitial_attribute, pCurrent_attribute);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final ExtractMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final ExtractMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_metaclass(final ExtractMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_metaclass(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_metaclass(final ExtractMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final ExtractMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final ExtractMetaclassPrecondition.Match partialMatch) {
    ...
    @Override
    protected ExtractMetaclassPrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return ExtractMetaclassPrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_INITIAL_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_CURRENT_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_METACLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_METACLASS), (Attribute) t.get(POSITION_INITIAL_ATTRIBUTE), (Attribute) t.get(POSITION_CURRENT_ATTRIBUTE));
    ...
    @Override
    protected ExtractMetaclassPrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtractMetaclassPrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_METACLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_METACLASS], (Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtractMetaclassPrecondition.Matcher> querySpecification() {
      return ExtractMetaclassPrecondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<ExtractMetaclassPrecondition.Match> {
    /**
    ...
    @Override
    public void process(final ExtractMetaclassPrecondition.Match match) {
      process(match.getInitial_package(), match.getCurrent_package(), match.getInitial_metaclass(), match.getCurrent_metaclass(), match.getInitial_attribute(), match.getCurrent_attribute());
    }
  }
  
  private ExtractMetaclassPrecondition() {
   ...
   * 
   */
  public static ExtractMetaclassPrecondition instance() {
    try{
  ...
  @Override
  protected ExtractMetaclassPrecondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtractMetaclassPrecondition.Matcher.on(engine);
  }
  
  @Override
  public ExtractMetaclassPrecondition.Matcher instantiate() {
    return ExtractMetaclassPrecondition.Matcher.create();
  }
  
  @Override
  public ExtractMetaclassPrecondition.Match newEmptyMatch() {
    return ExtractMetaclassPrecondition.Match.newEmptyMatch();
  }
  
  @Override
  public ExtractMetaclassPrecondition.Match newMatch(final Object... parameters) {
    return ExtractMetaclassPrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[3], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[4], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[5]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition (visibility: PUBLIC, simpleName: ExtractMetaclassPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition (visibility: PUBLIC, simpleName: ExtractMetaclassPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractMetaclassPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ExtractMetaclassPrecondition INSTANCE = new ExtractMetaclassPrecondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ExtractMetaclassPrecondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pInitial_package, parameter_pCurrent_package, parameter_pInitial_metaclass, parameter_pCurrent_metaclass, parameter_pInitial_attribute, parameter_pCurrent_attribute);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("initial_package","current_package","initial_metaclass","current_metaclass","initial_attribute","current_attribute");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find preserved_class_attribute (initial_metaclass, current_metaclass, initial_attribute, current_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_metaclass, var_current_metaclass, var_initial_attribute, var_current_attribute), Preserved_class_attribute.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
