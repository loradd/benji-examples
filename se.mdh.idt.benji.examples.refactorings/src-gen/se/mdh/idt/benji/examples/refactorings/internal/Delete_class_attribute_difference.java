...
public final class Delete_class_attribute_difference extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Delete_class_attribute_difference() {
   ...
   * 
   */
  public static Delete_class_attribute_difference instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_attribute_difference (visibility: PUBLIC, simpleName: Delete_class_attribute_difference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_attribute_difference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_attribute_difference (visibility: PUBLIC, simpleName: Delete_class_attribute_difference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_attribute_difference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Delete_class_attribute_difference INSTANCE = new Delete_class_attribute_difference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Delete_class_attribute_difference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$left_class, parameter_p$right_class, parameter_p$left_attribute);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.delete_class_attribute_difference";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$left_class","$right_class","$left_attribute");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var__$right_attribute = body.getOrCreateVariableByName("_$right_attribute");
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$left_attribute, var_$name), Delete_class_attribute_name.instance().getInternalQueryRepresentation());
          //  	neg find delete_class_attribute_name ($right_class, _$right_attribute, $name)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_$right_class, var__$right_attribute, var_$name), Delete_class_attribute_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
