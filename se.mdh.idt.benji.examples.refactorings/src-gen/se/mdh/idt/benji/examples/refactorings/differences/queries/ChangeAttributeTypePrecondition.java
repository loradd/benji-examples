...
public final class ChangeAttributeTypePrecondition extends BaseGeneratedEMFQuerySpecification<ChangeAttributeTypePrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition";
    }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition pattern,
  ...
  public static class Matcher extends BaseMatcher<ChangeAttributeTypePrecondition.Match> {
     ...
     * 
     */
    public Collection<ChangeAttributeTypePrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_attribute_type, final DataType pCurrent_attribute_type, final DataType pInitial_type, final DataType pCurrent_type) {
     ...
     * 
     */
    public ChangeAttributeTypePrecondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_attribute_type, final DataType pCurrent_attribute_type, final DataType pInitial_type, final DataType pCurrent_type) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_attribute_type, final DataType pCurrent_attribute_type, final DataType pInitial_type, final DataType pCurrent_type, final IMatchProcessor<? super ChangeAttributeTypePrecondition.Match> processor) {
     ...
     * 
     */
    public ChangeAttributeTypePrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_attribute_type, final DataType pCurrent_attribute_type, final DataType pInitial_type, final DataType pCurrent_type) {
      return ChangeAttributeTypePrecondition.Match.newMatch(pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_attribute_type, pCurrent_attribute_type, pInitial_type, pCurrent_type);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_attribute_type(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfcurrent_attribute_type(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_type(final ChangeAttributeTypePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfcurrent_type(final ChangeAttributeTypePrecondition.Match partialMatch) {
    ...
    protected ChangeAttributeTypePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ChangeAttributeTypePrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (DataType) match[POSITION_INITIAL_ATTRIBUTE_TYPE], (DataType) match[POSITION_CURRENT_ATTRIBUTE_TYPE], (DataType) match[POSITION_INITIAL_TYPE], (DataType) match[POSITION_CURRENT_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition pattern.
   * 
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition (visibility: PUBLIC, simpleName: ChangeAttributeTypePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition (visibility: PUBLIC, simpleName: ChangeAttributeTypePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ChangeAttributeTypePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find preserved_attribute_type (initial_attribute, current_attribute, initial_attribute_type, current_attribute_type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_attribute, var_current_attribute, var_initial_attribute_type, var_current_attribute_type), Preserved_attribute_type.instance().getInternalQueryRepresentation());
          //  	initial_attribute_type != initial_type
          new Inequality(body, var_initial_attribute_type, var_initial_type);
          //   	initial_attribute_type != current_type
          new Inequality(body, var_initial_attribute_type, var_current_type);
          bodies.add(body);
      }
      return bodies;
    }
