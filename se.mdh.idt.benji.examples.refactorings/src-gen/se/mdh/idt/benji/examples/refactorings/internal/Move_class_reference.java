...
public final class Move_class_reference extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Move_class_reference() {
   ...
   * 
   */
  public static Move_class_reference instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference (visibility: PUBLIC, simpleName: Move_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference (visibility: PUBLIC, simpleName: Move_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Move_class_reference INSTANCE = new Move_class_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Move_class_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$source_class, parameter_p$source_reference, parameter_p$target_class);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.move_class_reference";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$source_class","$source_reference","$target_class");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$source_reference, var_$target_reference), Move_reference_name.instance().getInternalQueryRepresentation());
          // 	find move_reference_type ($source_reference, $target_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$source_reference, var_$target_reference), Move_reference_type.instance().getInternalQueryRepresentation());
          // 	find delete_class_reference ($source_class, $source_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$source_class, var_$source_reference), Delete_class_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
