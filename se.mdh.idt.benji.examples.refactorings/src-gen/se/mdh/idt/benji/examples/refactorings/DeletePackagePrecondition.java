...
public final class DeletePackagePrecondition extends BaseGeneratedEMFQuerySpecification<DeletePackagePrecondition.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static DeletePackagePrecondition.Match newMutableMatch(final TraceLink p$package) {
     ...
     * 
     */
    public static DeletePackagePrecondition.Match newMatch(final TraceLink p$package) {
  ...
  public static class Matcher extends BaseMatcher<DeletePackagePrecondition.Match> {
     ...
     * 
     */
    public Collection<DeletePackagePrecondition.Match> getAllMatches(final TraceLink p$package) {
     ...
     * 
     */
    public DeletePackagePrecondition.Match getOneArbitraryMatch(final TraceLink p$package) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink p$package, final IMatchProcessor<? super DeletePackagePrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink p$package, final IMatchProcessor<? super DeletePackagePrecondition.Match> processor) {
     ...
     * 
     */
    public DeletePackagePrecondition.Match newMatch(final TraceLink p$package) {
    ...
    protected DeletePackagePrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeletePackagePrecondition.Match.newMatch((TraceLink) t.get(POSITION_$PACKAGE));
    ...
    protected DeletePackagePrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeletePackagePrecondition.Match.newMatch((TraceLink) match[POSITION_$PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected DeletePackagePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeletePackagePrecondition.Match.newMutableMatch((TraceLink) match[POSITION_$PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public DeletePackagePrecondition.Match newMatch(final Object... parameters) {
    return DeletePackagePrecondition.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
