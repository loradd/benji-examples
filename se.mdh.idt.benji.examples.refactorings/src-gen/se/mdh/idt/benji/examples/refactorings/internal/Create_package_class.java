...
public final class Create_package_class extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Create_package_class() {
   ...
   * 
   */
  public static Create_package_class instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Create_package_class (visibility: PUBLIC, simpleName: Create_package_class, identifier: se.mdh.idt.benji.examples.refactorings.internal.Create_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Create_package_class (visibility: PUBLIC, simpleName: Create_package_class, identifier: se.mdh.idt.benji.examples.refactorings.internal.Create_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Create_package_class INSTANCE = new Create_package_class();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Create_package_class.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.create_package_class";
    }
