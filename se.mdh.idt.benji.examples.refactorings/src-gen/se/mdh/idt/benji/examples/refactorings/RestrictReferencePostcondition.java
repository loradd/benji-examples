...
public final class RestrictReferencePostcondition extends BaseGeneratedEMFQuerySpecification<RestrictReferencePostcondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return RestrictReferencePostcondition.Match.parameterNames;
    }
    ...
    @Override
    public RestrictReferencePostcondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RestrictReferencePostcondition.Match)) {
          RestrictReferencePostcondition.Match other = (RestrictReferencePostcondition.Match) obj;
    ...
    @Override
    public RestrictReferencePostcondition specification() {
     ...
     * 
     */
    public static RestrictReferencePostcondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static RestrictReferencePostcondition.Match newMutableMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower) {
     ...
     * 
     */
    public static RestrictReferencePostcondition.Match newMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower) {
      return new Immutable(p$reference, p$source_upper, p$source_lower);
    }
    
    private static final class Mutable extends RestrictReferencePostcondition.Match {
    ...
    private static final class Immutable extends RestrictReferencePostcondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition pattern,
   ...
   * 	check ($source_lower {@literal <}= $target_upper);
   * 	check ($source_upper == -1 && $source_upper {@literal <} $target_upper
   * 		|| $source_upper != -1 && $source_upper {@literal >} $target_upper);
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see RestrictReferencePostcondition
   * 
   */
  public static class Matcher extends BaseMatcher<RestrictReferencePostcondition.Match> {
    /**
     ...
     * 
     */
    public static RestrictReferencePostcondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RestrictReferencePostcondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RestrictReferencePostcondition.Matcher.class);
     ...
     * 
     */
    public Collection<RestrictReferencePostcondition.Match> getAllMatches(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower) {
     ...
     * 
     */
    public RestrictReferencePostcondition.Match getOneArbitraryMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower, final IMatchProcessor<? super RestrictReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower, final IMatchProcessor<? super RestrictReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public RestrictReferencePostcondition.Match newMatch(final TraceLink p$reference, final Integer p$source_upper, final Integer p$source_lower) {
      return RestrictReferencePostcondition.Match.newMatch(p$reference, p$source_upper, p$source_lower);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$reference(final RestrictReferencePostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOf$source_upper(final RestrictReferencePostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOf$source_lower(final RestrictReferencePostcondition.Match partialMatch) {
    ...
    @Override
    protected RestrictReferencePostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return RestrictReferencePostcondition.Match.newMatch((TraceLink) t.get(POSITION_$REFERENCE), (Integer) t.get(POSITION_$SOURCE_UPPER), (Integer) t.get(POSITION_$SOURCE_LOWER));
    ...
    @Override
    protected RestrictReferencePostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return RestrictReferencePostcondition.Match.newMatch((TraceLink) match[POSITION_$REFERENCE], (Integer) match[POSITION_$SOURCE_UPPER], (Integer) match[POSITION_$SOURCE_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RestrictReferencePostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RestrictReferencePostcondition.Match.newMutableMatch((TraceLink) match[POSITION_$REFERENCE], (Integer) match[POSITION_$SOURCE_UPPER], (Integer) match[POSITION_$SOURCE_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RestrictReferencePostcondition.Matcher> querySpecification() {
      return RestrictReferencePostcondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<RestrictReferencePostcondition.Match> {
    /**
    ...
    @Override
    public void process(final RestrictReferencePostcondition.Match match) {
      process(match.get$reference(), match.get$source_upper(), match.get$source_lower());
    }
  }
  
  private RestrictReferencePostcondition() {
   ...
   * 
   */
  public static RestrictReferencePostcondition instance() {
    try{
  ...
  @Override
  protected RestrictReferencePostcondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return RestrictReferencePostcondition.Matcher.on(engine);
  }
  
  @Override
  public RestrictReferencePostcondition.Matcher instantiate() {
    return RestrictReferencePostcondition.Matcher.create();
  }
  
  @Override
  public RestrictReferencePostcondition.Match newEmptyMatch() {
    return RestrictReferencePostcondition.Match.newEmptyMatch();
  }
  
  @Override
  public RestrictReferencePostcondition.Match newMatch(final Object... parameters) {
    return RestrictReferencePostcondition.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1], (java.lang.Integer) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition (visibility: PUBLIC, simpleName: RestrictReferencePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition (visibility: PUBLIC, simpleName: RestrictReferencePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.RestrictReferencePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static RestrictReferencePostcondition INSTANCE = new RestrictReferencePostcondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static RestrictReferencePostcondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var_$target_upper = body.getOrCreateVariableByName("$target_upper");
          ...
          // 	find unset_reference_upper ($reference, $source_upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$reference, var_$source_upper), Unset_reference_upper.instance().getInternalQueryRepresentation());
          // 	find set_reference_upper ($reference, $target_upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$reference, var_$target_upper), Set_reference_upper.instance().getInternalQueryRepresentation());
          // 	check ($source_lower <= $target_upper)
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
          
              @Override
              public String getShortDescription() {
                  return "Expression evaluation from pattern RestrictReferencePostcondition";
              }
              
              @Override
              public Iterable<String> getInputParameterNames() {
                  return Arrays.asList("$source_lower", "$target_upper");}
          
              @Override
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  Integer $source_lower = (Integer) provider.getValue("$source_lower");
                  Integer $target_upper = (Integer) provider.getValue("$target_upper");
                  return evaluateExpression_1_1($source_lower, $target_upper);
              }
          },  null); 
          // 	check ($source_upper == -1 && $source_upper < $target_upper		|| $source_upper != -1 && $source_upper > $target_upper)
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              @Override
              public Iterable<String> getInputParameterNames() {
                  return Arrays.asList("$source_upper", "$target_upper");}
          
              @Override
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  Integer $source_upper = (Integer) provider.getValue("$source_upper");
                  Integer $target_upper = (Integer) provider.getValue("$target_upper");
                  return evaluateExpression_1_2($source_upper, $target_upper);
              }
          },  null); 
          bodies.add(body);
      }
  ...
  private static boolean evaluateExpression_1_1(final Integer $source_lower, final Integer $target_upper) {
    boolean _lessEqualsThan = ($source_lower.compareTo($target_upper) <= 0);
    return _lessEqualsThan;
  }
  
  private static boolean evaluateExpression_1_2(final Integer $source_upper, final Integer $target_upper) {
    return (((($source_upper).intValue() == (-1)) && ($source_upper.compareTo($target_upper) < 0)) || ((($source_upper).intValue() != (-1)) && ($source_upper.compareTo($target_upper) > 0)));
  }
}
