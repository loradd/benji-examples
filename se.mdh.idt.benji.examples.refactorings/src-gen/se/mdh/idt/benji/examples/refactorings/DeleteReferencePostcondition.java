...
public final class DeleteReferencePostcondition extends BaseGeneratedEMFQuerySpecification<DeleteReferencePostcondition.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static DeleteReferencePostcondition.Match newMutableMatch(final TraceLink p$reference) {
     ...
     * 
     */
    public static DeleteReferencePostcondition.Match newMatch(final TraceLink p$reference) {
  ...
  public static class Matcher extends BaseMatcher<DeleteReferencePostcondition.Match> {
     ...
     * 
     */
    public Collection<DeleteReferencePostcondition.Match> getAllMatches(final TraceLink p$reference) {
     ...
     * 
     */
    public DeleteReferencePostcondition.Match getOneArbitraryMatch(final TraceLink p$reference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink p$reference, final IMatchProcessor<? super DeleteReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink p$reference, final IMatchProcessor<? super DeleteReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public DeleteReferencePostcondition.Match newMatch(final TraceLink p$reference) {
    ...
    protected DeleteReferencePostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeleteReferencePostcondition.Match.newMatch((TraceLink) t.get(POSITION_$REFERENCE));
    ...
    protected DeleteReferencePostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeleteReferencePostcondition.Match.newMatch((TraceLink) match[POSITION_$REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected DeleteReferencePostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeleteReferencePostcondition.Match.newMutableMatch((TraceLink) match[POSITION_$REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public DeleteReferencePostcondition.Match newMatch(final Object... parameters) {
    return DeleteReferencePostcondition.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find delete_reference ($reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$reference), Delete_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
