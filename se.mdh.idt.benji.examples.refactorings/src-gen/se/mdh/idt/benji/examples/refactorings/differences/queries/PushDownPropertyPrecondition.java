...
public final class PushDownPropertyPrecondition extends BaseGeneratedEMFQuerySpecification<PushDownPropertyPrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return PushDownPropertyPrecondition.Match.parameterNames;
    }
    ...
    @Override
    public PushDownPropertyPrecondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PushDownPropertyPrecondition.Match)) {
          PushDownPropertyPrecondition.Match other = (PushDownPropertyPrecondition.Match) obj;
    ...
    @Override
    public PushDownPropertyPrecondition specification() {
      return PushDownPropertyPrecondition.instance();
    }
     ...
     * 
     */
    public static PushDownPropertyPrecondition.Match newEmptyMatch() {
    ...
    private static final class Mutable extends PushDownPropertyPrecondition.Match {
    ...
    private static final class Immutable extends PushDownPropertyPrecondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // CDACA22 - Push Down Property - Precondition
   * pattern PushDownPropertyPrecondition (
   ...
   * ) {
   * 	find preserved_class_attribute (initial_class, current_class, initial_property, current_property); 
   ...
   * @see Match
   *  @see Processor
   * @see PushDownPropertyPrecondition
   * 
   */
  public static class Matcher extends BaseMatcher<PushDownPropertyPrecondition.Match> {
    /**
     ...
     * 
     */
    public static PushDownPropertyPrecondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PushDownPropertyPrecondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PushDownPropertyPrecondition.Matcher.class);
     ...
     * 
     */
    public Collection<PushDownPropertyPrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass, final Attribute pInitial_property, final Attribute pCurrent_property) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass, final Attribute pInitial_property, final Attribute pCurrent_property, final IMatchProcessor<? super PushDownPropertyPrecondition.Match> processor) {
     ...
     */
    public PushDownPropertyPrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass, final Attribute pInitial_property, final Attribute pCurrent_property) {
      return PushDownPropertyPrecondition.Match.newMatch(pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass, pInitial_property, pCurrent_property);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final PushDownPropertyPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final PushDownPropertyPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_subClass(final PushDownPropertyPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_subClass(final PushDownPropertyPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_property(final PushDownPropertyPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_property(final PushDownPropertyPrecondition.Match partialMatch) {
    ...
    @Override
    protected PushDownPropertyPrecondition.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected PushDownPropertyPrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PushDownPropertyPrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_SUBCLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_SUBCLASS], (Attribute) match[POSITION_INITIAL_PROPERTY], (Attribute) match[POSITION_CURRENT_PROPERTY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
     ...
     * 
     */
    public static IQuerySpecification<PushDownPropertyPrecondition.Matcher> querySpecification() {
      return PushDownPropertyPrecondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<PushDownPropertyPrecondition.Match> {
    /**
    ...
    @Override
    public void process(final PushDownPropertyPrecondition.Match match) {
  ...
  private PushDownPropertyPrecondition() {
   ...
   * 
   */
  public static PushDownPropertyPrecondition instance() {
    try{
  ...
  @Override
  protected PushDownPropertyPrecondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return PushDownPropertyPrecondition.Matcher.on(engine);
  }
  
  @Override
  public PushDownPropertyPrecondition.Matcher instantiate() {
    return PushDownPropertyPrecondition.Matcher.create();
  }
  
  @Override
  public PushDownPropertyPrecondition.Match newEmptyMatch() {
    return PushDownPropertyPrecondition.Match.newEmptyMatch();
  }
  
  @Override
  public PushDownPropertyPrecondition.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition (visibility: PUBLIC, simpleName: PushDownPropertyPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition (visibility: PUBLIC, simpleName: PushDownPropertyPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.PushDownPropertyPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static PushDownPropertyPrecondition INSTANCE = new PushDownPropertyPrecondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static PushDownPropertyPrecondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_class_attribute (initial_class, current_class, initial_property, current_property)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_class, var_current_class, var_initial_property, var_current_property), Preserved_class_attribute.instance().getInternalQueryRepresentation());
          //  	find preserved_class_subClass (initial_class, current_class, initial_subClass, current_subClass)
