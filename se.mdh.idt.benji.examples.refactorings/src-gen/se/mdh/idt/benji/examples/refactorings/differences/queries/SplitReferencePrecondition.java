...
public final class SplitReferencePrecondition extends BaseGeneratedEMFQuerySpecification<SplitReferencePrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return SplitReferencePrecondition.Match.parameterNames;
    }
    ...
    @Override
    public SplitReferencePrecondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SplitReferencePrecondition.Match)) {
          SplitReferencePrecondition.Match other = (SplitReferencePrecondition.Match) obj;
    ...
    @Override
    public SplitReferencePrecondition specification() {
     ...
     * 
     */
    public static SplitReferencePrecondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static SplitReferencePrecondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public static SplitReferencePrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final Reference pCurrent_reference) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_reference, pCurrent_reference);
    }
    
    private static final class Mutable extends SplitReferencePrecondition.Match {
    ...
    private static final class Immutable extends SplitReferencePrecondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition pattern,
   ...
   * @see Match
   *  @see Processor
   * @see SplitReferencePrecondition
   * 
   */
  public static class Matcher extends BaseMatcher<SplitReferencePrecondition.Match> {
    /**
     ...
     * 
     */
    public static SplitReferencePrecondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SplitReferencePrecondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SplitReferencePrecondition.Matcher.class);
     ...
     * 
     */
    public Collection<SplitReferencePrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public SplitReferencePrecondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public SplitReferencePrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final Reference pCurrent_reference) {
      return SplitReferencePrecondition.Match.newMatch(pInitial_class, pCurrent_class, pInitial_reference, pCurrent_reference);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final SplitReferencePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final SplitReferencePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final SplitReferencePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final SplitReferencePrecondition.Match partialMatch) {
    ...
    @Override
    protected SplitReferencePrecondition.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected SplitReferencePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SplitReferencePrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SplitReferencePrecondition.Matcher> querySpecification() {
      return SplitReferencePrecondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<SplitReferencePrecondition.Match> {
    /**
   ...
   * 
   */
  public static SplitReferencePrecondition instance() {
    try{
  ...
  @Override
  protected SplitReferencePrecondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return SplitReferencePrecondition.Matcher.on(engine);
  }
  
  @Override
  public SplitReferencePrecondition.Matcher instantiate() {
    return SplitReferencePrecondition.Matcher.create();
  }
  
  @Override
  public SplitReferencePrecondition.Match newEmptyMatch() {
    return SplitReferencePrecondition.Match.newEmptyMatch();
  }
  
  @Override
  public SplitReferencePrecondition.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition (visibility: PUBLIC, simpleName: SplitReferencePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition (visibility: PUBLIC, simpleName: SplitReferencePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.SplitReferencePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static SplitReferencePrecondition INSTANCE = new SplitReferencePrecondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SplitReferencePrecondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
