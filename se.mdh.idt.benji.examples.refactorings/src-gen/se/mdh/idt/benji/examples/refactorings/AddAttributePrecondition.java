...
public final class AddAttributePrecondition extends BaseGeneratedEMFQuerySpecification<AddAttributePrecondition.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static AddAttributePrecondition.Match newMutableMatch(final TraceLink p$class, final TraceLink p$type, final String p$name) {
     ...
     * 
     */
    public static AddAttributePrecondition.Match newMatch(final TraceLink p$class, final TraceLink p$type, final String p$name) {
  ...
  public static class Matcher extends BaseMatcher<AddAttributePrecondition.Match> {
     ...
     * 
     */
    public Collection<AddAttributePrecondition.Match> getAllMatches(final TraceLink p$class, final TraceLink p$type, final String p$name) {
     ...
     * 
     */
    public AddAttributePrecondition.Match getOneArbitraryMatch(final TraceLink p$class, final TraceLink p$type, final String p$name) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink p$class, final TraceLink p$type, final String p$name, final IMatchProcessor<? super AddAttributePrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink p$class, final TraceLink p$type, final String p$name, final IMatchProcessor<? super AddAttributePrecondition.Match> processor) {
     ...
     * 
     */
    public AddAttributePrecondition.Match newMatch(final TraceLink p$class, final TraceLink p$type, final String p$name) {
      return AddAttributePrecondition.Match.newMatch(p$class, p$type, p$name);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$class(final AddAttributePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOf$type(final AddAttributePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOf$name(final AddAttributePrecondition.Match partialMatch) {
    ...
    protected AddAttributePrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return AddAttributePrecondition.Match.newMatch((TraceLink) t.get(POSITION_$CLASS), (TraceLink) t.get(POSITION_$TYPE), (String) t.get(POSITION_$NAME));
    ...
    protected AddAttributePrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return AddAttributePrecondition.Match.newMatch((TraceLink) match[POSITION_$CLASS], (TraceLink) match[POSITION_$TYPE], (String) match[POSITION_$NAME]);
      } catch(ClassCastException e) {
    ...
    protected AddAttributePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AddAttributePrecondition.Match.newMutableMatch((TraceLink) match[POSITION_$CLASS], (TraceLink) match[POSITION_$TYPE], (String) match[POSITION_$NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AddAttributePrecondition.Match newMatch(final Object... parameters) {
    return AddAttributePrecondition.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1], (java.lang.String) parameters[2]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var_$attribute_index = body.getOrCreateVariableByName("$attribute_index");
          ...
          // 	find get_datatype ($type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$type), Get_datatype.instance().getInternalQueryRepresentation());
          // 	$attribute_index == count find create_class_attribute ($class, _)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new PatternMatchCounter(body, Tuples.flatTupleOf(var_$class, var___0_), Create_class_attribute.instance().getInternalQueryRepresentation(), var__virtual_0_);
          new Equality(body, var_$attribute_index, var__virtual_0_);
          //  	$name == eval ("created_attribute_" + $attribute_index)
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern AddAttributePrecondition";
              }
              
              @Override
              public Iterable<String> getInputParameterNames() {
                  return Arrays.asList("$attribute_index");}
          
              @Override
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  Integer $attribute_index = (Integer) provider.getValue("$attribute_index");
                  return evaluateExpression_1_1($attribute_index);
              }
          },  var__virtual_1_ ); 
  ...
  private static String evaluateExpression_1_1(final Integer $attribute_index) {
    return ("created_attribute_" + $attribute_index);
  }
}
