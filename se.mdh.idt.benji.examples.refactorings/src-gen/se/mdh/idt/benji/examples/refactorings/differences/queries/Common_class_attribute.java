...
public final class Common_class_attribute extends BaseGeneratedEMFQuerySpecification<Common_class_attribute.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_attribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_attribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return Common_class_attribute.Match.parameterNames;
    }
    ...
    @Override
    public Common_class_attribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Common_class_attribute.Match)) {
          Common_class_attribute.Match other = (Common_class_attribute.Match) obj;
    ...
    @Override
    public Common_class_attribute specification() {
     ...
     * 
     */
    public static Common_class_attribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static Common_class_attribute.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Attribute pLeft_attribute, final Attribute pRight_attribute) {
     ...
     * 
     */
    public static Common_class_attribute.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Attribute pLeft_attribute, final Attribute pRight_attribute) {
      return new Immutable(pLeft_class, pRight_class, pLeft_attribute, pRight_attribute);
    }
    
    private static final class Mutable extends Common_class_attribute.Match {
    ...
    private static final class Immutable extends Common_class_attribute.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_attribute pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Common_class_attribute
   * 
   */
  public static class Matcher extends BaseMatcher<Common_class_attribute.Match> {
    /**
     ...
     * 
     */
    public static Common_class_attribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Common_class_attribute.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Common_class_attribute.Matcher.class);
     ...
     * 
     */
    public Collection<Common_class_attribute.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Attribute pLeft_attribute, final Attribute pRight_attribute) {
     ...
     * 
     */
    public Common_class_attribute.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Attribute pLeft_attribute, final Attribute pRight_attribute) {
     ...
     * 
     */
    public Common_class_attribute.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Attribute pLeft_attribute, final Attribute pRight_attribute) {
      return Common_class_attribute.Match.newMatch(pLeft_class, pRight_class, pLeft_attribute, pRight_attribute);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfleft_class(final Common_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfright_class(final Common_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfleft_attribute(final Common_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfright_attribute(final Common_class_attribute.Match partialMatch) {
    ...
    @Override
    protected Common_class_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return Common_class_attribute.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_LEFT_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_RIGHT_CLASS), (Attribute) t.get(POSITION_LEFT_ATTRIBUTE), (Attribute) t.get(POSITION_RIGHT_ATTRIBUTE));
    ...
    @Override
    protected Common_class_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return Common_class_attribute.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS], (Attribute) match[POSITION_LEFT_ATTRIBUTE], (Attribute) match[POSITION_RIGHT_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Common_class_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Common_class_attribute.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS], (Attribute) match[POSITION_LEFT_ATTRIBUTE], (Attribute) match[POSITION_RIGHT_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Common_class_attribute.Matcher> querySpecification() {
      return Common_class_attribute.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.common_class_attribute pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Common_class_attribute.Match> {
    /**
   ...
   * 
   */
  public static Common_class_attribute instance() {
    try{
  ...
  @Override
  protected Common_class_attribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return Common_class_attribute.Matcher.on(engine);
  }
  
  @Override
  public Common_class_attribute.Matcher instantiate() {
    return Common_class_attribute.Matcher.create();
  }
  
  @Override
  public Common_class_attribute.Match newEmptyMatch() {
    return Common_class_attribute.Match.newEmptyMatch();
  }
  
  @Override
  public Common_class_attribute.Match newMatch(final Object... parameters) {
    return Common_class_attribute.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_attribute (visibility: PUBLIC, simpleName: Common_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_attribute (visibility: PUBLIC, simpleName: Common_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.Common_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Common_class_attribute INSTANCE = new Common_class_attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Common_class_attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
