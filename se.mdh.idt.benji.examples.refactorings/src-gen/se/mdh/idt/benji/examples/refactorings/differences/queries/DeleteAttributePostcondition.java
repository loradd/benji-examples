...
public final class DeleteAttributePostcondition extends BaseGeneratedEMFQuerySpecification<DeleteAttributePostcondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition";
    }
     ...
     * 
     */
    public static DeleteAttributePostcondition.Match newMutableMatch(final Attribute pInitial_attribute) {
     ...
     * 
     */
    public static DeleteAttributePostcondition.Match newMatch(final Attribute pInitial_attribute) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition pattern,
   ...
   * pattern DeleteAttributePostcondition (initial_attribute : Attribute) {
   * 	find deleted_attribute (initial_attribute); 
   * }
   * </pre></code>
   * 
   * @see Match
  ...
  public static class Matcher extends BaseMatcher<DeleteAttributePostcondition.Match> {
     ...
     * 
     */
    public Collection<DeleteAttributePostcondition.Match> getAllMatches(final Attribute pInitial_attribute) {
     ...
     * 
     */
    public DeleteAttributePostcondition.Match getOneArbitraryMatch(final Attribute pInitial_attribute) {
     ...
     * 
     */
    public void forEachMatch(final Attribute pInitial_attribute, final IMatchProcessor<? super DeleteAttributePostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Attribute pInitial_attribute, final IMatchProcessor<? super DeleteAttributePostcondition.Match> processor) {
     ...
     * 
     */
    public DeleteAttributePostcondition.Match newMatch(final Attribute pInitial_attribute) {
      return DeleteAttributePostcondition.Match.newMatch(pInitial_attribute);
    }
    ...
    protected DeleteAttributePostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeleteAttributePostcondition.Match.newMatch((Attribute) t.get(POSITION_INITIAL_ATTRIBUTE));
    ...
    protected DeleteAttributePostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeleteAttributePostcondition.Match.newMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected DeleteAttributePostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeleteAttributePostcondition.Match.newMutableMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition pattern.
   * 
  ...
  public DeleteAttributePostcondition.Match newMatch(final Object... parameters) {
    return DeleteAttributePostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition (visibility: PUBLIC, simpleName: DeleteAttributePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition (visibility: PUBLIC, simpleName: DeleteAttributePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find deleted_attribute (initial_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_attribute), Deleted_attribute.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
