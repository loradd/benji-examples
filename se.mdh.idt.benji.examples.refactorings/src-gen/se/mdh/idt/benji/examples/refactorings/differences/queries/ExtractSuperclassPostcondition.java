...
public final class ExtractSuperclassPostcondition extends BaseGeneratedEMFQuerySpecification<ExtractSuperclassPostcondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("initial_package", "current_package", "initial_class", "current_class", "initial_attribute", "current_attribute", "initial_reference", "current_reference", "current_superClass");
    
    private Match(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition";
    }
    ...
    public Object[] toArray() {
      return new Object[]{fInitial_package, fCurrent_package, fInitial_class, fCurrent_class, fInitial_attribute, fCurrent_attribute, fInitial_reference, fCurrent_reference, fCurrent_superClass};
    }
    
    @Override
    public ExtractSuperclassPostcondition.Match toImmutable() {
      return isMutable() ? newMatch(fInitial_package, fCurrent_package, fInitial_class, fCurrent_class, fInitial_attribute, fCurrent_attribute, fInitial_reference, fCurrent_reference, fCurrent_superClass) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fInitial_package, fCurrent_package, fInitial_class, fCurrent_class, fInitial_attribute, fCurrent_attribute, fInitial_reference, fCurrent_reference, fCurrent_superClass);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtractSuperclassPostcondition.Match)) {
          ...
          return Objects.equals(fInitial_package, other.fInitial_package) && Objects.equals(fCurrent_package, other.fCurrent_package) && Objects.equals(fInitial_class, other.fInitial_class) && Objects.equals(fCurrent_class, other.fCurrent_class) && Objects.equals(fInitial_attribute, other.fInitial_attribute) && Objects.equals(fCurrent_attribute, other.fCurrent_attribute) && Objects.equals(fInitial_reference, other.fInitial_reference) && Objects.equals(fCurrent_reference, other.fCurrent_reference) && Objects.equals(fCurrent_superClass, other.fCurrent_superClass);
      } else {
     ...
     * 
     */
    public static ExtractSuperclassPostcondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return new Mutable(pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass);
    }
     ...
     * 
     */
    public static ExtractSuperclassPostcondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return new Immutable(pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass);
    }
    ...
    private static final class Mutable extends ExtractSuperclassPostcondition.Match {
      Mutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
        super(pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition pattern,
  ...
  public static class Matcher extends BaseMatcher<ExtractSuperclassPostcondition.Match> {
    ...
    private final static int POSITION_CURRENT_SUPERCLASS = 8;
     ...
     * 
     */
    public Collection<ExtractSuperclassPostcondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return rawGetAllMatches(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass});
    }
     ...
     * 
     */
    public ExtractSuperclassPostcondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return rawGetOneArbitraryMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass});
    }
    ...
    public boolean hasMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return rawHasMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass});
    }
    ...
    public int countMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return rawCountMatches(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass});
    }
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass, final IMatchProcessor<? super ExtractSuperclassPostcondition.Match> processor) {
      rawForEachMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass}, processor);
    }
    ...
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass, final IMatchProcessor<? super ExtractSuperclassPostcondition.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass}, processor);
    }
     ...
     * 
     */
    public ExtractSuperclassPostcondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
      return ExtractSuperclassPostcondition.Match.newMatch(pInitial_package, pCurrent_package, pInitial_class, pCurrent_class, pInitial_attribute, pCurrent_attribute, pInitial_reference, pCurrent_reference, pCurrent_superClass);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_superClass) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_superClass(final ExtractSuperclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_superClass(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final Reference pInitial_reference, final Reference pCurrent_reference) {
    ...
    protected ExtractSuperclassPostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return ExtractSuperclassPostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_SUPERCLASS]);
      } catch(ClassCastException e) {
    ...
    protected ExtractSuperclassPostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtractSuperclassPostcondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_SUPERCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition pattern.
   * 
  ...
  public static abstract class Processor implements IMatchProcessor<ExtractSuperclassPostcondition.Match> {
    ...
    public void process(final ExtractSuperclassPostcondition.Match match) {
      process(match.getInitial_package(), match.getCurrent_package(), match.getInitial_class(), match.getCurrent_class(), match.getInitial_attribute(), match.getCurrent_attribute(), match.getInitial_reference(), match.getCurrent_reference(), match.getCurrent_superClass());
    }
  }
  ...
  public ExtractSuperclassPostcondition.Match newMatch(final Object... parameters) {
    return ExtractSuperclassPostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[3], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[4], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[5], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[6], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[7], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[8]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition (visibility: PUBLIC, simpleName: ExtractSuperclassPostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition (visibility: PUBLIC, simpleName: ExtractSuperclassPostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.ExtractSuperclassPostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pInitial_package, parameter_pCurrent_package, parameter_pInitial_class, parameter_pCurrent_class, parameter_pInitial_attribute, parameter_pCurrent_attribute, parameter_pInitial_reference, parameter_pCurrent_reference, parameter_pCurrent_superClass);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("initial_package","current_package","initial_class","current_class","initial_attribute","current_attribute","initial_reference","current_reference","current_superClass");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find added_package_class (initial_package, current_package, current_superClass)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_package, var_current_package, var_current_superClass), Added_package_class.instance().getInternalQueryRepresentation());
          //  	find added_class_superClass (initial_class, current_class, current_superClass)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_class, var_current_class, var_current_superClass), Added_class_superClass.instance().getInternalQueryRepresentation());
          //  	find changed_attribute_owner (initial_attribute, current_attribute, initial_class, current_superClass)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_attribute, var_current_attribute, var_initial_class, var_current_superClass), Changed_attribute_owner.instance().getInternalQueryRepresentation());
          //  	find changed_reference_owner (initial_reference, current_reference, initial_class, current_superClass)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference, var_initial_class, var_current_superClass), Changed_reference_owner.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
