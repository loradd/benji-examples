...
public final class Merge_class_attribute extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Merge_class_attribute() {
   ...
   * 
   */
  public static Merge_class_attribute instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_attribute (visibility: PUBLIC, simpleName: Merge_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_attribute (visibility: PUBLIC, simpleName: Merge_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Merge_class_attribute INSTANCE = new Merge_class_attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Merge_class_attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$left_class, parameter_p$right_class, parameter_p$left_attribute, parameter_p$right_attribute, parameter_p$target_class);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.merge_class_attribute";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$left_class","$right_class","$left_attribute","$right_attribute","$target_class");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_attribute, var_$right_attribute, var_$target_attribute), Merge_attribute_name.instance().getInternalQueryRepresentation());
          //  	find merge_attribute_type ($left_attribute, $right_attribute, $target_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_attribute, var_$right_attribute, var_$target_attribute), Merge_attribute_type.instance().getInternalQueryRepresentation());
          // 	find delete_class_attribute ($left_class, $left_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$left_attribute), Delete_class_attribute.instance().getInternalQueryRepresentation());
          // 	find delete_class_attribute ($right_class, $right_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$right_class, var_$right_attribute), Delete_class_attribute.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
