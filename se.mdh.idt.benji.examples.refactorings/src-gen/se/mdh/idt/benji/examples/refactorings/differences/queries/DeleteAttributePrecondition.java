...
public final class DeleteAttributePrecondition extends BaseGeneratedEMFQuerySpecification<DeleteAttributePrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeleteAttributePrecondition.Match.parameterNames;
    }
    ...
    @Override
    public DeleteAttributePrecondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeleteAttributePrecondition.Match)) {
          DeleteAttributePrecondition.Match other = (DeleteAttributePrecondition.Match) obj;
    ...
    @Override
    public DeleteAttributePrecondition specification() {
     ...
     * 
     */
    public static DeleteAttributePrecondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeleteAttributePrecondition.Match newMutableMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public static DeleteAttributePrecondition.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return new Immutable(pInitial_attribute, pCurrent_attribute);
    }
    
    private static final class Mutable extends DeleteAttributePrecondition.Match {
    ...
    private static final class Immutable extends DeleteAttributePrecondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition pattern,
   ...
   * pattern DeleteAttributePrecondition (initial_attribute : Attribute, current_attribute : Attribute) {
   ...
   * @see Match
   *  @see Processor
   * @see DeleteAttributePrecondition
   * 
   */
  public static class Matcher extends BaseMatcher<DeleteAttributePrecondition.Match> {
    /**
     ...
     * 
     */
    public static DeleteAttributePrecondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeleteAttributePrecondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeleteAttributePrecondition.Matcher.class);
     ...
     * 
     */
    public Collection<DeleteAttributePrecondition.Match> getAllMatches(final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public DeleteAttributePrecondition.Match getOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public void forEachMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super DeleteAttributePrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super DeleteAttributePrecondition.Match> processor) {
     ...
     * 
     */
    public DeleteAttributePrecondition.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute) {
      return DeleteAttributePrecondition.Match.newMatch(pInitial_attribute, pCurrent_attribute);
    }
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final DeleteAttributePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final DeleteAttributePrecondition.Match partialMatch) {
    ...
    @Override
    protected DeleteAttributePrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeleteAttributePrecondition.Match.newMatch((Attribute) t.get(POSITION_INITIAL_ATTRIBUTE), (Attribute) t.get(POSITION_CURRENT_ATTRIBUTE));
    ...
    @Override
    protected DeleteAttributePrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeleteAttributePrecondition.Match.newMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeleteAttributePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeleteAttributePrecondition.Match.newMutableMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeleteAttributePrecondition.Matcher> querySpecification() {
      return DeleteAttributePrecondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<DeleteAttributePrecondition.Match> {
    /**
    ...
    @Override
    public void process(final DeleteAttributePrecondition.Match match) {
      process(match.getInitial_attribute(), match.getCurrent_attribute());
    }
  }
  
  private DeleteAttributePrecondition() {
   ...
   * 
   */
  public static DeleteAttributePrecondition instance() {
    try{
  ...
  @Override
  protected DeleteAttributePrecondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeleteAttributePrecondition.Matcher.on(engine);
  }
  
  @Override
  public DeleteAttributePrecondition.Matcher instantiate() {
    return DeleteAttributePrecondition.Matcher.create();
  }
  
  @Override
  public DeleteAttributePrecondition.Match newEmptyMatch() {
    return DeleteAttributePrecondition.Match.newEmptyMatch();
  }
  
  @Override
  public DeleteAttributePrecondition.Match newMatch(final Object... parameters) {
    return DeleteAttributePrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition (visibility: PUBLIC, simpleName: DeleteAttributePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition (visibility: PUBLIC, simpleName: DeleteAttributePrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteAttributePrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DeleteAttributePrecondition INSTANCE = new DeleteAttributePrecondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DeleteAttributePrecondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
