...
public final class Move_attribute_name extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Move_attribute_name() {
   ...
   * 
   */
  public static Move_attribute_name instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_name (visibility: PUBLIC, simpleName: Move_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_name (visibility: PUBLIC, simpleName: Move_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Move_attribute_name INSTANCE = new Move_attribute_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Move_attribute_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$source_attribute, parameter_p$target_attribute);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.move_attribute_name";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$source_attribute","$target_attribute");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$source_attribute, var_$name), Unset_attribute_name.instance().getInternalQueryRepresentation());
