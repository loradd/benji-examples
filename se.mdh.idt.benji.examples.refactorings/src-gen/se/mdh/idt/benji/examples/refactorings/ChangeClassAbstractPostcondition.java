...
public final class ChangeClassAbstractPostcondition extends BaseGeneratedEMFQuerySpecification<ChangeClassAbstractPostcondition.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ChangeClassAbstractPostcondition.Match newMutableMatch(final Trace pClass) {
     ...
     * 
     */
    public static ChangeClassAbstractPostcondition.Match newMatch(final Trace pClass) {
  ...
  public static class Matcher extends BaseMatcher<ChangeClassAbstractPostcondition.Match> {
     ...
     * 
     */
    public Collection<ChangeClassAbstractPostcondition.Match> getAllMatches(final Trace pClass) {
     ...
     * 
     */
    public ChangeClassAbstractPostcondition.Match getOneArbitraryMatch(final Trace pClass) {
     ...
     * 
     */
    public void forEachMatch(final Trace pClass, final IMatchProcessor<? super ChangeClassAbstractPostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pClass, final IMatchProcessor<? super ChangeClassAbstractPostcondition.Match> processor) {
     ...
     * 
     */
    public ChangeClassAbstractPostcondition.Match newMatch(final Trace pClass) {
      return ChangeClassAbstractPostcondition.Match.newMatch(pClass);
    }
    ...
    protected ChangeClassAbstractPostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return ChangeClassAbstractPostcondition.Match.newMatch((Trace) t.get(POSITION_CLASS));
    ...
    protected ChangeClassAbstractPostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return ChangeClassAbstractPostcondition.Match.newMatch((Trace) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    protected ChangeClassAbstractPostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ChangeClassAbstractPostcondition.Match.newMutableMatch((Trace) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_class, var__virtual_0_), Set_class_abstract.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
