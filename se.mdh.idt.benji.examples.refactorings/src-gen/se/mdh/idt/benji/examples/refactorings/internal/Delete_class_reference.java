...
public final class Delete_class_reference extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Delete_class_reference() {
   ...
   * 
   */
  public static Delete_class_reference instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference (visibility: PUBLIC, simpleName: Delete_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference (visibility: PUBLIC, simpleName: Delete_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Delete_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Delete_class_reference INSTANCE = new Delete_class_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Delete_class_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.delete_class_reference";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$class, var_$reference), Remove_class_reference.instance().getInternalQueryRepresentation());
