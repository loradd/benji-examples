...
public final class Move_class_reference_difference extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Move_class_reference_difference() {
   ...
   * 
   */
  public static Move_class_reference_difference instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference_difference (visibility: PUBLIC, simpleName: Move_class_reference_difference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference_difference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference_difference (visibility: PUBLIC, simpleName: Move_class_reference_difference, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_class_reference_difference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Move_class_reference_difference INSTANCE = new Move_class_reference_difference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Move_class_reference_difference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_p$left_class, parameter_p$right_class, parameter_p$left_reference, parameter_p$target_class);
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.move_class_reference_difference";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("$left_class","$right_class","$left_reference","$target_class");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$right_class, var_$left_reference), Delete_class_reference_difference.instance().getInternalQueryRepresentation());
          // 	find move_class_reference ($left_class, $left_reference, $target_class)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_class, var_$left_reference, var_$target_class), Move_class_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
