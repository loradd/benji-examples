...
public final class AddReferencePrecondition extends BaseGeneratedEMFQuerySpecification<AddReferencePrecondition.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static AddReferencePrecondition.Match newMutableMatch(final Trace pClass, final Trace pType, final String pName) {
     ...
     * 
     */
    public static AddReferencePrecondition.Match newMatch(final Trace pClass, final Trace pType, final String pName) {
  ...
  public static class Matcher extends BaseMatcher<AddReferencePrecondition.Match> {
     ...
     * 
     */
    public Collection<AddReferencePrecondition.Match> getAllMatches(final Trace pClass, final Trace pType, final String pName) {
     ...
     * 
     */
    public AddReferencePrecondition.Match getOneArbitraryMatch(final Trace pClass, final Trace pType, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final Trace pClass, final Trace pType, final String pName, final IMatchProcessor<? super AddReferencePrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pClass, final Trace pType, final String pName, final IMatchProcessor<? super AddReferencePrecondition.Match> processor) {
     ...
     * 
     */
    public AddReferencePrecondition.Match newMatch(final Trace pClass, final Trace pType, final String pName) {
      return AddReferencePrecondition.Match.newMatch(pClass, pType, pName);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfclass(final AddReferencePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOftype(final AddReferencePrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final AddReferencePrecondition.Match partialMatch) {
    ...
    protected AddReferencePrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return AddReferencePrecondition.Match.newMatch((Trace) t.get(POSITION_CLASS), (Trace) t.get(POSITION_TYPE), (String) t.get(POSITION_NAME));
    ...
    protected AddReferencePrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return AddReferencePrecondition.Match.newMatch((Trace) match[POSITION_CLASS], (Trace) match[POSITION_TYPE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected AddReferencePrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AddReferencePrecondition.Match.newMutableMatch((Trace) match[POSITION_CLASS], (Trace) match[POSITION_TYPE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AddReferencePrecondition.Match newMatch(final Object... parameters) {
    return AddReferencePrecondition.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.trace.Trace) parameters[1], (java.lang.String) parameters[2]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find generate_class_reference_name (class, name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_class, var_name), Generate_class_reference_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
