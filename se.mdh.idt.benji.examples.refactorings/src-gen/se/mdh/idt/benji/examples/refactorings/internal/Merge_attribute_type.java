...
public final class Merge_attribute_type extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Merge_attribute_type() {
   ...
   * 
   */
  public static Merge_attribute_type instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_attribute_type (visibility: PUBLIC, simpleName: Merge_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Merge_attribute_type (visibility: PUBLIC, simpleName: Merge_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.internal.Merge_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Merge_attribute_type INSTANCE = new Merge_attribute_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Merge_attribute_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.merge_attribute_type";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$left_attribute, var_$type), Unset_attribute_type.instance().getInternalQueryRepresentation());
          // 	find unset_attribute_type ($right_attribute, $type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$right_attribute, var_$type), Unset_attribute_type.instance().getInternalQueryRepresentation());
          // 	find set_attribute_type ($target_attribute, $type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$target_attribute, var_$type), Set_attribute_type.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
