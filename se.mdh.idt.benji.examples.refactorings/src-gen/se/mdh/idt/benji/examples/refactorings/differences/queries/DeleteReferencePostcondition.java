...
public final class DeleteReferencePostcondition extends BaseGeneratedEMFQuerySpecification<DeleteReferencePostcondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition";
    }
     ...
     * 
     */
    public static DeleteReferencePostcondition.Match newMutableMatch(final Reference pInitial_reference) {
     ...
     * 
     */
    public static DeleteReferencePostcondition.Match newMatch(final Reference pInitial_reference) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition pattern,
   ...
   * pattern DeleteReferencePostcondition (initial_reference : Reference) {
   * 	find deleted_reference (initial_reference); 
   * }
   * </pre></code>
   * 
   * @see Match
  ...
  public static class Matcher extends BaseMatcher<DeleteReferencePostcondition.Match> {
     ...
     * 
     */
    public Collection<DeleteReferencePostcondition.Match> getAllMatches(final Reference pInitial_reference) {
     ...
     * 
     */
    public DeleteReferencePostcondition.Match getOneArbitraryMatch(final Reference pInitial_reference) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final IMatchProcessor<? super DeleteReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final IMatchProcessor<? super DeleteReferencePostcondition.Match> processor) {
     ...
     * 
     */
    public DeleteReferencePostcondition.Match newMatch(final Reference pInitial_reference) {
      return DeleteReferencePostcondition.Match.newMatch(pInitial_reference);
    }
    ...
    protected DeleteReferencePostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeleteReferencePostcondition.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE));
    ...
    protected DeleteReferencePostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeleteReferencePostcondition.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected DeleteReferencePostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeleteReferencePostcondition.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition pattern.
   * 
  ...
  public DeleteReferencePostcondition.Match newMatch(final Object... parameters) {
    return DeleteReferencePostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition (visibility: PUBLIC, simpleName: DeleteReferencePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition (visibility: PUBLIC, simpleName: DeleteReferencePostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteReferencePostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find deleted_reference (initial_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference), Deleted_reference.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
