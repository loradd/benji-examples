...
public final class Generate_attribute_class_name extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Generate_attribute_class_name() {
   ...
   * 
   */
  public static Generate_attribute_class_name instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Generate_attribute_class_name (visibility: PUBLIC, simpleName: Generate_attribute_class_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Generate_attribute_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Generate_attribute_class_name (visibility: PUBLIC, simpleName: Generate_attribute_class_name, identifier: se.mdh.idt.benji.examples.refactorings.internal.Generate_attribute_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Generate_attribute_class_name INSTANCE = new Generate_attribute_class_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Generate_attribute_class_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.generate_attribute_class_name";
    }
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern generate_attribute_class_name";
              }
