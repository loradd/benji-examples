...
public final class DeleteMetaclassPrecondition extends BaseGeneratedEMFQuerySpecification<DeleteMetaclassPrecondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeleteMetaclassPrecondition.Match.parameterNames;
    }
    ...
    @Override
    public DeleteMetaclassPrecondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeleteMetaclassPrecondition.Match)) {
          DeleteMetaclassPrecondition.Match other = (DeleteMetaclassPrecondition.Match) obj;
    ...
    @Override
    public DeleteMetaclassPrecondition specification() {
     ...
     * 
     */
    public static DeleteMetaclassPrecondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeleteMetaclassPrecondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public static DeleteMetaclassPrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
      return new Immutable(pInitial_metaclass, pCurrent_metaclass);
    }
    
    private static final class Mutable extends DeleteMetaclassPrecondition.Match {
    ...
    private static final class Immutable extends DeleteMetaclassPrecondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // CDCR7 - Delete Metaclass - Precondition
   * pattern DeleteMetaclassPrecondition (initial_metaclass : Class, current_metaclass : Class) {
   * 	find preserved_class (initial_metaclass, current_metaclass); 	
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see DeleteMetaclassPrecondition
   * 
   */
  public static class Matcher extends BaseMatcher<DeleteMetaclassPrecondition.Match> {
    /**
     ...
     * 
     */
    public static DeleteMetaclassPrecondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeleteMetaclassPrecondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeleteMetaclassPrecondition.Matcher.class);
     ...
     * 
     */
    public Collection<DeleteMetaclassPrecondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public DeleteMetaclassPrecondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final IMatchProcessor<? super DeleteMetaclassPrecondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final IMatchProcessor<? super DeleteMetaclassPrecondition.Match> processor) {
     ...
     * 
     */
    public DeleteMetaclassPrecondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
      return DeleteMetaclassPrecondition.Match.newMatch(pInitial_metaclass, pCurrent_metaclass);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_metaclass(final DeleteMetaclassPrecondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_metaclass(final DeleteMetaclassPrecondition.Match partialMatch) {
    ...
    @Override
    protected DeleteMetaclassPrecondition.Match tupleToMatch(final Tuple t) {
      try {
          return DeleteMetaclassPrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_METACLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_METACLASS));
    ...
    @Override
    protected DeleteMetaclassPrecondition.Match arrayToMatch(final Object[] match) {
      try {
          return DeleteMetaclassPrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_METACLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_METACLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeleteMetaclassPrecondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeleteMetaclassPrecondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_METACLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_METACLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeleteMetaclassPrecondition.Matcher> querySpecification() {
      return DeleteMetaclassPrecondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<DeleteMetaclassPrecondition.Match> {
    /**
    ...
    @Override
    public void process(final DeleteMetaclassPrecondition.Match match) {
      process(match.getInitial_metaclass(), match.getCurrent_metaclass());
    }
  }
  
  private DeleteMetaclassPrecondition() {
   ...
   * 
   */
  public static DeleteMetaclassPrecondition instance() {
    try{
  ...
  @Override
  protected DeleteMetaclassPrecondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeleteMetaclassPrecondition.Matcher.on(engine);
  }
  
  @Override
  public DeleteMetaclassPrecondition.Matcher instantiate() {
    return DeleteMetaclassPrecondition.Matcher.create();
  }
  
  @Override
  public DeleteMetaclassPrecondition.Match newEmptyMatch() {
    return DeleteMetaclassPrecondition.Match.newEmptyMatch();
  }
  
  @Override
  public DeleteMetaclassPrecondition.Match newMatch(final Object... parameters) {
    return DeleteMetaclassPrecondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition (visibility: PUBLIC, simpleName: DeleteMetaclassPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition (visibility: PUBLIC, simpleName: DeleteMetaclassPrecondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.DeleteMetaclassPrecondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DeleteMetaclassPrecondition INSTANCE = new DeleteMetaclassPrecondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DeleteMetaclassPrecondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_class (initial_metaclass, current_metaclass)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_metaclass, var_current_metaclass), Preserved_class.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
