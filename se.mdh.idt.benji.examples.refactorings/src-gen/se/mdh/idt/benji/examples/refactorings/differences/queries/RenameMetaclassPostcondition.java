...
public final class RenameMetaclassPostcondition extends BaseGeneratedEMFQuerySpecification<RenameMetaclassPostcondition.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return RenameMetaclassPostcondition.Match.parameterNames;
    }
    ...
    @Override
    public RenameMetaclassPostcondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RenameMetaclassPostcondition.Match)) {
          RenameMetaclassPostcondition.Match other = (RenameMetaclassPostcondition.Match) obj;
    ...
    @Override
    public RenameMetaclassPostcondition specification() {
     ...
     * 
     */
    public static RenameMetaclassPostcondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static RenameMetaclassPostcondition.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public static RenameMetaclassPostcondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
      return new Immutable(pInitial_metaclass, pCurrent_metaclass);
    }
    
    private static final class Mutable extends RenameMetaclassPostcondition.Match {
    ...
    private static final class Immutable extends RenameMetaclassPostcondition.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // ACC6 - Rename Metaclass - Postcondition
   * pattern RenameMetaclassPostcondition (initial_metaclass : Class, current_metaclass : Class) {
   * 	find changed_class_name (initial_metaclass, current_metaclass, _initial_name, _current_name); 
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see RenameMetaclassPostcondition
   * 
   */
  public static class Matcher extends BaseMatcher<RenameMetaclassPostcondition.Match> {
    /**
     ...
     * 
     */
    public static RenameMetaclassPostcondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RenameMetaclassPostcondition.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RenameMetaclassPostcondition.Matcher.class);
     ...
     * 
     */
    public Collection<RenameMetaclassPostcondition.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public RenameMetaclassPostcondition.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final IMatchProcessor<? super RenameMetaclassPostcondition.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass, final IMatchProcessor<? super RenameMetaclassPostcondition.Match> processor) {
     ...
     * 
     */
    public RenameMetaclassPostcondition.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_metaclass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_metaclass) {
      return RenameMetaclassPostcondition.Match.newMatch(pInitial_metaclass, pCurrent_metaclass);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_metaclass(final RenameMetaclassPostcondition.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_metaclass(final RenameMetaclassPostcondition.Match partialMatch) {
    ...
    @Override
    protected RenameMetaclassPostcondition.Match tupleToMatch(final Tuple t) {
      try {
          return RenameMetaclassPostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_METACLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_METACLASS));
    ...
    @Override
    protected RenameMetaclassPostcondition.Match arrayToMatch(final Object[] match) {
      try {
          return RenameMetaclassPostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_METACLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_METACLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RenameMetaclassPostcondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RenameMetaclassPostcondition.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_METACLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_METACLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RenameMetaclassPostcondition.Matcher> querySpecification() {
      return RenameMetaclassPostcondition.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<RenameMetaclassPostcondition.Match> {
    /**
    ...
    @Override
    public void process(final RenameMetaclassPostcondition.Match match) {
      process(match.getInitial_metaclass(), match.getCurrent_metaclass());
    }
  }
  
  private RenameMetaclassPostcondition() {
   ...
   * 
   */
  public static RenameMetaclassPostcondition instance() {
    try{
  ...
  @Override
  protected RenameMetaclassPostcondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return RenameMetaclassPostcondition.Matcher.on(engine);
  }
  
  @Override
  public RenameMetaclassPostcondition.Matcher instantiate() {
    return RenameMetaclassPostcondition.Matcher.create();
  }
  
  @Override
  public RenameMetaclassPostcondition.Match newEmptyMatch() {
    return RenameMetaclassPostcondition.Match.newEmptyMatch();
  }
  
  @Override
  public RenameMetaclassPostcondition.Match newMatch(final Object... parameters) {
    return RenameMetaclassPostcondition.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition (visibility: PUBLIC, simpleName: RenameMetaclassPostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition (visibility: PUBLIC, simpleName: RenameMetaclassPostcondition, identifier: se.mdh.idt.benji.examples.refactorings.differences.queries.RenameMetaclassPostcondition, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.differences.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static RenameMetaclassPostcondition INSTANCE = new RenameMetaclassPostcondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static RenameMetaclassPostcondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_class_name (initial_metaclass, current_metaclass, _initial_name, _current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_metaclass, var_current_metaclass, var__initial_name, var__current_name), Changed_class_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
