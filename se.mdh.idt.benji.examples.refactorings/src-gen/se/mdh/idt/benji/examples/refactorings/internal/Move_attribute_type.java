...
public final class Move_attribute_type extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Move_attribute_type() {
   ...
   * 
   */
  public static Move_attribute_type instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_type (visibility: PUBLIC, simpleName: Move_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_type (visibility: PUBLIC, simpleName: Move_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.internal.Move_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Move_attribute_type INSTANCE = new Move_attribute_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Move_attribute_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "se.mdh.idt.benji.examples.refactorings.move_attribute_type";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_$source_attribute, var_$type), Unset_attribute_type.instance().getInternalQueryRepresentation());
