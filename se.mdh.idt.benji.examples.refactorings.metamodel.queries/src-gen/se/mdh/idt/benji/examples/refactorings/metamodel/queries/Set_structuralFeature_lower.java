...
public final class Set_structuralFeature_lower extends BaseGeneratedEMFQuerySpecification<Set_structuralFeature_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_structuralFeature_lower.Match.parameterNames;
    }
    ...
    @Override
    public Set_structuralFeature_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_structuralFeature_lower.Match)) {
          Set_structuralFeature_lower.Match other = (Set_structuralFeature_lower.Match) obj;
    ...
    @Override
    public Set_structuralFeature_lower specification() {
     ...
     * 
     */
    public static Set_structuralFeature_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_structuralFeature_lower.Match newMutableMatch(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public static Set_structuralFeature_lower.Match newMatch(final TraceLink pStructuralFeature, final Integer pLower) {
      return new Immutable(pStructuralFeature, pLower);
    }
    
    private static final class Mutable extends Set_structuralFeature_lower.Match {
    ...
    private static final class Immutable extends Set_structuralFeature_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_lower pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_structuralFeature_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Set_structuralFeature_lower.Match> {
    /**
     ...
     * 
     */
    public static Set_structuralFeature_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_structuralFeature_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_structuralFeature_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Set_structuralFeature_lower.Match> getAllMatches(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public Set_structuralFeature_lower.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final Integer pLower, final IMatchProcessor<? super Set_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pLower, final IMatchProcessor<? super Set_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public Set_structuralFeature_lower.Match newMatch(final TraceLink pStructuralFeature, final Integer pLower) {
      return Set_structuralFeature_lower.Match.newMatch(pStructuralFeature, pLower);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Set_structuralFeature_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOflower(final Set_structuralFeature_lower.Match partialMatch) {
    ...
    @Override
    protected Set_structuralFeature_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Set_structuralFeature_lower.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (Integer) t.get(POSITION_LOWER));
    ...
    @Override
    protected Set_structuralFeature_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Set_structuralFeature_lower.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_structuralFeature_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_structuralFeature_lower.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_structuralFeature_lower.Matcher> querySpecification() {
      return Set_structuralFeature_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_structuralFeature_lower.Match> {
    /**
    ...
    @Override
    public void process(final Set_structuralFeature_lower.Match match) {
      process(match.getStructuralFeature(), match.getLower());
    }
  }
  
  private Set_structuralFeature_lower() {
   ...
   * 
   */
  public static Set_structuralFeature_lower instance() {
    try{
  ...
  @Override
  protected Set_structuralFeature_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_structuralFeature_lower.Matcher.on(engine);
  }
  
  @Override
  public Set_structuralFeature_lower.Matcher instantiate() {
    return Set_structuralFeature_lower.Matcher.create();
  }
  
  @Override
  public Set_structuralFeature_lower.Match newEmptyMatch() {
    return Set_structuralFeature_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Set_structuralFeature_lower.Match newMatch(final Object... parameters) {
    return Set_structuralFeature_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_lower (visibility: PUBLIC, simpleName: Set_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_lower (visibility: PUBLIC, simpleName: Set_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_structuralFeature_lower INSTANCE = new Set_structuralFeature_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_structuralFeature_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_structuralFeature_lower (structuralFeature, _initial_structuralFeature, lower)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_structuralFeature, var__initial_structuralFeature, var_lower), Initial_structuralFeature_lower.instance().getInternalQueryRepresentation());
          // 	find current_structuralFeature_lower (structuralFeature, _current_structuralFeature, lower)
