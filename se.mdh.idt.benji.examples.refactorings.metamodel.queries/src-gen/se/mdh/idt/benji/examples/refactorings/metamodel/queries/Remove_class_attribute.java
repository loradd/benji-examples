...
public final class Remove_class_attribute extends BaseGeneratedEMFQuerySpecification<Remove_class_attribute.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_attribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_attribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return Remove_class_attribute.Match.parameterNames;
    }
    ...
    @Override
    public Remove_class_attribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Remove_class_attribute.Match)) {
          Remove_class_attribute.Match other = (Remove_class_attribute.Match) obj;
    ...
    @Override
    public Remove_class_attribute specification() {
     ...
     * 
     */
    public static Remove_class_attribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static Remove_class_attribute.Match newMutableMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public static Remove_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
      return new Immutable(pClass, pAttribute);
    }
    
    private static final class Mutable extends Remove_class_attribute.Match {
    ...
    private static final class Immutable extends Remove_class_attribute.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_attribute pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Remove_class_attribute
   * 
   */
  public static class Matcher extends BaseMatcher<Remove_class_attribute.Match> {
    /**
     ...
     * 
     */
    public static Remove_class_attribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Remove_class_attribute.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Remove_class_attribute.Matcher.class);
     ...
     * 
     */
    public Collection<Remove_class_attribute.Match> getAllMatches(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public Remove_class_attribute.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super Remove_class_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super Remove_class_attribute.Match> processor) {
     ...
     * 
     */
    public Remove_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
      return Remove_class_attribute.Match.newMatch(pClass, pAttribute);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Remove_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Remove_class_attribute.Match partialMatch) {
    ...
    @Override
    protected Remove_class_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return Remove_class_attribute.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    @Override
    protected Remove_class_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return Remove_class_attribute.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Remove_class_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Remove_class_attribute.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Remove_class_attribute.Matcher> querySpecification() {
      return Remove_class_attribute.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_attribute pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Remove_class_attribute.Match> {
    /**
    ...
    @Override
    public void process(final Remove_class_attribute.Match match) {
      process(match.getValueOfClass(), match.getAttribute());
    }
  }
  
  private Remove_class_attribute() {
   ...
   * 
   */
  public static Remove_class_attribute instance() {
    try{
  ...
  @Override
  protected Remove_class_attribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return Remove_class_attribute.Matcher.on(engine);
  }
  
  @Override
  public Remove_class_attribute.Matcher instantiate() {
    return Remove_class_attribute.Matcher.create();
  }
  
  @Override
  public Remove_class_attribute.Match newEmptyMatch() {
    return Remove_class_attribute.Match.newEmptyMatch();
  }
  
  @Override
  public Remove_class_attribute.Match newMatch(final Object... parameters) {
    return Remove_class_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_attribute (visibility: PUBLIC, simpleName: Remove_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_attribute (visibility: PUBLIC, simpleName: Remove_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Remove_class_attribute INSTANCE = new Remove_class_attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Remove_class_attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find initial_class_attribute (class, _initial_class, attribute, _initial_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_class, var__initial_class, var_attribute, var__initial_attribute), Initial_class_attribute.instance().getInternalQueryRepresentation());
          // 	neg find current_class_attribute (class, _current_class, attribute, _current_attribute)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__current_class, var_attribute, var__current_attribute), Current_class_attribute.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
