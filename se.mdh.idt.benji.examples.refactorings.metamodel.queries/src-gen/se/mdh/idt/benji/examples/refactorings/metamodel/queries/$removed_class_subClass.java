...
public final class $removed_class_subClass extends BaseGeneratedEMFQuerySpecification<$removed_class_subClass.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $removed_class_subClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public static $removed_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
  ...
  public static class Matcher extends BaseMatcher<$removed_class_subClass.Match> {
     ...
     * 
     */
    public Collection<$removed_class_subClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public $removed_class_subClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $removed_class_subClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $removed_class_subClass.Match> processor) {
     ...
     * 
     */
    public $removed_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
      return $removed_class_subClass.Match.newMatch(pClass, pSubClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $removed_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubClass(final $removed_class_subClass.Match partialMatch) {
    ...
    protected $removed_class_subClass.Match tupleToMatch(final Tuple t) {
      try {
          return $removed_class_subClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUBCLASS));
    ...
    protected $removed_class_subClass.Match arrayToMatch(final Object[] match) {
      try {
          return $removed_class_subClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
    ...
    protected $removed_class_subClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $removed_class_subClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $removed_class_subClass.Match newMatch(final Object... parameters) {
    return $removed_class_subClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
