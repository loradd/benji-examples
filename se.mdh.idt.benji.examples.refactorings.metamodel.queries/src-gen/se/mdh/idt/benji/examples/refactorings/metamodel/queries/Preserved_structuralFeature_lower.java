...
public final class Preserved_structuralFeature_lower extends BaseGeneratedEMFQuerySpecification<Preserved_structuralFeature_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_structuralFeature_lower.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_structuralFeature_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_structuralFeature_lower.Match)) {
          Preserved_structuralFeature_lower.Match other = (Preserved_structuralFeature_lower.Match) obj;
    ...
    @Override
    public Preserved_structuralFeature_lower specification() {
     ...
     * 
     */
    public static Preserved_structuralFeature_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_structuralFeature_lower.Match newMutableMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public static Preserved_structuralFeature_lower.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower) {
      return new Immutable(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_lower, pCurrent_lower);
    }
    
    private static final class Mutable extends Preserved_structuralFeature_lower.Match {
    ...
    private static final class Immutable extends Preserved_structuralFeature_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_lower pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // structuralFeature - lower - preserved
   * pattern preserved_structuralFeature_lower (initial_structuralFeature : StructuralFeature, current_structuralFeature : StructuralFeature, initial_lower : java Integer, current_lower : java Integer) {
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_structuralFeature_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_structuralFeature_lower.Match> {
    /**
     ...
     * 
     */
    public static Preserved_structuralFeature_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_structuralFeature_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_structuralFeature_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_structuralFeature_lower.Match> getAllMatches(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public Preserved_structuralFeature_lower.Match getOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public void forEachMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower, final IMatchProcessor<? super Preserved_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower, final IMatchProcessor<? super Preserved_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public Preserved_structuralFeature_lower.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_lower, final Integer pCurrent_lower) {
      return Preserved_structuralFeature_lower.Match.newMatch(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_lower, pCurrent_lower);
    }
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfinitial_structuralFeature(final Preserved_structuralFeature_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfcurrent_structuralFeature(final Preserved_structuralFeature_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfinitial_lower(final Preserved_structuralFeature_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfcurrent_lower(final Preserved_structuralFeature_lower.Match partialMatch) {
    ...
    @Override
    protected Preserved_structuralFeature_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_structuralFeature_lower.Match.newMatch((StructuralFeature) t.get(POSITION_INITIAL_STRUCTURALFEATURE), (StructuralFeature) t.get(POSITION_CURRENT_STRUCTURALFEATURE), (Integer) t.get(POSITION_INITIAL_LOWER), (Integer) t.get(POSITION_CURRENT_LOWER));
    ...
    @Override
    protected Preserved_structuralFeature_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_structuralFeature_lower.Match.newMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (Integer) match[POSITION_INITIAL_LOWER], (Integer) match[POSITION_CURRENT_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_structuralFeature_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_structuralFeature_lower.Match.newMutableMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (Integer) match[POSITION_INITIAL_LOWER], (Integer) match[POSITION_CURRENT_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_structuralFeature_lower.Matcher> querySpecification() {
      return Preserved_structuralFeature_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_structuralFeature_lower.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_structuralFeature_lower.Match match) {
  ...
  private Preserved_structuralFeature_lower() {
   ...
   * 
   */
  public static Preserved_structuralFeature_lower instance() {
    try{
  ...
  @Override
  protected Preserved_structuralFeature_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_structuralFeature_lower.Matcher.on(engine);
  }
  
  @Override
  public Preserved_structuralFeature_lower.Matcher instantiate() {
    return Preserved_structuralFeature_lower.Matcher.create();
  }
  
  @Override
  public Preserved_structuralFeature_lower.Match newEmptyMatch() {
    return Preserved_structuralFeature_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_structuralFeature_lower.Match newMatch(final Object... parameters) {
    return Preserved_structuralFeature_lower.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[1], (java.lang.Integer) parameters[2], (java.lang.Integer) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_lower (visibility: PUBLIC, simpleName: Preserved_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_lower (visibility: PUBLIC, simpleName: Preserved_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_structuralFeature_lower INSTANCE = new Preserved_structuralFeature_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_structuralFeature_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern preserved_structuralFeature_lower";
              }
  ...
  private static boolean evaluateExpression_1_1(final Integer current_lower, final Integer initial_lower) {
    boolean _equals = com.google.common.base.Objects.equal(initial_lower, current_lower);
    return _equals;
  }
}
