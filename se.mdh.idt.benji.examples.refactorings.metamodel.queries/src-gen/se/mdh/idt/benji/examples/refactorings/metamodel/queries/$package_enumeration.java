...
public final class $package_enumeration extends BaseGeneratedEMFQuerySpecification<$package_enumeration.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_enumeration.Match newMutableMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static $package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
  ...
  public static class Matcher extends BaseMatcher<$package_enumeration.Match> {
     ...
     * 
     */
    public Collection<$package_enumeration.Match> getAllMatches(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public $package_enumeration.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super $package_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super $package_enumeration.Match> processor) {
     ...
     * 
     */
    public $package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final $package_enumeration.Match partialMatch) {
    ...
    protected $package_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return $package_enumeration.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    protected $package_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return $package_enumeration.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    protected $package_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_enumeration.Match newMatch(final Object... parameters) {
    return $package_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
