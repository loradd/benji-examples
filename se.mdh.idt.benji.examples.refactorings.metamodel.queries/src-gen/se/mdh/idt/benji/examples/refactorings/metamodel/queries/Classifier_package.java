...
public final class Classifier_package extends BaseGeneratedEMFQuerySpecification<Classifier_package.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public static Classifier_package.Match newMutableMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public static Classifier_package.Match newMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
      return new Immutable(pClassifier, pPackage);
    }
    
    private static final class Mutable extends Classifier_package.Match {
      Mutable(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
    ...
    private static final class Immutable extends Classifier_package.Match {
      Immutable(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
        super(pClassifier, pPackage);
      }
  ...
  public static class Matcher extends BaseMatcher<Classifier_package.Match> {
     ...
     * 
     */
    public Collection<Classifier_package.Match> getAllMatches(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public Classifier_package.Match getOneArbitraryMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public boolean hasMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public int countMatches(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public void forEachMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage, final IMatchProcessor<? super Classifier_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage, final IMatchProcessor<? super Classifier_package.Match> processor) {
     ...
     * 
     */
    public Classifier_package.Match newMatch(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfclassifier(final Classifier_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfpackage(final Classifier_package.Match partialMatch) {
    ...
    protected Classifier_package.Match tupleToMatch(final Tuple t) {
      try {
          return Classifier_package.Match.newMatch((Classifier) t.get(POSITION_CLASSIFIER), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_PACKAGE));
    ...
    protected Classifier_package.Match arrayToMatch(final Object[] match) {
      try {
          return Classifier_package.Match.newMatch((Classifier) match[POSITION_CLASSIFIER], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected Classifier_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Classifier_package.Match.newMutableMatch((Classifier) match[POSITION_CLASSIFIER], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public static abstract class Processor implements IMatchProcessor<Classifier_package.Match> {
     ...
     * 
     */
    public abstract void process(final Classifier pClassifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pPackage);
  ...
  public Classifier_package.Match newMatch(final Object... parameters) {
    return Classifier_package.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Classifier) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_classifier, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdh.se/examples/refactorings/Metamodel", "Classifier", "package")));
          ...
          new Equality(body, var__virtual_0_, var_package);
          bodies.add(body);
      }
      return bodies;
    }
