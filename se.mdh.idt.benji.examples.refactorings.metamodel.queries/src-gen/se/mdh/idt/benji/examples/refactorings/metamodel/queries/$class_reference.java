...
public final class $class_reference extends BaseGeneratedEMFQuerySpecification<$class_reference.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $class_reference.Match newMutableMatch(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public static $class_reference.Match newMatch(final TraceLink pClass, final TraceLink pReference) {
  ...
  public static class Matcher extends BaseMatcher<$class_reference.Match> {
     ...
     * 
     */
    public Collection<$class_reference.Match> getAllMatches(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public $class_reference.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pReference, final IMatchProcessor<? super $class_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pReference, final IMatchProcessor<? super $class_reference.Match> processor) {
     ...
     * 
     */
    public $class_reference.Match newMatch(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final $class_reference.Match partialMatch) {
    ...
    protected $class_reference.Match tupleToMatch(final Tuple t) {
      try {
          return $class_reference.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_REFERENCE));
    ...
    protected $class_reference.Match arrayToMatch(final Object[] match) {
      try {
          return $class_reference.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected $class_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $class_reference.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $class_reference.Match newMatch(final Object... parameters) {
    return $class_reference.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
