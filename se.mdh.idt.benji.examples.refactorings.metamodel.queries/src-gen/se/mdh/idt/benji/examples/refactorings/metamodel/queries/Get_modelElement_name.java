...
public final class Get_modelElement_name extends BaseGeneratedEMFQuerySpecification<Get_modelElement_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_modelElement_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_modelElement_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_modelElement_name.Match.parameterNames;
    }
    ...
    @Override
    public Get_modelElement_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_modelElement_name.Match)) {
          Get_modelElement_name.Match other = (Get_modelElement_name.Match) obj;
    ...
    @Override
    public Get_modelElement_name specification() {
     ...
     * 
     */
    public static Get_modelElement_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_modelElement_name.Match newMutableMatch(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public static Get_modelElement_name.Match newMatch(final TraceLink pModelElement, final String pName) {
      return new Immutable(pModelElement, pName);
    }
    
    private static final class Mutable extends Get_modelElement_name.Match {
    ...
    private static final class Immutable extends Get_modelElement_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_modelElement_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_modelElement_name
   * 
   */
  public static class Matcher extends BaseMatcher<Get_modelElement_name.Match> {
    /**
     ...
     * 
     */
    public static Get_modelElement_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_modelElement_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_modelElement_name.Matcher.class);
     ...
     * 
     */
    public Collection<Get_modelElement_name.Match> getAllMatches(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public Get_modelElement_name.Match getOneArbitraryMatch(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pModelElement, final String pName, final IMatchProcessor<? super Get_modelElement_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pModelElement, final String pName, final IMatchProcessor<? super Get_modelElement_name.Match> processor) {
     ...
     * 
     */
    public Get_modelElement_name.Match newMatch(final TraceLink pModelElement, final String pName) {
      return Get_modelElement_name.Match.newMatch(pModelElement, pName);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmodelElement(final Get_modelElement_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final Get_modelElement_name.Match partialMatch) {
    ...
    @Override
    protected Get_modelElement_name.Match tupleToMatch(final Tuple t) {
      try {
          return Get_modelElement_name.Match.newMatch((TraceLink) t.get(POSITION_MODELELEMENT), (String) t.get(POSITION_NAME));
    ...
    @Override
    protected Get_modelElement_name.Match arrayToMatch(final Object[] match) {
      try {
          return Get_modelElement_name.Match.newMatch((TraceLink) match[POSITION_MODELELEMENT], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_modelElement_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_modelElement_name.Match.newMutableMatch((TraceLink) match[POSITION_MODELELEMENT], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_modelElement_name.Matcher> querySpecification() {
      return Get_modelElement_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_modelElement_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_modelElement_name.Match> {
    /**
    ...
    @Override
    public void process(final Get_modelElement_name.Match match) {
      process(match.getModelElement(), match.getName());
    }
  }
  
  private Get_modelElement_name() {
   ...
   * 
   */
  public static Get_modelElement_name instance() {
    try{
  ...
  @Override
  protected Get_modelElement_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_modelElement_name.Matcher.on(engine);
  }
  
  @Override
  public Get_modelElement_name.Matcher instantiate() {
    return Get_modelElement_name.Matcher.create();
  }
  
  @Override
  public Get_modelElement_name.Match newEmptyMatch() {
    return Get_modelElement_name.Match.newEmptyMatch();
  }
  
  @Override
  public Get_modelElement_name.Match newMatch(final Object... parameters) {
    return Get_modelElement_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_modelElement_name (visibility: PUBLIC, simpleName: Get_modelElement_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_modelElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_modelElement_name (visibility: PUBLIC, simpleName: Get_modelElement_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_modelElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_modelElement_name INSTANCE = new Get_modelElement_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_modelElement_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
