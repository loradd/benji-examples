...
public final class Added_package_subPackage extends BaseGeneratedEMFQuerySpecification<Added_package_subPackage.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.added_package_subPackage pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("initial_package", "current_package", "current_subPackage");
    
    private Match(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.added_package_subPackage";
    }
    ...
    public Object[] toArray() {
      return new Object[]{fInitial_package, fCurrent_package, fCurrent_subPackage};
    }
    
    @Override
    public Added_package_subPackage.Match toImmutable() {
      return isMutable() ? newMatch(fInitial_package, fCurrent_package, fCurrent_subPackage) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fInitial_package, fCurrent_package, fCurrent_subPackage);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Added_package_subPackage.Match)) {
          ...
          return Objects.equals(fInitial_package, other.fInitial_package) && Objects.equals(fCurrent_package, other.fCurrent_package) && Objects.equals(fCurrent_subPackage, other.fCurrent_subPackage);
      } else {
     ...
     * 
     */
    public static Added_package_subPackage.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
      return new Immutable(pInitial_package, pCurrent_package, pCurrent_subPackage);
    }
    
    private static final class Mutable extends Added_package_subPackage.Match {
      Mutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
        super(pInitial_package, pCurrent_package, pCurrent_subPackage);
      }
    ...
    private static final class Immutable extends Added_package_subPackage.Match {
      Immutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
        super(pInitial_package, pCurrent_package, pCurrent_subPackage);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.added_package_subPackage pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // package - classifiers (subPackage) - added
   * pattern added_package_subPackage (initial_package : Package, current_package : Package, current_subPackage : Package) {
   * 	find added_package_classifier (initial_package, current_package, current_subPackage); 
   * }
   * </pre></code>
   * 
   * @see Match
  ...
  public static class Matcher extends BaseMatcher<Added_package_subPackage.Match> {
    ...
    private final static int POSITION_CURRENT_SUBPACKAGE = 2;
    
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Added_package_subPackage.Matcher.class);
     ...
     * 
     */
    public Collection<Added_package_subPackage.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
      return rawGetAllMatches(new Object[]{pInitial_package, pCurrent_package, pCurrent_subPackage});
    }
     ...
     * 
     */
    public boolean hasMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
      return rawHasMatch(new Object[]{pInitial_package, pCurrent_package, pCurrent_subPackage});
    }
     ...
     * 
     */
    public int countMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
      return rawCountMatches(new Object[]{pInitial_package, pCurrent_package, pCurrent_subPackage});
    }
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage, final IMatchProcessor<? super Added_package_subPackage.Match> processor) {
      rawForEachMatch(new Object[]{pInitial_package, pCurrent_package, pCurrent_subPackage}, processor);
    }
    ...
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage, final IMatchProcessor<? super Added_package_subPackage.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pInitial_package, pCurrent_package, pCurrent_subPackage}, processor);
    }
     ...
     * 
     */
    public Added_package_subPackage.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
      return Added_package_subPackage.Match.newMatch(pInitial_package, pCurrent_package, pCurrent_subPackage);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Added_package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Added_package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_subPackage(final Added_package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_subPackage(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
    ...
    protected Added_package_subPackage.Match tupleToMatch(final Tuple t) {
      try {
          return Added_package_subPackage.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_INITIAL_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_CURRENT_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_CURRENT_SUBPACKAGE));
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.added_package_subPackage pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Added_package_subPackage.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_subPackage);
    
    @Override
    public void process(final Added_package_subPackage.Match match) {
      process(match.getInitial_package(), match.getCurrent_package(), match.getCurrent_subPackage());
    }
  }
  ...
  public Added_package_subPackage.Match newMatch(final Object... parameters) {
    return Added_package_subPackage.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Added_package_subPackage (visibility: PUBLIC, simpleName: Added_package_subPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Added_package_subPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Added_package_subPackage (visibility: PUBLIC, simpleName: Added_package_subPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Added_package_subPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Added_package_subPackage INSTANCE = new Added_package_subPackage();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Added_package_subPackage.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pInitial_package, parameter_pCurrent_package, parameter_pCurrent_subPackage);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("initial_package","current_package","current_subPackage");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find added_package_classifier (initial_package, current_package, current_subPackage)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_package, var_current_package, var_current_subPackage), Added_package_classifier.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
