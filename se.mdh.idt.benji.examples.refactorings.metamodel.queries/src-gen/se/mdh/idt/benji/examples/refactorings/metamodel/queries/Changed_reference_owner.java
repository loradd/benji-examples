...
public final class Changed_reference_owner extends BaseGeneratedEMFQuerySpecification<Changed_reference_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_reference_owner.Match.parameterNames;
    }
    ...
    @Override
    public Changed_reference_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_reference_owner.Match)) {
          Changed_reference_owner.Match other = (Changed_reference_owner.Match) obj;
    ...
    @Override
    public Changed_reference_owner specification() {
     ...
     * 
     */
    public static Changed_reference_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_reference_owner.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
     ...
     * 
     */
    public static Changed_reference_owner.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_owner, pCurrent_owner);
    }
    
    private static final class Mutable extends Changed_reference_owner.Match {
    ...
    private static final class Immutable extends Changed_reference_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_reference_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_reference_owner.Match> {
    /**
     ...
     * 
     */
    public static Changed_reference_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_reference_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_reference_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_reference_owner.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
     ...
     * 
     */
    public Changed_reference_owner.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner, final IMatchProcessor<? super Changed_reference_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner, final IMatchProcessor<? super Changed_reference_owner.Match> processor) {
     ...
     * 
     */
    public Changed_reference_owner.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
      return Changed_reference_owner.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_owner, pCurrent_owner);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Changed_reference_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Changed_reference_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_owner(final Changed_reference_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_owner(final Changed_reference_owner.Match partialMatch) {
    ...
    @Override
    protected Changed_reference_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_reference_owner.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_OWNER), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_OWNER));
    ...
    @Override
    protected Changed_reference_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_reference_owner.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_OWNER], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_OWNER]);
      } catch(ClassCastException e) {
     ...
     * 
     */
    public static IQuerySpecification<Changed_reference_owner.Matcher> querySpecification() {
      return Changed_reference_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_reference_owner.Match> {
    /**
   ...
   * 
   */
  public static Changed_reference_owner instance() {
    try{
  ...
  @Override
  protected Changed_reference_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_reference_owner.Matcher.on(engine);
  }
  
  @Override
  public Changed_reference_owner.Matcher instantiate() {
    return Changed_reference_owner.Matcher.create();
  }
  
  @Override
  public Changed_reference_owner.Match newEmptyMatch() {
    return Changed_reference_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_reference_owner.Match newMatch(final Object... parameters) {
    return Changed_reference_owner.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_owner (visibility: PUBLIC, simpleName: Changed_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_owner (visibility: PUBLIC, simpleName: Changed_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_reference_owner INSTANCE = new Changed_reference_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_reference_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_structuralFeature_owner (initial_reference, current_reference, initial_owner, current_owner)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference, var_initial_owner, var_current_owner), Changed_structuralFeature_owner.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
