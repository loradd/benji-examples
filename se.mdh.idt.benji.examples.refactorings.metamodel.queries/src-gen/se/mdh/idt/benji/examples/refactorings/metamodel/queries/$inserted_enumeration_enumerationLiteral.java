...
public final class $inserted_enumeration_enumerationLiteral extends BaseGeneratedEMFQuerySpecification<$inserted_enumeration_enumerationLiteral.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral";
    }
    
    @Override
    public List<String> parameterNames() {
      return $inserted_enumeration_enumerationLiteral.Match.parameterNames;
    }
    ...
    @Override
    public $inserted_enumeration_enumerationLiteral.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $inserted_enumeration_enumerationLiteral.Match)) {
          $inserted_enumeration_enumerationLiteral.Match other = ($inserted_enumeration_enumerationLiteral.Match) obj;
    ...
    @Override
    public $inserted_enumeration_enumerationLiteral specification() {
     ...
     * 
     */
    public static $inserted_enumeration_enumerationLiteral.Match newEmptyMatch() {
     ...
     * 
     */
    public static $inserted_enumeration_enumerationLiteral.Match newMutableMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public static $inserted_enumeration_enumerationLiteral.Match newMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
      return new Immutable(pEnumeration, pEnumerationLiteral);
    }
    
    private static final class Mutable extends $inserted_enumeration_enumerationLiteral.Match {
    ...
    private static final class Immutable extends $inserted_enumeration_enumerationLiteral.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $inserted_enumeration_enumerationLiteral
   * 
   */
  public static class Matcher extends BaseMatcher<$inserted_enumeration_enumerationLiteral.Match> {
    /**
     ...
     * 
     */
    public static $inserted_enumeration_enumerationLiteral.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $inserted_enumeration_enumerationLiteral.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($inserted_enumeration_enumerationLiteral.Matcher.class);
     ...
     * 
     */
    public Collection<$inserted_enumeration_enumerationLiteral.Match> getAllMatches(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public $inserted_enumeration_enumerationLiteral.Match getOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $inserted_enumeration_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $inserted_enumeration_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public $inserted_enumeration_enumerationLiteral.Match newMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
      return $inserted_enumeration_enumerationLiteral.Match.newMatch(pEnumeration, pEnumerationLiteral);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final $inserted_enumeration_enumerationLiteral.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumerationLiteral(final $inserted_enumeration_enumerationLiteral.Match partialMatch) {
    ...
    @Override
    protected $inserted_enumeration_enumerationLiteral.Match tupleToMatch(final Tuple t) {
      try {
          return $inserted_enumeration_enumerationLiteral.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATION), (TraceLink) t.get(POSITION_ENUMERATIONLITERAL));
    ...
    @Override
    protected $inserted_enumeration_enumerationLiteral.Match arrayToMatch(final Object[] match) {
      try {
          return $inserted_enumeration_enumerationLiteral.Match.newMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $inserted_enumeration_enumerationLiteral.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $inserted_enumeration_enumerationLiteral.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$inserted_enumeration_enumerationLiteral.Matcher> querySpecification() {
      return $inserted_enumeration_enumerationLiteral.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$inserted_enumeration_enumerationLiteral.Match> {
    /**
    ...
    @Override
    public void process(final $inserted_enumeration_enumerationLiteral.Match match) {
      process(match.getEnumeration(), match.getEnumerationLiteral());
    }
  }
  
  private $inserted_enumeration_enumerationLiteral() {
   ...
   * 
   */
  public static $inserted_enumeration_enumerationLiteral instance() {
    try{
  ...
  @Override
  protected $inserted_enumeration_enumerationLiteral.Matcher instantiate(final ViatraQueryEngine engine) {
    return $inserted_enumeration_enumerationLiteral.Matcher.on(engine);
  }
  
  @Override
  public $inserted_enumeration_enumerationLiteral.Matcher instantiate() {
    return $inserted_enumeration_enumerationLiteral.Matcher.create();
  }
  
  @Override
  public $inserted_enumeration_enumerationLiteral.Match newEmptyMatch() {
    return $inserted_enumeration_enumerationLiteral.Match.newEmptyMatch();
  }
  
  @Override
  public $inserted_enumeration_enumerationLiteral.Match newMatch(final Object... parameters) {
    return $inserted_enumeration_enumerationLiteral.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral (visibility: PUBLIC, simpleName: $inserted_enumeration_enumerationLiteral, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral (visibility: PUBLIC, simpleName: $inserted_enumeration_enumerationLiteral, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_enumeration_enumerationLiteral, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $inserted_enumeration_enumerationLiteral INSTANCE = new $inserted_enumeration_enumerationLiteral();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $inserted_enumeration_enumerationLiteral.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find $initial_enumeration_enumerationLiteral (enumeration, _initial_enumeration, enumerationLiteral, _initial_enumerationLiteral)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_enumeration, var__initial_enumeration, var_enumerationLiteral, var__initial_enumerationLiteral), $initial_enumeration_enumerationLiteral.instance().getInternalQueryRepresentation());
          // 	find $current_enumeration_enumerationLiteral (enumeration, _current_enumeration, enumerationLiteral, _current_enumerationLiteral)
