...
public final class Changed_package_uri extends BaseGeneratedEMFQuerySpecification<Changed_package_uri.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_package_uri pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_package_uri";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_package_uri.Match.parameterNames;
    }
    ...
    @Override
    public Changed_package_uri.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_package_uri.Match)) {
          Changed_package_uri.Match other = (Changed_package_uri.Match) obj;
    ...
    @Override
    public Changed_package_uri specification() {
     ...
     * 
     */
    public static Changed_package_uri.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_package_uri.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri) {
     ...
     * 
     */
    public static Changed_package_uri.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri) {
      return new Immutable(pInitial_package, pCurrent_package, pInitial_uri, pCurrent_uri);
    }
    
    private static final class Mutable extends Changed_package_uri.Match {
    ...
    private static final class Immutable extends Changed_package_uri.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_package_uri pattern,
   ...
   * <code><pre>
   * // package - uri - changed
   * pattern changed_package_uri (initial_package : Package, current_package : Package, initial_uri : java String, current_uri : java String) {
   ...
   * @see Match
   *  @see Processor
   * @see Changed_package_uri
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_package_uri.Match> {
    /**
     ...
     * 
     */
    public static Changed_package_uri.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_package_uri.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_package_uri.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_package_uri.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri) {
     ...
     * 
     */
    public Changed_package_uri.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri, final IMatchProcessor<? super Changed_package_uri.Match> processor) {
     ...
     * 
     */
    public Changed_package_uri.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final String pInitial_uri, final String pCurrent_uri) {
      return Changed_package_uri.Match.newMatch(pInitial_package, pCurrent_package, pInitial_uri, pCurrent_uri);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Changed_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Changed_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_uri(final Changed_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_uri(final Changed_package_uri.Match partialMatch) {
    ...
    @Override
    protected Changed_package_uri.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_package_uri.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_INITIAL_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_CURRENT_PACKAGE), (String) t.get(POSITION_INITIAL_URI), (String) t.get(POSITION_CURRENT_URI));
    ...
    @Override
    protected Changed_package_uri.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_package_uri.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (String) match[POSITION_INITIAL_URI], (String) match[POSITION_CURRENT_URI]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_package_uri.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_package_uri.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (String) match[POSITION_INITIAL_URI], (String) match[POSITION_CURRENT_URI]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_package_uri.Matcher> querySpecification() {
      return Changed_package_uri.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_package_uri pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_package_uri.Match> {
    /**
   ...
   * 
   */
  public static Changed_package_uri instance() {
    try{
  ...
  @Override
  protected Changed_package_uri.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_package_uri.Matcher.on(engine);
  }
  
  @Override
  public Changed_package_uri.Matcher instantiate() {
    return Changed_package_uri.Matcher.create();
  }
  
  @Override
  public Changed_package_uri.Match newEmptyMatch() {
    return Changed_package_uri.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_package_uri.Match newMatch(final Object... parameters) {
    return Changed_package_uri.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_package_uri (visibility: PUBLIC, simpleName: Changed_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_package_uri (visibility: PUBLIC, simpleName: Changed_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_package_uri INSTANCE = new Changed_package_uri();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_package_uri.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern changed_package_uri";
              }
  ...
  private static boolean evaluateExpression_1_1(final String current_uri, final String initial_uri) {
    boolean _notEquals = (!com.google.common.base.Objects.equal(initial_uri, current_uri));
    return _notEquals;
  }
}
