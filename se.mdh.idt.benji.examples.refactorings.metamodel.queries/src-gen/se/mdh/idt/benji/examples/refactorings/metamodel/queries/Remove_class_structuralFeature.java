...
public final class Remove_class_structuralFeature extends BaseGeneratedEMFQuerySpecification<Remove_class_structuralFeature.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_structuralFeature pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_structuralFeature";
    }
    
    @Override
    public List<String> parameterNames() {
      return Remove_class_structuralFeature.Match.parameterNames;
    }
    ...
    @Override
    public Remove_class_structuralFeature.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Remove_class_structuralFeature.Match)) {
          Remove_class_structuralFeature.Match other = (Remove_class_structuralFeature.Match) obj;
    ...
    @Override
    public Remove_class_structuralFeature specification() {
     ...
     * 
     */
    public static Remove_class_structuralFeature.Match newEmptyMatch() {
     ...
     * 
     */
    public static Remove_class_structuralFeature.Match newMutableMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public static Remove_class_structuralFeature.Match newMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
      return new Immutable(pClass, pStructuralFeature);
    }
    
    private static final class Mutable extends Remove_class_structuralFeature.Match {
    ...
    private static final class Immutable extends Remove_class_structuralFeature.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_structuralFeature pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Remove_class_structuralFeature
   * 
   */
  public static class Matcher extends BaseMatcher<Remove_class_structuralFeature.Match> {
    /**
     ...
     * 
     */
    public static Remove_class_structuralFeature.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Remove_class_structuralFeature.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Remove_class_structuralFeature.Matcher.class);
     ...
     * 
     */
    public Collection<Remove_class_structuralFeature.Match> getAllMatches(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public Remove_class_structuralFeature.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pStructuralFeature, final IMatchProcessor<? super Remove_class_structuralFeature.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pStructuralFeature, final IMatchProcessor<? super Remove_class_structuralFeature.Match> processor) {
     ...
     * 
     */
    public Remove_class_structuralFeature.Match newMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
      return Remove_class_structuralFeature.Match.newMatch(pClass, pStructuralFeature);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Remove_class_structuralFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Remove_class_structuralFeature.Match partialMatch) {
    ...
    @Override
    protected Remove_class_structuralFeature.Match tupleToMatch(final Tuple t) {
      try {
          return Remove_class_structuralFeature.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_STRUCTURALFEATURE));
    ...
    @Override
    protected Remove_class_structuralFeature.Match arrayToMatch(final Object[] match) {
      try {
          return Remove_class_structuralFeature.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Remove_class_structuralFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Remove_class_structuralFeature.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Remove_class_structuralFeature.Matcher> querySpecification() {
      return Remove_class_structuralFeature.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.remove_class_structuralFeature pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Remove_class_structuralFeature.Match> {
    /**
    ...
    @Override
    public void process(final Remove_class_structuralFeature.Match match) {
      process(match.getValueOfClass(), match.getStructuralFeature());
    }
  }
  
  private Remove_class_structuralFeature() {
   ...
   * 
   */
  public static Remove_class_structuralFeature instance() {
    try{
  ...
  @Override
  protected Remove_class_structuralFeature.Matcher instantiate(final ViatraQueryEngine engine) {
    return Remove_class_structuralFeature.Matcher.on(engine);
  }
  
  @Override
  public Remove_class_structuralFeature.Matcher instantiate() {
    return Remove_class_structuralFeature.Matcher.create();
  }
  
  @Override
  public Remove_class_structuralFeature.Match newEmptyMatch() {
    return Remove_class_structuralFeature.Match.newEmptyMatch();
  }
  
  @Override
  public Remove_class_structuralFeature.Match newMatch(final Object... parameters) {
    return Remove_class_structuralFeature.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_structuralFeature (visibility: PUBLIC, simpleName: Remove_class_structuralFeature, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_structuralFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_structuralFeature (visibility: PUBLIC, simpleName: Remove_class_structuralFeature, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Remove_class_structuralFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Remove_class_structuralFeature INSTANCE = new Remove_class_structuralFeature();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Remove_class_structuralFeature.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_class_structuralFeature (class, _current_class, structuralFeature, _current_structuralFeature)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__current_class, var_structuralFeature, var__current_structuralFeature), Current_class_structuralFeature.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
