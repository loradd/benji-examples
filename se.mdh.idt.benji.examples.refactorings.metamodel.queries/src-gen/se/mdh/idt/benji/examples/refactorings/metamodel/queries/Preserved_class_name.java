...
public final class Preserved_class_name extends BaseGeneratedEMFQuerySpecification<Preserved_class_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_class_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_class_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_class_name.Match)) {
          Preserved_class_name.Match other = (Preserved_class_name.Match) obj;
    ...
    @Override
    public Preserved_class_name specification() {
     ...
     * 
     */
    public static Preserved_class_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_class_name.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_class_name.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_class_name.Match {
    ...
    private static final class Immutable extends Preserved_class_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_class_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_class_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_class_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_class_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_class_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_class_name.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_class_name.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_class_name.Match> processor) {
     ...
     * 
     */
    public Preserved_class_name.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final String pInitial_name, final String pCurrent_name) {
      return Preserved_class_name.Match.newMatch(pInitial_class, pCurrent_class, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final Preserved_class_name.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final Preserved_class_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_class_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_class_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_class_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_class_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_CLASS), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_class_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_class_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_class_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_class_name.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_class_name.Matcher> querySpecification() {
      return Preserved_class_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_class_name.Match> {
    /**
   ...
   * 
   */
  public static Preserved_class_name instance() {
    try{
  ...
  @Override
  protected Preserved_class_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_class_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_class_name.Matcher instantiate() {
    return Preserved_class_name.Matcher.create();
  }
  
  @Override
  public Preserved_class_name.Match newEmptyMatch() {
    return Preserved_class_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_class_name.Match newMatch(final Object... parameters) {
    return Preserved_class_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_name (visibility: PUBLIC, simpleName: Preserved_class_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_name (visibility: PUBLIC, simpleName: Preserved_class_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_class_name INSTANCE = new Preserved_class_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_class_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_classifier_name (initial_class, current_class, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_class, var_current_class, var_initial_name, var_current_name), Preserved_classifier_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
