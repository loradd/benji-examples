  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_structuralFeature_upper (attribute, _initial_attribute, upper)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_attribute, var__initial_attribute, var_upper), Initial_structuralFeature_upper.instance().getInternalQueryRepresentation());
          // 	find current_structuralFeature_upper (attribute, _current_attribute, upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_attribute, var__current_attribute, var_upper), Current_structuralFeature_upper.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
