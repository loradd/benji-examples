...
public final class Preserved_enumerationLiteral_enumeration extends BaseGeneratedEMFQuerySpecification<Preserved_enumerationLiteral_enumeration.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumerationLiteral_enumeration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumerationLiteral_enumeration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_enumerationLiteral_enumeration.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_enumerationLiteral_enumeration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_enumerationLiteral_enumeration.Match)) {
          Preserved_enumerationLiteral_enumeration.Match other = (Preserved_enumerationLiteral_enumeration.Match) obj;
    ...
    @Override
    public Preserved_enumerationLiteral_enumeration specification() {
     ...
     * 
     */
    public static Preserved_enumerationLiteral_enumeration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_enumerationLiteral_enumeration.Match newMutableMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration) {
     ...
     * 
     */
    public static Preserved_enumerationLiteral_enumeration.Match newMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration) {
      return new Immutable(pInitial_literal, pCurrent_literal, pInitial_enumeration, pCurrent_enumeration);
    }
    
    private static final class Mutable extends Preserved_enumerationLiteral_enumeration.Match {
    ...
    private static final class Immutable extends Preserved_enumerationLiteral_enumeration.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumerationLiteral_enumeration pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_enumerationLiteral_enumeration
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_enumerationLiteral_enumeration.Match> {
    /**
     ...
     * 
     */
    public static Preserved_enumerationLiteral_enumeration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_enumerationLiteral_enumeration.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_enumerationLiteral_enumeration.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_enumerationLiteral_enumeration.Match> getAllMatches(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration) {
     ...
     * 
     */
    public Preserved_enumerationLiteral_enumeration.Match getOneArbitraryMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration) {
     ...
     * 
     */
    public void forEachMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final IMatchProcessor<? super Preserved_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final IMatchProcessor<? super Preserved_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public Preserved_enumerationLiteral_enumeration.Match newMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration) {
      return Preserved_enumerationLiteral_enumeration.Match.newMatch(pInitial_literal, pCurrent_literal, pInitial_enumeration, pCurrent_enumeration);
    }
     ...
     * 
     */
    public Set<EnumerationLiteral> getAllValuesOfinitial_literal(final Preserved_enumerationLiteral_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<EnumerationLiteral> getAllValuesOfcurrent_literal(final Preserved_enumerationLiteral_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfinitial_enumeration(final Preserved_enumerationLiteral_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfcurrent_enumeration(final Preserved_enumerationLiteral_enumeration.Match partialMatch) {
    ...
    @Override
    protected Preserved_enumerationLiteral_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_enumerationLiteral_enumeration.Match.newMatch((EnumerationLiteral) t.get(POSITION_INITIAL_LITERAL), (EnumerationLiteral) t.get(POSITION_CURRENT_LITERAL), (Enumeration) t.get(POSITION_INITIAL_ENUMERATION), (Enumeration) t.get(POSITION_CURRENT_ENUMERATION));
    ...
    @Override
    protected Preserved_enumerationLiteral_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_enumerationLiteral_enumeration.Match.newMatch((EnumerationLiteral) match[POSITION_INITIAL_LITERAL], (EnumerationLiteral) match[POSITION_CURRENT_LITERAL], (Enumeration) match[POSITION_INITIAL_ENUMERATION], (Enumeration) match[POSITION_CURRENT_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_enumerationLiteral_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_enumerationLiteral_enumeration.Match.newMutableMatch((EnumerationLiteral) match[POSITION_INITIAL_LITERAL], (EnumerationLiteral) match[POSITION_CURRENT_LITERAL], (Enumeration) match[POSITION_INITIAL_ENUMERATION], (Enumeration) match[POSITION_CURRENT_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_enumerationLiteral_enumeration.Matcher> querySpecification() {
      return Preserved_enumerationLiteral_enumeration.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumerationLiteral_enumeration pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_enumerationLiteral_enumeration.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_enumerationLiteral_enumeration.Match match) {
      process(match.getInitial_literal(), match.getCurrent_literal(), match.getInitial_enumeration(), match.getCurrent_enumeration());
    }
  }
  
  private Preserved_enumerationLiteral_enumeration() {
   ...
   * 
   */
  public static Preserved_enumerationLiteral_enumeration instance() {
    try{
  ...
  @Override
  protected Preserved_enumerationLiteral_enumeration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_enumerationLiteral_enumeration.Matcher.on(engine);
  }
  
  @Override
  public Preserved_enumerationLiteral_enumeration.Matcher instantiate() {
    return Preserved_enumerationLiteral_enumeration.Matcher.create();
  }
  
  @Override
  public Preserved_enumerationLiteral_enumeration.Match newEmptyMatch() {
    return Preserved_enumerationLiteral_enumeration.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_enumerationLiteral_enumeration.Match newMatch(final Object... parameters) {
    return Preserved_enumerationLiteral_enumeration.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.EnumerationLiteral) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.EnumerationLiteral) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Enumeration) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Enumeration) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: Preserved_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: Preserved_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_enumerationLiteral_enumeration INSTANCE = new Preserved_enumerationLiteral_enumeration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_enumerationLiteral_enumeration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
