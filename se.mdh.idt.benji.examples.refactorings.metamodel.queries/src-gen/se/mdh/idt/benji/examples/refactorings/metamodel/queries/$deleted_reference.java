...
public final class $deleted_reference extends BaseGeneratedEMFQuerySpecification<$deleted_reference.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_reference.Match newMutableMatch(final TraceLink pReference) {
     ...
     * 
     */
    public static $deleted_reference.Match newMatch(final TraceLink pReference) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_reference.Match> {
     ...
     * 
     */
    public Collection<$deleted_reference.Match> getAllMatches(final TraceLink pReference) {
     ...
     * 
     */
    public $deleted_reference.Match getOneArbitraryMatch(final TraceLink pReference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final IMatchProcessor<? super $deleted_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final IMatchProcessor<? super $deleted_reference.Match> processor) {
     ...
     * 
     */
    public $deleted_reference.Match newMatch(final TraceLink pReference) {
    ...
    protected $deleted_reference.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_reference.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE));
    ...
    protected $deleted_reference.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_reference.Match.newMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_reference.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_reference.Match newMatch(final Object... parameters) {
    return $deleted_reference.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
