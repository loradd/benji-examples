...
public final class $structuralFeature_owner extends BaseGeneratedEMFQuerySpecification<$structuralFeature_owner.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $structuralFeature_owner.Match newMutableMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public static $structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
  ...
  public static class Matcher extends BaseMatcher<$structuralFeature_owner.Match> {
     ...
     * 
     */
    public Collection<$structuralFeature_owner.Match> getAllMatches(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public $structuralFeature_owner.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super $structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super $structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public $structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final $structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final $structuralFeature_owner.Match partialMatch) {
    ...
    protected $structuralFeature_owner.Match tupleToMatch(final Tuple t) {
      try {
          return $structuralFeature_owner.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (TraceLink) t.get(POSITION_OWNER));
    ...
    protected $structuralFeature_owner.Match arrayToMatch(final Object[] match) {
      try {
          return $structuralFeature_owner.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    protected $structuralFeature_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $structuralFeature_owner.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $structuralFeature_owner.Match newMatch(final Object... parameters) {
    return $structuralFeature_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
