...
public final class $set_class_package extends BaseGeneratedEMFQuerySpecification<$set_class_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return $set_class_package.Match.parameterNames;
    }
    ...
    @Override
    public $set_class_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $set_class_package.Match)) {
          $set_class_package.Match other = ($set_class_package.Match) obj;
    ...
    @Override
    public $set_class_package specification() {
     ...
     * 
     */
    public static $set_class_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static $set_class_package.Match newMutableMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public static $set_class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
      return new Immutable(pClass, pPackage);
    }
    
    private static final class Mutable extends $set_class_package.Match {
    ...
    private static final class Immutable extends $set_class_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $set_class_package
   * 
   */
  public static class Matcher extends BaseMatcher<$set_class_package.Match> {
    /**
     ...
     * 
     */
    public static $set_class_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $set_class_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($set_class_package.Matcher.class);
     ...
     * 
     */
    public Collection<$set_class_package.Match> getAllMatches(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public $set_class_package.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super $set_class_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super $set_class_package.Match> processor) {
     ...
     * 
     */
    public $set_class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
      return $set_class_package.Match.newMatch(pClass, pPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $set_class_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $set_class_package.Match partialMatch) {
    ...
    @Override
    protected $set_class_package.Match tupleToMatch(final Tuple t) {
      try {
          return $set_class_package.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    @Override
    protected $set_class_package.Match arrayToMatch(final Object[] match) {
      try {
          return $set_class_package.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $set_class_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $set_class_package.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$set_class_package.Matcher> querySpecification() {
      return $set_class_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$set_class_package.Match> {
    /**
    ...
    @Override
    public void process(final $set_class_package.Match match) {
      process(match.getValueOfClass(), match.getPackage());
    }
  }
  
  private $set_class_package() {
   ...
   * 
   */
  public static $set_class_package instance() {
    try{
  ...
  @Override
  protected $set_class_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return $set_class_package.Matcher.on(engine);
  }
  
  @Override
  public $set_class_package.Matcher instantiate() {
    return $set_class_package.Matcher.create();
  }
  
  @Override
  public $set_class_package.Match newEmptyMatch() {
    return $set_class_package.Match.newEmptyMatch();
  }
  
  @Override
  public $set_class_package.Match newMatch(final Object... parameters) {
    return $set_class_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package (visibility: PUBLIC, simpleName: $set_class_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package (visibility: PUBLIC, simpleName: $set_class_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $set_class_package INSTANCE = new $set_class_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $set_class_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find $initial_class_package (class, _initial_class, ^package, _initial_package)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__initial_class, var_package, var__initial_package), $initial_class_package.instance().getInternalQueryRepresentation());
          // 	find $current_class_package (class, _current_class, ^package, _current_package)
