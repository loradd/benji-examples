...
public final class Changed_enumeration_name extends BaseGeneratedEMFQuerySpecification<Changed_enumeration_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumeration_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumeration_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_enumeration_name.Match.parameterNames;
    }
    ...
    @Override
    public Changed_enumeration_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_enumeration_name.Match)) {
          Changed_enumeration_name.Match other = (Changed_enumeration_name.Match) obj;
    ...
    @Override
    public Changed_enumeration_name specification() {
     ...
     * 
     */
    public static Changed_enumeration_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_enumeration_name.Match newMutableMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Changed_enumeration_name.Match newMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_enumeration, pCurrent_enumeration, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Changed_enumeration_name.Match {
    ...
    private static final class Immutable extends Changed_enumeration_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumeration_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_enumeration_name
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_enumeration_name.Match> {
    /**
     ...
     * 
     */
    public static Changed_enumeration_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_enumeration_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_enumeration_name.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_enumeration_name.Match> getAllMatches(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Changed_enumeration_name.Match getOneArbitraryMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_enumeration_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_enumeration_name.Match> processor) {
     ...
     * 
     */
    public Changed_enumeration_name.Match newMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final String pInitial_name, final String pCurrent_name) {
      return Changed_enumeration_name.Match.newMatch(pInitial_enumeration, pCurrent_enumeration, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfinitial_enumeration(final Changed_enumeration_name.Match partialMatch) {
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfcurrent_enumeration(final Changed_enumeration_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Changed_enumeration_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Changed_enumeration_name.Match partialMatch) {
    ...
    @Override
    protected Changed_enumeration_name.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_enumeration_name.Match.newMatch((Enumeration) t.get(POSITION_INITIAL_ENUMERATION), (Enumeration) t.get(POSITION_CURRENT_ENUMERATION), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Changed_enumeration_name.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_enumeration_name.Match.newMatch((Enumeration) match[POSITION_INITIAL_ENUMERATION], (Enumeration) match[POSITION_CURRENT_ENUMERATION], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_enumeration_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_enumeration_name.Match.newMutableMatch((Enumeration) match[POSITION_INITIAL_ENUMERATION], (Enumeration) match[POSITION_CURRENT_ENUMERATION], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_enumeration_name.Matcher> querySpecification() {
      return Changed_enumeration_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumeration_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_enumeration_name.Match> {
    /**
   ...
   * 
   */
  public static Changed_enumeration_name instance() {
    try{
  ...
  @Override
  protected Changed_enumeration_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_enumeration_name.Matcher.on(engine);
  }
  
  @Override
  public Changed_enumeration_name.Matcher instantiate() {
    return Changed_enumeration_name.Matcher.create();
  }
  
  @Override
  public Changed_enumeration_name.Match newEmptyMatch() {
    return Changed_enumeration_name.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_enumeration_name.Match newMatch(final Object... parameters) {
    return Changed_enumeration_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Enumeration) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Enumeration) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumeration_name (visibility: PUBLIC, simpleName: Changed_enumeration_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumeration_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumeration_name (visibility: PUBLIC, simpleName: Changed_enumeration_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumeration_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_enumeration_name INSTANCE = new Changed_enumeration_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_enumeration_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_dataType_name (initial_enumeration, current_enumeration, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_enumeration, var_current_enumeration, var_initial_name, var_current_name), Changed_dataType_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
