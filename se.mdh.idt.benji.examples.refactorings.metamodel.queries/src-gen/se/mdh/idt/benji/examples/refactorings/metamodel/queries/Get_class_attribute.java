...
public final class Get_class_attribute extends BaseGeneratedEMFQuerySpecification<Get_class_attribute.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_attribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_class_attribute.Match.parameterNames;
    }
    ...
    @Override
    public Get_class_attribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_class_attribute.Match)) {
          Get_class_attribute.Match other = (Get_class_attribute.Match) obj;
    ...
    @Override
    public Get_class_attribute specification() {
     ...
     * 
     */
    public static Get_class_attribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_class_attribute.Match newMutableMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public static Get_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
      return new Immutable(pClass, pAttribute);
    }
    
    private static final class Mutable extends Get_class_attribute.Match {
    ...
    private static final class Immutable extends Get_class_attribute.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_attribute pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_class_attribute
   * 
   */
  public static class Matcher extends BaseMatcher<Get_class_attribute.Match> {
    /**
     ...
     * 
     */
    public static Get_class_attribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_class_attribute.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_class_attribute.Matcher.class);
     ...
     * 
     */
    public Collection<Get_class_attribute.Match> getAllMatches(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public Get_class_attribute.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super Get_class_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super Get_class_attribute.Match> processor) {
     ...
     * 
     */
    public Get_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
      return Get_class_attribute.Match.newMatch(pClass, pAttribute);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Get_class_attribute.Match partialMatch) {
    ...
    @Override
    protected Get_class_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return Get_class_attribute.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    @Override
    protected Get_class_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return Get_class_attribute.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_class_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_class_attribute.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_class_attribute.Matcher> querySpecification() {
      return Get_class_attribute.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_attribute pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_class_attribute.Match> {
    /**
    ...
    @Override
    public void process(final Get_class_attribute.Match match) {
      process(match.getValueOfClass(), match.getAttribute());
    }
  }
  
  private Get_class_attribute() {
   ...
   * 
   */
  public static Get_class_attribute instance() {
    try{
  ...
  @Override
  protected Get_class_attribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_class_attribute.Matcher.on(engine);
  }
  
  @Override
  public Get_class_attribute.Matcher instantiate() {
    return Get_class_attribute.Matcher.create();
  }
  
  @Override
  public Get_class_attribute.Match newEmptyMatch() {
    return Get_class_attribute.Match.newEmptyMatch();
  }
  
  @Override
  public Get_class_attribute.Match newMatch(final Object... parameters) {
    return Get_class_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_attribute (visibility: PUBLIC, simpleName: Get_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_attribute (visibility: PUBLIC, simpleName: Get_class_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_class_attribute INSTANCE = new Get_class_attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_class_attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
