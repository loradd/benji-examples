...
public final class Get_package_uri extends BaseGeneratedEMFQuerySpecification<Get_package_uri.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_uri pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_uri";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_package_uri.Match.parameterNames;
    }
    ...
    @Override
    public Get_package_uri.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_package_uri.Match)) {
          Get_package_uri.Match other = (Get_package_uri.Match) obj;
    ...
    @Override
    public Get_package_uri specification() {
     ...
     * 
     */
    public static Get_package_uri.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_package_uri.Match newMutableMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public static Get_package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
      return new Immutable(pPackage, pUri);
    }
    
    private static final class Mutable extends Get_package_uri.Match {
    ...
    private static final class Immutable extends Get_package_uri.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_uri pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Get_package_uri.Match> {
    /**
     ...
     * 
     */
    public static Get_package_uri.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_package_uri.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_package_uri.Matcher.class);
     ...
     * 
     */
    public Collection<Get_package_uri.Match> getAllMatches(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public Get_package_uri.Match getOneArbitraryMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super Get_package_uri.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super Get_package_uri.Match> processor) {
     ...
     * 
     */
    public Get_package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
      return Get_package_uri.Match.newMatch(pPackage, pUri);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfuri(final Get_package_uri.Match partialMatch) {
    ...
    @Override
    protected Get_package_uri.Match tupleToMatch(final Tuple t) {
      try {
          return Get_package_uri.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (String) t.get(POSITION_URI));
    ...
    @Override
    protected Get_package_uri.Match arrayToMatch(final Object[] match) {
      try {
          return Get_package_uri.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_package_uri.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_package_uri.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_package_uri.Matcher> querySpecification() {
      return Get_package_uri.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_uri pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_package_uri.Match> {
    /**
    ...
    @Override
    public void process(final Get_package_uri.Match match) {
      process(match.getPackage(), match.getUri());
    }
  }
  
  private Get_package_uri() {
   ...
   * 
   */
  public static Get_package_uri instance() {
    try{
  ...
  @Override
  protected Get_package_uri.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_package_uri.Matcher.on(engine);
  }
  
  @Override
  public Get_package_uri.Matcher instantiate() {
    return Get_package_uri.Matcher.create();
  }
  
  @Override
  public Get_package_uri.Match newEmptyMatch() {
    return Get_package_uri.Match.newEmptyMatch();
  }
  
  @Override
  public Get_package_uri.Match newMatch(final Object... parameters) {
    return Get_package_uri.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_uri (visibility: PUBLIC, simpleName: Get_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_uri (visibility: PUBLIC, simpleName: Get_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_package_uri INSTANCE = new Get_package_uri();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_package_uri.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find current_package_uri (^package, _current_package, uri)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_package, var__current_package, var_uri), Current_package_uri.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
