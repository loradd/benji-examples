...
public final class $inserted_class_subClass extends BaseGeneratedEMFQuerySpecification<$inserted_class_subClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return $inserted_class_subClass.Match.parameterNames;
    }
    ...
    @Override
    public $inserted_class_subClass.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $inserted_class_subClass.Match)) {
          $inserted_class_subClass.Match other = ($inserted_class_subClass.Match) obj;
    ...
    @Override
    public $inserted_class_subClass specification() {
     ...
     * 
     */
    public static $inserted_class_subClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static $inserted_class_subClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public static $inserted_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
      return new Immutable(pClass, pSubClass);
    }
    
    private static final class Mutable extends $inserted_class_subClass.Match {
    ...
    private static final class Immutable extends $inserted_class_subClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $inserted_class_subClass
   * 
   */
  public static class Matcher extends BaseMatcher<$inserted_class_subClass.Match> {
    /**
     ...
     * 
     */
    public static $inserted_class_subClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $inserted_class_subClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($inserted_class_subClass.Matcher.class);
     ...
     * 
     */
    public Collection<$inserted_class_subClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public $inserted_class_subClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $inserted_class_subClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $inserted_class_subClass.Match> processor) {
     ...
     * 
     */
    public $inserted_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
      return $inserted_class_subClass.Match.newMatch(pClass, pSubClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $inserted_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubClass(final $inserted_class_subClass.Match partialMatch) {
    ...
    @Override
    protected $inserted_class_subClass.Match tupleToMatch(final Tuple t) {
      try {
          return $inserted_class_subClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUBCLASS));
    ...
    @Override
    protected $inserted_class_subClass.Match arrayToMatch(final Object[] match) {
      try {
          return $inserted_class_subClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $inserted_class_subClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $inserted_class_subClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$inserted_class_subClass.Matcher> querySpecification() {
      return $inserted_class_subClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$inserted_class_subClass.Match> {
    /**
    ...
    @Override
    public void process(final $inserted_class_subClass.Match match) {
      process(match.getValueOfClass(), match.getSubClass());
    }
  }
  
  private $inserted_class_subClass() {
   ...
   * 
   */
  public static $inserted_class_subClass instance() {
    try{
  ...
  @Override
  protected $inserted_class_subClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return $inserted_class_subClass.Matcher.on(engine);
  }
  
  @Override
  public $inserted_class_subClass.Matcher instantiate() {
    return $inserted_class_subClass.Matcher.create();
  }
  
  @Override
  public $inserted_class_subClass.Match newEmptyMatch() {
    return $inserted_class_subClass.Match.newEmptyMatch();
  }
  
  @Override
  public $inserted_class_subClass.Match newMatch(final Object... parameters) {
    return $inserted_class_subClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass (visibility: PUBLIC, simpleName: $inserted_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass (visibility: PUBLIC, simpleName: $inserted_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $inserted_class_subClass INSTANCE = new $inserted_class_subClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $inserted_class_subClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
