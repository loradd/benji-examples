...
public final class Equals_class_reference extends BaseGeneratedEMFQuerySpecification<Equals_class_reference.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.equals_class_reference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.equals_class_reference";
    }
    
    @Override
    public List<String> parameterNames() {
      return Equals_class_reference.Match.parameterNames;
    }
    ...
    @Override
    public Equals_class_reference.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Equals_class_reference.Match)) {
          Equals_class_reference.Match other = (Equals_class_reference.Match) obj;
    ...
    @Override
    public Equals_class_reference specification() {
     ...
     * 
     */
    public static Equals_class_reference.Match newEmptyMatch() {
     ...
     * 
     */
    public static Equals_class_reference.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Reference pLeft_reference, final Reference pRight_reference) {
     ...
     * 
     */
    public static Equals_class_reference.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Reference pLeft_reference, final Reference pRight_reference) {
      return new Immutable(pLeft_class, pRight_class, pLeft_reference, pRight_reference);
    }
    
    private static final class Mutable extends Equals_class_reference.Match {
    ...
    private static final class Immutable extends Equals_class_reference.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.equals_class_reference pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // {@literal @}TODO class - structuralFeature (reference) - equals 
   ...
   * @see Match
   *  @see Processor
   * @see Equals_class_reference
   * 
   */
  public static class Matcher extends BaseMatcher<Equals_class_reference.Match> {
    /**
     ...
     * 
     */
    public static Equals_class_reference.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Equals_class_reference.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Equals_class_reference.Matcher.class);
     ...
     * 
     */
    public Collection<Equals_class_reference.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Reference pLeft_reference, final Reference pRight_reference) {
     ...
     * 
     */
    public Equals_class_reference.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Reference pLeft_reference, final Reference pRight_reference) {
     ...
     * 
     */
    public Equals_class_reference.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pLeft_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pRight_class, final Reference pLeft_reference, final Reference pRight_reference) {
      return Equals_class_reference.Match.newMatch(pLeft_class, pRight_class, pLeft_reference, pRight_reference);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfleft_class(final Equals_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfright_class(final Equals_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfleft_reference(final Equals_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfright_reference(final Equals_class_reference.Match partialMatch) {
    ...
    @Override
    protected Equals_class_reference.Match tupleToMatch(final Tuple t) {
      try {
          return Equals_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_LEFT_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_RIGHT_CLASS), (Reference) t.get(POSITION_LEFT_REFERENCE), (Reference) t.get(POSITION_RIGHT_REFERENCE));
    ...
    @Override
    protected Equals_class_reference.Match arrayToMatch(final Object[] match) {
      try {
          return Equals_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS], (Reference) match[POSITION_LEFT_REFERENCE], (Reference) match[POSITION_RIGHT_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Equals_class_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Equals_class_reference.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_LEFT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_RIGHT_CLASS], (Reference) match[POSITION_LEFT_REFERENCE], (Reference) match[POSITION_RIGHT_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Equals_class_reference.Matcher> querySpecification() {
      return Equals_class_reference.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.equals_class_reference pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Equals_class_reference.Match> {
    /**
   ...
   * 
   */
  public static Equals_class_reference instance() {
    try{
  ...
  @Override
  protected Equals_class_reference.Matcher instantiate(final ViatraQueryEngine engine) {
    return Equals_class_reference.Matcher.on(engine);
  }
  
  @Override
  public Equals_class_reference.Matcher instantiate() {
    return Equals_class_reference.Matcher.create();
  }
  
  @Override
  public Equals_class_reference.Match newEmptyMatch() {
    return Equals_class_reference.Match.newEmptyMatch();
  }
  
  @Override
  public Equals_class_reference.Match newMatch(final Object... parameters) {
    return Equals_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Equals_class_reference (visibility: PUBLIC, simpleName: Equals_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Equals_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Equals_class_reference (visibility: PUBLIC, simpleName: Equals_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Equals_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Equals_class_reference INSTANCE = new Equals_class_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Equals_class_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
