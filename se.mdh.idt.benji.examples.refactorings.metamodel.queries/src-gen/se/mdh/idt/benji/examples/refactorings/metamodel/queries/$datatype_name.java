...
public final class $datatype_name extends BaseGeneratedEMFQuerySpecification<$datatype_name.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $datatype_name.Match newMutableMatch(final TraceLink pDatatype, final String pName) {
     ...
     * 
     */
    public static $datatype_name.Match newMatch(final TraceLink pDatatype, final String pName) {
  ...
  public static class Matcher extends BaseMatcher<$datatype_name.Match> {
     ...
     * 
     */
    public Collection<$datatype_name.Match> getAllMatches(final TraceLink pDatatype, final String pName) {
     ...
     * 
     */
    public $datatype_name.Match getOneArbitraryMatch(final TraceLink pDatatype, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pDatatype, final String pName, final IMatchProcessor<? super $datatype_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pDatatype, final String pName, final IMatchProcessor<? super $datatype_name.Match> processor) {
     ...
     * 
     */
    public $datatype_name.Match newMatch(final TraceLink pDatatype, final String pName) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final $datatype_name.Match partialMatch) {
    ...
    protected $datatype_name.Match tupleToMatch(final Tuple t) {
      try {
          return $datatype_name.Match.newMatch((TraceLink) t.get(POSITION_DATATYPE), (String) t.get(POSITION_NAME));
    ...
    protected $datatype_name.Match arrayToMatch(final Object[] match) {
      try {
          return $datatype_name.Match.newMatch((TraceLink) match[POSITION_DATATYPE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected $datatype_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $datatype_name.Match.newMutableMatch((TraceLink) match[POSITION_DATATYPE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $datatype_name.Match newMatch(final Object... parameters) {
    return $datatype_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
