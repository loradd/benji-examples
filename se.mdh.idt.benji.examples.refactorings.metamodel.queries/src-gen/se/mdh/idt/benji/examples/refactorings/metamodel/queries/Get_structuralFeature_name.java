...
public final class Get_structuralFeature_name extends BaseGeneratedEMFQuerySpecification<Get_structuralFeature_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_structuralFeature_name.Match.parameterNames;
    }
    ...
    @Override
    public Get_structuralFeature_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_structuralFeature_name.Match)) {
          Get_structuralFeature_name.Match other = (Get_structuralFeature_name.Match) obj;
    ...
    @Override
    public Get_structuralFeature_name specification() {
     ...
     * 
     */
    public static Get_structuralFeature_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_structuralFeature_name.Match newMutableMatch(final TraceLink pStructuralFeature, final String pName) {
     ...
     * 
     */
    public static Get_structuralFeature_name.Match newMatch(final TraceLink pStructuralFeature, final String pName) {
      return new Immutable(pStructuralFeature, pName);
    }
    
    private static final class Mutable extends Get_structuralFeature_name.Match {
    ...
    private static final class Immutable extends Get_structuralFeature_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_structuralFeature_name
   * 
   */
  public static class Matcher extends BaseMatcher<Get_structuralFeature_name.Match> {
    /**
     ...
     * 
     */
    public static Get_structuralFeature_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_structuralFeature_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_structuralFeature_name.Matcher.class);
     ...
     * 
     */
    public Collection<Get_structuralFeature_name.Match> getAllMatches(final TraceLink pStructuralFeature, final String pName) {
     ...
     * 
     */
    public Get_structuralFeature_name.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final String pName, final IMatchProcessor<? super Get_structuralFeature_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final String pName, final IMatchProcessor<? super Get_structuralFeature_name.Match> processor) {
     ...
     * 
     */
    public Get_structuralFeature_name.Match newMatch(final TraceLink pStructuralFeature, final String pName) {
      return Get_structuralFeature_name.Match.newMatch(pStructuralFeature, pName);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Get_structuralFeature_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final Get_structuralFeature_name.Match partialMatch) {
    ...
    @Override
    protected Get_structuralFeature_name.Match tupleToMatch(final Tuple t) {
      try {
          return Get_structuralFeature_name.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (String) t.get(POSITION_NAME));
    ...
    @Override
    protected Get_structuralFeature_name.Match arrayToMatch(final Object[] match) {
      try {
          return Get_structuralFeature_name.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_structuralFeature_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_structuralFeature_name.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_structuralFeature_name.Matcher> querySpecification() {
      return Get_structuralFeature_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_structuralFeature_name.Match> {
    /**
    ...
    @Override
    public void process(final Get_structuralFeature_name.Match match) {
      process(match.getStructuralFeature(), match.getName());
    }
  }
  
  private Get_structuralFeature_name() {
   ...
   * 
   */
  public static Get_structuralFeature_name instance() {
    try{
  ...
  @Override
  protected Get_structuralFeature_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_structuralFeature_name.Matcher.on(engine);
  }
  
  @Override
  public Get_structuralFeature_name.Matcher instantiate() {
    return Get_structuralFeature_name.Matcher.create();
  }
  
  @Override
  public Get_structuralFeature_name.Match newEmptyMatch() {
    return Get_structuralFeature_name.Match.newEmptyMatch();
  }
  
  @Override
  public Get_structuralFeature_name.Match newMatch(final Object... parameters) {
    return Get_structuralFeature_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_name (visibility: PUBLIC, simpleName: Get_structuralFeature_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_name (visibility: PUBLIC, simpleName: Get_structuralFeature_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_structuralFeature_name INSTANCE = new Get_structuralFeature_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_structuralFeature_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
