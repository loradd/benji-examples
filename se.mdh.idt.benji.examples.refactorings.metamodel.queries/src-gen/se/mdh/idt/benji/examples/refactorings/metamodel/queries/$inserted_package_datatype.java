...
public final class $inserted_package_datatype extends BaseGeneratedEMFQuerySpecification<$inserted_package_datatype.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype";
    }
    
    @Override
    public List<String> parameterNames() {
      return $inserted_package_datatype.Match.parameterNames;
    }
    ...
    @Override
    public $inserted_package_datatype.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $inserted_package_datatype.Match)) {
          $inserted_package_datatype.Match other = ($inserted_package_datatype.Match) obj;
    ...
    @Override
    public $inserted_package_datatype specification() {
     ...
     * 
     */
    public static $inserted_package_datatype.Match newEmptyMatch() {
     ...
     * 
     */
    public static $inserted_package_datatype.Match newMutableMatch(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public static $inserted_package_datatype.Match newMatch(final TraceLink pPackage, final TraceLink pDatatype) {
      return new Immutable(pPackage, pDatatype);
    }
    
    private static final class Mutable extends $inserted_package_datatype.Match {
    ...
    private static final class Immutable extends $inserted_package_datatype.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $inserted_package_datatype
   * 
   */
  public static class Matcher extends BaseMatcher<$inserted_package_datatype.Match> {
    /**
     ...
     * 
     */
    public static $inserted_package_datatype.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $inserted_package_datatype.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($inserted_package_datatype.Matcher.class);
     ...
     * 
     */
    public Collection<$inserted_package_datatype.Match> getAllMatches(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public $inserted_package_datatype.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pDatatype, final IMatchProcessor<? super $inserted_package_datatype.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pDatatype, final IMatchProcessor<? super $inserted_package_datatype.Match> processor) {
     ...
     * 
     */
    public $inserted_package_datatype.Match newMatch(final TraceLink pPackage, final TraceLink pDatatype) {
      return $inserted_package_datatype.Match.newMatch(pPackage, pDatatype);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $inserted_package_datatype.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final $inserted_package_datatype.Match partialMatch) {
    ...
    @Override
    protected $inserted_package_datatype.Match tupleToMatch(final Tuple t) {
      try {
          return $inserted_package_datatype.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_DATATYPE));
    ...
    @Override
    protected $inserted_package_datatype.Match arrayToMatch(final Object[] match) {
      try {
          return $inserted_package_datatype.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $inserted_package_datatype.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $inserted_package_datatype.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$inserted_package_datatype.Matcher> querySpecification() {
      return $inserted_package_datatype.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$inserted_package_datatype.Match> {
    /**
    ...
    @Override
    public void process(final $inserted_package_datatype.Match match) {
      process(match.getPackage(), match.getDatatype());
    }
  }
  
  private $inserted_package_datatype() {
   ...
   * 
   */
  public static $inserted_package_datatype instance() {
    try{
  ...
  @Override
  protected $inserted_package_datatype.Matcher instantiate(final ViatraQueryEngine engine) {
    return $inserted_package_datatype.Matcher.on(engine);
  }
  
  @Override
  public $inserted_package_datatype.Matcher instantiate() {
    return $inserted_package_datatype.Matcher.create();
  }
  
  @Override
  public $inserted_package_datatype.Match newEmptyMatch() {
    return $inserted_package_datatype.Match.newEmptyMatch();
  }
  
  @Override
  public $inserted_package_datatype.Match newMatch(final Object... parameters) {
    return $inserted_package_datatype.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype (visibility: PUBLIC, simpleName: $inserted_package_datatype, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype (visibility: PUBLIC, simpleName: $inserted_package_datatype, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_datatype, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $inserted_package_datatype INSTANCE = new $inserted_package_datatype();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $inserted_package_datatype.GeneratedPQuery INSTANCE = new GeneratedPQuery();
