...
public final class Unset_reference_owner extends BaseGeneratedEMFQuerySpecification<Unset_reference_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_reference_owner.Match.parameterNames;
    }
    ...
    @Override
    public Unset_reference_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_reference_owner.Match)) {
          Unset_reference_owner.Match other = (Unset_reference_owner.Match) obj;
    ...
    @Override
    public Unset_reference_owner specification() {
     ...
     * 
     */
    public static Unset_reference_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_reference_owner.Match newMutableMatch(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public static Unset_reference_owner.Match newMatch(final TraceLink pReference, final TraceLink pOwner) {
      return new Immutable(pReference, pOwner);
    }
    
    private static final class Mutable extends Unset_reference_owner.Match {
    ...
    private static final class Immutable extends Unset_reference_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_reference_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_reference_owner.Match> {
    /**
     ...
     * 
     */
    public static Unset_reference_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_reference_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_reference_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_reference_owner.Match> getAllMatches(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public Unset_reference_owner.Match getOneArbitraryMatch(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final TraceLink pOwner, final IMatchProcessor<? super Unset_reference_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final TraceLink pOwner, final IMatchProcessor<? super Unset_reference_owner.Match> processor) {
     ...
     * 
     */
    public Unset_reference_owner.Match newMatch(final TraceLink pReference, final TraceLink pOwner) {
      return Unset_reference_owner.Match.newMatch(pReference, pOwner);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Unset_reference_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final Unset_reference_owner.Match partialMatch) {
    ...
    @Override
    protected Unset_reference_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_reference_owner.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (TraceLink) t.get(POSITION_OWNER));
    ...
    @Override
    protected Unset_reference_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_reference_owner.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_reference_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_reference_owner.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_reference_owner.Matcher> querySpecification() {
      return Unset_reference_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_reference_owner.Match> {
    /**
    ...
    @Override
    public void process(final Unset_reference_owner.Match match) {
      process(match.getReference(), match.getOwner());
    }
  }
  
  private Unset_reference_owner() {
   ...
   * 
   */
  public static Unset_reference_owner instance() {
    try{
  ...
  @Override
  protected Unset_reference_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_reference_owner.Matcher.on(engine);
  }
  
  @Override
  public Unset_reference_owner.Matcher instantiate() {
    return Unset_reference_owner.Matcher.create();
  }
  
  @Override
  public Unset_reference_owner.Match newEmptyMatch() {
    return Unset_reference_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_reference_owner.Match newMatch(final Object... parameters) {
    return Unset_reference_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_owner (visibility: PUBLIC, simpleName: Unset_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_owner (visibility: PUBLIC, simpleName: Unset_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_reference_owner INSTANCE = new Unset_reference_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_reference_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_reference_owner (reference, _current_reference, owner, _current_owner)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_reference, var__current_reference, var_owner, var__current_owner), Current_reference_owner.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
