...
public final class Preserved_reference_containment extends BaseGeneratedEMFQuerySpecification<Preserved_reference_containment.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_containment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_containment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_reference_containment.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_reference_containment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_reference_containment.Match)) {
          Preserved_reference_containment.Match other = (Preserved_reference_containment.Match) obj;
    ...
    @Override
    public Preserved_reference_containment specification() {
     ...
     * 
     */
    public static Preserved_reference_containment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_reference_containment.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment) {
     ...
     * 
     */
    public static Preserved_reference_containment.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_containment, pCurrent_containment);
    }
    
    private static final class Mutable extends Preserved_reference_containment.Match {
    ...
    private static final class Immutable extends Preserved_reference_containment.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_containment pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_reference_containment
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_reference_containment.Match> {
    /**
     ...
     * 
     */
    public static Preserved_reference_containment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_reference_containment.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_reference_containment.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_reference_containment.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment) {
     ...
     * 
     */
    public Preserved_reference_containment.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment, final IMatchProcessor<? super Preserved_reference_containment.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment, final IMatchProcessor<? super Preserved_reference_containment.Match> processor) {
     ...
     * 
     */
    public Preserved_reference_containment.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Boolean pInitial_containment, final Boolean pCurrent_containment) {
      return Preserved_reference_containment.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_containment, pCurrent_containment);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Preserved_reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Preserved_reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfinitial_containment(final Preserved_reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfcurrent_containment(final Preserved_reference_containment.Match partialMatch) {
    ...
    @Override
    protected Preserved_reference_containment.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_reference_containment.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (Boolean) t.get(POSITION_INITIAL_CONTAINMENT), (Boolean) t.get(POSITION_CURRENT_CONTAINMENT));
    ...
    @Override
    protected Preserved_reference_containment.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_reference_containment.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Boolean) match[POSITION_INITIAL_CONTAINMENT], (Boolean) match[POSITION_CURRENT_CONTAINMENT]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_reference_containment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_reference_containment.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Boolean) match[POSITION_INITIAL_CONTAINMENT], (Boolean) match[POSITION_CURRENT_CONTAINMENT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_reference_containment.Matcher> querySpecification() {
      return Preserved_reference_containment.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_containment pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_reference_containment.Match> {
    /**
   ...
   * 
   */
  public static Preserved_reference_containment instance() {
    try{
  ...
  @Override
  protected Preserved_reference_containment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_reference_containment.Matcher.on(engine);
  }
  
  @Override
  public Preserved_reference_containment.Matcher instantiate() {
    return Preserved_reference_containment.Matcher.create();
  }
  
  @Override
  public Preserved_reference_containment.Match newEmptyMatch() {
    return Preserved_reference_containment.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_reference_containment.Match newMatch(final Object... parameters) {
    return Preserved_reference_containment.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (java.lang.Boolean) parameters[2], (java.lang.Boolean) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_containment (visibility: PUBLIC, simpleName: Preserved_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_containment (visibility: PUBLIC, simpleName: Preserved_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_reference_containment INSTANCE = new Preserved_reference_containment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_reference_containment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern preserved_reference_containment";
              }
  ...
  private static boolean evaluateExpression_1_1(final Boolean current_containment, final Boolean initial_containment) {
    boolean _equals = com.google.common.base.Objects.equal(initial_containment, current_containment);
    return _equals;
  }
}
