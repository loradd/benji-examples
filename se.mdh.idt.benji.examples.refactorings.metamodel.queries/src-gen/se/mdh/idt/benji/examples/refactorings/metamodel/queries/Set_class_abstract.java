...
public final class Set_class_abstract extends BaseGeneratedEMFQuerySpecification<Set_class_abstract.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_abstract pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_abstract";
    }
     ...
     * 
     */
    public static Set_class_abstract.Match newMutableMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public static Set_class_abstract.Match newMatch(final TraceLink pClass, final Boolean pAbstract) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_abstract pattern,
  ...
  public static class Matcher extends BaseMatcher<Set_class_abstract.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_class_abstract.Matcher.class);
     ...
     * 
     */
    public Collection<Set_class_abstract.Match> getAllMatches(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public Set_class_abstract.Match getOneArbitraryMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final Boolean pAbstract, final IMatchProcessor<? super Set_class_abstract.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final Boolean pAbstract, final IMatchProcessor<? super Set_class_abstract.Match> processor) {
     ...
     * 
     */
    public Set_class_abstract.Match newMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Set_class_abstract.Match partialMatch) {
    ...
    protected Set_class_abstract.Match tupleToMatch(final Tuple t) {
      try {
          return Set_class_abstract.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (Boolean) t.get(POSITION_ABSTRACT));
    ...
    protected Set_class_abstract.Match arrayToMatch(final Object[] match) {
      try {
          return Set_class_abstract.Match.newMatch((TraceLink) match[POSITION_CLASS], (Boolean) match[POSITION_ABSTRACT]);
      } catch(ClassCastException e) {
    ...
    protected Set_class_abstract.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_class_abstract.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (Boolean) match[POSITION_ABSTRACT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_abstract pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_class_abstract.Match> {
    /**
    ...
    @Override
    public void process(final Set_class_abstract.Match match) {
  ...
  public Set_class_abstract.Match newMatch(final Object... parameters) {
    return Set_class_abstract.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_abstract (visibility: PUBLIC, simpleName: Set_class_abstract, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_abstract, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_abstract (visibility: PUBLIC, simpleName: Set_class_abstract, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_abstract, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_class_abstract INSTANCE = new Set_class_abstract();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_class_abstract.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_class_abstract (class, _initial_class, abstract)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__initial_class, var_abstract), Initial_class_abstract.instance().getInternalQueryRepresentation());
          // 	find current_class_abstract (class, _current_class, abstract)
