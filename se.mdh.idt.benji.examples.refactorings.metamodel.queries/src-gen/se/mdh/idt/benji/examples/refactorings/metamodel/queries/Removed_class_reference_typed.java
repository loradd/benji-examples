...
public final class Removed_class_reference_typed extends BaseGeneratedEMFQuerySpecification<Removed_class_reference_typed.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference_typed pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference_typed";
    }
    
    @Override
    public List<String> parameterNames() {
      return Removed_class_reference_typed.Match.parameterNames;
    }
    ...
    @Override
    public Removed_class_reference_typed.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Removed_class_reference_typed.Match)) {
          Removed_class_reference_typed.Match other = (Removed_class_reference_typed.Match) obj;
    ...
    @Override
    public Removed_class_reference_typed specification() {
     ...
     * 
     */
    public static Removed_class_reference_typed.Match newEmptyMatch() {
     ...
     * 
     */
    public static Removed_class_reference_typed.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_reference, pInitial_type);
    }
    
    private static final class Mutable extends Removed_class_reference_typed.Match {
    ...
    private static final class Immutable extends Removed_class_reference_typed.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference_typed pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Removed_class_reference_typed
   * 
   */
  public static class Matcher extends BaseMatcher<Removed_class_reference_typed.Match> {
    /**
     ...
     * 
     */
    public static Removed_class_reference_typed.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Removed_class_reference_typed.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Removed_class_reference_typed.Matcher.class);
     ...
     * 
     */
    public Collection<Removed_class_reference_typed.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final IMatchProcessor<? super Removed_class_reference_typed.Match> processor) {
     ...
     */
    public Removed_class_reference_typed.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type) {
      return Removed_class_reference_typed.Match.newMatch(pInitial_class, pCurrent_class, pInitial_reference, pInitial_type);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final Removed_class_reference_typed.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final Removed_class_reference_typed.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Removed_class_reference_typed.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_type(final Removed_class_reference_typed.Match partialMatch) {
    ...
    @Override
    protected Removed_class_reference_typed.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Removed_class_reference_typed.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Removed_class_reference_typed.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Reference) match[POSITION_INITIAL_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Removed_class_reference_typed.Matcher> querySpecification() {
      return Removed_class_reference_typed.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference_typed pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Removed_class_reference_typed.Match> {
    /**
    ...
    @Override
    public void process(final Removed_class_reference_typed.Match match) {
      process(match.getInitial_class(), match.getCurrent_class(), match.getInitial_reference(), match.getInitial_type());
    }
  }
  
  private Removed_class_reference_typed() {
   ...
   * 
   */
  public static Removed_class_reference_typed instance() {
    try{
  ...
  @Override
  protected Removed_class_reference_typed.Matcher instantiate(final ViatraQueryEngine engine) {
    return Removed_class_reference_typed.Matcher.on(engine);
  }
  
  @Override
  public Removed_class_reference_typed.Matcher instantiate() {
    return Removed_class_reference_typed.Matcher.create();
  }
  
  @Override
  public Removed_class_reference_typed.Match newEmptyMatch() {
    return Removed_class_reference_typed.Match.newEmptyMatch();
  }
  
  @Override
  public Removed_class_reference_typed.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference_typed (visibility: PUBLIC, simpleName: Removed_class_reference_typed, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference_typed, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference_typed (visibility: PUBLIC, simpleName: Removed_class_reference_typed, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference_typed, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Removed_class_reference_typed INSTANCE = new Removed_class_reference_typed();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Removed_class_reference_typed.GeneratedPQuery INSTANCE = new GeneratedPQuery();
