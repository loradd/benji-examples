...
public final class $unset_attribute_name extends BaseGeneratedEMFQuerySpecification<$unset_attribute_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name";
    }
     ...
     * 
     */
    public static $unset_attribute_name.Match newMutableMatch(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public static $unset_attribute_name.Match newMatch(final TraceLink pAttribute, final String pName) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name pattern,
  ...
  public static class Matcher extends BaseMatcher<$unset_attribute_name.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($unset_attribute_name.Matcher.class);
     ...
     * 
     */
    public Collection<$unset_attribute_name.Match> getAllMatches(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public $unset_attribute_name.Match getOneArbitraryMatch(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final String pName, final IMatchProcessor<? super $unset_attribute_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final String pName, final IMatchProcessor<? super $unset_attribute_name.Match> processor) {
     ...
     * 
     */
    public $unset_attribute_name.Match newMatch(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $unset_attribute_name.Match partialMatch) {
    ...
    protected $unset_attribute_name.Match tupleToMatch(final Tuple t) {
      try {
          return $unset_attribute_name.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (String) t.get(POSITION_NAME));
    ...
    protected $unset_attribute_name.Match arrayToMatch(final Object[] match) {
      try {
          return $unset_attribute_name.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected $unset_attribute_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $unset_attribute_name.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$unset_attribute_name.Match> {
    /**
    ...
    @Override
    public void process(final $unset_attribute_name.Match match) {
  ...
  public $unset_attribute_name.Match newMatch(final Object... parameters) {
    return $unset_attribute_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name (visibility: PUBLIC, simpleName: $unset_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name (visibility: PUBLIC, simpleName: $unset_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$unset_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $unset_attribute_name INSTANCE = new $unset_attribute_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $unset_attribute_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	neg find $current_attribute_name (attribute, _current_attribute, name)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_attribute, var__current_attribute, var_name), $current_attribute_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
