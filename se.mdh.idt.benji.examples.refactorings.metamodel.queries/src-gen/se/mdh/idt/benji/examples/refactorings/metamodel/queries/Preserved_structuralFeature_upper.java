...
public final class Preserved_structuralFeature_upper extends BaseGeneratedEMFQuerySpecification<Preserved_structuralFeature_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_structuralFeature_upper.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_structuralFeature_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_structuralFeature_upper.Match)) {
          Preserved_structuralFeature_upper.Match other = (Preserved_structuralFeature_upper.Match) obj;
    ...
    @Override
    public Preserved_structuralFeature_upper specification() {
     ...
     * 
     */
    public static Preserved_structuralFeature_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_structuralFeature_upper.Match newMutableMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public static Preserved_structuralFeature_upper.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper) {
      return new Immutable(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_upper, pCurrent_upper);
    }
    
    private static final class Mutable extends Preserved_structuralFeature_upper.Match {
    ...
    private static final class Immutable extends Preserved_structuralFeature_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_upper pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // structuralFeature - upper - preserved
   * pattern preserved_structuralFeature_upper (initial_structuralFeature : StructuralFeature, current_structuralFeature : StructuralFeature, initial_upper : java Integer, current_upper : java Integer) {
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_structuralFeature_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_structuralFeature_upper.Match> {
    /**
     ...
     * 
     */
    public static Preserved_structuralFeature_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_structuralFeature_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_structuralFeature_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_structuralFeature_upper.Match> getAllMatches(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public Preserved_structuralFeature_upper.Match getOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public void forEachMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper, final IMatchProcessor<? super Preserved_structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper, final IMatchProcessor<? super Preserved_structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public Preserved_structuralFeature_upper.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final Integer pInitial_upper, final Integer pCurrent_upper) {
      return Preserved_structuralFeature_upper.Match.newMatch(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_upper, pCurrent_upper);
    }
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfinitial_structuralFeature(final Preserved_structuralFeature_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfcurrent_structuralFeature(final Preserved_structuralFeature_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfinitial_upper(final Preserved_structuralFeature_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfcurrent_upper(final Preserved_structuralFeature_upper.Match partialMatch) {
    ...
    @Override
    protected Preserved_structuralFeature_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_structuralFeature_upper.Match.newMatch((StructuralFeature) t.get(POSITION_INITIAL_STRUCTURALFEATURE), (StructuralFeature) t.get(POSITION_CURRENT_STRUCTURALFEATURE), (Integer) t.get(POSITION_INITIAL_UPPER), (Integer) t.get(POSITION_CURRENT_UPPER));
    ...
    @Override
    protected Preserved_structuralFeature_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_structuralFeature_upper.Match.newMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (Integer) match[POSITION_INITIAL_UPPER], (Integer) match[POSITION_CURRENT_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_structuralFeature_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_structuralFeature_upper.Match.newMutableMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (Integer) match[POSITION_INITIAL_UPPER], (Integer) match[POSITION_CURRENT_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_structuralFeature_upper.Matcher> querySpecification() {
      return Preserved_structuralFeature_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_structuralFeature_upper.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_structuralFeature_upper.Match match) {
  ...
  private Preserved_structuralFeature_upper() {
   ...
   * 
   */
  public static Preserved_structuralFeature_upper instance() {
    try{
  ...
  @Override
  protected Preserved_structuralFeature_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_structuralFeature_upper.Matcher.on(engine);
  }
  
  @Override
  public Preserved_structuralFeature_upper.Matcher instantiate() {
    return Preserved_structuralFeature_upper.Matcher.create();
  }
  
  @Override
  public Preserved_structuralFeature_upper.Match newEmptyMatch() {
    return Preserved_structuralFeature_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_structuralFeature_upper.Match newMatch(final Object... parameters) {
    return Preserved_structuralFeature_upper.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[1], (java.lang.Integer) parameters[2], (java.lang.Integer) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_upper (visibility: PUBLIC, simpleName: Preserved_structuralFeature_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_upper (visibility: PUBLIC, simpleName: Preserved_structuralFeature_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_structuralFeature_upper INSTANCE = new Preserved_structuralFeature_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_structuralFeature_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern preserved_structuralFeature_upper";
              }
  ...
  private static boolean evaluateExpression_1_1(final Integer current_upper, final Integer initial_upper) {
    boolean _equals = com.google.common.base.Objects.equal(initial_upper, current_upper);
    return _equals;
  }
}
