...
public final class $attribute_owner extends BaseGeneratedEMFQuerySpecification<$attribute_owner.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $attribute_owner.Match newMutableMatch(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public static $attribute_owner.Match newMatch(final TraceLink pAttribute, final TraceLink pOwner) {
  ...
  public static class Matcher extends BaseMatcher<$attribute_owner.Match> {
     ...
     * 
     */
    public Collection<$attribute_owner.Match> getAllMatches(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public $attribute_owner.Match getOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final TraceLink pOwner, final IMatchProcessor<? super $attribute_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pOwner, final IMatchProcessor<? super $attribute_owner.Match> processor) {
     ...
     * 
     */
    public $attribute_owner.Match newMatch(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $attribute_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final $attribute_owner.Match partialMatch) {
    ...
    protected $attribute_owner.Match tupleToMatch(final Tuple t) {
      try {
          return $attribute_owner.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (TraceLink) t.get(POSITION_OWNER));
    ...
    protected $attribute_owner.Match arrayToMatch(final Object[] match) {
      try {
          return $attribute_owner.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    protected $attribute_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $attribute_owner.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $attribute_owner.Match newMatch(final Object... parameters) {
    return $attribute_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
