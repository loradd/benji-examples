...
public final class $deleted_class extends BaseGeneratedEMFQuerySpecification<$deleted_class.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_class.Match newMutableMatch(final TraceLink pClass) {
     ...
     * 
     */
    public static $deleted_class.Match newMatch(final TraceLink pClass) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_class.Match> {
     ...
     * 
     */
    public Collection<$deleted_class.Match> getAllMatches(final TraceLink pClass) {
     ...
     * 
     */
    public $deleted_class.Match getOneArbitraryMatch(final TraceLink pClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final IMatchProcessor<? super $deleted_class.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final IMatchProcessor<? super $deleted_class.Match> processor) {
     ...
     * 
     */
    public $deleted_class.Match newMatch(final TraceLink pClass) {
    ...
    protected $deleted_class.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_class.Match.newMatch((TraceLink) t.get(POSITION_CLASS));
    ...
    protected $deleted_class.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_class.Match.newMatch((TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_class.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_class.Match.newMutableMatch((TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_class.Match newMatch(final Object... parameters) {
    return $deleted_class.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
