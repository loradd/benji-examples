...
public final class Initial_package_uri extends BaseGeneratedEMFQuerySpecification<Initial_package_uri.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_package_uri pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("package", "initial_package", "uri");
    
    private Match(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_package_uri";
    }
    ...
    public Object[] toArray() {
      return new Object[]{fPackage, fInitial_package, fUri};
    }
    
    @Override
    public Initial_package_uri.Match toImmutable() {
      return isMutable() ? newMatch(fPackage, fInitial_package, fUri) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fPackage, fInitial_package, fUri);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Initial_package_uri.Match)) {
          ...
          return Objects.equals(fPackage, other.fPackage) && Objects.equals(fInitial_package, other.fInitial_package) && Objects.equals(fUri, other.fUri);
      } else {
     ...
     * 
     */
    public static Initial_package_uri.Match newMutableMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return new Mutable(pPackage, pInitial_package, pUri);
    }
     ...
     * 
     */
    public static Initial_package_uri.Match newMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return new Immutable(pPackage, pInitial_package, pUri);
    }
    
    private static final class Mutable extends Initial_package_uri.Match {
      Mutable(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
        super(pPackage, pInitial_package, pUri);
      }
    ...
    private static final class Immutable extends Initial_package_uri.Match {
      Immutable(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
        super(pPackage, pInitial_package, pUri);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_package_uri pattern,
  ...
  public static class Matcher extends BaseMatcher<Initial_package_uri.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_package_uri.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_package_uri.Match> getAllMatches(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return rawGetAllMatches(new Object[]{pPackage, pInitial_package, pUri});
    }
     ...
     * 
     */
    public Initial_package_uri.Match getOneArbitraryMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return rawGetOneArbitraryMatch(new Object[]{pPackage, pInitial_package, pUri});
    }
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return rawHasMatch(new Object[]{pPackage, pInitial_package, pUri});
    }
     ...
     * 
     */
    public int countMatches(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return rawCountMatches(new Object[]{pPackage, pInitial_package, pUri});
    }
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri, final IMatchProcessor<? super Initial_package_uri.Match> processor) {
      rawForEachMatch(new Object[]{pPackage, pInitial_package, pUri}, processor);
    }
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri, final IMatchProcessor<? super Initial_package_uri.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pPackage, pInitial_package, pUri}, processor);
    }
     ...
     * 
     */
    public Initial_package_uri.Match newMatch(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
      return Initial_package_uri.Match.newMatch(pPackage, pInitial_package, pUri);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Initial_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Initial_package_uri.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public Set<String> getAllValuesOfuri(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package) {
    ...
    protected Initial_package_uri.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_package_uri.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (se.mdh.idt.benji.examples.refactorings.metamodel.Package) t.get(POSITION_INITIAL_PACKAGE), (String) t.get(POSITION_URI));
    ...
    protected Initial_package_uri.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_package_uri.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
    ...
    protected Initial_package_uri.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_package_uri.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_package_uri pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_package_uri.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final String pUri);
    
    @Override
    public void process(final Initial_package_uri.Match match) {
      process(match.getPackage(), match.getInitial_package(), match.getUri());
    }
  }
  ...
  public Initial_package_uri.Match newMatch(final Object... parameters) {
    return Initial_package_uri.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) parameters[1], (java.lang.String) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_package_uri (visibility: PUBLIC, simpleName: Initial_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_package_uri (visibility: PUBLIC, simpleName: Initial_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_package_uri INSTANCE = new Initial_package_uri();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_package_uri.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pPackage, parameter_pInitial_package, parameter_pUri);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("package","initial_package","uri");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_initial_package, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdh.se/examples/refactorings/Metamodel", "Package", "uri")));
