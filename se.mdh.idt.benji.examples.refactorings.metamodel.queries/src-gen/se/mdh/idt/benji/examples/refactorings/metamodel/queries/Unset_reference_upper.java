...
public final class Unset_reference_upper extends BaseGeneratedEMFQuerySpecification<Unset_reference_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_reference_upper.Match.parameterNames;
    }
    ...
    @Override
    public Unset_reference_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_reference_upper.Match)) {
          Unset_reference_upper.Match other = (Unset_reference_upper.Match) obj;
    ...
    @Override
    public Unset_reference_upper specification() {
     ...
     * 
     */
    public static Unset_reference_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_reference_upper.Match newMutableMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public static Unset_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return new Immutable(pReference, pUpper);
    }
    
    private static final class Mutable extends Unset_reference_upper.Match {
    ...
    private static final class Immutable extends Unset_reference_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_reference_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_reference_upper.Match> {
    /**
     ...
     * 
     */
    public static Unset_reference_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_reference_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_reference_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_reference_upper.Match> getAllMatches(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public Unset_reference_upper.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Unset_reference_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Unset_reference_upper.Match> processor) {
     ...
     * 
     */
    public Unset_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return Unset_reference_upper.Match.newMatch(pReference, pUpper);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Unset_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Unset_reference_upper.Match partialMatch) {
    ...
    @Override
    protected Unset_reference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_reference_upper.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_UPPER));
    ...
    @Override
    protected Unset_reference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_reference_upper.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_reference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_reference_upper.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_reference_upper.Matcher> querySpecification() {
      return Unset_reference_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_reference_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_reference_upper.Match> {
    /**
    ...
    @Override
    public void process(final Unset_reference_upper.Match match) {
      process(match.getReference(), match.getUpper());
    }
  }
  
  private Unset_reference_upper() {
   ...
   * 
   */
  public static Unset_reference_upper instance() {
    try{
  ...
  @Override
  protected Unset_reference_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_reference_upper.Matcher.on(engine);
  }
  
  @Override
  public Unset_reference_upper.Matcher instantiate() {
    return Unset_reference_upper.Matcher.create();
  }
  
  @Override
  public Unset_reference_upper.Match newEmptyMatch() {
    return Unset_reference_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_reference_upper.Match newMatch(final Object... parameters) {
    return Unset_reference_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_upper (visibility: PUBLIC, simpleName: Unset_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_upper (visibility: PUBLIC, simpleName: Unset_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_reference_upper INSTANCE = new Unset_reference_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_reference_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_reference_upper (reference, _current_reference, upper)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_reference, var__current_reference, var_upper), Current_reference_upper.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
