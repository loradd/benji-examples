...
public final class $structuralFeature_upper extends BaseGeneratedEMFQuerySpecification<$structuralFeature_upper.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $structuralFeature_upper.Match newMutableMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public static $structuralFeature_upper.Match newMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
  ...
  public static class Matcher extends BaseMatcher<$structuralFeature_upper.Match> {
     ...
     * 
     */
    public Collection<$structuralFeature_upper.Match> getAllMatches(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public $structuralFeature_upper.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final Integer pUpper, final IMatchProcessor<? super $structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pUpper, final IMatchProcessor<? super $structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public $structuralFeature_upper.Match newMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final $structuralFeature_upper.Match partialMatch) {
    ...
    protected $structuralFeature_upper.Match tupleToMatch(final Tuple t) {
      try {
          return $structuralFeature_upper.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (Integer) t.get(POSITION_UPPER));
    ...
    protected $structuralFeature_upper.Match arrayToMatch(final Object[] match) {
      try {
          return $structuralFeature_upper.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    protected $structuralFeature_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $structuralFeature_upper.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $structuralFeature_upper.Match newMatch(final Object... parameters) {
    return $structuralFeature_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
