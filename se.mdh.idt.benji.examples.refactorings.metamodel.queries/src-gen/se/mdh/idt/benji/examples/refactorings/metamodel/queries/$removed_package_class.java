...
public final class $removed_package_class extends BaseGeneratedEMFQuerySpecification<$removed_package_class.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $removed_package_class.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public static $removed_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
  ...
  public static class Matcher extends BaseMatcher<$removed_package_class.Match> {
     ...
     * 
     */
    public Collection<$removed_package_class.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public $removed_package_class.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $removed_package_class.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $removed_package_class.Match> processor) {
     ...
     * 
     */
    public $removed_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $removed_package_class.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $removed_package_class.Match partialMatch) {
    ...
    protected $removed_package_class.Match tupleToMatch(final Tuple t) {
      try {
          return $removed_package_class.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASS));
    ...
    protected $removed_package_class.Match arrayToMatch(final Object[] match) {
      try {
          return $removed_package_class.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    protected $removed_package_class.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $removed_package_class.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $removed_package_class.Match newMatch(final Object... parameters) {
    return $removed_package_class.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
