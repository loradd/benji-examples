...
public final class Set_package_uri extends BaseGeneratedEMFQuerySpecification<Set_package_uri.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_package_uri pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_package_uri";
    }
     ...
     * 
     */
    public static Set_package_uri.Match newMutableMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public static Set_package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_package_uri pattern,
  ...
  public static class Matcher extends BaseMatcher<Set_package_uri.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_package_uri.Matcher.class);
     ...
     * 
     */
    public Collection<Set_package_uri.Match> getAllMatches(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public Set_package_uri.Match getOneArbitraryMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super Set_package_uri.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super Set_package_uri.Match> processor) {
     ...
     * 
     */
    public Set_package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Set_package_uri.Match partialMatch) {
    ...
    protected Set_package_uri.Match tupleToMatch(final Tuple t) {
      try {
          return Set_package_uri.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (String) t.get(POSITION_URI));
    ...
    protected Set_package_uri.Match arrayToMatch(final Object[] match) {
      try {
          return Set_package_uri.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
    ...
    protected Set_package_uri.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_package_uri.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_package_uri pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_package_uri.Match> {
    /**
    ...
    @Override
    public void process(final Set_package_uri.Match match) {
  ...
  public Set_package_uri.Match newMatch(final Object... parameters) {
    return Set_package_uri.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_package_uri (visibility: PUBLIC, simpleName: Set_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_package_uri (visibility: PUBLIC, simpleName: Set_package_uri, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_package_uri, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_package_uri INSTANCE = new Set_package_uri();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_package_uri.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_package_uri (^package, _initial_package, uri)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_package, var__initial_package, var_uri), Initial_package_uri.instance().getInternalQueryRepresentation());
          // 	find current_package_uri (^package, _current_package, uri)
