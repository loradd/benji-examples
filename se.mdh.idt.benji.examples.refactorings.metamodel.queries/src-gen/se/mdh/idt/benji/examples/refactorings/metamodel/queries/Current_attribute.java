...
public final class Current_attribute extends BaseGeneratedEMFQuerySpecification<Current_attribute.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.current_attribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.current_attribute";
    }
     ...
     * 
     */
    public static Current_attribute.Match newMutableMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public static Current_attribute.Match newMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
      return new Immutable(pAttribute, pCurrent_attribute);
    }
    
    private static final class Mutable extends Current_attribute.Match {
      Mutable(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
    ...
    private static final class Immutable extends Current_attribute.Match {
      Immutable(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
        super(pAttribute, pCurrent_attribute);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.current_attribute pattern,
  ...
  public static class Matcher extends BaseMatcher<Current_attribute.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_attribute.Matcher.class);
     ...
     * 
     */
    public Collection<Current_attribute.Match> getAllMatches(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
      return rawGetAllMatches(new Object[]{pAttribute, pCurrent_attribute});
    }
     ...
     * 
     */
    public Current_attribute.Match getOneArbitraryMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public int countMatches(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super Current_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute, final IMatchProcessor<? super Current_attribute.Match> processor) {
     ...
     * 
     */
    public Current_attribute.Match newMatch(final TraceLink pAttribute, final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Current_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Attribute pCurrent_attribute) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final TraceLink pAttribute) {
    ...
    protected Current_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return Current_attribute.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (Attribute) t.get(POSITION_CURRENT_ATTRIBUTE));
    ...
    protected Current_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return Current_attribute.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected Current_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_attribute.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.current_attribute pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_attribute.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pAttribute, final Attribute pCurrent_attribute);
    
    @Override
    public void process(final Current_attribute.Match match) {
      process(match.getAttribute(), match.getCurrent_attribute());
    }
  }
  ...
  public Current_attribute.Match newMatch(final Object... parameters) {
    return Current_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Current_attribute (visibility: PUBLIC, simpleName: Current_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Current_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Current_attribute (visibility: PUBLIC, simpleName: Current_attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Current_attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_attribute INSTANCE = new Current_attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pAttribute, parameter_pCurrent_attribute);
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find current_structuralFeature (attribute, current_attribute)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_attribute, var_current_attribute), Current_structuralFeature.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
