...
public final class Changed_reference_lower extends BaseGeneratedEMFQuerySpecification<Changed_reference_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_reference_lower.Match.parameterNames;
    }
    ...
    @Override
    public Changed_reference_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_reference_lower.Match)) {
          Changed_reference_lower.Match other = (Changed_reference_lower.Match) obj;
    ...
    @Override
    public Changed_reference_lower specification() {
     ...
     * 
     */
    public static Changed_reference_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_reference_lower.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public static Changed_reference_lower.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_lower, pCurrent_lower);
    }
    
    private static final class Mutable extends Changed_reference_lower.Match {
    ...
    private static final class Immutable extends Changed_reference_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_lower pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_reference_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_reference_lower.Match> {
    /**
     ...
     * 
     */
    public static Changed_reference_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_reference_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_reference_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_reference_lower.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public Changed_reference_lower.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower, final IMatchProcessor<? super Changed_reference_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower, final IMatchProcessor<? super Changed_reference_lower.Match> processor) {
     ...
     * 
     */
    public Changed_reference_lower.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_lower, final Integer pCurrent_lower) {
      return Changed_reference_lower.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_lower, pCurrent_lower);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Changed_reference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Changed_reference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfinitial_lower(final Changed_reference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfcurrent_lower(final Changed_reference_lower.Match partialMatch) {
    ...
    @Override
    protected Changed_reference_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_reference_lower.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (Integer) t.get(POSITION_INITIAL_LOWER), (Integer) t.get(POSITION_CURRENT_LOWER));
    ...
    @Override
    protected Changed_reference_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_reference_lower.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Integer) match[POSITION_INITIAL_LOWER], (Integer) match[POSITION_CURRENT_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_reference_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_reference_lower.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Integer) match[POSITION_INITIAL_LOWER], (Integer) match[POSITION_CURRENT_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_reference_lower.Matcher> querySpecification() {
      return Changed_reference_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_reference_lower.Match> {
    /**
   ...
   * 
   */
  public static Changed_reference_lower instance() {
    try{
  ...
  @Override
  protected Changed_reference_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_reference_lower.Matcher.on(engine);
  }
  
  @Override
  public Changed_reference_lower.Matcher instantiate() {
    return Changed_reference_lower.Matcher.create();
  }
  
  @Override
  public Changed_reference_lower.Match newEmptyMatch() {
    return Changed_reference_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_reference_lower.Match newMatch(final Object... parameters) {
    return Changed_reference_lower.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (java.lang.Integer) parameters[2], (java.lang.Integer) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_lower (visibility: PUBLIC, simpleName: Changed_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_lower (visibility: PUBLIC, simpleName: Changed_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_reference_lower INSTANCE = new Changed_reference_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_reference_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_structuralFeature_lower (initial_reference, current_reference, initial_lower, current_lower)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference, var_initial_lower, var_current_lower), Changed_structuralFeature_lower.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
