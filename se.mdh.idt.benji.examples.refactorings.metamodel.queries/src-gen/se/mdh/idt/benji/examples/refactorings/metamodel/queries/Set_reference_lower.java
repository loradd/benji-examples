...
public final class Set_reference_lower extends BaseGeneratedEMFQuerySpecification<Set_reference_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_reference_lower.Match.parameterNames;
    }
    ...
    @Override
    public Set_reference_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_reference_lower.Match)) {
          Set_reference_lower.Match other = (Set_reference_lower.Match) obj;
    ...
    @Override
    public Set_reference_lower specification() {
     ...
     * 
     */
    public static Set_reference_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_reference_lower.Match newMutableMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public static Set_reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
      return new Immutable(pReference, pLower);
    }
    
    private static final class Mutable extends Set_reference_lower.Match {
    ...
    private static final class Immutable extends Set_reference_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_lower pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_reference_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Set_reference_lower.Match> {
    /**
     ...
     * 
     */
    public static Set_reference_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_reference_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_reference_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Set_reference_lower.Match> getAllMatches(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public Set_reference_lower.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super Set_reference_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super Set_reference_lower.Match> processor) {
     ...
     * 
     */
    public Set_reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
      return Set_reference_lower.Match.newMatch(pReference, pLower);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Set_reference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOflower(final Set_reference_lower.Match partialMatch) {
    ...
    @Override
    protected Set_reference_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Set_reference_lower.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_LOWER));
    ...
    @Override
    protected Set_reference_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Set_reference_lower.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_reference_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_reference_lower.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_reference_lower.Matcher> querySpecification() {
      return Set_reference_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_reference_lower.Match> {
    /**
    ...
    @Override
    public void process(final Set_reference_lower.Match match) {
      process(match.getReference(), match.getLower());
    }
  }
  
  private Set_reference_lower() {
   ...
   * 
   */
  public static Set_reference_lower instance() {
    try{
  ...
  @Override
  protected Set_reference_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_reference_lower.Matcher.on(engine);
  }
  
  @Override
  public Set_reference_lower.Matcher instantiate() {
    return Set_reference_lower.Matcher.create();
  }
  
  @Override
  public Set_reference_lower.Match newEmptyMatch() {
    return Set_reference_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Set_reference_lower.Match newMatch(final Object... parameters) {
    return Set_reference_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_lower (visibility: PUBLIC, simpleName: Set_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_lower (visibility: PUBLIC, simpleName: Set_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_reference_lower INSTANCE = new Set_reference_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_reference_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_reference_lower (reference, _initial_reference, lower)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_reference, var__initial_reference, var_lower), Initial_reference_lower.instance().getInternalQueryRepresentation());
          // 	find current_reference_lower (reference, _current_reference, lower)
