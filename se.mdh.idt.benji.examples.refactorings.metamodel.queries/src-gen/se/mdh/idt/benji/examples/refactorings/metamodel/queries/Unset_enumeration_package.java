...
public final class Unset_enumeration_package extends BaseGeneratedEMFQuerySpecification<Unset_enumeration_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumeration_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumeration_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_enumeration_package.Match.parameterNames;
    }
    ...
    @Override
    public Unset_enumeration_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_enumeration_package.Match)) {
          Unset_enumeration_package.Match other = (Unset_enumeration_package.Match) obj;
    ...
    @Override
    public Unset_enumeration_package specification() {
     ...
     * 
     */
    public static Unset_enumeration_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_enumeration_package.Match newMutableMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public static Unset_enumeration_package.Match newMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
      return new Immutable(pEnumeration, pPackage);
    }
    
    private static final class Mutable extends Unset_enumeration_package.Match {
    ...
    private static final class Immutable extends Unset_enumeration_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumeration_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_enumeration_package
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_enumeration_package.Match> {
    /**
     ...
     * 
     */
    public static Unset_enumeration_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_enumeration_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_enumeration_package.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_enumeration_package.Match> getAllMatches(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public Unset_enumeration_package.Match getOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumeration, final TraceLink pPackage, final IMatchProcessor<? super Unset_enumeration_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pPackage, final IMatchProcessor<? super Unset_enumeration_package.Match> processor) {
     ...
     * 
     */
    public Unset_enumeration_package.Match newMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
      return Unset_enumeration_package.Match.newMatch(pEnumeration, pPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final Unset_enumeration_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Unset_enumeration_package.Match partialMatch) {
    ...
    @Override
    protected Unset_enumeration_package.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_enumeration_package.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATION), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    @Override
    protected Unset_enumeration_package.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_enumeration_package.Match.newMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_enumeration_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_enumeration_package.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_enumeration_package.Matcher> querySpecification() {
      return Unset_enumeration_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumeration_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_enumeration_package.Match> {
    /**
    ...
    @Override
    public void process(final Unset_enumeration_package.Match match) {
      process(match.getEnumeration(), match.getPackage());
    }
  }
  
  private Unset_enumeration_package() {
   ...
   * 
   */
  public static Unset_enumeration_package instance() {
    try{
  ...
  @Override
  protected Unset_enumeration_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_enumeration_package.Matcher.on(engine);
  }
  
  @Override
  public Unset_enumeration_package.Matcher instantiate() {
    return Unset_enumeration_package.Matcher.create();
  }
  
  @Override
  public Unset_enumeration_package.Match newEmptyMatch() {
    return Unset_enumeration_package.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_enumeration_package.Match newMatch(final Object... parameters) {
    return Unset_enumeration_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumeration_package (visibility: PUBLIC, simpleName: Unset_enumeration_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumeration_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumeration_package (visibility: PUBLIC, simpleName: Unset_enumeration_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumeration_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_enumeration_package INSTANCE = new Unset_enumeration_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_enumeration_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_enumeration_package (enumeration, _current_enumeration, ^package, _current_package)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_enumeration, var__current_enumeration, var_package, var__current_package), Current_enumeration_package.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
