...
public final class Insert_package_enumeration extends BaseGeneratedEMFQuerySpecification<Insert_package_enumeration.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_enumeration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_enumeration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Insert_package_enumeration.Match.parameterNames;
    }
    ...
    @Override
    public Insert_package_enumeration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Insert_package_enumeration.Match)) {
          Insert_package_enumeration.Match other = (Insert_package_enumeration.Match) obj;
    ...
    @Override
    public Insert_package_enumeration specification() {
     ...
     * 
     */
    public static Insert_package_enumeration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Insert_package_enumeration.Match newMutableMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static Insert_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
      return new Immutable(pPackage, pEnumeration);
    }
    
    private static final class Mutable extends Insert_package_enumeration.Match {
    ...
    private static final class Immutable extends Insert_package_enumeration.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_enumeration pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Insert_package_enumeration
   * 
   */
  public static class Matcher extends BaseMatcher<Insert_package_enumeration.Match> {
    /**
     ...
     * 
     */
    public static Insert_package_enumeration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Insert_package_enumeration.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Insert_package_enumeration.Matcher.class);
     ...
     * 
     */
    public Collection<Insert_package_enumeration.Match> getAllMatches(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public Insert_package_enumeration.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super Insert_package_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super Insert_package_enumeration.Match> processor) {
     ...
     * 
     */
    public Insert_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
      return Insert_package_enumeration.Match.newMatch(pPackage, pEnumeration);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Insert_package_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final Insert_package_enumeration.Match partialMatch) {
    ...
    @Override
    protected Insert_package_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return Insert_package_enumeration.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    @Override
    protected Insert_package_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return Insert_package_enumeration.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Insert_package_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Insert_package_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Insert_package_enumeration.Matcher> querySpecification() {
      return Insert_package_enumeration.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_enumeration pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Insert_package_enumeration.Match> {
    /**
    ...
    @Override
    public void process(final Insert_package_enumeration.Match match) {
      process(match.getPackage(), match.getEnumeration());
    }
  }
  
  private Insert_package_enumeration() {
   ...
   * 
   */
  public static Insert_package_enumeration instance() {
    try{
  ...
  @Override
  protected Insert_package_enumeration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Insert_package_enumeration.Matcher.on(engine);
  }
  
  @Override
  public Insert_package_enumeration.Matcher instantiate() {
    return Insert_package_enumeration.Matcher.create();
  }
  
  @Override
  public Insert_package_enumeration.Match newEmptyMatch() {
    return Insert_package_enumeration.Match.newEmptyMatch();
  }
  
  @Override
  public Insert_package_enumeration.Match newMatch(final Object... parameters) {
    return Insert_package_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_enumeration (visibility: PUBLIC, simpleName: Insert_package_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_enumeration (visibility: PUBLIC, simpleName: Insert_package_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Insert_package_enumeration INSTANCE = new Insert_package_enumeration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Insert_package_enumeration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
