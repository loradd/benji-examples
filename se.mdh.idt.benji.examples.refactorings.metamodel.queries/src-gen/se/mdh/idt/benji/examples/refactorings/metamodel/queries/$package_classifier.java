...
public final class $package_classifier extends BaseGeneratedEMFQuerySpecification<$package_classifier.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_classifier.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public static $package_classifier.Match newMatch(final TraceLink pPackage, final TraceLink pClassifier) {
  ...
  public static class Matcher extends BaseMatcher<$package_classifier.Match> {
     ...
     * 
     */
    public Collection<$package_classifier.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public $package_classifier.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClassifier, final IMatchProcessor<? super $package_classifier.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClassifier, final IMatchProcessor<? super $package_classifier.Match> processor) {
     ...
     * 
     */
    public $package_classifier.Match newMatch(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_classifier.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclassifier(final $package_classifier.Match partialMatch) {
    ...
    protected $package_classifier.Match tupleToMatch(final Tuple t) {
      try {
          return $package_classifier.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASSIFIER));
    ...
    protected $package_classifier.Match arrayToMatch(final Object[] match) {
      try {
          return $package_classifier.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
    ...
    protected $package_classifier.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_classifier.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_classifier.Match newMatch(final Object... parameters) {
    return $package_classifier.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
