...
public final class $package_subPackage extends BaseGeneratedEMFQuerySpecification<$package_subPackage.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_subPackage.Match newMutableMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public static $package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
  ...
  public static class Matcher extends BaseMatcher<$package_subPackage.Match> {
     ...
     * 
     */
    public Collection<$package_subPackage.Match> getAllMatches(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public $package_subPackage.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super $package_subPackage.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super $package_subPackage.Match> processor) {
     ...
     * 
     */
    public $package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubPackage(final $package_subPackage.Match partialMatch) {
    ...
    protected $package_subPackage.Match tupleToMatch(final Tuple t) {
      try {
          return $package_subPackage.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_SUBPACKAGE));
    ...
    protected $package_subPackage.Match arrayToMatch(final Object[] match) {
      try {
          return $package_subPackage.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $package_subPackage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_subPackage.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_subPackage.Match newMatch(final Object... parameters) {
    return $package_subPackage.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
