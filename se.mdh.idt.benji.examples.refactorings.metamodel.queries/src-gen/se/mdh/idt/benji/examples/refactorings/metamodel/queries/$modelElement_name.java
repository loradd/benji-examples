...
public final class $modelElement_name extends BaseGeneratedEMFQuerySpecification<$modelElement_name.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $modelElement_name.Match newMutableMatch(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public static $modelElement_name.Match newMatch(final TraceLink pModelElement, final String pName) {
  ...
  public static class Matcher extends BaseMatcher<$modelElement_name.Match> {
     ...
     * 
     */
    public Collection<$modelElement_name.Match> getAllMatches(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public $modelElement_name.Match getOneArbitraryMatch(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pModelElement, final String pName, final IMatchProcessor<? super $modelElement_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pModelElement, final String pName, final IMatchProcessor<? super $modelElement_name.Match> processor) {
     ...
     * 
     */
    public $modelElement_name.Match newMatch(final TraceLink pModelElement, final String pName) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmodelElement(final $modelElement_name.Match partialMatch) {
    ...
    protected $modelElement_name.Match tupleToMatch(final Tuple t) {
      try {
          return $modelElement_name.Match.newMatch((TraceLink) t.get(POSITION_MODELELEMENT), (String) t.get(POSITION_NAME));
    ...
    protected $modelElement_name.Match arrayToMatch(final Object[] match) {
      try {
          return $modelElement_name.Match.newMatch((TraceLink) match[POSITION_MODELELEMENT], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected $modelElement_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $modelElement_name.Match.newMutableMatch((TraceLink) match[POSITION_MODELELEMENT], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $modelElement_name.Match newMatch(final Object... parameters) {
    return $modelElement_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
