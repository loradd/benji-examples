...
public final class $created_package extends BaseGeneratedEMFQuerySpecification<$created_package.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_package.Match newMutableMatch(final TraceLink pPackage) {
     ...
     * 
     */
    public static $created_package.Match newMatch(final TraceLink pPackage) {
  ...
  public static class Matcher extends BaseMatcher<$created_package.Match> {
     ...
     * 
     */
    public Collection<$created_package.Match> getAllMatches(final TraceLink pPackage) {
     ...
     * 
     */
    public $created_package.Match getOneArbitraryMatch(final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final IMatchProcessor<? super $created_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final IMatchProcessor<? super $created_package.Match> processor) {
     ...
     * 
     */
    public $created_package.Match newMatch(final TraceLink pPackage) {
    ...
    protected $created_package.Match tupleToMatch(final Tuple t) {
      try {
          return $created_package.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE));
    ...
    protected $created_package.Match arrayToMatch(final Object[] match) {
      try {
          return $created_package.Match.newMatch((TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $created_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_package.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_package.Match newMatch(final Object... parameters) {
    return $created_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
