...
public final class $created_reference extends BaseGeneratedEMFQuerySpecification<$created_reference.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_reference.Match newMutableMatch(final TraceLink pReference) {
     ...
     * 
     */
    public static $created_reference.Match newMatch(final TraceLink pReference) {
  ...
  public static class Matcher extends BaseMatcher<$created_reference.Match> {
     ...
     * 
     */
    public Collection<$created_reference.Match> getAllMatches(final TraceLink pReference) {
     ...
     * 
     */
    public $created_reference.Match getOneArbitraryMatch(final TraceLink pReference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final IMatchProcessor<? super $created_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final IMatchProcessor<? super $created_reference.Match> processor) {
     ...
     * 
     */
    public $created_reference.Match newMatch(final TraceLink pReference) {
    ...
    protected $created_reference.Match tupleToMatch(final Tuple t) {
      try {
          return $created_reference.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE));
    ...
    protected $created_reference.Match arrayToMatch(final Object[] match) {
      try {
          return $created_reference.Match.newMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected $created_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_reference.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_reference.Match newMatch(final Object... parameters) {
    return $created_reference.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
