...
public final class $datatype_package extends BaseGeneratedEMFQuerySpecification<$datatype_package.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $datatype_package.Match newMutableMatch(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public static $datatype_package.Match newMatch(final TraceLink pDatatype, final TraceLink pPackage) {
  ...
  public static class Matcher extends BaseMatcher<$datatype_package.Match> {
     ...
     * 
     */
    public Collection<$datatype_package.Match> getAllMatches(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public $datatype_package.Match getOneArbitraryMatch(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pDatatype, final TraceLink pPackage, final IMatchProcessor<? super $datatype_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pDatatype, final TraceLink pPackage, final IMatchProcessor<? super $datatype_package.Match> processor) {
     ...
     * 
     */
    public $datatype_package.Match newMatch(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final $datatype_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $datatype_package.Match partialMatch) {
    ...
    protected $datatype_package.Match tupleToMatch(final Tuple t) {
      try {
          return $datatype_package.Match.newMatch((TraceLink) t.get(POSITION_DATATYPE), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    protected $datatype_package.Match arrayToMatch(final Object[] match) {
      try {
          return $datatype_package.Match.newMatch((TraceLink) match[POSITION_DATATYPE], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $datatype_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $datatype_package.Match.newMutableMatch((TraceLink) match[POSITION_DATATYPE], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $datatype_package.Match newMatch(final Object... parameters) {
    return $datatype_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
