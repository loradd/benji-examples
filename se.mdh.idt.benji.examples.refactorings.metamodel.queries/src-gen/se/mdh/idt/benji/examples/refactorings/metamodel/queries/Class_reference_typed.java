...
public final class Class_reference_typed extends BaseGeneratedEMFQuerySpecification<Class_reference_typed.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.class_reference_typed pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.class_reference_typed";
    }
    
    @Override
    public List<String> parameterNames() {
      return Class_reference_typed.Match.parameterNames;
    }
    ...
    @Override
    public Class_reference_typed.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Class_reference_typed.Match)) {
          Class_reference_typed.Match other = (Class_reference_typed.Match) obj;
    ...
    @Override
    public Class_reference_typed specification() {
     ...
     * 
     */
    public static Class_reference_typed.Match newEmptyMatch() {
     ...
     * 
     */
    public static Class_reference_typed.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType) {
     ...
     * 
     */
    public static Class_reference_typed.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType) {
      return new Immutable(pClass, pReference, pType);
    }
    
    private static final class Mutable extends Class_reference_typed.Match {
    ...
    private static final class Immutable extends Class_reference_typed.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.class_reference_typed pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Class_reference_typed
   * 
   */
  public static class Matcher extends BaseMatcher<Class_reference_typed.Match> {
    /**
     ...
     * 
     */
    public static Class_reference_typed.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Class_reference_typed.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Class_reference_typed.Matcher.class);
     ...
     * 
     */
    public Collection<Class_reference_typed.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType) {
     ...
     * 
     */
    public Class_reference_typed.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType, final IMatchProcessor<? super Class_reference_typed.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType, final IMatchProcessor<? super Class_reference_typed.Match> processor) {
     ...
     * 
     */
    public Class_reference_typed.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pClass, final Reference pReference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pType) {
      return Class_reference_typed.Match.newMatch(pClass, pReference, pType);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfclass(final Class_reference_typed.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfreference(final Class_reference_typed.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOftype(final Class_reference_typed.Match partialMatch) {
    ...
    @Override
    protected Class_reference_typed.Match tupleToMatch(final Tuple t) {
      try {
          return Class_reference_typed.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CLASS), (Reference) t.get(POSITION_REFERENCE), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_TYPE));
    ...
    @Override
    protected Class_reference_typed.Match arrayToMatch(final Object[] match) {
      try {
          return Class_reference_typed.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CLASS], (Reference) match[POSITION_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Class_reference_typed.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Class_reference_typed.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CLASS], (Reference) match[POSITION_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Class_reference_typed.Matcher> querySpecification() {
      return Class_reference_typed.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.class_reference_typed pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Class_reference_typed.Match> {
    /**
    ...
    @Override
    public void process(final Class_reference_typed.Match match) {
      process(match.getValueOfClass(), match.getReference(), match.getType());
    }
  }
  
  private Class_reference_typed() {
   ...
   * 
   */
  public static Class_reference_typed instance() {
    try{
  ...
  @Override
  protected Class_reference_typed.Matcher instantiate(final ViatraQueryEngine engine) {
    return Class_reference_typed.Matcher.on(engine);
  }
  
  @Override
  public Class_reference_typed.Matcher instantiate() {
    return Class_reference_typed.Matcher.create();
  }
  
  @Override
  public Class_reference_typed.Match newEmptyMatch() {
    return Class_reference_typed.Match.newEmptyMatch();
  }
  
  @Override
  public Class_reference_typed.Match newMatch(final Object... parameters) {
    return Class_reference_typed.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Class_reference_typed (visibility: PUBLIC, simpleName: Class_reference_typed, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Class_reference_typed, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Class_reference_typed (visibility: PUBLIC, simpleName: Class_reference_typed, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Class_reference_typed, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Class_reference_typed INSTANCE = new Class_reference_typed();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Class_reference_typed.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find reference_type (reference, type)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_reference, var_type), Reference_type.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
