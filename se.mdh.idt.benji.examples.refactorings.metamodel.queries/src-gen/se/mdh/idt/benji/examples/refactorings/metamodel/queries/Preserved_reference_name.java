...
public final class Preserved_reference_name extends BaseGeneratedEMFQuerySpecification<Preserved_reference_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_reference_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_reference_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_reference_name.Match)) {
          Preserved_reference_name.Match other = (Preserved_reference_name.Match) obj;
    ...
    @Override
    public Preserved_reference_name specification() {
     ...
     * 
     */
    public static Preserved_reference_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_reference_name.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_reference_name.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_reference_name.Match {
    ...
    private static final class Immutable extends Preserved_reference_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_reference_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_reference_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_reference_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_reference_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_reference_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_reference_name.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_reference_name.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_reference_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_reference_name.Match> processor) {
     ...
     * 
     */
    public Preserved_reference_name.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final String pInitial_name, final String pCurrent_name) {
      return Preserved_reference_name.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Preserved_reference_name.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Preserved_reference_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_reference_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_reference_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_reference_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_reference_name.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_reference_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_reference_name.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_reference_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_reference_name.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_reference_name.Matcher> querySpecification() {
      return Preserved_reference_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_reference_name.Match> {
    /**
   ...
   * 
   */
  public static Preserved_reference_name instance() {
    try{
  ...
  @Override
  protected Preserved_reference_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_reference_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_reference_name.Matcher instantiate() {
    return Preserved_reference_name.Matcher.create();
  }
  
  @Override
  public Preserved_reference_name.Match newEmptyMatch() {
    return Preserved_reference_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_reference_name.Match newMatch(final Object... parameters) {
    return Preserved_reference_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_name (visibility: PUBLIC, simpleName: Preserved_reference_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_name (visibility: PUBLIC, simpleName: Preserved_reference_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_reference_name INSTANCE = new Preserved_reference_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_reference_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_structuralFeature_name (initial_reference, current_reference, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference, var_initial_name, var_current_name), Preserved_structuralFeature_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
