...
public final class Reference_containment extends BaseGeneratedEMFQuerySpecification<Reference_containment.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public static Reference_containment.Match newMutableMatch(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public static Reference_containment.Match newMatch(final Reference pReference, final Boolean pContainment) {
      return new Immutable(pReference, pContainment);
    }
    
    private static final class Mutable extends Reference_containment.Match {
      Mutable(final Reference pReference, final Boolean pContainment) {
    ...
    private static final class Immutable extends Reference_containment.Match {
      Immutable(final Reference pReference, final Boolean pContainment) {
        super(pReference, pContainment);
      }
  ...
  public static class Matcher extends BaseMatcher<Reference_containment.Match> {
     ...
     * 
     */
    public Collection<Reference_containment.Match> getAllMatches(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public Reference_containment.Match getOneArbitraryMatch(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public boolean hasMatch(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public int countMatches(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public void forEachMatch(final Reference pReference, final Boolean pContainment, final IMatchProcessor<? super Reference_containment.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pReference, final Boolean pContainment, final IMatchProcessor<? super Reference_containment.Match> processor) {
     ...
     * 
     */
    public Reference_containment.Match newMatch(final Reference pReference, final Boolean pContainment) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfreference(final Reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfreference(final Boolean pContainment) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfcontainment(final Reference pReference) {
    ...
    protected Reference_containment.Match tupleToMatch(final Tuple t) {
      try {
          return Reference_containment.Match.newMatch((Reference) t.get(POSITION_REFERENCE), (Boolean) t.get(POSITION_CONTAINMENT));
    ...
    protected Reference_containment.Match arrayToMatch(final Object[] match) {
      try {
          return Reference_containment.Match.newMatch((Reference) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
    ...
    protected Reference_containment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Reference_containment.Match.newMutableMatch((Reference) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public static abstract class Processor implements IMatchProcessor<Reference_containment.Match> {
     ...
     * 
     */
    public abstract void process(final Reference pReference, final Boolean pContainment);
  ...
  public Reference_containment.Match newMatch(final Object... parameters) {
    return Reference_containment.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_reference, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdh.se/examples/refactorings/Metamodel", "Reference", "containment")));
