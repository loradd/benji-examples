...
public final class Preserved_modelElement_name extends BaseGeneratedEMFQuerySpecification<Preserved_modelElement_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_modelElement_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_modelElement_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_modelElement_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_modelElement_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_modelElement_name.Match)) {
          Preserved_modelElement_name.Match other = (Preserved_modelElement_name.Match) obj;
    ...
    @Override
    public Preserved_modelElement_name specification() {
     ...
     * 
     */
    public static Preserved_modelElement_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_modelElement_name.Match newMutableMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_modelElement_name.Match newMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_modelElement, pCurrent_modelElement, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_modelElement_name.Match {
    ...
    private static final class Immutable extends Preserved_modelElement_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_modelElement_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_modelElement_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_modelElement_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_modelElement_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_modelElement_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_modelElement_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_modelElement_name.Match> getAllMatches(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_modelElement_name.Match getOneArbitraryMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_modelElement_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_modelElement_name.Match> processor) {
     ...
     * 
     */
    public Preserved_modelElement_name.Match newMatch(final ModelElement pInitial_modelElement, final ModelElement pCurrent_modelElement, final String pInitial_name, final String pCurrent_name) {
      return Preserved_modelElement_name.Match.newMatch(pInitial_modelElement, pCurrent_modelElement, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<ModelElement> getAllValuesOfinitial_modelElement(final Preserved_modelElement_name.Match partialMatch) {
     ...
     * 
     */
    public Set<ModelElement> getAllValuesOfcurrent_modelElement(final Preserved_modelElement_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_modelElement_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_modelElement_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_modelElement_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_modelElement_name.Match.newMatch((ModelElement) t.get(POSITION_INITIAL_MODELELEMENT), (ModelElement) t.get(POSITION_CURRENT_MODELELEMENT), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_modelElement_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_modelElement_name.Match.newMatch((ModelElement) match[POSITION_INITIAL_MODELELEMENT], (ModelElement) match[POSITION_CURRENT_MODELELEMENT], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_modelElement_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_modelElement_name.Match.newMutableMatch((ModelElement) match[POSITION_INITIAL_MODELELEMENT], (ModelElement) match[POSITION_CURRENT_MODELELEMENT], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_modelElement_name.Matcher> querySpecification() {
      return Preserved_modelElement_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_modelElement_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_modelElement_name.Match> {
    /**
   ...
   * 
   */
  public static Preserved_modelElement_name instance() {
    try{
  ...
  @Override
  protected Preserved_modelElement_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_modelElement_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_modelElement_name.Matcher instantiate() {
    return Preserved_modelElement_name.Matcher.create();
  }
  
  @Override
  public Preserved_modelElement_name.Match newEmptyMatch() {
    return Preserved_modelElement_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_modelElement_name.Match newMatch(final Object... parameters) {
    return Preserved_modelElement_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.ModelElement) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.ModelElement) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_modelElement_name (visibility: PUBLIC, simpleName: Preserved_modelElement_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_modelElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_modelElement_name (visibility: PUBLIC, simpleName: Preserved_modelElement_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_modelElement_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_modelElement_name INSTANCE = new Preserved_modelElement_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_modelElement_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern preserved_modelElement_name";
              }
