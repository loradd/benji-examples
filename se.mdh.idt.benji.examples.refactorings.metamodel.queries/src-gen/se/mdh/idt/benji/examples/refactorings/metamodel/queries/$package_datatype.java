...
public final class $package_datatype extends BaseGeneratedEMFQuerySpecification<$package_datatype.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_datatype.Match newMutableMatch(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public static $package_datatype.Match newMatch(final TraceLink pPackage, final TraceLink pDatatype) {
  ...
  public static class Matcher extends BaseMatcher<$package_datatype.Match> {
     ...
     * 
     */
    public Collection<$package_datatype.Match> getAllMatches(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public $package_datatype.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pDatatype, final IMatchProcessor<? super $package_datatype.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pDatatype, final IMatchProcessor<? super $package_datatype.Match> processor) {
     ...
     * 
     */
    public $package_datatype.Match newMatch(final TraceLink pPackage, final TraceLink pDatatype) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_datatype.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final $package_datatype.Match partialMatch) {
    ...
    protected $package_datatype.Match tupleToMatch(final Tuple t) {
      try {
          return $package_datatype.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_DATATYPE));
    ...
    protected $package_datatype.Match arrayToMatch(final Object[] match) {
      try {
          return $package_datatype.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
    ...
    protected $package_datatype.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_datatype.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_datatype.Match newMatch(final Object... parameters) {
    return $package_datatype.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
