...
public final class $deleted_attribute extends BaseGeneratedEMFQuerySpecification<$deleted_attribute.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_attribute.Match newMutableMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public static $deleted_attribute.Match newMatch(final TraceLink pAttribute) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_attribute.Match> {
     ...
     * 
     */
    public Collection<$deleted_attribute.Match> getAllMatches(final TraceLink pAttribute) {
     ...
     * 
     */
    public $deleted_attribute.Match getOneArbitraryMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final IMatchProcessor<? super $deleted_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final IMatchProcessor<? super $deleted_attribute.Match> processor) {
     ...
     * 
     */
    public $deleted_attribute.Match newMatch(final TraceLink pAttribute) {
    ...
    protected $deleted_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_attribute.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    protected $deleted_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_attribute.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_attribute.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_attribute.Match newMatch(final Object... parameters) {
    return $deleted_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
