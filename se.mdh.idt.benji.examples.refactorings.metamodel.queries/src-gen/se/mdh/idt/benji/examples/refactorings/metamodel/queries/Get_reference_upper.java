...
public final class Get_reference_upper extends BaseGeneratedEMFQuerySpecification<Get_reference_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_reference_upper.Match.parameterNames;
    }
    ...
    @Override
    public Get_reference_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_reference_upper.Match)) {
          Get_reference_upper.Match other = (Get_reference_upper.Match) obj;
    ...
    @Override
    public Get_reference_upper specification() {
     ...
     * 
     */
    public static Get_reference_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_reference_upper.Match newMutableMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public static Get_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return new Immutable(pReference, pUpper);
    }
    
    private static final class Mutable extends Get_reference_upper.Match {
    ...
    private static final class Immutable extends Get_reference_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_reference_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Get_reference_upper.Match> {
    /**
     ...
     * 
     */
    public static Get_reference_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_reference_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_reference_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Get_reference_upper.Match> getAllMatches(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public Get_reference_upper.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Get_reference_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Get_reference_upper.Match> processor) {
     ...
     * 
     */
    public Get_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return Get_reference_upper.Match.newMatch(pReference, pUpper);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Get_reference_upper.Match partialMatch) {
    ...
    @Override
    protected Get_reference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Get_reference_upper.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_UPPER));
    ...
    @Override
    protected Get_reference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Get_reference_upper.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_reference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_reference_upper.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_reference_upper.Matcher> querySpecification() {
      return Get_reference_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_reference_upper.Match> {
    /**
    ...
    @Override
    public void process(final Get_reference_upper.Match match) {
      process(match.getReference(), match.getUpper());
    }
  }
  
  private Get_reference_upper() {
   ...
   * 
   */
  public static Get_reference_upper instance() {
    try{
  ...
  @Override
  protected Get_reference_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_reference_upper.Matcher.on(engine);
  }
  
  @Override
  public Get_reference_upper.Matcher instantiate() {
    return Get_reference_upper.Matcher.create();
  }
  
  @Override
  public Get_reference_upper.Match newEmptyMatch() {
    return Get_reference_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Get_reference_upper.Match newMatch(final Object... parameters) {
    return Get_reference_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_upper (visibility: PUBLIC, simpleName: Get_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_upper (visibility: PUBLIC, simpleName: Get_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_reference_upper INSTANCE = new Get_reference_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_reference_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
