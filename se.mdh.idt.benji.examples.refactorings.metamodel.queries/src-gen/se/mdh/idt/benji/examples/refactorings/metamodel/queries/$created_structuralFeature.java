...
public final class $created_structuralFeature extends BaseGeneratedEMFQuerySpecification<$created_structuralFeature.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_structuralFeature.Match newMutableMatch(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public static $created_structuralFeature.Match newMatch(final TraceLink pStructuralFeature) {
  ...
  public static class Matcher extends BaseMatcher<$created_structuralFeature.Match> {
     ...
     * 
     */
    public Collection<$created_structuralFeature.Match> getAllMatches(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public $created_structuralFeature.Match getOneArbitraryMatch(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final IMatchProcessor<? super $created_structuralFeature.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final IMatchProcessor<? super $created_structuralFeature.Match> processor) {
     ...
     * 
     */
    public $created_structuralFeature.Match newMatch(final TraceLink pStructuralFeature) {
      return $created_structuralFeature.Match.newMatch(pStructuralFeature);
    }
    ...
    protected $created_structuralFeature.Match tupleToMatch(final Tuple t) {
      try {
          return $created_structuralFeature.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE));
    ...
    protected $created_structuralFeature.Match arrayToMatch(final Object[] match) {
      try {
          return $created_structuralFeature.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
    ...
    protected $created_structuralFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_structuralFeature.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_structuralFeature.Match newMatch(final Object... parameters) {
    return $created_structuralFeature.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
