...
public final class $set_class_superClass extends BaseGeneratedEMFQuerySpecification<$set_class_superClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return $set_class_superClass.Match.parameterNames;
    }
    ...
    @Override
    public $set_class_superClass.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $set_class_superClass.Match)) {
          $set_class_superClass.Match other = ($set_class_superClass.Match) obj;
    ...
    @Override
    public $set_class_superClass specification() {
     ...
     * 
     */
    public static $set_class_superClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static $set_class_superClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public static $set_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return new Immutable(pClass, pSuperClass);
    }
    
    private static final class Mutable extends $set_class_superClass.Match {
    ...
    private static final class Immutable extends $set_class_superClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $set_class_superClass
   * 
   */
  public static class Matcher extends BaseMatcher<$set_class_superClass.Match> {
    /**
     ...
     * 
     */
    public static $set_class_superClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $set_class_superClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($set_class_superClass.Matcher.class);
     ...
     * 
     */
    public Collection<$set_class_superClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public $set_class_superClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super $set_class_superClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super $set_class_superClass.Match> processor) {
     ...
     * 
     */
    public $set_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return $set_class_superClass.Match.newMatch(pClass, pSuperClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $set_class_superClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsuperClass(final $set_class_superClass.Match partialMatch) {
    ...
    @Override
    protected $set_class_superClass.Match tupleToMatch(final Tuple t) {
      try {
          return $set_class_superClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUPERCLASS));
    ...
    @Override
    protected $set_class_superClass.Match arrayToMatch(final Object[] match) {
      try {
          return $set_class_superClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $set_class_superClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $set_class_superClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$set_class_superClass.Matcher> querySpecification() {
      return $set_class_superClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$set_class_superClass.Match> {
    /**
    ...
    @Override
    public void process(final $set_class_superClass.Match match) {
      process(match.getValueOfClass(), match.getSuperClass());
    }
  }
  
  private $set_class_superClass() {
   ...
   * 
   */
  public static $set_class_superClass instance() {
    try{
  ...
  @Override
  protected $set_class_superClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return $set_class_superClass.Matcher.on(engine);
  }
  
  @Override
  public $set_class_superClass.Matcher instantiate() {
    return $set_class_superClass.Matcher.create();
  }
  
  @Override
  public $set_class_superClass.Match newEmptyMatch() {
    return $set_class_superClass.Match.newEmptyMatch();
  }
  
  @Override
  public $set_class_superClass.Match newMatch(final Object... parameters) {
    return $set_class_superClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass (visibility: PUBLIC, simpleName: $set_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass (visibility: PUBLIC, simpleName: $set_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $set_class_superClass INSTANCE = new $set_class_superClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $set_class_superClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find $initial_class_superClass (class, _initial_class, superClass, _initial_superClass)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__initial_class, var_superClass, var__initial_superClass), $initial_class_superClass.instance().getInternalQueryRepresentation());
          // 	find $current_class_superClass (class, _current_class, superClass, _current_superClass)
