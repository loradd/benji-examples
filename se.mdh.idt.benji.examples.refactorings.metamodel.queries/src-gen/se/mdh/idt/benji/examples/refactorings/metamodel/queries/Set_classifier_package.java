...
public final class Set_classifier_package extends BaseGeneratedEMFQuerySpecification<Set_classifier_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_classifier_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_classifier_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_classifier_package.Match.parameterNames;
    }
    ...
    @Override
    public Set_classifier_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_classifier_package.Match)) {
          Set_classifier_package.Match other = (Set_classifier_package.Match) obj;
    ...
    @Override
    public Set_classifier_package specification() {
     ...
     * 
     */
    public static Set_classifier_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_classifier_package.Match newMutableMatch(final TraceLink pClassifier, final TraceLink pPackage) {
     ...
     * 
     */
    public static Set_classifier_package.Match newMatch(final TraceLink pClassifier, final TraceLink pPackage) {
      return new Immutable(pClassifier, pPackage);
    }
    
    private static final class Mutable extends Set_classifier_package.Match {
    ...
    private static final class Immutable extends Set_classifier_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_classifier_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_classifier_package
   * 
   */
  public static class Matcher extends BaseMatcher<Set_classifier_package.Match> {
    /**
     ...
     * 
     */
    public static Set_classifier_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_classifier_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_classifier_package.Matcher.class);
     ...
     * 
     */
    public Collection<Set_classifier_package.Match> getAllMatches(final TraceLink pClassifier, final TraceLink pPackage) {
     ...
     * 
     */
    public Set_classifier_package.Match getOneArbitraryMatch(final TraceLink pClassifier, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClassifier, final TraceLink pPackage, final IMatchProcessor<? super Set_classifier_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClassifier, final TraceLink pPackage, final IMatchProcessor<? super Set_classifier_package.Match> processor) {
     ...
     * 
     */
    public Set_classifier_package.Match newMatch(final TraceLink pClassifier, final TraceLink pPackage) {
      return Set_classifier_package.Match.newMatch(pClassifier, pPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclassifier(final Set_classifier_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Set_classifier_package.Match partialMatch) {
    ...
    @Override
    protected Set_classifier_package.Match tupleToMatch(final Tuple t) {
      try {
          return Set_classifier_package.Match.newMatch((TraceLink) t.get(POSITION_CLASSIFIER), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    @Override
    protected Set_classifier_package.Match arrayToMatch(final Object[] match) {
      try {
          return Set_classifier_package.Match.newMatch((TraceLink) match[POSITION_CLASSIFIER], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_classifier_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_classifier_package.Match.newMutableMatch((TraceLink) match[POSITION_CLASSIFIER], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_classifier_package.Matcher> querySpecification() {
      return Set_classifier_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_classifier_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_classifier_package.Match> {
    /**
    ...
    @Override
    public void process(final Set_classifier_package.Match match) {
      process(match.getClassifier(), match.getPackage());
    }
  }
  
  private Set_classifier_package() {
   ...
   * 
   */
  public static Set_classifier_package instance() {
    try{
  ...
  @Override
  protected Set_classifier_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_classifier_package.Matcher.on(engine);
  }
  
  @Override
  public Set_classifier_package.Matcher instantiate() {
    return Set_classifier_package.Matcher.create();
  }
  
  @Override
  public Set_classifier_package.Match newEmptyMatch() {
    return Set_classifier_package.Match.newEmptyMatch();
  }
  
  @Override
  public Set_classifier_package.Match newMatch(final Object... parameters) {
    return Set_classifier_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_classifier_package (visibility: PUBLIC, simpleName: Set_classifier_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_classifier_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_classifier_package (visibility: PUBLIC, simpleName: Set_classifier_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_classifier_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_classifier_package INSTANCE = new Set_classifier_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_classifier_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_classifier_package (classifier, _initial_classifier, ^package, _initial_package)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_classifier, var__initial_classifier, var_package, var__initial_package), Initial_classifier_package.instance().getInternalQueryRepresentation());
          // 	find current_classifier_package (classifier, _current_classifier, ^package, _current_package)
