...
public final class Get_reference_lower extends BaseGeneratedEMFQuerySpecification<Get_reference_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_reference_lower.Match.parameterNames;
    }
    ...
    @Override
    public Get_reference_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_reference_lower.Match)) {
          Get_reference_lower.Match other = (Get_reference_lower.Match) obj;
    ...
    @Override
    public Get_reference_lower specification() {
     ...
     * 
     */
    public static Get_reference_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_reference_lower.Match newMutableMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public static Get_reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
      return new Immutable(pReference, pLower);
    }
    
    private static final class Mutable extends Get_reference_lower.Match {
    ...
    private static final class Immutable extends Get_reference_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_lower pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_reference_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Get_reference_lower.Match> {
    /**
     ...
     * 
     */
    public static Get_reference_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_reference_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_reference_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Get_reference_lower.Match> getAllMatches(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public Get_reference_lower.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super Get_reference_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super Get_reference_lower.Match> processor) {
     ...
     * 
     */
    public Get_reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
      return Get_reference_lower.Match.newMatch(pReference, pLower);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_reference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOflower(final Get_reference_lower.Match partialMatch) {
    ...
    @Override
    protected Get_reference_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Get_reference_lower.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_LOWER));
    ...
    @Override
    protected Get_reference_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Get_reference_lower.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_reference_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_reference_lower.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_reference_lower.Matcher> querySpecification() {
      return Get_reference_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_reference_lower.Match> {
    /**
    ...
    @Override
    public void process(final Get_reference_lower.Match match) {
      process(match.getReference(), match.getLower());
    }
  }
  
  private Get_reference_lower() {
   ...
   * 
   */
  public static Get_reference_lower instance() {
    try{
  ...
  @Override
  protected Get_reference_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_reference_lower.Matcher.on(engine);
  }
  
  @Override
  public Get_reference_lower.Matcher instantiate() {
    return Get_reference_lower.Matcher.create();
  }
  
  @Override
  public Get_reference_lower.Match newEmptyMatch() {
    return Get_reference_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Get_reference_lower.Match newMatch(final Object... parameters) {
    return Get_reference_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_lower (visibility: PUBLIC, simpleName: Get_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_lower (visibility: PUBLIC, simpleName: Get_reference_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_reference_lower INSTANCE = new Get_reference_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_reference_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find current_reference_lower (reference, _current_reference, lower)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_reference, var__current_reference, var_lower), Current_reference_lower.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
