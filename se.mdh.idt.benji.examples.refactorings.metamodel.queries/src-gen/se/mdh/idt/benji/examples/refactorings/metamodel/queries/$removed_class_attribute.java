...
public final class $removed_class_attribute extends BaseGeneratedEMFQuerySpecification<$removed_class_attribute.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $removed_class_attribute.Match newMutableMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public static $removed_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
  ...
  public static class Matcher extends BaseMatcher<$removed_class_attribute.Match> {
     ...
     * 
     */
    public Collection<$removed_class_attribute.Match> getAllMatches(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public $removed_class_attribute.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super $removed_class_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pAttribute, final IMatchProcessor<? super $removed_class_attribute.Match> processor) {
     ...
     * 
     */
    public $removed_class_attribute.Match newMatch(final TraceLink pClass, final TraceLink pAttribute) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $removed_class_attribute.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $removed_class_attribute.Match partialMatch) {
    ...
    protected $removed_class_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return $removed_class_attribute.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    protected $removed_class_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return $removed_class_attribute.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected $removed_class_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $removed_class_attribute.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $removed_class_attribute.Match newMatch(final Object... parameters) {
    return $removed_class_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
