...
public final class $created_modelElement extends BaseGeneratedEMFQuerySpecification<$created_modelElement.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_modelElement.Match newMutableMatch(final TraceLink pModelElement) {
     ...
     * 
     */
    public static $created_modelElement.Match newMatch(final TraceLink pModelElement) {
  ...
  public static class Matcher extends BaseMatcher<$created_modelElement.Match> {
     ...
     * 
     */
    public Collection<$created_modelElement.Match> getAllMatches(final TraceLink pModelElement) {
     ...
     * 
     */
    public $created_modelElement.Match getOneArbitraryMatch(final TraceLink pModelElement) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pModelElement, final IMatchProcessor<? super $created_modelElement.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pModelElement, final IMatchProcessor<? super $created_modelElement.Match> processor) {
     ...
     * 
     */
    public $created_modelElement.Match newMatch(final TraceLink pModelElement) {
      return $created_modelElement.Match.newMatch(pModelElement);
    }
    ...
    protected $created_modelElement.Match tupleToMatch(final Tuple t) {
      try {
          return $created_modelElement.Match.newMatch((TraceLink) t.get(POSITION_MODELELEMENT));
    ...
    protected $created_modelElement.Match arrayToMatch(final Object[] match) {
      try {
          return $created_modelElement.Match.newMatch((TraceLink) match[POSITION_MODELELEMENT]);
      } catch(ClassCastException e) {
    ...
    protected $created_modelElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_modelElement.Match.newMutableMatch((TraceLink) match[POSITION_MODELELEMENT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_modelElement.Match newMatch(final Object... parameters) {
    return $created_modelElement.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
