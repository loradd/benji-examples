...
public final class Get_reference_containment extends BaseGeneratedEMFQuerySpecification<Get_reference_containment.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_containment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_containment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_reference_containment.Match.parameterNames;
    }
    ...
    @Override
    public Get_reference_containment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_reference_containment.Match)) {
          Get_reference_containment.Match other = (Get_reference_containment.Match) obj;
    ...
    @Override
    public Get_reference_containment specification() {
     ...
     * 
     */
    public static Get_reference_containment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_reference_containment.Match newMutableMatch(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public static Get_reference_containment.Match newMatch(final TraceLink pReference, final Boolean pContainment) {
      return new Immutable(pReference, pContainment);
    }
    
    private static final class Mutable extends Get_reference_containment.Match {
    ...
    private static final class Immutable extends Get_reference_containment.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_containment pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_reference_containment
   * 
   */
  public static class Matcher extends BaseMatcher<Get_reference_containment.Match> {
    /**
     ...
     * 
     */
    public static Get_reference_containment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_reference_containment.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_reference_containment.Matcher.class);
     ...
     * 
     */
    public Collection<Get_reference_containment.Match> getAllMatches(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public Get_reference_containment.Match getOneArbitraryMatch(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Boolean pContainment, final IMatchProcessor<? super Get_reference_containment.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Boolean pContainment, final IMatchProcessor<? super Get_reference_containment.Match> processor) {
     ...
     * 
     */
    public Get_reference_containment.Match newMatch(final TraceLink pReference, final Boolean pContainment) {
      return Get_reference_containment.Match.newMatch(pReference, pContainment);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfcontainment(final Get_reference_containment.Match partialMatch) {
    ...
    @Override
    protected Get_reference_containment.Match tupleToMatch(final Tuple t) {
      try {
          return Get_reference_containment.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Boolean) t.get(POSITION_CONTAINMENT));
    ...
    @Override
    protected Get_reference_containment.Match arrayToMatch(final Object[] match) {
      try {
          return Get_reference_containment.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_reference_containment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_reference_containment.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_reference_containment.Matcher> querySpecification() {
      return Get_reference_containment.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_containment pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_reference_containment.Match> {
    /**
    ...
    @Override
    public void process(final Get_reference_containment.Match match) {
      process(match.getReference(), match.getContainment());
    }
  }
  
  private Get_reference_containment() {
   ...
   * 
   */
  public static Get_reference_containment instance() {
    try{
  ...
  @Override
  protected Get_reference_containment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_reference_containment.Matcher.on(engine);
  }
  
  @Override
  public Get_reference_containment.Matcher instantiate() {
    return Get_reference_containment.Matcher.create();
  }
  
  @Override
  public Get_reference_containment.Match newEmptyMatch() {
    return Get_reference_containment.Match.newEmptyMatch();
  }
  
  @Override
  public Get_reference_containment.Match newMatch(final Object... parameters) {
    return Get_reference_containment.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_containment (visibility: PUBLIC, simpleName: Get_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_containment (visibility: PUBLIC, simpleName: Get_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_reference_containment INSTANCE = new Get_reference_containment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_reference_containment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
