...
public final class $attribute_name extends BaseGeneratedEMFQuerySpecification<$attribute_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return $attribute_name.Match.parameterNames;
    }
    ...
    @Override
    public $attribute_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $attribute_name.Match)) {
          $attribute_name.Match other = ($attribute_name.Match) obj;
    ...
    @Override
    public $attribute_name specification() {
     ...
     * 
     */
    public static $attribute_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static $attribute_name.Match newMutableMatch(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public static $attribute_name.Match newMatch(final TraceLink pAttribute, final String pName) {
      return new Immutable(pAttribute, pName);
    }
    
    private static final class Mutable extends $attribute_name.Match {
    ...
    private static final class Immutable extends $attribute_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<$attribute_name.Match> {
    /**
     ...
     * 
     */
    public static $attribute_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $attribute_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($attribute_name.Matcher.class);
     ...
     * 
     */
    public Collection<$attribute_name.Match> getAllMatches(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public $attribute_name.Match getOneArbitraryMatch(final TraceLink pAttribute, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final String pName, final IMatchProcessor<? super $attribute_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final String pName, final IMatchProcessor<? super $attribute_name.Match> processor) {
     ...
     * 
     */
    public $attribute_name.Match newMatch(final TraceLink pAttribute, final String pName) {
      return $attribute_name.Match.newMatch(pAttribute, pName);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $attribute_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final $attribute_name.Match partialMatch) {
    ...
    @Override
    protected $attribute_name.Match tupleToMatch(final Tuple t) {
      try {
          return $attribute_name.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (String) t.get(POSITION_NAME));
    ...
    @Override
    protected $attribute_name.Match arrayToMatch(final Object[] match) {
      try {
          return $attribute_name.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $attribute_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $attribute_name.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$attribute_name.Matcher> querySpecification() {
      return $attribute_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$attribute_name.Match> {
    /**
    ...
    @Override
    public void process(final $attribute_name.Match match) {
   ...
   * 
   */
  public static $attribute_name instance() {
    try{
  ...
  @Override
  protected $attribute_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return $attribute_name.Matcher.on(engine);
  }
  
  @Override
  public $attribute_name.Matcher instantiate() {
    return $attribute_name.Matcher.create();
  }
  
  @Override
  public $attribute_name.Match newEmptyMatch() {
    return $attribute_name.Match.newEmptyMatch();
  }
  
  @Override
  public $attribute_name.Match newMatch(final Object... parameters) {
    return $attribute_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name (visibility: PUBLIC, simpleName: $attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name (visibility: PUBLIC, simpleName: $attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $attribute_name INSTANCE = new $attribute_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $attribute_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
