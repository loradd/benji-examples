...
public final class Set_reference_containment extends BaseGeneratedEMFQuerySpecification<Set_reference_containment.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_containment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_containment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_reference_containment.Match.parameterNames;
    }
    ...
    @Override
    public Set_reference_containment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_reference_containment.Match)) {
          Set_reference_containment.Match other = (Set_reference_containment.Match) obj;
    ...
    @Override
    public Set_reference_containment specification() {
     ...
     * 
     */
    public static Set_reference_containment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_reference_containment.Match newMutableMatch(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public static Set_reference_containment.Match newMatch(final TraceLink pReference, final Boolean pContainment) {
      return new Immutable(pReference, pContainment);
    }
    
    private static final class Mutable extends Set_reference_containment.Match {
    ...
    private static final class Immutable extends Set_reference_containment.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_containment pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_reference_containment
   * 
   */
  public static class Matcher extends BaseMatcher<Set_reference_containment.Match> {
    /**
     ...
     * 
     */
    public static Set_reference_containment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_reference_containment.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_reference_containment.Matcher.class);
     ...
     * 
     */
    public Collection<Set_reference_containment.Match> getAllMatches(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public Set_reference_containment.Match getOneArbitraryMatch(final TraceLink pReference, final Boolean pContainment) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Boolean pContainment, final IMatchProcessor<? super Set_reference_containment.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Boolean pContainment, final IMatchProcessor<? super Set_reference_containment.Match> processor) {
     ...
     * 
     */
    public Set_reference_containment.Match newMatch(final TraceLink pReference, final Boolean pContainment) {
      return Set_reference_containment.Match.newMatch(pReference, pContainment);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Set_reference_containment.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfcontainment(final Set_reference_containment.Match partialMatch) {
    ...
    @Override
    protected Set_reference_containment.Match tupleToMatch(final Tuple t) {
      try {
          return Set_reference_containment.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Boolean) t.get(POSITION_CONTAINMENT));
    ...
    @Override
    protected Set_reference_containment.Match arrayToMatch(final Object[] match) {
      try {
          return Set_reference_containment.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_reference_containment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_reference_containment.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Boolean) match[POSITION_CONTAINMENT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_reference_containment.Matcher> querySpecification() {
      return Set_reference_containment.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_containment pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_reference_containment.Match> {
    /**
    ...
    @Override
    public void process(final Set_reference_containment.Match match) {
      process(match.getReference(), match.getContainment());
    }
  }
  
  private Set_reference_containment() {
   ...
   * 
   */
  public static Set_reference_containment instance() {
    try{
  ...
  @Override
  protected Set_reference_containment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_reference_containment.Matcher.on(engine);
  }
  
  @Override
  public Set_reference_containment.Matcher instantiate() {
    return Set_reference_containment.Matcher.create();
  }
  
  @Override
  public Set_reference_containment.Match newEmptyMatch() {
    return Set_reference_containment.Match.newEmptyMatch();
  }
  
  @Override
  public Set_reference_containment.Match newMatch(final Object... parameters) {
    return Set_reference_containment.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_containment (visibility: PUBLIC, simpleName: Set_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_containment (visibility: PUBLIC, simpleName: Set_reference_containment, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_containment, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_reference_containment INSTANCE = new Set_reference_containment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_reference_containment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_reference_containment (reference, _initial_reference, containment)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_reference, var__initial_reference, var_containment), Initial_reference_containment.instance().getInternalQueryRepresentation());
          // 	find current_reference_containment (reference, _current_reference, containment)
