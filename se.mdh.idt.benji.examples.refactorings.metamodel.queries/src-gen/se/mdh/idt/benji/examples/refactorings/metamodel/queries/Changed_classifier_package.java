...
public final class Changed_classifier_package extends BaseGeneratedEMFQuerySpecification<Changed_classifier_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_classifier_package.Match.parameterNames;
    }
    ...
    @Override
    public Changed_classifier_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_classifier_package.Match)) {
          Changed_classifier_package.Match other = (Changed_classifier_package.Match) obj;
    ...
    @Override
    public Changed_classifier_package specification() {
     ...
     * 
     */
    public static Changed_classifier_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_classifier_package.Match newMutableMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public static Changed_classifier_package.Match newMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return new Immutable(pInitial_classifier, pCurrent_classifier, pInitial_package, pCurrent_package);
    }
    
    private static final class Mutable extends Changed_classifier_package.Match {
    ...
    private static final class Immutable extends Changed_classifier_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_classifier_package
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_classifier_package.Match> {
    /**
     ...
     * 
     */
    public static Changed_classifier_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_classifier_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_classifier_package.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_classifier_package.Match> getAllMatches(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Changed_classifier_package.Match getOneArbitraryMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Changed_classifier_package.Match newMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return Changed_classifier_package.Match.newMatch(pInitial_classifier, pCurrent_classifier, pInitial_package, pCurrent_package);
    }
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfinitial_classifier(final Changed_classifier_package.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfcurrent_classifier(final Changed_classifier_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Changed_classifier_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Changed_classifier_package.Match partialMatch) {
    ...
    @Override
    protected Changed_classifier_package.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Changed_classifier_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_classifier_package.Match.newMutableMatch((Classifier) match[POSITION_INITIAL_CLASSIFIER], (Classifier) match[POSITION_CURRENT_CLASSIFIER], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
     ...
     * 
     */
    public static IQuerySpecification<Changed_classifier_package.Matcher> querySpecification() {
      return Changed_classifier_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_classifier_package.Match> {
    /**
   ...
   * 
   */
  public static Changed_classifier_package instance() {
    try{
  ...
  @Override
  protected Changed_classifier_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_classifier_package.Matcher.on(engine);
  }
  
  @Override
  public Changed_classifier_package.Matcher instantiate() {
    return Changed_classifier_package.Matcher.create();
  }
  
  @Override
  public Changed_classifier_package.Match newEmptyMatch() {
    return Changed_classifier_package.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_classifier_package.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_package (visibility: PUBLIC, simpleName: Changed_classifier_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_package (visibility: PUBLIC, simpleName: Changed_classifier_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_classifier_package INSTANCE = new Changed_classifier_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_classifier_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	neg find preserved_package (initial_package, current_package)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_initial_package, var_current_package), Preserved_package.instance().getInternalQueryRepresentation());
          //   	find classifier_package (initial_classifier, initial_package)
