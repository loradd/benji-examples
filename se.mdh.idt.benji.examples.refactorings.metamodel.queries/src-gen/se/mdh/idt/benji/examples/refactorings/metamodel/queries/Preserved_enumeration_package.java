...
public final class Preserved_enumeration_package extends BaseGeneratedEMFQuerySpecification<Preserved_enumeration_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumeration_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumeration_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_enumeration_package.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_enumeration_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_enumeration_package.Match)) {
          Preserved_enumeration_package.Match other = (Preserved_enumeration_package.Match) obj;
    ...
    @Override
    public Preserved_enumeration_package specification() {
     ...
     * 
     */
    public static Preserved_enumeration_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_enumeration_package.Match newMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return new Immutable(pInitial_enumeration, pCurrent_enumeration, pInitial_package, pCurrent_package);
    }
    
    private static final class Mutable extends Preserved_enumeration_package.Match {
    ...
    private static final class Immutable extends Preserved_enumeration_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumeration_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_enumeration_package
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_enumeration_package.Match> {
    /**
     ...
     * 
     */
    public static Preserved_enumeration_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_enumeration_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_enumeration_package.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_enumeration_package.Match> getAllMatches(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Preserved_enumeration_package.Match getOneArbitraryMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Preserved_enumeration_package.Match newMatch(final Enumeration pInitial_enumeration, final Enumeration pCurrent_enumeration, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return Preserved_enumeration_package.Match.newMatch(pInitial_enumeration, pCurrent_enumeration, pInitial_package, pCurrent_package);
    }
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfinitial_enumeration(final Preserved_enumeration_package.Match partialMatch) {
     ...
     * 
     */
    public Set<Enumeration> getAllValuesOfcurrent_enumeration(final Preserved_enumeration_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Preserved_enumeration_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Preserved_enumeration_package.Match partialMatch) {
    ...
    @Override
    protected Preserved_enumeration_package.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Preserved_enumeration_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_enumeration_package.Match.newMutableMatch((Enumeration) match[POSITION_INITIAL_ENUMERATION], (Enumeration) match[POSITION_CURRENT_ENUMERATION], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_enumeration_package.Matcher> querySpecification() {
      return Preserved_enumeration_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_enumeration_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_enumeration_package.Match> {
    /**
   ...
   * 
   */
  public static Preserved_enumeration_package instance() {
    try{
  ...
  @Override
  protected Preserved_enumeration_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_enumeration_package.Matcher.on(engine);
  }
  
  @Override
  public Preserved_enumeration_package.Matcher instantiate() {
    return Preserved_enumeration_package.Matcher.create();
  }
  
  @Override
  public Preserved_enumeration_package.Match newEmptyMatch() {
    return Preserved_enumeration_package.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_enumeration_package.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumeration_package (visibility: PUBLIC, simpleName: Preserved_enumeration_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumeration_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumeration_package (visibility: PUBLIC, simpleName: Preserved_enumeration_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_enumeration_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_enumeration_package INSTANCE = new Preserved_enumeration_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_enumeration_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_dataType_package (initial_enumeration, current_enumeration, initial_package, current_package)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_enumeration, var_current_enumeration, var_initial_package, var_current_package), Preserved_dataType_package.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
