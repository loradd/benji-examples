...
public final class $removed_package_enumeration extends BaseGeneratedEMFQuerySpecification<$removed_package_enumeration.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $removed_package_enumeration.Match newMutableMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static $removed_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
  ...
  public static class Matcher extends BaseMatcher<$removed_package_enumeration.Match> {
     ...
     * 
     */
    public Collection<$removed_package_enumeration.Match> getAllMatches(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public $removed_package_enumeration.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super $removed_package_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super $removed_package_enumeration.Match> processor) {
     ...
     * 
     */
    public $removed_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
      return $removed_package_enumeration.Match.newMatch(pPackage, pEnumeration);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $removed_package_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final $removed_package_enumeration.Match partialMatch) {
    ...
    protected $removed_package_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return $removed_package_enumeration.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    protected $removed_package_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return $removed_package_enumeration.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    protected $removed_package_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $removed_package_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $removed_package_enumeration.Match newMatch(final Object... parameters) {
    return $removed_package_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
