...
public final class Get_reference_type extends BaseGeneratedEMFQuerySpecification<Get_reference_type.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_type pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_type";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_reference_type.Match.parameterNames;
    }
    ...
    @Override
    public Get_reference_type.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_reference_type.Match)) {
          Get_reference_type.Match other = (Get_reference_type.Match) obj;
    ...
    @Override
    public Get_reference_type specification() {
     ...
     * 
     */
    public static Get_reference_type.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_reference_type.Match newMutableMatch(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public static Get_reference_type.Match newMatch(final TraceLink pReference, final TraceLink pType) {
      return new Immutable(pReference, pType);
    }
    
    private static final class Mutable extends Get_reference_type.Match {
    ...
    private static final class Immutable extends Get_reference_type.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_type pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_reference_type
   * 
   */
  public static class Matcher extends BaseMatcher<Get_reference_type.Match> {
    /**
     ...
     * 
     */
    public static Get_reference_type.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_reference_type.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_reference_type.Matcher.class);
     ...
     * 
     */
    public Collection<Get_reference_type.Match> getAllMatches(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public Get_reference_type.Match getOneArbitraryMatch(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final TraceLink pType, final IMatchProcessor<? super Get_reference_type.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final TraceLink pType, final IMatchProcessor<? super Get_reference_type.Match> processor) {
     ...
     * 
     */
    public Get_reference_type.Match newMatch(final TraceLink pReference, final TraceLink pType) {
      return Get_reference_type.Match.newMatch(pReference, pType);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_reference_type.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOftype(final Get_reference_type.Match partialMatch) {
    ...
    @Override
    protected Get_reference_type.Match tupleToMatch(final Tuple t) {
      try {
          return Get_reference_type.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (TraceLink) t.get(POSITION_TYPE));
    ...
    @Override
    protected Get_reference_type.Match arrayToMatch(final Object[] match) {
      try {
          return Get_reference_type.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_reference_type.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_reference_type.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_reference_type.Matcher> querySpecification() {
      return Get_reference_type.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_type pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_reference_type.Match> {
    /**
    ...
    @Override
    public void process(final Get_reference_type.Match match) {
      process(match.getReference(), match.getType());
    }
  }
  
  private Get_reference_type() {
   ...
   * 
   */
  public static Get_reference_type instance() {
    try{
  ...
  @Override
  protected Get_reference_type.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_reference_type.Matcher.on(engine);
  }
  
  @Override
  public Get_reference_type.Matcher instantiate() {
    return Get_reference_type.Matcher.create();
  }
  
  @Override
  public Get_reference_type.Match newEmptyMatch() {
    return Get_reference_type.Match.newEmptyMatch();
  }
  
  @Override
  public Get_reference_type.Match newMatch(final Object... parameters) {
    return Get_reference_type.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_type (visibility: PUBLIC, simpleName: Get_reference_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_type (visibility: PUBLIC, simpleName: Get_reference_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_reference_type INSTANCE = new Get_reference_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_reference_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
