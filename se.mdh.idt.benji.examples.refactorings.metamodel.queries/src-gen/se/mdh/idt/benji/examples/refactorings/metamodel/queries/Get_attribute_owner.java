...
public final class Get_attribute_owner extends BaseGeneratedEMFQuerySpecification<Get_attribute_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_attribute_owner.Match.parameterNames;
    }
    ...
    @Override
    public Get_attribute_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_attribute_owner.Match)) {
          Get_attribute_owner.Match other = (Get_attribute_owner.Match) obj;
    ...
    @Override
    public Get_attribute_owner specification() {
     ...
     * 
     */
    public static Get_attribute_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_attribute_owner.Match newMutableMatch(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public static Get_attribute_owner.Match newMatch(final TraceLink pAttribute, final TraceLink pOwner) {
      return new Immutable(pAttribute, pOwner);
    }
    
    private static final class Mutable extends Get_attribute_owner.Match {
    ...
    private static final class Immutable extends Get_attribute_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_attribute_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Get_attribute_owner.Match> {
    /**
     ...
     * 
     */
    public static Get_attribute_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_attribute_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_attribute_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Get_attribute_owner.Match> getAllMatches(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public Get_attribute_owner.Match getOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final TraceLink pOwner, final IMatchProcessor<? super Get_attribute_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pOwner, final IMatchProcessor<? super Get_attribute_owner.Match> processor) {
     ...
     * 
     */
    public Get_attribute_owner.Match newMatch(final TraceLink pAttribute, final TraceLink pOwner) {
      return Get_attribute_owner.Match.newMatch(pAttribute, pOwner);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Get_attribute_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final Get_attribute_owner.Match partialMatch) {
    ...
    @Override
    protected Get_attribute_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Get_attribute_owner.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (TraceLink) t.get(POSITION_OWNER));
    ...
    @Override
    protected Get_attribute_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Get_attribute_owner.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_attribute_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_attribute_owner.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_attribute_owner.Matcher> querySpecification() {
      return Get_attribute_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_attribute_owner.Match> {
    /**
    ...
    @Override
    public void process(final Get_attribute_owner.Match match) {
      process(match.getAttribute(), match.getOwner());
    }
  }
  
  private Get_attribute_owner() {
   ...
   * 
   */
  public static Get_attribute_owner instance() {
    try{
  ...
  @Override
  protected Get_attribute_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_attribute_owner.Matcher.on(engine);
  }
  
  @Override
  public Get_attribute_owner.Matcher instantiate() {
    return Get_attribute_owner.Matcher.create();
  }
  
  @Override
  public Get_attribute_owner.Match newEmptyMatch() {
    return Get_attribute_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Get_attribute_owner.Match newMatch(final Object... parameters) {
    return Get_attribute_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_owner (visibility: PUBLIC, simpleName: Get_attribute_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_owner (visibility: PUBLIC, simpleName: Get_attribute_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_attribute_owner INSTANCE = new Get_attribute_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_attribute_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
