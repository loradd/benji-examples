...
public final class Removed_class_reference extends BaseGeneratedEMFQuerySpecification<Removed_class_reference.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference";
    }
    
    @Override
    public List<String> parameterNames() {
      return Removed_class_reference.Match.parameterNames;
    }
    ...
    @Override
    public Removed_class_reference.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Removed_class_reference.Match)) {
          Removed_class_reference.Match other = (Removed_class_reference.Match) obj;
    ...
    @Override
    public Removed_class_reference specification() {
     ...
     * 
     */
    public static Removed_class_reference.Match newEmptyMatch() {
     ...
     * 
     */
    public static Removed_class_reference.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference) {
     ...
     * 
     */
    public static Removed_class_reference.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_reference);
    }
    
    private static final class Mutable extends Removed_class_reference.Match {
    ...
    private static final class Immutable extends Removed_class_reference.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Removed_class_reference
   * 
   */
  public static class Matcher extends BaseMatcher<Removed_class_reference.Match> {
    /**
     ...
     * 
     */
    public static Removed_class_reference.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Removed_class_reference.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Removed_class_reference.Matcher.class);
     ...
     * 
     */
    public Collection<Removed_class_reference.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference) {
     ...
     * 
     */
    public Removed_class_reference.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final IMatchProcessor<? super Removed_class_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference, final IMatchProcessor<? super Removed_class_reference.Match> processor) {
     ...
     * 
     */
    public Removed_class_reference.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Reference pInitial_reference) {
      return Removed_class_reference.Match.newMatch(pInitial_class, pCurrent_class, pInitial_reference);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final Removed_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final Removed_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Removed_class_reference.Match partialMatch) {
    ...
    @Override
    protected Removed_class_reference.Match tupleToMatch(final Tuple t) {
      try {
          return Removed_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_CLASS), (Reference) t.get(POSITION_INITIAL_REFERENCE));
    ...
    @Override
    protected Removed_class_reference.Match arrayToMatch(final Object[] match) {
      try {
          return Removed_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Reference) match[POSITION_INITIAL_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Removed_class_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Removed_class_reference.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Reference) match[POSITION_INITIAL_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Removed_class_reference.Matcher> querySpecification() {
      return Removed_class_reference.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.removed_class_reference pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Removed_class_reference.Match> {
    /**
    ...
    @Override
    public void process(final Removed_class_reference.Match match) {
      process(match.getInitial_class(), match.getCurrent_class(), match.getInitial_reference());
    }
  }
  
  private Removed_class_reference() {
   ...
   * 
   */
  public static Removed_class_reference instance() {
    try{
  ...
  @Override
  protected Removed_class_reference.Matcher instantiate(final ViatraQueryEngine engine) {
    return Removed_class_reference.Matcher.on(engine);
  }
  
  @Override
  public Removed_class_reference.Matcher instantiate() {
    return Removed_class_reference.Matcher.create();
  }
  
  @Override
  public Removed_class_reference.Match newEmptyMatch() {
    return Removed_class_reference.Match.newEmptyMatch();
  }
  
  @Override
  public Removed_class_reference.Match newMatch(final Object... parameters) {
    return Removed_class_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference (visibility: PUBLIC, simpleName: Removed_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference (visibility: PUBLIC, simpleName: Removed_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Removed_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Removed_class_reference INSTANCE = new Removed_class_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Removed_class_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find removed_class_structuralFeature (initial_class, current_class, initial_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_class, var_current_class, var_initial_reference), Removed_class_structuralFeature.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
