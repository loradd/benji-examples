...
public final class $enumerationLiteral_name extends BaseGeneratedEMFQuerySpecification<$enumerationLiteral_name.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $enumerationLiteral_name.Match newMutableMatch(final TraceLink pEnumerationLiteral, final String pName) {
     ...
     * 
     */
    public static $enumerationLiteral_name.Match newMatch(final TraceLink pEnumerationLiteral, final String pName) {
  ...
  public static class Matcher extends BaseMatcher<$enumerationLiteral_name.Match> {
     ...
     * 
     */
    public Collection<$enumerationLiteral_name.Match> getAllMatches(final TraceLink pEnumerationLiteral, final String pName) {
     ...
     * 
     */
    public $enumerationLiteral_name.Match getOneArbitraryMatch(final TraceLink pEnumerationLiteral, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumerationLiteral, final String pName, final IMatchProcessor<? super $enumerationLiteral_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumerationLiteral, final String pName, final IMatchProcessor<? super $enumerationLiteral_name.Match> processor) {
     ...
     * 
     */
    public $enumerationLiteral_name.Match newMatch(final TraceLink pEnumerationLiteral, final String pName) {
      return $enumerationLiteral_name.Match.newMatch(pEnumerationLiteral, pName);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumerationLiteral(final $enumerationLiteral_name.Match partialMatch) {
    ...
    protected $enumerationLiteral_name.Match tupleToMatch(final Tuple t) {
      try {
          return $enumerationLiteral_name.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATIONLITERAL), (String) t.get(POSITION_NAME));
    ...
    protected $enumerationLiteral_name.Match arrayToMatch(final Object[] match) {
      try {
          return $enumerationLiteral_name.Match.newMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected $enumerationLiteral_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $enumerationLiteral_name.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $enumerationLiteral_name.Match newMatch(final Object... parameters) {
    return $enumerationLiteral_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
