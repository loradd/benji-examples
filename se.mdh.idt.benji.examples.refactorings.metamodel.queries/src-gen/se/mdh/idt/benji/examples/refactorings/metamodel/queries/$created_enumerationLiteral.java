...
public final class $created_enumerationLiteral extends BaseGeneratedEMFQuerySpecification<$created_enumerationLiteral.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_enumerationLiteral.Match newMutableMatch(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public static $created_enumerationLiteral.Match newMatch(final TraceLink pEnumerationLiteral) {
  ...
  public static class Matcher extends BaseMatcher<$created_enumerationLiteral.Match> {
     ...
     * 
     */
    public Collection<$created_enumerationLiteral.Match> getAllMatches(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public $created_enumerationLiteral.Match getOneArbitraryMatch(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $created_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $created_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public $created_enumerationLiteral.Match newMatch(final TraceLink pEnumerationLiteral) {
      return $created_enumerationLiteral.Match.newMatch(pEnumerationLiteral);
    }
    ...
    protected $created_enumerationLiteral.Match tupleToMatch(final Tuple t) {
      try {
          return $created_enumerationLiteral.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATIONLITERAL));
    ...
    protected $created_enumerationLiteral.Match arrayToMatch(final Object[] match) {
      try {
          return $created_enumerationLiteral.Match.newMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
    ...
    protected $created_enumerationLiteral.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_enumerationLiteral.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_enumerationLiteral.Match newMatch(final Object... parameters) {
    return $created_enumerationLiteral.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
