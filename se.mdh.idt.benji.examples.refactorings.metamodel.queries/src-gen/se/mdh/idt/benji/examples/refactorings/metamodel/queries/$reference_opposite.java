...
public final class $reference_opposite extends BaseGeneratedEMFQuerySpecification<$reference_opposite.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $reference_opposite.Match newMutableMatch(final TraceLink pReference, final TraceLink pOpposite) {
     ...
     * 
     */
    public static $reference_opposite.Match newMatch(final TraceLink pReference, final TraceLink pOpposite) {
  ...
  public static class Matcher extends BaseMatcher<$reference_opposite.Match> {
     ...
     * 
     */
    public Collection<$reference_opposite.Match> getAllMatches(final TraceLink pReference, final TraceLink pOpposite) {
     ...
     * 
     */
    public $reference_opposite.Match getOneArbitraryMatch(final TraceLink pReference, final TraceLink pOpposite) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final TraceLink pOpposite, final IMatchProcessor<? super $reference_opposite.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final TraceLink pOpposite, final IMatchProcessor<? super $reference_opposite.Match> processor) {
     ...
     * 
     */
    public $reference_opposite.Match newMatch(final TraceLink pReference, final TraceLink pOpposite) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final $reference_opposite.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfopposite(final $reference_opposite.Match partialMatch) {
    ...
    protected $reference_opposite.Match tupleToMatch(final Tuple t) {
      try {
          return $reference_opposite.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (TraceLink) t.get(POSITION_OPPOSITE));
    ...
    protected $reference_opposite.Match arrayToMatch(final Object[] match) {
      try {
          return $reference_opposite.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OPPOSITE]);
      } catch(ClassCastException e) {
    ...
    protected $reference_opposite.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $reference_opposite.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OPPOSITE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $reference_opposite.Match newMatch(final Object... parameters) {
    return $reference_opposite.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
