...
public final class Get_class_subClass extends BaseGeneratedEMFQuerySpecification<Get_class_subClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_subClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_subClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_class_subClass.Match.parameterNames;
    }
    ...
    @Override
    public Get_class_subClass.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_class_subClass.Match)) {
          Get_class_subClass.Match other = (Get_class_subClass.Match) obj;
    ...
    @Override
    public Get_class_subClass specification() {
     ...
     * 
     */
    public static Get_class_subClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_class_subClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public static Get_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
      return new Immutable(pClass, pSubClass);
    }
    
    private static final class Mutable extends Get_class_subClass.Match {
    ...
    private static final class Immutable extends Get_class_subClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_subClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_class_subClass
   * 
   */
  public static class Matcher extends BaseMatcher<Get_class_subClass.Match> {
    /**
     ...
     * 
     */
    public static Get_class_subClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_class_subClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_class_subClass.Matcher.class);
     ...
     * 
     */
    public Collection<Get_class_subClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public Get_class_subClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super Get_class_subClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super Get_class_subClass.Match> processor) {
     ...
     * 
     */
    public Get_class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
      return Get_class_subClass.Match.newMatch(pClass, pSubClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubClass(final Get_class_subClass.Match partialMatch) {
    ...
    @Override
    protected Get_class_subClass.Match tupleToMatch(final Tuple t) {
      try {
          return Get_class_subClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUBCLASS));
    ...
    @Override
    protected Get_class_subClass.Match arrayToMatch(final Object[] match) {
      try {
          return Get_class_subClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_class_subClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_class_subClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_class_subClass.Matcher> querySpecification() {
      return Get_class_subClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_subClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_class_subClass.Match> {
    /**
    ...
    @Override
    public void process(final Get_class_subClass.Match match) {
      process(match.getValueOfClass(), match.getSubClass());
    }
  }
  
  private Get_class_subClass() {
   ...
   * 
   */
  public static Get_class_subClass instance() {
    try{
  ...
  @Override
  protected Get_class_subClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_class_subClass.Matcher.on(engine);
  }
  
  @Override
  public Get_class_subClass.Matcher instantiate() {
    return Get_class_subClass.Matcher.create();
  }
  
  @Override
  public Get_class_subClass.Match newEmptyMatch() {
    return Get_class_subClass.Match.newEmptyMatch();
  }
  
  @Override
  public Get_class_subClass.Match newMatch(final Object... parameters) {
    return Get_class_subClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_subClass (visibility: PUBLIC, simpleName: Get_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_subClass (visibility: PUBLIC, simpleName: Get_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_class_subClass INSTANCE = new Get_class_subClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_class_subClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
