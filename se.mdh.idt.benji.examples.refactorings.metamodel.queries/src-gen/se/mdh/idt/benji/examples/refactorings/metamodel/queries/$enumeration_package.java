...
public final class $enumeration_package extends BaseGeneratedEMFQuerySpecification<$enumeration_package.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $enumeration_package.Match newMutableMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public static $enumeration_package.Match newMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
  ...
  public static class Matcher extends BaseMatcher<$enumeration_package.Match> {
     ...
     * 
     */
    public Collection<$enumeration_package.Match> getAllMatches(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public $enumeration_package.Match getOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumeration, final TraceLink pPackage, final IMatchProcessor<? super $enumeration_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pPackage, final IMatchProcessor<? super $enumeration_package.Match> processor) {
     ...
     * 
     */
    public $enumeration_package.Match newMatch(final TraceLink pEnumeration, final TraceLink pPackage) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final $enumeration_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $enumeration_package.Match partialMatch) {
    ...
    protected $enumeration_package.Match tupleToMatch(final Tuple t) {
      try {
          return $enumeration_package.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATION), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    protected $enumeration_package.Match arrayToMatch(final Object[] match) {
      try {
          return $enumeration_package.Match.newMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $enumeration_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $enumeration_package.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $enumeration_package.Match newMatch(final Object... parameters) {
    return $enumeration_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
