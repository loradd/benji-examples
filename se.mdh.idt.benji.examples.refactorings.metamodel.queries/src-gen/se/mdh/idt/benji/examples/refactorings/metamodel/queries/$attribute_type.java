...
public final class $attribute_type extends BaseGeneratedEMFQuerySpecification<$attribute_type.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $attribute_type.Match newMutableMatch(final TraceLink pAttribute, final TraceLink pType) {
     ...
     * 
     */
    public static $attribute_type.Match newMatch(final TraceLink pAttribute, final TraceLink pType) {
  ...
  public static class Matcher extends BaseMatcher<$attribute_type.Match> {
     ...
     * 
     */
    public Collection<$attribute_type.Match> getAllMatches(final TraceLink pAttribute, final TraceLink pType) {
     ...
     * 
     */
    public $attribute_type.Match getOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pType) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final TraceLink pType, final IMatchProcessor<? super $attribute_type.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final TraceLink pType, final IMatchProcessor<? super $attribute_type.Match> processor) {
     ...
     * 
     */
    public $attribute_type.Match newMatch(final TraceLink pAttribute, final TraceLink pType) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $attribute_type.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOftype(final $attribute_type.Match partialMatch) {
    ...
    protected $attribute_type.Match tupleToMatch(final Tuple t) {
      try {
          return $attribute_type.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (TraceLink) t.get(POSITION_TYPE));
    ...
    protected $attribute_type.Match arrayToMatch(final Object[] match) {
      try {
          return $attribute_type.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
    ...
    protected $attribute_type.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $attribute_type.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $attribute_type.Match newMatch(final Object... parameters) {
    return $attribute_type.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
