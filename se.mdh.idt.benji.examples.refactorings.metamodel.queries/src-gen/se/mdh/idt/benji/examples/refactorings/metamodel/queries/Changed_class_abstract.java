...
public final class Changed_class_abstract extends BaseGeneratedEMFQuerySpecification<Changed_class_abstract.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_class_abstract pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_class_abstract";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_class_abstract.Match.parameterNames;
    }
    ...
    @Override
    public Changed_class_abstract.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_class_abstract.Match)) {
          Changed_class_abstract.Match other = (Changed_class_abstract.Match) obj;
    ...
    @Override
    public Changed_class_abstract specification() {
     ...
     * 
     */
    public static Changed_class_abstract.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_class_abstract.Match newMutableMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Boolean pInitial_abstract, final Boolean pCurrent_abstract) {
     ...
     * 
     */
    public static Changed_class_abstract.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Boolean pInitial_abstract, final Boolean pCurrent_abstract) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_abstract, pCurrent_abstract);
    }
    
    private static final class Mutable extends Changed_class_abstract.Match {
    ...
    private static final class Immutable extends Changed_class_abstract.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_class_abstract pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_class_abstract
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_class_abstract.Match> {
    /**
     ...
     * 
     */
    public static Changed_class_abstract.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_class_abstract.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_class_abstract.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_class_abstract.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Boolean pInitial_abstract, final Boolean pCurrent_abstract) {
     ...
     * 
     */
    public Changed_class_abstract.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Boolean pInitial_abstract, final Boolean pCurrent_abstract) {
     ...
     * 
     */
    public Changed_class_abstract.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final Boolean pInitial_abstract, final Boolean pCurrent_abstract) {
      return Changed_class_abstract.Match.newMatch(pInitial_class, pCurrent_class, pInitial_abstract, pCurrent_abstract);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final Changed_class_abstract.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final Changed_class_abstract.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfinitial_abstract(final Changed_class_abstract.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfcurrent_abstract(final Changed_class_abstract.Match partialMatch) {
    ...
    @Override
    protected Changed_class_abstract.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_class_abstract.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_CLASS), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_CLASS), (Boolean) t.get(POSITION_INITIAL_ABSTRACT), (Boolean) t.get(POSITION_CURRENT_ABSTRACT));
    ...
    @Override
    protected Changed_class_abstract.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_class_abstract.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Boolean) match[POSITION_INITIAL_ABSTRACT], (Boolean) match[POSITION_CURRENT_ABSTRACT]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_class_abstract.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_class_abstract.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (Boolean) match[POSITION_INITIAL_ABSTRACT], (Boolean) match[POSITION_CURRENT_ABSTRACT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_class_abstract.Matcher> querySpecification() {
      return Changed_class_abstract.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_class_abstract pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_class_abstract.Match> {
    /**
   ...
   * 
   */
  public static Changed_class_abstract instance() {
    try{
  ...
  @Override
  protected Changed_class_abstract.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_class_abstract.Matcher.on(engine);
  }
  
  @Override
  public Changed_class_abstract.Matcher instantiate() {
    return Changed_class_abstract.Matcher.create();
  }
  
  @Override
  public Changed_class_abstract.Match newEmptyMatch() {
    return Changed_class_abstract.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_class_abstract.Match newMatch(final Object... parameters) {
    return Changed_class_abstract.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) parameters[1], (java.lang.Boolean) parameters[2], (java.lang.Boolean) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_class_abstract (visibility: PUBLIC, simpleName: Changed_class_abstract, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_class_abstract, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_class_abstract (visibility: PUBLIC, simpleName: Changed_class_abstract, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_class_abstract, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_class_abstract INSTANCE = new Changed_class_abstract();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_class_abstract.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern changed_class_abstract";
              }
  ...
  private static boolean evaluateExpression_1_1(final Boolean current_abstract, final Boolean initial_abstract) {
    boolean _notEquals = (!com.google.common.base.Objects.equal(initial_abstract, current_abstract));
    return _notEquals;
  }
}
