...
public final class Preserved_reference_upper extends BaseGeneratedEMFQuerySpecification<Preserved_reference_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_reference_upper.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_reference_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_reference_upper.Match)) {
          Preserved_reference_upper.Match other = (Preserved_reference_upper.Match) obj;
    ...
    @Override
    public Preserved_reference_upper specification() {
     ...
     * 
     */
    public static Preserved_reference_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_reference_upper.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public static Preserved_reference_upper.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_upper, pCurrent_upper);
    }
    
    private static final class Mutable extends Preserved_reference_upper.Match {
    ...
    private static final class Immutable extends Preserved_reference_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_reference_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_reference_upper.Match> {
    /**
     ...
     * 
     */
    public static Preserved_reference_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_reference_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_reference_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_reference_upper.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public Preserved_reference_upper.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper, final IMatchProcessor<? super Preserved_reference_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper, final IMatchProcessor<? super Preserved_reference_upper.Match> processor) {
     ...
     * 
     */
    public Preserved_reference_upper.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Integer pInitial_upper, final Integer pCurrent_upper) {
      return Preserved_reference_upper.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_upper, pCurrent_upper);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Preserved_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Preserved_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfinitial_upper(final Preserved_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfcurrent_upper(final Preserved_reference_upper.Match partialMatch) {
    ...
    @Override
    protected Preserved_reference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_reference_upper.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (Integer) t.get(POSITION_INITIAL_UPPER), (Integer) t.get(POSITION_CURRENT_UPPER));
    ...
    @Override
    protected Preserved_reference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_reference_upper.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Integer) match[POSITION_INITIAL_UPPER], (Integer) match[POSITION_CURRENT_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_reference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_reference_upper.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Integer) match[POSITION_INITIAL_UPPER], (Integer) match[POSITION_CURRENT_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_reference_upper.Matcher> querySpecification() {
      return Preserved_reference_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_reference_upper.Match> {
    /**
   ...
   * 
   */
  public static Preserved_reference_upper instance() {
    try{
  ...
  @Override
  protected Preserved_reference_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_reference_upper.Matcher.on(engine);
  }
  
  @Override
  public Preserved_reference_upper.Matcher instantiate() {
    return Preserved_reference_upper.Matcher.create();
  }
  
  @Override
  public Preserved_reference_upper.Match newEmptyMatch() {
    return Preserved_reference_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_reference_upper.Match newMatch(final Object... parameters) {
    return Preserved_reference_upper.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (java.lang.Integer) parameters[2], (java.lang.Integer) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_upper (visibility: PUBLIC, simpleName: Preserved_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_upper (visibility: PUBLIC, simpleName: Preserved_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_reference_upper INSTANCE = new Preserved_reference_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_reference_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_structuralFeature_upper (initial_reference, current_reference, initial_upper, current_upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference, var_initial_upper, var_current_upper), Preserved_structuralFeature_upper.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
