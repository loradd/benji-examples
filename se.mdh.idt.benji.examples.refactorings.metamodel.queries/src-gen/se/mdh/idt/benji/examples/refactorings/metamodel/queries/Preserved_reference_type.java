...
public final class Preserved_reference_type extends BaseGeneratedEMFQuerySpecification<Preserved_reference_type.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_type pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_type";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_reference_type.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_reference_type.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_reference_type.Match)) {
          Preserved_reference_type.Match other = (Preserved_reference_type.Match) obj;
    ...
    @Override
    public Preserved_reference_type specification() {
     ...
     * 
     */
    public static Preserved_reference_type.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_reference_type.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_type) {
     ...
     * 
     */
    public static Preserved_reference_type.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_type) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_type, pCurrent_type);
    }
    
    private static final class Mutable extends Preserved_reference_type.Match {
    ...
    private static final class Immutable extends Preserved_reference_type.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_type pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_reference_type
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_reference_type.Match> {
    /**
     ...
     * 
     */
    public static Preserved_reference_type.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_reference_type.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_reference_type.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_reference_type.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_type) {
     ...
     * 
     */
    public Preserved_reference_type.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_type) {
     ...
     * 
     */
    public Preserved_reference_type.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_type, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_type) {
      return Preserved_reference_type.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_type, pCurrent_type);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Preserved_reference_type.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Preserved_reference_type.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_type(final Preserved_reference_type.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_type(final Preserved_reference_type.Match partialMatch) {
    ...
    @Override
    protected Preserved_reference_type.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_reference_type.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_INITIAL_TYPE), (se.mdh.idt.benji.examples.refactorings.metamodel.Class) t.get(POSITION_CURRENT_TYPE));
    ...
    @Override
    protected Preserved_reference_type.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_reference_type.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_TYPE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_TYPE]);
      } catch(ClassCastException e) {
     ...
     * 
     */
    public static IQuerySpecification<Preserved_reference_type.Matcher> querySpecification() {
      return Preserved_reference_type.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference_type pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_reference_type.Match> {
    /**
   ...
   * 
   */
  public static Preserved_reference_type instance() {
    try{
  ...
  @Override
  protected Preserved_reference_type.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_reference_type.Matcher.on(engine);
  }
  
  @Override
  public Preserved_reference_type.Matcher instantiate() {
    return Preserved_reference_type.Matcher.create();
  }
  
  @Override
  public Preserved_reference_type.Match newEmptyMatch() {
    return Preserved_reference_type.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_reference_type.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_type (visibility: PUBLIC, simpleName: Preserved_reference_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_type (visibility: PUBLIC, simpleName: Preserved_reference_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_reference_type INSTANCE = new Preserved_reference_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_reference_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
