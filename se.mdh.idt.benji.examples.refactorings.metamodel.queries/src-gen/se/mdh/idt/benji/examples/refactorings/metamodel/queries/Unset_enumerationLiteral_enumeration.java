...
public final class Unset_enumerationLiteral_enumeration extends BaseGeneratedEMFQuerySpecification<Unset_enumerationLiteral_enumeration.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumerationLiteral_enumeration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumerationLiteral_enumeration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_enumerationLiteral_enumeration.Match.parameterNames;
    }
    ...
    @Override
    public Unset_enumerationLiteral_enumeration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_enumerationLiteral_enumeration.Match)) {
          Unset_enumerationLiteral_enumeration.Match other = (Unset_enumerationLiteral_enumeration.Match) obj;
    ...
    @Override
    public Unset_enumerationLiteral_enumeration specification() {
     ...
     * 
     */
    public static Unset_enumerationLiteral_enumeration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_enumerationLiteral_enumeration.Match newMutableMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static Unset_enumerationLiteral_enumeration.Match newMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
      return new Immutable(pEnumerationLiteral, pEnumeration);
    }
    
    private static final class Mutable extends Unset_enumerationLiteral_enumeration.Match {
    ...
    private static final class Immutable extends Unset_enumerationLiteral_enumeration.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumerationLiteral_enumeration pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_enumerationLiteral_enumeration
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_enumerationLiteral_enumeration.Match> {
    /**
     ...
     * 
     */
    public static Unset_enumerationLiteral_enumeration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_enumerationLiteral_enumeration.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_enumerationLiteral_enumeration.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_enumerationLiteral_enumeration.Match> getAllMatches(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public Unset_enumerationLiteral_enumeration.Match getOneArbitraryMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration, final IMatchProcessor<? super Unset_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration, final IMatchProcessor<? super Unset_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public Unset_enumerationLiteral_enumeration.Match newMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
      return Unset_enumerationLiteral_enumeration.Match.newMatch(pEnumerationLiteral, pEnumeration);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumerationLiteral(final Unset_enumerationLiteral_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final Unset_enumerationLiteral_enumeration.Match partialMatch) {
    ...
    @Override
    protected Unset_enumerationLiteral_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_enumerationLiteral_enumeration.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATIONLITERAL), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    @Override
    protected Unset_enumerationLiteral_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_enumerationLiteral_enumeration.Match.newMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_enumerationLiteral_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_enumerationLiteral_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_enumerationLiteral_enumeration.Matcher> querySpecification() {
      return Unset_enumerationLiteral_enumeration.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_enumerationLiteral_enumeration pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_enumerationLiteral_enumeration.Match> {
    /**
    ...
    @Override
    public void process(final Unset_enumerationLiteral_enumeration.Match match) {
      process(match.getEnumerationLiteral(), match.getEnumeration());
    }
  }
  
  private Unset_enumerationLiteral_enumeration() {
   ...
   * 
   */
  public static Unset_enumerationLiteral_enumeration instance() {
    try{
  ...
  @Override
  protected Unset_enumerationLiteral_enumeration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_enumerationLiteral_enumeration.Matcher.on(engine);
  }
  
  @Override
  public Unset_enumerationLiteral_enumeration.Matcher instantiate() {
    return Unset_enumerationLiteral_enumeration.Matcher.create();
  }
  
  @Override
  public Unset_enumerationLiteral_enumeration.Match newEmptyMatch() {
    return Unset_enumerationLiteral_enumeration.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_enumerationLiteral_enumeration.Match newMatch(final Object... parameters) {
    return Unset_enumerationLiteral_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: Unset_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: Unset_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_enumerationLiteral_enumeration INSTANCE = new Unset_enumerationLiteral_enumeration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_enumerationLiteral_enumeration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_enumerationLiteral_enumeration (enumerationLiteral, _current_enumerationLiteral, enumeration, _current_enumeration)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_enumerationLiteral, var__current_enumerationLiteral, var_enumeration, var__current_enumeration), Current_enumerationLiteral_enumeration.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
