...
public final class $package_class extends BaseGeneratedEMFQuerySpecification<$package_class.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_class.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public static $package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
  ...
  public static class Matcher extends BaseMatcher<$package_class.Match> {
     ...
     * 
     */
    public Collection<$package_class.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public $package_class.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $package_class.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $package_class.Match> processor) {
     ...
     * 
     */
    public $package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_class.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $package_class.Match partialMatch) {
    ...
    protected $package_class.Match tupleToMatch(final Tuple t) {
      try {
          return $package_class.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASS));
    ...
    protected $package_class.Match arrayToMatch(final Object[] match) {
      try {
          return $package_class.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    protected $package_class.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_class.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_class.Match newMatch(final Object... parameters) {
    return $package_class.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
