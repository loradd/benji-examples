...
public final class $class_abstract extends BaseGeneratedEMFQuerySpecification<$class_abstract.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $class_abstract.Match newMutableMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public static $class_abstract.Match newMatch(final TraceLink pClass, final Boolean pAbstract) {
  ...
  public static class Matcher extends BaseMatcher<$class_abstract.Match> {
     ...
     * 
     */
    public Collection<$class_abstract.Match> getAllMatches(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public $class_abstract.Match getOneArbitraryMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final Boolean pAbstract, final IMatchProcessor<? super $class_abstract.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final Boolean pAbstract, final IMatchProcessor<? super $class_abstract.Match> processor) {
     ...
     * 
     */
    public $class_abstract.Match newMatch(final TraceLink pClass, final Boolean pAbstract) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $class_abstract.Match partialMatch) {
    ...
    protected $class_abstract.Match tupleToMatch(final Tuple t) {
      try {
          return $class_abstract.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (Boolean) t.get(POSITION_ABSTRACT));
    ...
    protected $class_abstract.Match arrayToMatch(final Object[] match) {
      try {
          return $class_abstract.Match.newMatch((TraceLink) match[POSITION_CLASS], (Boolean) match[POSITION_ABSTRACT]);
      } catch(ClassCastException e) {
    ...
    protected $class_abstract.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $class_abstract.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (Boolean) match[POSITION_ABSTRACT]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $class_abstract.Match newMatch(final Object... parameters) {
    return $class_abstract.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Boolean) parameters[1]);
  }
