...
public final class $reference_type extends BaseGeneratedEMFQuerySpecification<$reference_type.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $reference_type.Match newMutableMatch(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public static $reference_type.Match newMatch(final TraceLink pReference, final TraceLink pType) {
  ...
  public static class Matcher extends BaseMatcher<$reference_type.Match> {
     ...
     * 
     */
    public Collection<$reference_type.Match> getAllMatches(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public $reference_type.Match getOneArbitraryMatch(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final TraceLink pType, final IMatchProcessor<? super $reference_type.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final TraceLink pType, final IMatchProcessor<? super $reference_type.Match> processor) {
     ...
     * 
     */
    public $reference_type.Match newMatch(final TraceLink pReference, final TraceLink pType) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final $reference_type.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOftype(final $reference_type.Match partialMatch) {
    ...
    protected $reference_type.Match tupleToMatch(final Tuple t) {
      try {
          return $reference_type.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (TraceLink) t.get(POSITION_TYPE));
    ...
    protected $reference_type.Match arrayToMatch(final Object[] match) {
      try {
          return $reference_type.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
    ...
    protected $reference_type.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $reference_type.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $reference_type.Match newMatch(final Object... parameters) {
    return $reference_type.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
