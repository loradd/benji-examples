...
public final class Unset_structuralFeature_upper extends BaseGeneratedEMFQuerySpecification<Unset_structuralFeature_upper.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_structuralFeature_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_structuralFeature_upper.Match.parameterNames;
    }
    ...
    @Override
    public Unset_structuralFeature_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_structuralFeature_upper.Match)) {
          Unset_structuralFeature_upper.Match other = (Unset_structuralFeature_upper.Match) obj;
    ...
    @Override
    public Unset_structuralFeature_upper specification() {
     ...
     * 
     */
    public static Unset_structuralFeature_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_structuralFeature_upper.Match newMutableMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public static Unset_structuralFeature_upper.Match newMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
      return new Immutable(pStructuralFeature, pUpper);
    }
    
    private static final class Mutable extends Unset_structuralFeature_upper.Match {
    ...
    private static final class Immutable extends Unset_structuralFeature_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_structuralFeature_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_structuralFeature_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_structuralFeature_upper.Match> {
    /**
     ...
     * 
     */
    public static Unset_structuralFeature_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_structuralFeature_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_structuralFeature_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_structuralFeature_upper.Match> getAllMatches(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public Unset_structuralFeature_upper.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final Integer pUpper, final IMatchProcessor<? super Unset_structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pUpper, final IMatchProcessor<? super Unset_structuralFeature_upper.Match> processor) {
     ...
     * 
     */
    public Unset_structuralFeature_upper.Match newMatch(final TraceLink pStructuralFeature, final Integer pUpper) {
      return Unset_structuralFeature_upper.Match.newMatch(pStructuralFeature, pUpper);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Unset_structuralFeature_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Unset_structuralFeature_upper.Match partialMatch) {
    ...
    @Override
    protected Unset_structuralFeature_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_structuralFeature_upper.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (Integer) t.get(POSITION_UPPER));
    ...
    @Override
    protected Unset_structuralFeature_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_structuralFeature_upper.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_structuralFeature_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_structuralFeature_upper.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_structuralFeature_upper.Matcher> querySpecification() {
      return Unset_structuralFeature_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_structuralFeature_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_structuralFeature_upper.Match> {
    /**
    ...
    @Override
    public void process(final Unset_structuralFeature_upper.Match match) {
      process(match.getStructuralFeature(), match.getUpper());
    }
  }
  
  private Unset_structuralFeature_upper() {
   ...
   * 
   */
  public static Unset_structuralFeature_upper instance() {
    try{
  ...
  @Override
  protected Unset_structuralFeature_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_structuralFeature_upper.Matcher.on(engine);
  }
  
  @Override
  public Unset_structuralFeature_upper.Matcher instantiate() {
    return Unset_structuralFeature_upper.Matcher.create();
  }
  
  @Override
  public Unset_structuralFeature_upper.Match newEmptyMatch() {
    return Unset_structuralFeature_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_structuralFeature_upper.Match newMatch(final Object... parameters) {
    return Unset_structuralFeature_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_structuralFeature_upper (visibility: PUBLIC, simpleName: Unset_structuralFeature_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_structuralFeature_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_structuralFeature_upper (visibility: PUBLIC, simpleName: Unset_structuralFeature_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_structuralFeature_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_structuralFeature_upper INSTANCE = new Unset_structuralFeature_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_structuralFeature_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find initial_structuralFeature_upper (structuralFeature, _initial_structuralFeature, upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_structuralFeature, var__initial_structuralFeature, var_upper), Initial_structuralFeature_upper.instance().getInternalQueryRepresentation());
          // 	neg find current_structuralFeature_upper (structuralFeature, _current_structuralFeature, upper)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_structuralFeature, var__current_structuralFeature, var_upper), Current_structuralFeature_upper.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
