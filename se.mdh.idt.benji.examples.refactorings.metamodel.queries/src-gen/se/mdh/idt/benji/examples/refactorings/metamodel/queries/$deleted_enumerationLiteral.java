...
public final class $deleted_enumerationLiteral extends BaseGeneratedEMFQuerySpecification<$deleted_enumerationLiteral.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_enumerationLiteral.Match newMutableMatch(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public static $deleted_enumerationLiteral.Match newMatch(final TraceLink pEnumerationLiteral) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_enumerationLiteral.Match> {
     ...
     * 
     */
    public Collection<$deleted_enumerationLiteral.Match> getAllMatches(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public $deleted_enumerationLiteral.Match getOneArbitraryMatch(final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $deleted_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumerationLiteral, final IMatchProcessor<? super $deleted_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public $deleted_enumerationLiteral.Match newMatch(final TraceLink pEnumerationLiteral) {
      return $deleted_enumerationLiteral.Match.newMatch(pEnumerationLiteral);
    }
    ...
    protected $deleted_enumerationLiteral.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_enumerationLiteral.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATIONLITERAL));
    ...
    protected $deleted_enumerationLiteral.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_enumerationLiteral.Match.newMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_enumerationLiteral.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_enumerationLiteral.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_enumerationLiteral.Match newMatch(final Object... parameters) {
    return $deleted_enumerationLiteral.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
