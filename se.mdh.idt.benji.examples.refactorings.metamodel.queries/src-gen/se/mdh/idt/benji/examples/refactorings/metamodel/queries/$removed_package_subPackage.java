...
public final class $removed_package_subPackage extends BaseGeneratedEMFQuerySpecification<$removed_package_subPackage.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $removed_package_subPackage.Match newMutableMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public static $removed_package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
  ...
  public static class Matcher extends BaseMatcher<$removed_package_subPackage.Match> {
     ...
     * 
     */
    public Collection<$removed_package_subPackage.Match> getAllMatches(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public $removed_package_subPackage.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super $removed_package_subPackage.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super $removed_package_subPackage.Match> processor) {
     ...
     * 
     */
    public $removed_package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $removed_package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubPackage(final $removed_package_subPackage.Match partialMatch) {
    ...
    protected $removed_package_subPackage.Match tupleToMatch(final Tuple t) {
      try {
          return $removed_package_subPackage.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_SUBPACKAGE));
    ...
    protected $removed_package_subPackage.Match arrayToMatch(final Object[] match) {
      try {
          return $removed_package_subPackage.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $removed_package_subPackage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $removed_package_subPackage.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $removed_package_subPackage.Match newMatch(final Object... parameters) {
    return $removed_package_subPackage.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
