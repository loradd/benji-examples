...
public final class Preserved_attribute_name extends BaseGeneratedEMFQuerySpecification<Preserved_attribute_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_attribute_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_attribute_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_attribute_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_attribute_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_attribute_name.Match)) {
          Preserved_attribute_name.Match other = (Preserved_attribute_name.Match) obj;
    ...
    @Override
    public Preserved_attribute_name specification() {
     ...
     * 
     */
    public static Preserved_attribute_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_attribute_name.Match newMutableMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_attribute_name.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_attribute, pCurrent_attribute, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_attribute_name.Match {
    ...
    private static final class Immutable extends Preserved_attribute_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_attribute_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_attribute_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_attribute_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_attribute_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_attribute_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_attribute_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_attribute_name.Match> getAllMatches(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_attribute_name.Match getOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_attribute_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_attribute_name.Match> processor) {
     ...
     * 
     */
    public Preserved_attribute_name.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final String pInitial_name, final String pCurrent_name) {
      return Preserved_attribute_name.Match.newMatch(pInitial_attribute, pCurrent_attribute, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final Preserved_attribute_name.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final Preserved_attribute_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_attribute_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_attribute_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_attribute_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_attribute_name.Match.newMatch((Attribute) t.get(POSITION_INITIAL_ATTRIBUTE), (Attribute) t.get(POSITION_CURRENT_ATTRIBUTE), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_attribute_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_attribute_name.Match.newMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_attribute_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_attribute_name.Match.newMutableMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_attribute_name.Matcher> querySpecification() {
      return Preserved_attribute_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_attribute_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_attribute_name.Match> {
    /**
   ...
   * 
   */
  public static Preserved_attribute_name instance() {
    try{
  ...
  @Override
  protected Preserved_attribute_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_attribute_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_attribute_name.Matcher instantiate() {
    return Preserved_attribute_name.Matcher.create();
  }
  
  @Override
  public Preserved_attribute_name.Match newEmptyMatch() {
    return Preserved_attribute_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_attribute_name.Match newMatch(final Object... parameters) {
    return Preserved_attribute_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_attribute_name (visibility: PUBLIC, simpleName: Preserved_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_attribute_name (visibility: PUBLIC, simpleName: Preserved_attribute_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_attribute_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_attribute_name INSTANCE = new Preserved_attribute_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_attribute_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_structuralFeature_name (initial_attribute, current_attribute, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_attribute, var_current_attribute, var_initial_name, var_current_name), Preserved_structuralFeature_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
