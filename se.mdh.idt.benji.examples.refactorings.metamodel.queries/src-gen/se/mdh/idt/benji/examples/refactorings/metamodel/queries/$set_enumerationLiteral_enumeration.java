...
public final class $set_enumerationLiteral_enumeration extends BaseGeneratedEMFQuerySpecification<$set_enumerationLiteral_enumeration.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration";
    }
    
    @Override
    public List<String> parameterNames() {
      return $set_enumerationLiteral_enumeration.Match.parameterNames;
    }
    ...
    @Override
    public $set_enumerationLiteral_enumeration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $set_enumerationLiteral_enumeration.Match)) {
          $set_enumerationLiteral_enumeration.Match other = ($set_enumerationLiteral_enumeration.Match) obj;
    ...
    @Override
    public $set_enumerationLiteral_enumeration specification() {
     ...
     * 
     */
    public static $set_enumerationLiteral_enumeration.Match newEmptyMatch() {
     ...
     * 
     */
    public static $set_enumerationLiteral_enumeration.Match newMutableMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static $set_enumerationLiteral_enumeration.Match newMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
      return new Immutable(pEnumerationLiteral, pEnumeration);
    }
    
    private static final class Mutable extends $set_enumerationLiteral_enumeration.Match {
    ...
    private static final class Immutable extends $set_enumerationLiteral_enumeration.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $set_enumerationLiteral_enumeration
   * 
   */
  public static class Matcher extends BaseMatcher<$set_enumerationLiteral_enumeration.Match> {
    /**
     ...
     * 
     */
    public static $set_enumerationLiteral_enumeration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $set_enumerationLiteral_enumeration.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($set_enumerationLiteral_enumeration.Matcher.class);
     ...
     * 
     */
    public Collection<$set_enumerationLiteral_enumeration.Match> getAllMatches(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public $set_enumerationLiteral_enumeration.Match getOneArbitraryMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration, final IMatchProcessor<? super $set_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration, final IMatchProcessor<? super $set_enumerationLiteral_enumeration.Match> processor) {
     ...
     * 
     */
    public $set_enumerationLiteral_enumeration.Match newMatch(final TraceLink pEnumerationLiteral, final TraceLink pEnumeration) {
      return $set_enumerationLiteral_enumeration.Match.newMatch(pEnumerationLiteral, pEnumeration);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumerationLiteral(final $set_enumerationLiteral_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final $set_enumerationLiteral_enumeration.Match partialMatch) {
    ...
    @Override
    protected $set_enumerationLiteral_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return $set_enumerationLiteral_enumeration.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATIONLITERAL), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    @Override
    protected $set_enumerationLiteral_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return $set_enumerationLiteral_enumeration.Match.newMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $set_enumerationLiteral_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $set_enumerationLiteral_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATIONLITERAL], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$set_enumerationLiteral_enumeration.Matcher> querySpecification() {
      return $set_enumerationLiteral_enumeration.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$set_enumerationLiteral_enumeration.Match> {
    /**
    ...
    @Override
    public void process(final $set_enumerationLiteral_enumeration.Match match) {
      process(match.getEnumerationLiteral(), match.getEnumeration());
    }
  }
  
  private $set_enumerationLiteral_enumeration() {
   ...
   * 
   */
  public static $set_enumerationLiteral_enumeration instance() {
    try{
  ...
  @Override
  protected $set_enumerationLiteral_enumeration.Matcher instantiate(final ViatraQueryEngine engine) {
    return $set_enumerationLiteral_enumeration.Matcher.on(engine);
  }
  
  @Override
  public $set_enumerationLiteral_enumeration.Matcher instantiate() {
    return $set_enumerationLiteral_enumeration.Matcher.create();
  }
  
  @Override
  public $set_enumerationLiteral_enumeration.Match newEmptyMatch() {
    return $set_enumerationLiteral_enumeration.Match.newEmptyMatch();
  }
  
  @Override
  public $set_enumerationLiteral_enumeration.Match newMatch(final Object... parameters) {
    return $set_enumerationLiteral_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: $set_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration (visibility: PUBLIC, simpleName: $set_enumerationLiteral_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$set_enumerationLiteral_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $set_enumerationLiteral_enumeration INSTANCE = new $set_enumerationLiteral_enumeration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $set_enumerationLiteral_enumeration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find $initial_enumerationLiteral_enumeration (enumerationLiteral, _initial_enumerationLiteral, enumeration, _initial_enumeration)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_enumerationLiteral, var__initial_enumerationLiteral, var_enumeration, var__initial_enumeration), $initial_enumerationLiteral_enumeration.instance().getInternalQueryRepresentation());
          //  	find $current_enumerationLiteral_enumeration (enumerationLiteral, _current_enumerationLiteral, enumeration, _current_enumeration)
