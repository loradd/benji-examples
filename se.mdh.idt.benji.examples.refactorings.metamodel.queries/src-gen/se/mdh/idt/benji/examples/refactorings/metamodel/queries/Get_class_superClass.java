...
public final class Get_class_superClass extends BaseGeneratedEMFQuerySpecification<Get_class_superClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_superClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_superClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_class_superClass.Match.parameterNames;
    }
    ...
    @Override
    public Get_class_superClass.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_class_superClass.Match)) {
          Get_class_superClass.Match other = (Get_class_superClass.Match) obj;
    ...
    @Override
    public Get_class_superClass specification() {
     ...
     * 
     */
    public static Get_class_superClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_class_superClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public static Get_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return new Immutable(pClass, pSuperClass);
    }
    
    private static final class Mutable extends Get_class_superClass.Match {
    ...
    private static final class Immutable extends Get_class_superClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_superClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_class_superClass
   * 
   */
  public static class Matcher extends BaseMatcher<Get_class_superClass.Match> {
    /**
     ...
     * 
     */
    public static Get_class_superClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_class_superClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_class_superClass.Matcher.class);
     ...
     * 
     */
    public Collection<Get_class_superClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public Get_class_superClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super Get_class_superClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super Get_class_superClass.Match> processor) {
     ...
     * 
     */
    public Get_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return Get_class_superClass.Match.newMatch(pClass, pSuperClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_class_superClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsuperClass(final Get_class_superClass.Match partialMatch) {
    ...
    @Override
    protected Get_class_superClass.Match tupleToMatch(final Tuple t) {
      try {
          return Get_class_superClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUPERCLASS));
    ...
    @Override
    protected Get_class_superClass.Match arrayToMatch(final Object[] match) {
      try {
          return Get_class_superClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_class_superClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_class_superClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_class_superClass.Matcher> querySpecification() {
      return Get_class_superClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_superClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_class_superClass.Match> {
    /**
    ...
    @Override
    public void process(final Get_class_superClass.Match match) {
      process(match.getValueOfClass(), match.getSuperClass());
    }
  }
  
  private Get_class_superClass() {
   ...
   * 
   */
  public static Get_class_superClass instance() {
    try{
  ...
  @Override
  protected Get_class_superClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_class_superClass.Matcher.on(engine);
  }
  
  @Override
  public Get_class_superClass.Matcher instantiate() {
    return Get_class_superClass.Matcher.create();
  }
  
  @Override
  public Get_class_superClass.Match newEmptyMatch() {
    return Get_class_superClass.Match.newEmptyMatch();
  }
  
  @Override
  public Get_class_superClass.Match newMatch(final Object... parameters) {
    return Get_class_superClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_superClass (visibility: PUBLIC, simpleName: Get_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_superClass (visibility: PUBLIC, simpleName: Get_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_class_superClass INSTANCE = new Get_class_superClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_class_superClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
