...
public final class Insert_package_subPackage extends BaseGeneratedEMFQuerySpecification<Insert_package_subPackage.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_subPackage pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_subPackage";
    }
    
    @Override
    public List<String> parameterNames() {
      return Insert_package_subPackage.Match.parameterNames;
    }
    ...
    @Override
    public Insert_package_subPackage.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Insert_package_subPackage.Match)) {
          Insert_package_subPackage.Match other = (Insert_package_subPackage.Match) obj;
    ...
    @Override
    public Insert_package_subPackage specification() {
     ...
     * 
     */
    public static Insert_package_subPackage.Match newEmptyMatch() {
     ...
     * 
     */
    public static Insert_package_subPackage.Match newMutableMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public static Insert_package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
      return new Immutable(pPackage, pSubPackage);
    }
    
    private static final class Mutable extends Insert_package_subPackage.Match {
    ...
    private static final class Immutable extends Insert_package_subPackage.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_subPackage pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Insert_package_subPackage
   * 
   */
  public static class Matcher extends BaseMatcher<Insert_package_subPackage.Match> {
    /**
     ...
     * 
     */
    public static Insert_package_subPackage.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Insert_package_subPackage.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Insert_package_subPackage.Matcher.class);
     ...
     * 
     */
    public Collection<Insert_package_subPackage.Match> getAllMatches(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public Insert_package_subPackage.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super Insert_package_subPackage.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pSubPackage, final IMatchProcessor<? super Insert_package_subPackage.Match> processor) {
     ...
     * 
     */
    public Insert_package_subPackage.Match newMatch(final TraceLink pPackage, final TraceLink pSubPackage) {
      return Insert_package_subPackage.Match.newMatch(pPackage, pSubPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Insert_package_subPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubPackage(final Insert_package_subPackage.Match partialMatch) {
    ...
    @Override
    protected Insert_package_subPackage.Match tupleToMatch(final Tuple t) {
      try {
          return Insert_package_subPackage.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_SUBPACKAGE));
    ...
    @Override
    protected Insert_package_subPackage.Match arrayToMatch(final Object[] match) {
      try {
          return Insert_package_subPackage.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Insert_package_subPackage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Insert_package_subPackage.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_SUBPACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Insert_package_subPackage.Matcher> querySpecification() {
      return Insert_package_subPackage.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.insert_package_subPackage pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Insert_package_subPackage.Match> {
    /**
    ...
    @Override
    public void process(final Insert_package_subPackage.Match match) {
      process(match.getPackage(), match.getSubPackage());
    }
  }
  
  private Insert_package_subPackage() {
   ...
   * 
   */
  public static Insert_package_subPackage instance() {
    try{
  ...
  @Override
  protected Insert_package_subPackage.Matcher instantiate(final ViatraQueryEngine engine) {
    return Insert_package_subPackage.Matcher.on(engine);
  }
  
  @Override
  public Insert_package_subPackage.Matcher instantiate() {
    return Insert_package_subPackage.Matcher.create();
  }
  
  @Override
  public Insert_package_subPackage.Match newEmptyMatch() {
    return Insert_package_subPackage.Match.newEmptyMatch();
  }
  
  @Override
  public Insert_package_subPackage.Match newMatch(final Object... parameters) {
    return Insert_package_subPackage.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_subPackage (visibility: PUBLIC, simpleName: Insert_package_subPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_subPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_subPackage (visibility: PUBLIC, simpleName: Insert_package_subPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Insert_package_subPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Insert_package_subPackage INSTANCE = new Insert_package_subPackage();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Insert_package_subPackage.GeneratedPQuery INSTANCE = new GeneratedPQuery();
