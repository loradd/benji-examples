...
public final class Set_reference_upper extends BaseGeneratedEMFQuerySpecification<Set_reference_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_reference_upper.Match.parameterNames;
    }
    ...
    @Override
    public Set_reference_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_reference_upper.Match)) {
          Set_reference_upper.Match other = (Set_reference_upper.Match) obj;
    ...
    @Override
    public Set_reference_upper specification() {
     ...
     * 
     */
    public static Set_reference_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_reference_upper.Match newMutableMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public static Set_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return new Immutable(pReference, pUpper);
    }
    
    private static final class Mutable extends Set_reference_upper.Match {
    ...
    private static final class Immutable extends Set_reference_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_reference_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Set_reference_upper.Match> {
    /**
     ...
     * 
     */
    public static Set_reference_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_reference_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_reference_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Set_reference_upper.Match> getAllMatches(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public Set_reference_upper.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Set_reference_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pUpper, final IMatchProcessor<? super Set_reference_upper.Match> processor) {
     ...
     * 
     */
    public Set_reference_upper.Match newMatch(final TraceLink pReference, final Integer pUpper) {
      return Set_reference_upper.Match.newMatch(pReference, pUpper);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Set_reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Set_reference_upper.Match partialMatch) {
    ...
    @Override
    protected Set_reference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Set_reference_upper.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_UPPER));
    ...
    @Override
    protected Set_reference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Set_reference_upper.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_reference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_reference_upper.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_reference_upper.Matcher> querySpecification() {
      return Set_reference_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_reference_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_reference_upper.Match> {
    /**
    ...
    @Override
    public void process(final Set_reference_upper.Match match) {
      process(match.getReference(), match.getUpper());
    }
  }
  
  private Set_reference_upper() {
   ...
   * 
   */
  public static Set_reference_upper instance() {
    try{
  ...
  @Override
  protected Set_reference_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_reference_upper.Matcher.on(engine);
  }
  
  @Override
  public Set_reference_upper.Matcher instantiate() {
    return Set_reference_upper.Matcher.create();
  }
  
  @Override
  public Set_reference_upper.Match newEmptyMatch() {
    return Set_reference_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Set_reference_upper.Match newMatch(final Object... parameters) {
    return Set_reference_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_upper (visibility: PUBLIC, simpleName: Set_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_upper (visibility: PUBLIC, simpleName: Set_reference_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_reference_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_reference_upper INSTANCE = new Set_reference_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_reference_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_reference_upper (reference, _initial_reference, upper)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_reference, var__initial_reference, var_upper), Initial_reference_upper.instance().getInternalQueryRepresentation());
          // 	find current_reference_upper (reference, _current_reference, upper)
