...
public final class Get_package_enumeration extends BaseGeneratedEMFQuerySpecification<Get_package_enumeration.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_enumeration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_enumeration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_package_enumeration.Match.parameterNames;
    }
    ...
    @Override
    public Get_package_enumeration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_package_enumeration.Match)) {
          Get_package_enumeration.Match other = (Get_package_enumeration.Match) obj;
    ...
    @Override
    public Get_package_enumeration specification() {
     ...
     * 
     */
    public static Get_package_enumeration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_package_enumeration.Match newMutableMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public static Get_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
      return new Immutable(pPackage, pEnumeration);
    }
    
    private static final class Mutable extends Get_package_enumeration.Match {
    ...
    private static final class Immutable extends Get_package_enumeration.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_enumeration pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_package_enumeration
   * 
   */
  public static class Matcher extends BaseMatcher<Get_package_enumeration.Match> {
    /**
     ...
     * 
     */
    public static Get_package_enumeration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_package_enumeration.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_package_enumeration.Matcher.class);
     ...
     * 
     */
    public Collection<Get_package_enumeration.Match> getAllMatches(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public Get_package_enumeration.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super Get_package_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pEnumeration, final IMatchProcessor<? super Get_package_enumeration.Match> processor) {
     ...
     * 
     */
    public Get_package_enumeration.Match newMatch(final TraceLink pPackage, final TraceLink pEnumeration) {
      return Get_package_enumeration.Match.newMatch(pPackage, pEnumeration);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_package_enumeration.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final Get_package_enumeration.Match partialMatch) {
    ...
    @Override
    protected Get_package_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return Get_package_enumeration.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_ENUMERATION));
    ...
    @Override
    protected Get_package_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return Get_package_enumeration.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_package_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_package_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_package_enumeration.Matcher> querySpecification() {
      return Get_package_enumeration.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_enumeration pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_package_enumeration.Match> {
    /**
    ...
    @Override
    public void process(final Get_package_enumeration.Match match) {
      process(match.getPackage(), match.getEnumeration());
    }
  }
  
  private Get_package_enumeration() {
   ...
   * 
   */
  public static Get_package_enumeration instance() {
    try{
  ...
  @Override
  protected Get_package_enumeration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_package_enumeration.Matcher.on(engine);
  }
  
  @Override
  public Get_package_enumeration.Matcher instantiate() {
    return Get_package_enumeration.Matcher.create();
  }
  
  @Override
  public Get_package_enumeration.Match newEmptyMatch() {
    return Get_package_enumeration.Match.newEmptyMatch();
  }
  
  @Override
  public Get_package_enumeration.Match newMatch(final Object... parameters) {
    return Get_package_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_enumeration (visibility: PUBLIC, simpleName: Get_package_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_enumeration (visibility: PUBLIC, simpleName: Get_package_enumeration, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_enumeration, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_package_enumeration INSTANCE = new Get_package_enumeration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_package_enumeration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
