...
public final class Preserved_structuralFeature_name extends BaseGeneratedEMFQuerySpecification<Preserved_structuralFeature_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_structuralFeature_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_structuralFeature_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_structuralFeature_name.Match)) {
          Preserved_structuralFeature_name.Match other = (Preserved_structuralFeature_name.Match) obj;
    ...
    @Override
    public Preserved_structuralFeature_name specification() {
     ...
     * 
     */
    public static Preserved_structuralFeature_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_structuralFeature_name.Match newMutableMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_structuralFeature_name.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_structuralFeature_name.Match {
    ...
    private static final class Immutable extends Preserved_structuralFeature_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_name pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // structuralFeature - name - preserved
   * pattern preserved_structuralFeature_name (initial_structuralFeature : StructuralFeature, current_structuralFeature : StructuralFeature, initial_name : java String, current_name : java String) {
   * 	find preserved_modelElement_name (initial_structuralFeature, current_structuralFeature, initial_name, current_name); 
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see Preserved_structuralFeature_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_structuralFeature_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_structuralFeature_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_structuralFeature_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_structuralFeature_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_structuralFeature_name.Match> getAllMatches(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_structuralFeature_name.Match getOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_structuralFeature_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_structuralFeature_name.Match> processor) {
     ...
     * 
     */
    public Preserved_structuralFeature_name.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final String pInitial_name, final String pCurrent_name) {
      return Preserved_structuralFeature_name.Match.newMatch(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfinitial_structuralFeature(final Preserved_structuralFeature_name.Match partialMatch) {
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfcurrent_structuralFeature(final Preserved_structuralFeature_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_structuralFeature_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_structuralFeature_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_structuralFeature_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_structuralFeature_name.Match.newMatch((StructuralFeature) t.get(POSITION_INITIAL_STRUCTURALFEATURE), (StructuralFeature) t.get(POSITION_CURRENT_STRUCTURALFEATURE), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_structuralFeature_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_structuralFeature_name.Match.newMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_structuralFeature_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_structuralFeature_name.Match.newMutableMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_structuralFeature_name.Matcher> querySpecification() {
      return Preserved_structuralFeature_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_structuralFeature_name.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_structuralFeature_name.Match match) {
  ...
  private Preserved_structuralFeature_name() {
   ...
   * 
   */
  public static Preserved_structuralFeature_name instance() {
    try{
  ...
  @Override
  protected Preserved_structuralFeature_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_structuralFeature_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_structuralFeature_name.Matcher instantiate() {
    return Preserved_structuralFeature_name.Matcher.create();
  }
  
  @Override
  public Preserved_structuralFeature_name.Match newEmptyMatch() {
    return Preserved_structuralFeature_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_structuralFeature_name.Match newMatch(final Object... parameters) {
    return Preserved_structuralFeature_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.StructuralFeature) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_name (visibility: PUBLIC, simpleName: Preserved_structuralFeature_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_name (visibility: PUBLIC, simpleName: Preserved_structuralFeature_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_structuralFeature_name INSTANCE = new Preserved_structuralFeature_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_structuralFeature_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_modelElement_name (initial_structuralFeature, current_structuralFeature, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_structuralFeature, var_current_structuralFeature, var_initial_name, var_current_name), Preserved_modelElement_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
