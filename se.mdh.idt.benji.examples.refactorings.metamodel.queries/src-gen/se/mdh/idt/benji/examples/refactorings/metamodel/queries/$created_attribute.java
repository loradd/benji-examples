...
public final class $created_attribute extends BaseGeneratedEMFQuerySpecification<$created_attribute.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_attribute.Match newMutableMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public static $created_attribute.Match newMatch(final TraceLink pAttribute) {
  ...
  public static class Matcher extends BaseMatcher<$created_attribute.Match> {
     ...
     * 
     */
    public Collection<$created_attribute.Match> getAllMatches(final TraceLink pAttribute) {
     ...
     * 
     */
    public $created_attribute.Match getOneArbitraryMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final IMatchProcessor<? super $created_attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final IMatchProcessor<? super $created_attribute.Match> processor) {
     ...
     * 
     */
    public $created_attribute.Match newMatch(final TraceLink pAttribute) {
    ...
    protected $created_attribute.Match tupleToMatch(final Tuple t) {
      try {
          return $created_attribute.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    protected $created_attribute.Match arrayToMatch(final Object[] match) {
      try {
          return $created_attribute.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected $created_attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_attribute.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_attribute.Match newMatch(final Object... parameters) {
    return $created_attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
