...
public final class $created_datatype extends BaseGeneratedEMFQuerySpecification<$created_datatype.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $created_datatype.Match newMutableMatch(final TraceLink pDatatype) {
     ...
     * 
     */
    public static $created_datatype.Match newMatch(final TraceLink pDatatype) {
  ...
  public static class Matcher extends BaseMatcher<$created_datatype.Match> {
     ...
     * 
     */
    public Collection<$created_datatype.Match> getAllMatches(final TraceLink pDatatype) {
     ...
     * 
     */
    public $created_datatype.Match getOneArbitraryMatch(final TraceLink pDatatype) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pDatatype, final IMatchProcessor<? super $created_datatype.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pDatatype, final IMatchProcessor<? super $created_datatype.Match> processor) {
     ...
     * 
     */
    public $created_datatype.Match newMatch(final TraceLink pDatatype) {
    ...
    protected $created_datatype.Match tupleToMatch(final Tuple t) {
      try {
          return $created_datatype.Match.newMatch((TraceLink) t.get(POSITION_DATATYPE));
    ...
    protected $created_datatype.Match arrayToMatch(final Object[] match) {
      try {
          return $created_datatype.Match.newMatch((TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
    ...
    protected $created_datatype.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $created_datatype.Match.newMutableMatch((TraceLink) match[POSITION_DATATYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $created_datatype.Match newMatch(final Object... parameters) {
    return $created_datatype.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
