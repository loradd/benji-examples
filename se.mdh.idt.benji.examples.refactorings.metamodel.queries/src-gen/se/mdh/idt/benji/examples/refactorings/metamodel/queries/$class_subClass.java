...
public final class $class_subClass extends BaseGeneratedEMFQuerySpecification<$class_subClass.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $class_subClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public static $class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
  ...
  public static class Matcher extends BaseMatcher<$class_subClass.Match> {
     ...
     * 
     */
    public Collection<$class_subClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public $class_subClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $class_subClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSubClass, final IMatchProcessor<? super $class_subClass.Match> processor) {
     ...
     * 
     */
    public $class_subClass.Match newMatch(final TraceLink pClass, final TraceLink pSubClass) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsubClass(final $class_subClass.Match partialMatch) {
    ...
    protected $class_subClass.Match tupleToMatch(final Tuple t) {
      try {
          return $class_subClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUBCLASS));
    ...
    protected $class_subClass.Match arrayToMatch(final Object[] match) {
      try {
          return $class_subClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
    ...
    protected $class_subClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $class_subClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUBCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $class_subClass.Match newMatch(final Object... parameters) {
    return $class_subClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
