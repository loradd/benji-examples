...
public final class Get_enumeration_enumerationLiteral extends BaseGeneratedEMFQuerySpecification<Get_enumeration_enumerationLiteral.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_enumeration_enumerationLiteral pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_enumeration_enumerationLiteral";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_enumeration_enumerationLiteral.Match.parameterNames;
    }
    ...
    @Override
    public Get_enumeration_enumerationLiteral.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_enumeration_enumerationLiteral.Match)) {
          Get_enumeration_enumerationLiteral.Match other = (Get_enumeration_enumerationLiteral.Match) obj;
    ...
    @Override
    public Get_enumeration_enumerationLiteral specification() {
     ...
     * 
     */
    public static Get_enumeration_enumerationLiteral.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_enumeration_enumerationLiteral.Match newMutableMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public static Get_enumeration_enumerationLiteral.Match newMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
      return new Immutable(pEnumeration, pEnumerationLiteral);
    }
    
    private static final class Mutable extends Get_enumeration_enumerationLiteral.Match {
    ...
    private static final class Immutable extends Get_enumeration_enumerationLiteral.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_enumeration_enumerationLiteral pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_enumeration_enumerationLiteral
   * 
   */
  public static class Matcher extends BaseMatcher<Get_enumeration_enumerationLiteral.Match> {
    /**
     ...
     * 
     */
    public static Get_enumeration_enumerationLiteral.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_enumeration_enumerationLiteral.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_enumeration_enumerationLiteral.Matcher.class);
     ...
     * 
     */
    public Collection<Get_enumeration_enumerationLiteral.Match> getAllMatches(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public Get_enumeration_enumerationLiteral.Match getOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral, final IMatchProcessor<? super Get_enumeration_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral, final IMatchProcessor<? super Get_enumeration_enumerationLiteral.Match> processor) {
     ...
     * 
     */
    public Get_enumeration_enumerationLiteral.Match newMatch(final TraceLink pEnumeration, final TraceLink pEnumerationLiteral) {
      return Get_enumeration_enumerationLiteral.Match.newMatch(pEnumeration, pEnumerationLiteral);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumeration(final Get_enumeration_enumerationLiteral.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfenumerationLiteral(final Get_enumeration_enumerationLiteral.Match partialMatch) {
    ...
    @Override
    protected Get_enumeration_enumerationLiteral.Match tupleToMatch(final Tuple t) {
      try {
          return Get_enumeration_enumerationLiteral.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATION), (TraceLink) t.get(POSITION_ENUMERATIONLITERAL));
    ...
    @Override
    protected Get_enumeration_enumerationLiteral.Match arrayToMatch(final Object[] match) {
      try {
          return Get_enumeration_enumerationLiteral.Match.newMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_enumeration_enumerationLiteral.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_enumeration_enumerationLiteral.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATION], (TraceLink) match[POSITION_ENUMERATIONLITERAL]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_enumeration_enumerationLiteral.Matcher> querySpecification() {
      return Get_enumeration_enumerationLiteral.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_enumeration_enumerationLiteral pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_enumeration_enumerationLiteral.Match> {
    /**
    ...
    @Override
    public void process(final Get_enumeration_enumerationLiteral.Match match) {
      process(match.getEnumeration(), match.getEnumerationLiteral());
    }
  }
  
  private Get_enumeration_enumerationLiteral() {
   ...
   * 
   */
  public static Get_enumeration_enumerationLiteral instance() {
    try{
  ...
  @Override
  protected Get_enumeration_enumerationLiteral.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_enumeration_enumerationLiteral.Matcher.on(engine);
  }
  
  @Override
  public Get_enumeration_enumerationLiteral.Matcher instantiate() {
    return Get_enumeration_enumerationLiteral.Matcher.create();
  }
  
  @Override
  public Get_enumeration_enumerationLiteral.Match newEmptyMatch() {
    return Get_enumeration_enumerationLiteral.Match.newEmptyMatch();
  }
  
  @Override
  public Get_enumeration_enumerationLiteral.Match newMatch(final Object... parameters) {
    return Get_enumeration_enumerationLiteral.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_enumeration_enumerationLiteral (visibility: PUBLIC, simpleName: Get_enumeration_enumerationLiteral, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_enumeration_enumerationLiteral, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_enumeration_enumerationLiteral (visibility: PUBLIC, simpleName: Get_enumeration_enumerationLiteral, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_enumeration_enumerationLiteral, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_enumeration_enumerationLiteral INSTANCE = new Get_enumeration_enumerationLiteral();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_enumeration_enumerationLiteral.GeneratedPQuery INSTANCE = new GeneratedPQuery();
