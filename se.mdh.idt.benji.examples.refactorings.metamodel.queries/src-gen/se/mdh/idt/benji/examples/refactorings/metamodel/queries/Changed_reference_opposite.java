...
public final class Changed_reference_opposite extends BaseGeneratedEMFQuerySpecification<Changed_reference_opposite.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_opposite pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_opposite";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_reference_opposite.Match.parameterNames;
    }
    ...
    @Override
    public Changed_reference_opposite.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_reference_opposite.Match)) {
          Changed_reference_opposite.Match other = (Changed_reference_opposite.Match) obj;
    ...
    @Override
    public Changed_reference_opposite specification() {
     ...
     * 
     */
    public static Changed_reference_opposite.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_reference_opposite.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite) {
     ...
     * 
     */
    public static Changed_reference_opposite.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite) {
      return new Immutable(pInitial_reference, pCurrent_reference, pInitial_opposite, pCurrent_opposite);
    }
    
    private static final class Mutable extends Changed_reference_opposite.Match {
    ...
    private static final class Immutable extends Changed_reference_opposite.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_opposite pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_reference_opposite
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_reference_opposite.Match> {
    /**
     ...
     * 
     */
    public static Changed_reference_opposite.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_reference_opposite.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_reference_opposite.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_reference_opposite.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite) {
     ...
     * 
     */
    public Changed_reference_opposite.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite, final IMatchProcessor<? super Changed_reference_opposite.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite, final IMatchProcessor<? super Changed_reference_opposite.Match> processor) {
     ...
     * 
     */
    public Changed_reference_opposite.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final Reference pInitial_opposite, final Reference pCurrent_opposite) {
      return Changed_reference_opposite.Match.newMatch(pInitial_reference, pCurrent_reference, pInitial_opposite, pCurrent_opposite);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Changed_reference_opposite.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Changed_reference_opposite.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_opposite(final Changed_reference_opposite.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_opposite(final Changed_reference_opposite.Match partialMatch) {
    ...
    @Override
    protected Changed_reference_opposite.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_reference_opposite.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE), (Reference) t.get(POSITION_INITIAL_OPPOSITE), (Reference) t.get(POSITION_CURRENT_OPPOSITE));
    ...
    @Override
    protected Changed_reference_opposite.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_reference_opposite.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Reference) match[POSITION_INITIAL_OPPOSITE], (Reference) match[POSITION_CURRENT_OPPOSITE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_reference_opposite.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_reference_opposite.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE], (Reference) match[POSITION_INITIAL_OPPOSITE], (Reference) match[POSITION_CURRENT_OPPOSITE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_reference_opposite.Matcher> querySpecification() {
      return Changed_reference_opposite.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_reference_opposite pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_reference_opposite.Match> {
    /**
   ...
   * 
   */
  public static Changed_reference_opposite instance() {
    try{
  ...
  @Override
  protected Changed_reference_opposite.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_reference_opposite.Matcher.on(engine);
  }
  
  @Override
  public Changed_reference_opposite.Matcher instantiate() {
    return Changed_reference_opposite.Matcher.create();
  }
  
  @Override
  public Changed_reference_opposite.Match newEmptyMatch() {
    return Changed_reference_opposite.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_reference_opposite.Match newMatch(final Object... parameters) {
    return Changed_reference_opposite.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_opposite (visibility: PUBLIC, simpleName: Changed_reference_opposite, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_opposite, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_opposite (visibility: PUBLIC, simpleName: Changed_reference_opposite, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_reference_opposite, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_reference_opposite INSTANCE = new Changed_reference_opposite();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_reference_opposite.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	neg find reference_opposite (current_reference, current_opposite)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_current_reference, var_current_opposite), Reference_opposite.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
