...
public final class Get_class_reference extends BaseGeneratedEMFQuerySpecification<Get_class_reference.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_reference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_reference";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_class_reference.Match.parameterNames;
    }
    ...
    @Override
    public Get_class_reference.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_class_reference.Match)) {
          Get_class_reference.Match other = (Get_class_reference.Match) obj;
    ...
    @Override
    public Get_class_reference specification() {
     ...
     * 
     */
    public static Get_class_reference.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_class_reference.Match newMutableMatch(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public static Get_class_reference.Match newMatch(final TraceLink pClass, final TraceLink pReference) {
      return new Immutable(pClass, pReference);
    }
    
    private static final class Mutable extends Get_class_reference.Match {
    ...
    private static final class Immutable extends Get_class_reference.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_reference pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_class_reference
   * 
   */
  public static class Matcher extends BaseMatcher<Get_class_reference.Match> {
    /**
     ...
     * 
     */
    public static Get_class_reference.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_class_reference.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_class_reference.Matcher.class);
     ...
     * 
     */
    public Collection<Get_class_reference.Match> getAllMatches(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public Get_class_reference.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pReference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pReference, final IMatchProcessor<? super Get_class_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pReference, final IMatchProcessor<? super Get_class_reference.Match> processor) {
     ...
     * 
     */
    public Get_class_reference.Match newMatch(final TraceLink pClass, final TraceLink pReference) {
      return Get_class_reference.Match.newMatch(pClass, pReference);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_class_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_class_reference.Match partialMatch) {
    ...
    @Override
    protected Get_class_reference.Match tupleToMatch(final Tuple t) {
      try {
          return Get_class_reference.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_REFERENCE));
    ...
    @Override
    protected Get_class_reference.Match arrayToMatch(final Object[] match) {
      try {
          return Get_class_reference.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_class_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_class_reference.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_class_reference.Matcher> querySpecification() {
      return Get_class_reference.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_reference pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_class_reference.Match> {
    /**
    ...
    @Override
    public void process(final Get_class_reference.Match match) {
      process(match.getValueOfClass(), match.getReference());
    }
  }
  
  private Get_class_reference() {
   ...
   * 
   */
  public static Get_class_reference instance() {
    try{
  ...
  @Override
  protected Get_class_reference.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_class_reference.Matcher.on(engine);
  }
  
  @Override
  public Get_class_reference.Matcher instantiate() {
    return Get_class_reference.Matcher.create();
  }
  
  @Override
  public Get_class_reference.Match newEmptyMatch() {
    return Get_class_reference.Match.newEmptyMatch();
  }
  
  @Override
  public Get_class_reference.Match newMatch(final Object... parameters) {
    return Get_class_reference.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_reference (visibility: PUBLIC, simpleName: Get_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_reference (visibility: PUBLIC, simpleName: Get_class_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_class_reference INSTANCE = new Get_class_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_class_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
