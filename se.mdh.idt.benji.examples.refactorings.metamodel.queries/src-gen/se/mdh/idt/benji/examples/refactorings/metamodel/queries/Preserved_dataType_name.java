...
public final class Preserved_dataType_name extends BaseGeneratedEMFQuerySpecification<Preserved_dataType_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_dataType_name.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_dataType_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_dataType_name.Match)) {
          Preserved_dataType_name.Match other = (Preserved_dataType_name.Match) obj;
    ...
    @Override
    public Preserved_dataType_name specification() {
     ...
     * 
     */
    public static Preserved_dataType_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_dataType_name.Match newMutableMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Preserved_dataType_name.Match newMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_dataType, pCurrent_dataType, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Preserved_dataType_name.Match {
    ...
    private static final class Immutable extends Preserved_dataType_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_name pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // dataType - name - preserved
   * pattern preserved_dataType_name (initial_dataType : DataType, current_dataType : DataType, initial_name : java String, current_name : java String) {
   * 	find preserved_classifier_name (initial_dataType, current_dataType, initial_name, current_name); 	
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see Preserved_dataType_name
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_dataType_name.Match> {
    /**
     ...
     * 
     */
    public static Preserved_dataType_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_dataType_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_dataType_name.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_dataType_name.Match> getAllMatches(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Preserved_dataType_name.Match getOneArbitraryMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_dataType_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Preserved_dataType_name.Match> processor) {
     ...
     * 
     */
    public Preserved_dataType_name.Match newMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final String pInitial_name, final String pCurrent_name) {
      return Preserved_dataType_name.Match.newMatch(pInitial_dataType, pCurrent_dataType, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_dataType(final Preserved_dataType_name.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfcurrent_dataType(final Preserved_dataType_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Preserved_dataType_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Preserved_dataType_name.Match partialMatch) {
    ...
    @Override
    protected Preserved_dataType_name.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_dataType_name.Match.newMatch((DataType) t.get(POSITION_INITIAL_DATATYPE), (DataType) t.get(POSITION_CURRENT_DATATYPE), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Preserved_dataType_name.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_dataType_name.Match.newMatch((DataType) match[POSITION_INITIAL_DATATYPE], (DataType) match[POSITION_CURRENT_DATATYPE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_dataType_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_dataType_name.Match.newMutableMatch((DataType) match[POSITION_INITIAL_DATATYPE], (DataType) match[POSITION_CURRENT_DATATYPE], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_dataType_name.Matcher> querySpecification() {
      return Preserved_dataType_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_dataType_name.Match> {
    /**
   ...
   * 
   */
  public static Preserved_dataType_name instance() {
    try{
  ...
  @Override
  protected Preserved_dataType_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_dataType_name.Matcher.on(engine);
  }
  
  @Override
  public Preserved_dataType_name.Matcher instantiate() {
    return Preserved_dataType_name.Matcher.create();
  }
  
  @Override
  public Preserved_dataType_name.Match newEmptyMatch() {
    return Preserved_dataType_name.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_dataType_name.Match newMatch(final Object... parameters) {
    return Preserved_dataType_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.DataType) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.DataType) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_name (visibility: PUBLIC, simpleName: Preserved_dataType_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_name (visibility: PUBLIC, simpleName: Preserved_dataType_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_dataType_name INSTANCE = new Preserved_dataType_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_dataType_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_classifier_name (initial_dataType, current_dataType, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_dataType, var_current_dataType, var_initial_name, var_current_name), Preserved_classifier_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
