...
public final class Get_structuralFeature_lower extends BaseGeneratedEMFQuerySpecification<Get_structuralFeature_lower.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_lower";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_structuralFeature_lower.Match.parameterNames;
    }
    ...
    @Override
    public Get_structuralFeature_lower.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_structuralFeature_lower.Match)) {
          Get_structuralFeature_lower.Match other = (Get_structuralFeature_lower.Match) obj;
    ...
    @Override
    public Get_structuralFeature_lower specification() {
     ...
     * 
     */
    public static Get_structuralFeature_lower.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_structuralFeature_lower.Match newMutableMatch(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public static Get_structuralFeature_lower.Match newMatch(final TraceLink pStructuralFeature, final Integer pLower) {
      return new Immutable(pStructuralFeature, pLower);
    }
    
    private static final class Mutable extends Get_structuralFeature_lower.Match {
    ...
    private static final class Immutable extends Get_structuralFeature_lower.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_lower pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_structuralFeature_lower
   * 
   */
  public static class Matcher extends BaseMatcher<Get_structuralFeature_lower.Match> {
    /**
     ...
     * 
     */
    public static Get_structuralFeature_lower.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_structuralFeature_lower.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_structuralFeature_lower.Matcher.class);
     ...
     * 
     */
    public Collection<Get_structuralFeature_lower.Match> getAllMatches(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public Get_structuralFeature_lower.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final Integer pLower, final IMatchProcessor<? super Get_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final Integer pLower, final IMatchProcessor<? super Get_structuralFeature_lower.Match> processor) {
     ...
     * 
     */
    public Get_structuralFeature_lower.Match newMatch(final TraceLink pStructuralFeature, final Integer pLower) {
      return Get_structuralFeature_lower.Match.newMatch(pStructuralFeature, pLower);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Get_structuralFeature_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOflower(final Get_structuralFeature_lower.Match partialMatch) {
    ...
    @Override
    protected Get_structuralFeature_lower.Match tupleToMatch(final Tuple t) {
      try {
          return Get_structuralFeature_lower.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (Integer) t.get(POSITION_LOWER));
    ...
    @Override
    protected Get_structuralFeature_lower.Match arrayToMatch(final Object[] match) {
      try {
          return Get_structuralFeature_lower.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_structuralFeature_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_structuralFeature_lower.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_structuralFeature_lower.Matcher> querySpecification() {
      return Get_structuralFeature_lower.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_lower pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_structuralFeature_lower.Match> {
    /**
    ...
    @Override
    public void process(final Get_structuralFeature_lower.Match match) {
      process(match.getStructuralFeature(), match.getLower());
    }
  }
  
  private Get_structuralFeature_lower() {
   ...
   * 
   */
  public static Get_structuralFeature_lower instance() {
    try{
  ...
  @Override
  protected Get_structuralFeature_lower.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_structuralFeature_lower.Matcher.on(engine);
  }
  
  @Override
  public Get_structuralFeature_lower.Matcher instantiate() {
    return Get_structuralFeature_lower.Matcher.create();
  }
  
  @Override
  public Get_structuralFeature_lower.Match newEmptyMatch() {
    return Get_structuralFeature_lower.Match.newEmptyMatch();
  }
  
  @Override
  public Get_structuralFeature_lower.Match newMatch(final Object... parameters) {
    return Get_structuralFeature_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_lower (visibility: PUBLIC, simpleName: Get_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_lower (visibility: PUBLIC, simpleName: Get_structuralFeature_lower, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_structuralFeature_lower INSTANCE = new Get_structuralFeature_lower();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_structuralFeature_lower.GeneratedPQuery INSTANCE = new GeneratedPQuery();
