...
public final class Changed_enumerationLiteral_name extends BaseGeneratedEMFQuerySpecification<Changed_enumerationLiteral_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumerationLiteral_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumerationLiteral_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_enumerationLiteral_name.Match.parameterNames;
    }
    ...
    @Override
    public Changed_enumerationLiteral_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_enumerationLiteral_name.Match)) {
          Changed_enumerationLiteral_name.Match other = (Changed_enumerationLiteral_name.Match) obj;
    ...
    @Override
    public Changed_enumerationLiteral_name specification() {
     ...
     * 
     */
    public static Changed_enumerationLiteral_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_enumerationLiteral_name.Match newMutableMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Changed_enumerationLiteral_name.Match newMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_literal, pCurrent_literal, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Changed_enumerationLiteral_name.Match {
    ...
    private static final class Immutable extends Changed_enumerationLiteral_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumerationLiteral_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_enumerationLiteral_name
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_enumerationLiteral_name.Match> {
    /**
     ...
     * 
     */
    public static Changed_enumerationLiteral_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_enumerationLiteral_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_enumerationLiteral_name.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_enumerationLiteral_name.Match> getAllMatches(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Changed_enumerationLiteral_name.Match getOneArbitraryMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_enumerationLiteral_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_enumerationLiteral_name.Match> processor) {
     ...
     * 
     */
    public Changed_enumerationLiteral_name.Match newMatch(final EnumerationLiteral pInitial_literal, final EnumerationLiteral pCurrent_literal, final String pInitial_name, final String pCurrent_name) {
      return Changed_enumerationLiteral_name.Match.newMatch(pInitial_literal, pCurrent_literal, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<EnumerationLiteral> getAllValuesOfinitial_literal(final Changed_enumerationLiteral_name.Match partialMatch) {
     ...
     * 
     */
    public Set<EnumerationLiteral> getAllValuesOfcurrent_literal(final Changed_enumerationLiteral_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Changed_enumerationLiteral_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Changed_enumerationLiteral_name.Match partialMatch) {
    ...
    @Override
    protected Changed_enumerationLiteral_name.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_enumerationLiteral_name.Match.newMatch((EnumerationLiteral) t.get(POSITION_INITIAL_LITERAL), (EnumerationLiteral) t.get(POSITION_CURRENT_LITERAL), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Changed_enumerationLiteral_name.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_enumerationLiteral_name.Match.newMatch((EnumerationLiteral) match[POSITION_INITIAL_LITERAL], (EnumerationLiteral) match[POSITION_CURRENT_LITERAL], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_enumerationLiteral_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_enumerationLiteral_name.Match.newMutableMatch((EnumerationLiteral) match[POSITION_INITIAL_LITERAL], (EnumerationLiteral) match[POSITION_CURRENT_LITERAL], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_enumerationLiteral_name.Matcher> querySpecification() {
      return Changed_enumerationLiteral_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_enumerationLiteral_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_enumerationLiteral_name.Match> {
    /**
    ...
    @Override
    public void process(final Changed_enumerationLiteral_name.Match match) {
      process(match.getInitial_literal(), match.getCurrent_literal(), match.getInitial_name(), match.getCurrent_name());
    }
  }
  
  private Changed_enumerationLiteral_name() {
   ...
   * 
   */
  public static Changed_enumerationLiteral_name instance() {
    try{
  ...
  @Override
  protected Changed_enumerationLiteral_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_enumerationLiteral_name.Matcher.on(engine);
  }
  
  @Override
  public Changed_enumerationLiteral_name.Matcher instantiate() {
    return Changed_enumerationLiteral_name.Matcher.create();
  }
  
  @Override
  public Changed_enumerationLiteral_name.Match newEmptyMatch() {
    return Changed_enumerationLiteral_name.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_enumerationLiteral_name.Match newMatch(final Object... parameters) {
    return Changed_enumerationLiteral_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.EnumerationLiteral) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.EnumerationLiteral) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumerationLiteral_name (visibility: PUBLIC, simpleName: Changed_enumerationLiteral_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumerationLiteral_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumerationLiteral_name (visibility: PUBLIC, simpleName: Changed_enumerationLiteral_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_enumerationLiteral_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_enumerationLiteral_name INSTANCE = new Changed_enumerationLiteral_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_enumerationLiteral_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_modelElement_name (initial_literal, current_literal, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_literal, var_current_literal, var_initial_name, var_current_name), Changed_modelElement_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
