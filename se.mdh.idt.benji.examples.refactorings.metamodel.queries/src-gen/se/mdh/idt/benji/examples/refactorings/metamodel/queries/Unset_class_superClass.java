...
public final class Unset_class_superClass extends BaseGeneratedEMFQuerySpecification<Unset_class_superClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_class_superClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_class_superClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unset_class_superClass.Match.parameterNames;
    }
    ...
    @Override
    public Unset_class_superClass.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unset_class_superClass.Match)) {
          Unset_class_superClass.Match other = (Unset_class_superClass.Match) obj;
    ...
    @Override
    public Unset_class_superClass specification() {
     ...
     * 
     */
    public static Unset_class_superClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unset_class_superClass.Match newMutableMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public static Unset_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return new Immutable(pClass, pSuperClass);
    }
    
    private static final class Mutable extends Unset_class_superClass.Match {
    ...
    private static final class Immutable extends Unset_class_superClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_class_superClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Unset_class_superClass
   * 
   */
  public static class Matcher extends BaseMatcher<Unset_class_superClass.Match> {
    /**
     ...
     * 
     */
    public static Unset_class_superClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unset_class_superClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unset_class_superClass.Matcher.class);
     ...
     * 
     */
    public Collection<Unset_class_superClass.Match> getAllMatches(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public Unset_class_superClass.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super Unset_class_superClass.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pSuperClass, final IMatchProcessor<? super Unset_class_superClass.Match> processor) {
     ...
     * 
     */
    public Unset_class_superClass.Match newMatch(final TraceLink pClass, final TraceLink pSuperClass) {
      return Unset_class_superClass.Match.newMatch(pClass, pSuperClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Unset_class_superClass.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsuperClass(final Unset_class_superClass.Match partialMatch) {
    ...
    @Override
    protected Unset_class_superClass.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_class_superClass.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_SUPERCLASS));
    ...
    @Override
    protected Unset_class_superClass.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_class_superClass.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unset_class_superClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_class_superClass.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_SUPERCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unset_class_superClass.Matcher> querySpecification() {
      return Unset_class_superClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.unset_class_superClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Unset_class_superClass.Match> {
    /**
    ...
    @Override
    public void process(final Unset_class_superClass.Match match) {
      process(match.getValueOfClass(), match.getSuperClass());
    }
  }
  
  private Unset_class_superClass() {
   ...
   * 
   */
  public static Unset_class_superClass instance() {
    try{
  ...
  @Override
  protected Unset_class_superClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unset_class_superClass.Matcher.on(engine);
  }
  
  @Override
  public Unset_class_superClass.Matcher instantiate() {
    return Unset_class_superClass.Matcher.create();
  }
  
  @Override
  public Unset_class_superClass.Match newEmptyMatch() {
    return Unset_class_superClass.Match.newEmptyMatch();
  }
  
  @Override
  public Unset_class_superClass.Match newMatch(final Object... parameters) {
    return Unset_class_superClass.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_class_superClass (visibility: PUBLIC, simpleName: Unset_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_class_superClass (visibility: PUBLIC, simpleName: Unset_class_superClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Unset_class_superClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Unset_class_superClass INSTANCE = new Unset_class_superClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Unset_class_superClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_class_superClass (class, _current_class, superClass, _current_superClass)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__current_class, var_superClass, var__current_superClass), Current_class_superClass.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
