...
public final class Preserved_dataType_package extends BaseGeneratedEMFQuerySpecification<Preserved_dataType_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_dataType_package.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_dataType_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_dataType_package.Match)) {
          Preserved_dataType_package.Match other = (Preserved_dataType_package.Match) obj;
    ...
    @Override
    public Preserved_dataType_package specification() {
     ...
     * 
     */
    public static Preserved_dataType_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_dataType_package.Match newMutableMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public static Preserved_dataType_package.Match newMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return new Immutable(pInitial_dataType, pCurrent_dataType, pInitial_package, pCurrent_package);
    }
    
    private static final class Mutable extends Preserved_dataType_package.Match {
    ...
    private static final class Immutable extends Preserved_dataType_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_package pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // dataType - package - preserved
   * pattern preserved_dataType_package (initial_dataType : DataType, current_dataType : DataType, initial_package : Package, current_package : Package) {
   * 	find preserved_classifier_package (initial_dataType, current_dataType, initial_package, current_package); 
   * }
   * </pre></code>
   * 
   * @see Match
   *  @see Processor
   * @see Preserved_dataType_package
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_dataType_package.Match> {
    /**
     ...
     * 
     */
    public static Preserved_dataType_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_dataType_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_dataType_package.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_dataType_package.Match> getAllMatches(final DataType pInitial_dataType, final DataType pCurrent_dataType, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Preserved_dataType_package.Match getOneArbitraryMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
     ...
     * 
     */
    public Preserved_dataType_package.Match newMatch(final DataType pInitial_dataType, final DataType pCurrent_dataType, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package) {
      return Preserved_dataType_package.Match.newMatch(pInitial_dataType, pCurrent_dataType, pInitial_package, pCurrent_package);
    }
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_dataType(final Preserved_dataType_package.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfcurrent_dataType(final Preserved_dataType_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Preserved_dataType_package.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Preserved_dataType_package.Match partialMatch) {
    ...
    @Override
    protected Preserved_dataType_package.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Preserved_dataType_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_dataType_package.Match.newMutableMatch((DataType) match[POSITION_INITIAL_DATATYPE], (DataType) match[POSITION_CURRENT_DATATYPE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_dataType_package.Matcher> querySpecification() {
      return Preserved_dataType_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_dataType_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_dataType_package.Match> {
    /**
   ...
   * 
   */
  public static Preserved_dataType_package instance() {
    try{
  ...
  @Override
  protected Preserved_dataType_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_dataType_package.Matcher.on(engine);
  }
  
  @Override
  public Preserved_dataType_package.Matcher instantiate() {
    return Preserved_dataType_package.Matcher.create();
  }
  
  @Override
  public Preserved_dataType_package.Match newEmptyMatch() {
    return Preserved_dataType_package.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_dataType_package.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_package (visibility: PUBLIC, simpleName: Preserved_dataType_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_package (visibility: PUBLIC, simpleName: Preserved_dataType_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_dataType_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_dataType_package INSTANCE = new Preserved_dataType_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_dataType_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_classifier_package (initial_dataType, current_dataType, initial_package, current_package)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_dataType, var_current_dataType, var_initial_package, var_current_package), Preserved_classifier_package.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
