...
public final class Preserved_structuralFeature_owner extends BaseGeneratedEMFQuerySpecification<Preserved_structuralFeature_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_structuralFeature_owner.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_structuralFeature_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_structuralFeature_owner.Match)) {
          Preserved_structuralFeature_owner.Match other = (Preserved_structuralFeature_owner.Match) obj;
    ...
    @Override
    public Preserved_structuralFeature_owner specification() {
     ...
     * 
     */
    public static Preserved_structuralFeature_owner.Match newEmptyMatch() {
    ...
    private static final class Mutable extends Preserved_structuralFeature_owner.Match {
    ...
    private static final class Immutable extends Preserved_structuralFeature_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_owner pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // structuralFeature - owner - preserved
   * pattern preserved_structuralFeature_owner (initial_structuralFeature : StructuralFeature, current_structuralFeature : StructuralFeature, initial_owner : Class, current_owner : Class) {
   * 	find preserved_structuralFeature (initial_structuralFeature, current_structuralFeature); 
   * 	find preserved_class (initial_owner, current_owner); 
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_structuralFeature_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_structuralFeature_owner.Match> {
    /**
     ...
     * 
     */
    public static Preserved_structuralFeature_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_structuralFeature_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_structuralFeature_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_structuralFeature_owner.Match> getAllMatches(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
     ...
     * 
     */
    public Preserved_structuralFeature_owner.Match getOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
     ...
     * 
     */
    public void forEachMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner, final IMatchProcessor<? super Preserved_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner, final IMatchProcessor<? super Preserved_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public Preserved_structuralFeature_owner.Match newMatch(final StructuralFeature pInitial_structuralFeature, final StructuralFeature pCurrent_structuralFeature, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_owner, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_owner) {
      return Preserved_structuralFeature_owner.Match.newMatch(pInitial_structuralFeature, pCurrent_structuralFeature, pInitial_owner, pCurrent_owner);
    }
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfinitial_structuralFeature(final Preserved_structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<StructuralFeature> getAllValuesOfcurrent_structuralFeature(final Preserved_structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_owner(final Preserved_structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_owner(final Preserved_structuralFeature_owner.Match partialMatch) {
    ...
    @Override
    protected Preserved_structuralFeature_owner.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Preserved_structuralFeature_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_structuralFeature_owner.Match.newMutableMatch((StructuralFeature) match[POSITION_INITIAL_STRUCTURALFEATURE], (StructuralFeature) match[POSITION_CURRENT_STRUCTURALFEATURE], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_OWNER], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_structuralFeature_owner.Matcher> querySpecification() {
      return Preserved_structuralFeature_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_structuralFeature_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_structuralFeature_owner.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_structuralFeature_owner.Match match) {
  ...
  private Preserved_structuralFeature_owner() {
   ...
   * 
   */
  public static Preserved_structuralFeature_owner instance() {
    try{
  ...
  @Override
  protected Preserved_structuralFeature_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_structuralFeature_owner.Matcher.on(engine);
  }
  
  @Override
  public Preserved_structuralFeature_owner.Matcher instantiate() {
    return Preserved_structuralFeature_owner.Matcher.create();
  }
  
  @Override
  public Preserved_structuralFeature_owner.Match newEmptyMatch() {
    return Preserved_structuralFeature_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_structuralFeature_owner.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_owner (visibility: PUBLIC, simpleName: Preserved_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_owner (visibility: PUBLIC, simpleName: Preserved_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_structuralFeature_owner INSTANCE = new Preserved_structuralFeature_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_structuralFeature_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find preserved_class (initial_owner, current_owner)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_owner, var_current_owner), Preserved_class.instance().getInternalQueryRepresentation());
          //  	find structuralFeature_owner (initial_structuralFeature, initial_owner)
