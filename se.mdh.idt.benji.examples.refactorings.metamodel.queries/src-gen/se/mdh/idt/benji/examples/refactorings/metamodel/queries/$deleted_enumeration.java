...
public final class $deleted_enumeration extends BaseGeneratedEMFQuerySpecification<$deleted_enumeration.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_enumeration.Match newMutableMatch(final TraceLink pEnumeration) {
     ...
     * 
     */
    public static $deleted_enumeration.Match newMatch(final TraceLink pEnumeration) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_enumeration.Match> {
     ...
     * 
     */
    public Collection<$deleted_enumeration.Match> getAllMatches(final TraceLink pEnumeration) {
     ...
     * 
     */
    public $deleted_enumeration.Match getOneArbitraryMatch(final TraceLink pEnumeration) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pEnumeration, final IMatchProcessor<? super $deleted_enumeration.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pEnumeration, final IMatchProcessor<? super $deleted_enumeration.Match> processor) {
     ...
     * 
     */
    public $deleted_enumeration.Match newMatch(final TraceLink pEnumeration) {
      return $deleted_enumeration.Match.newMatch(pEnumeration);
    }
    ...
    protected $deleted_enumeration.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_enumeration.Match.newMatch((TraceLink) t.get(POSITION_ENUMERATION));
    ...
    protected $deleted_enumeration.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_enumeration.Match.newMatch((TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_enumeration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_enumeration.Match.newMutableMatch((TraceLink) match[POSITION_ENUMERATION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_enumeration.Match newMatch(final Object... parameters) {
    return $deleted_enumeration.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
