...
public final class Preserved_reference extends BaseGeneratedEMFQuerySpecification<Preserved_reference.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference";
    }
     ...
     * 
     */
    public static Preserved_reference.Match newMutableMatch(final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public static Preserved_reference.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference pattern,
  ...
  public static class Matcher extends BaseMatcher<Preserved_reference.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_reference.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_reference.Match> getAllMatches(final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public Preserved_reference.Match getOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference) {
     ...
     * 
     */
    public void forEachMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final IMatchProcessor<? super Preserved_reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pInitial_reference, final Reference pCurrent_reference, final IMatchProcessor<? super Preserved_reference.Match> processor) {
     ...
     * 
     */
    public Preserved_reference.Match newMatch(final Reference pInitial_reference, final Reference pCurrent_reference) {
      return Preserved_reference.Match.newMatch(pInitial_reference, pCurrent_reference);
    }
     ...
     * 
     */
    public Set<Reference> getAllValuesOfinitial_reference(final Preserved_reference.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfcurrent_reference(final Preserved_reference.Match partialMatch) {
    ...
    protected Preserved_reference.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_reference.Match.newMatch((Reference) t.get(POSITION_INITIAL_REFERENCE), (Reference) t.get(POSITION_CURRENT_REFERENCE));
    ...
    protected Preserved_reference.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_reference.Match.newMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected Preserved_reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_reference.Match.newMutableMatch((Reference) match[POSITION_INITIAL_REFERENCE], (Reference) match[POSITION_CURRENT_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_reference pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_reference.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_reference.Match match) {
  ...
  public Preserved_reference.Match newMatch(final Object... parameters) {
    return Preserved_reference.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference (visibility: PUBLIC, simpleName: Preserved_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference (visibility: PUBLIC, simpleName: Preserved_reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_reference INSTANCE = new Preserved_reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find preserved_structuralFeature (initial_reference, current_reference)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_reference, var_current_reference), Preserved_structuralFeature.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
