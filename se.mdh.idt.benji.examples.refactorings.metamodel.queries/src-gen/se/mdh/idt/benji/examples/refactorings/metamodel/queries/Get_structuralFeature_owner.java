...
public final class Get_structuralFeature_owner extends BaseGeneratedEMFQuerySpecification<Get_structuralFeature_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_structuralFeature_owner.Match.parameterNames;
    }
    ...
    @Override
    public Get_structuralFeature_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_structuralFeature_owner.Match)) {
          Get_structuralFeature_owner.Match other = (Get_structuralFeature_owner.Match) obj;
    ...
    @Override
    public Get_structuralFeature_owner specification() {
     ...
     * 
     */
    public static Get_structuralFeature_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_structuralFeature_owner.Match newMutableMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public static Get_structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
      return new Immutable(pStructuralFeature, pOwner);
    }
    
    private static final class Mutable extends Get_structuralFeature_owner.Match {
    ...
    private static final class Immutable extends Get_structuralFeature_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_structuralFeature_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Get_structuralFeature_owner.Match> {
    /**
     ...
     * 
     */
    public static Get_structuralFeature_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_structuralFeature_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_structuralFeature_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Get_structuralFeature_owner.Match> getAllMatches(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public Get_structuralFeature_owner.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super Get_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super Get_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public Get_structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
      return Get_structuralFeature_owner.Match.newMatch(pStructuralFeature, pOwner);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Get_structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final Get_structuralFeature_owner.Match partialMatch) {
    ...
    @Override
    protected Get_structuralFeature_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Get_structuralFeature_owner.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (TraceLink) t.get(POSITION_OWNER));
    ...
    @Override
    protected Get_structuralFeature_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Get_structuralFeature_owner.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_structuralFeature_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_structuralFeature_owner.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_structuralFeature_owner.Matcher> querySpecification() {
      return Get_structuralFeature_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_structuralFeature_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_structuralFeature_owner.Match> {
    /**
    ...
    @Override
    public void process(final Get_structuralFeature_owner.Match match) {
      process(match.getStructuralFeature(), match.getOwner());
    }
  }
  
  private Get_structuralFeature_owner() {
   ...
   * 
   */
  public static Get_structuralFeature_owner instance() {
    try{
  ...
  @Override
  protected Get_structuralFeature_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_structuralFeature_owner.Matcher.on(engine);
  }
  
  @Override
  public Get_structuralFeature_owner.Matcher instantiate() {
    return Get_structuralFeature_owner.Matcher.create();
  }
  
  @Override
  public Get_structuralFeature_owner.Match newEmptyMatch() {
    return Get_structuralFeature_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Get_structuralFeature_owner.Match newMatch(final Object... parameters) {
    return Get_structuralFeature_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_owner (visibility: PUBLIC, simpleName: Get_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_owner (visibility: PUBLIC, simpleName: Get_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_structuralFeature_owner INSTANCE = new Get_structuralFeature_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_structuralFeature_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
