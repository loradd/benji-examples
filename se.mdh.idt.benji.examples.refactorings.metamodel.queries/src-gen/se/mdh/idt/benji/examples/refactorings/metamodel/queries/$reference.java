...
public final class $reference extends BaseGeneratedEMFQuerySpecification<$reference.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference";
    }
     ...
     * 
     */
    public static $reference.Match newMutableMatch(final TraceLink pReference) {
     ...
     * 
     */
    public static $reference.Match newMatch(final TraceLink pReference) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference pattern,
  ...
  public static class Matcher extends BaseMatcher<$reference.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($reference.Matcher.class);
     ...
     * 
     */
    public Collection<$reference.Match> getAllMatches(final TraceLink pReference) {
     ...
     * 
     */
    public $reference.Match getOneArbitraryMatch(final TraceLink pReference) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final IMatchProcessor<? super $reference.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final IMatchProcessor<? super $reference.Match> processor) {
     ...
     * 
     */
    public $reference.Match newMatch(final TraceLink pReference) {
      return $reference.Match.newMatch(pReference);
    }
    ...
    protected $reference.Match tupleToMatch(final Tuple t) {
      try {
          return $reference.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE));
    ...
    protected $reference.Match arrayToMatch(final Object[] match) {
      try {
          return $reference.Match.newMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
    ...
    protected $reference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $reference.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$reference.Match> {
    /**
    ...
    @Override
    public void process(final $reference.Match match) {
  ...
  public $reference.Match newMatch(final Object... parameters) {
    return $reference.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference (visibility: PUBLIC, simpleName: $reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference (visibility: PUBLIC, simpleName: $reference, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$reference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $reference INSTANCE = new $reference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $reference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
