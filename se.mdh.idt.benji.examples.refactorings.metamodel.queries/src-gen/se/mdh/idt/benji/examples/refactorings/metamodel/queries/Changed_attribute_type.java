...
public final class Changed_attribute_type extends BaseGeneratedEMFQuerySpecification<Changed_attribute_type.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_attribute_type pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_attribute_type";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_attribute_type.Match.parameterNames;
    }
    ...
    @Override
    public Changed_attribute_type.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_attribute_type.Match)) {
          Changed_attribute_type.Match other = (Changed_attribute_type.Match) obj;
    ...
    @Override
    public Changed_attribute_type specification() {
     ...
     * 
     */
    public static Changed_attribute_type.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_attribute_type.Match newMutableMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type) {
     ...
     * 
     */
    public static Changed_attribute_type.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type) {
      return new Immutable(pInitial_attribute, pCurrent_attribute, pInitial_type, pCurrent_type);
    }
    
    private static final class Mutable extends Changed_attribute_type.Match {
    ...
    private static final class Immutable extends Changed_attribute_type.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_attribute_type pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_attribute_type
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_attribute_type.Match> {
    /**
     ...
     * 
     */
    public static Changed_attribute_type.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_attribute_type.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_attribute_type.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_attribute_type.Match> getAllMatches(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type) {
     ...
     * 
     */
    public Changed_attribute_type.Match getOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type) {
     ...
     * 
     */
    public void forEachMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type, final IMatchProcessor<? super Changed_attribute_type.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type, final IMatchProcessor<? super Changed_attribute_type.Match> processor) {
     ...
     * 
     */
    public Changed_attribute_type.Match newMatch(final Attribute pInitial_attribute, final Attribute pCurrent_attribute, final DataType pInitial_type, final DataType pCurrent_type) {
      return Changed_attribute_type.Match.newMatch(pInitial_attribute, pCurrent_attribute, pInitial_type, pCurrent_type);
    }
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfinitial_attribute(final Changed_attribute_type.Match partialMatch) {
     ...
     * 
     */
    public Set<Attribute> getAllValuesOfcurrent_attribute(final Changed_attribute_type.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_type(final Changed_attribute_type.Match partialMatch) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfcurrent_type(final Changed_attribute_type.Match partialMatch) {
    ...
    @Override
    protected Changed_attribute_type.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_attribute_type.Match.newMatch((Attribute) t.get(POSITION_INITIAL_ATTRIBUTE), (Attribute) t.get(POSITION_CURRENT_ATTRIBUTE), (DataType) t.get(POSITION_INITIAL_TYPE), (DataType) t.get(POSITION_CURRENT_TYPE));
    ...
    @Override
    protected Changed_attribute_type.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_attribute_type.Match.newMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (DataType) match[POSITION_INITIAL_TYPE], (DataType) match[POSITION_CURRENT_TYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_attribute_type.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_attribute_type.Match.newMutableMatch((Attribute) match[POSITION_INITIAL_ATTRIBUTE], (Attribute) match[POSITION_CURRENT_ATTRIBUTE], (DataType) match[POSITION_INITIAL_TYPE], (DataType) match[POSITION_CURRENT_TYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_attribute_type.Matcher> querySpecification() {
      return Changed_attribute_type.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_attribute_type pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_attribute_type.Match> {
    /**
   ...
   * 
   */
  public static Changed_attribute_type instance() {
    try{
  ...
  @Override
  protected Changed_attribute_type.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_attribute_type.Matcher.on(engine);
  }
  
  @Override
  public Changed_attribute_type.Matcher instantiate() {
    return Changed_attribute_type.Matcher.create();
  }
  
  @Override
  public Changed_attribute_type.Match newEmptyMatch() {
    return Changed_attribute_type.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_attribute_type.Match newMatch(final Object... parameters) {
    return Changed_attribute_type.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Attribute) parameters[1], (se.mdh.idt.benji.examples.refactorings.metamodel.DataType) parameters[2], (se.mdh.idt.benji.examples.refactorings.metamodel.DataType) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_attribute_type (visibility: PUBLIC, simpleName: Changed_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_attribute_type (visibility: PUBLIC, simpleName: Changed_attribute_type, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_attribute_type, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_attribute_type INSTANCE = new Changed_attribute_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_attribute_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	neg find preserved_dataType (initial_type, current_type)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_initial_type, var_current_type), Preserved_dataType.instance().getInternalQueryRepresentation());
          //  	find attribute_type (initial_attribute, initial_type)
