...
public final class $class_package extends BaseGeneratedEMFQuerySpecification<$class_package.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $class_package.Match newMutableMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public static $class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
  ...
  public static class Matcher extends BaseMatcher<$class_package.Match> {
     ...
     * 
     */
    public Collection<$class_package.Match> getAllMatches(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public $class_package.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super $class_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super $class_package.Match> processor) {
     ...
     * 
     */
    public $class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $class_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $class_package.Match partialMatch) {
    ...
    protected $class_package.Match tupleToMatch(final Tuple t) {
      try {
          return $class_package.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    protected $class_package.Match arrayToMatch(final Object[] match) {
      try {
          return $class_package.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    protected $class_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $class_package.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $class_package.Match newMatch(final Object... parameters) {
    return $class_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
