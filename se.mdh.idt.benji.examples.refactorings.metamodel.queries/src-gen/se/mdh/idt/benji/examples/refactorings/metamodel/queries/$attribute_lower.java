...
public final class $attribute_lower extends BaseGeneratedEMFQuerySpecification<$attribute_lower.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $attribute_lower.Match newMutableMatch(final TraceLink pAttribute, final Integer pLower) {
     ...
     * 
     */
    public static $attribute_lower.Match newMatch(final TraceLink pAttribute, final Integer pLower) {
  ...
  public static class Matcher extends BaseMatcher<$attribute_lower.Match> {
     ...
     * 
     */
    public Collection<$attribute_lower.Match> getAllMatches(final TraceLink pAttribute, final Integer pLower) {
     ...
     * 
     */
    public $attribute_lower.Match getOneArbitraryMatch(final TraceLink pAttribute, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final Integer pLower, final IMatchProcessor<? super $attribute_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final Integer pLower, final IMatchProcessor<? super $attribute_lower.Match> processor) {
     ...
     * 
     */
    public $attribute_lower.Match newMatch(final TraceLink pAttribute, final Integer pLower) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final $attribute_lower.Match partialMatch) {
    ...
    protected $attribute_lower.Match tupleToMatch(final Tuple t) {
      try {
          return $attribute_lower.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (Integer) t.get(POSITION_LOWER));
    ...
    protected $attribute_lower.Match arrayToMatch(final Object[] match) {
      try {
          return $attribute_lower.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    protected $attribute_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $attribute_lower.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $attribute_lower.Match newMatch(final Object... parameters) {
    return $attribute_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
