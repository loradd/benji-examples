...
public final class $class_structuralFeature extends BaseGeneratedEMFQuerySpecification<$class_structuralFeature.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $class_structuralFeature.Match newMutableMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public static $class_structuralFeature.Match newMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
  ...
  public static class Matcher extends BaseMatcher<$class_structuralFeature.Match> {
     ...
     * 
     */
    public Collection<$class_structuralFeature.Match> getAllMatches(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public $class_structuralFeature.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pStructuralFeature, final IMatchProcessor<? super $class_structuralFeature.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pStructuralFeature, final IMatchProcessor<? super $class_structuralFeature.Match> processor) {
     ...
     * 
     */
    public $class_structuralFeature.Match newMatch(final TraceLink pClass, final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $class_structuralFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final $class_structuralFeature.Match partialMatch) {
    ...
    protected $class_structuralFeature.Match tupleToMatch(final Tuple t) {
      try {
          return $class_structuralFeature.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_STRUCTURALFEATURE));
    ...
    protected $class_structuralFeature.Match arrayToMatch(final Object[] match) {
      try {
          return $class_structuralFeature.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
    ...
    protected $class_structuralFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $class_structuralFeature.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $class_structuralFeature.Match newMatch(final Object... parameters) {
    return $class_structuralFeature.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
