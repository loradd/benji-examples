...
public final class Set_class_name extends BaseGeneratedEMFQuerySpecification<Set_class_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_name";
    }
     ...
     * 
     */
    public static Set_class_name.Match newMutableMatch(final TraceLink pClass, final String pName) {
     ...
     * 
     */
    public static Set_class_name.Match newMatch(final TraceLink pClass, final String pName) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_name pattern,
  ...
  public static class Matcher extends BaseMatcher<Set_class_name.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_class_name.Matcher.class);
     ...
     * 
     */
    public Collection<Set_class_name.Match> getAllMatches(final TraceLink pClass, final String pName) {
     ...
     * 
     */
    public Set_class_name.Match getOneArbitraryMatch(final TraceLink pClass, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final String pName, final IMatchProcessor<? super Set_class_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final String pName, final IMatchProcessor<? super Set_class_name.Match> processor) {
     ...
     * 
     */
    public Set_class_name.Match newMatch(final TraceLink pClass, final String pName) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Set_class_name.Match partialMatch) {
    ...
    protected Set_class_name.Match tupleToMatch(final Tuple t) {
      try {
          return Set_class_name.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (String) t.get(POSITION_NAME));
    ...
    protected Set_class_name.Match arrayToMatch(final Object[] match) {
      try {
          return Set_class_name.Match.newMatch((TraceLink) match[POSITION_CLASS], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected Set_class_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_class_name.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_class_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_class_name.Match> {
    /**
    ...
    @Override
    public void process(final Set_class_name.Match match) {
  ...
  public Set_class_name.Match newMatch(final Object... parameters) {
    return Set_class_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_name (visibility: PUBLIC, simpleName: Set_class_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_name (visibility: PUBLIC, simpleName: Set_class_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_class_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_class_name INSTANCE = new Set_class_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_class_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_class_name (class, _initial_class, name)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_class, var__initial_class, var_name), Initial_class_name.instance().getInternalQueryRepresentation());
          // 	find current_class_name (class, _current_class, name)
