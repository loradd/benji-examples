...
public final class Preserved_class_subClass extends BaseGeneratedEMFQuerySpecification<Preserved_class_subClass.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_subClass pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("initial_class", "current_class", "initial_subClass", "current_subClass");
    
    private Match(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_subClass";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_class_subClass.Match.parameterNames;
    }
    
    @Override
    public Object[] toArray() {
      return new Object[]{fInitial_class, fCurrent_class, fInitial_subClass, fCurrent_subClass};
    }
    
    @Override
    public Preserved_class_subClass.Match toImmutable() {
      return isMutable() ? newMatch(fInitial_class, fCurrent_class, fInitial_subClass, fCurrent_subClass) : this;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hash (fInitial_class, fCurrent_class, fInitial_subClass, fCurrent_subClass);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_class_subClass.Match)) {
          Preserved_class_subClass.Match other = (Preserved_class_subClass.Match) obj;
          return Objects.equals(fInitial_class, other.fInitial_class) && Objects.equals(fCurrent_class, other.fCurrent_class) && Objects.equals(fInitial_subClass, other.fInitial_subClass) && Objects.equals(fCurrent_subClass, other.fCurrent_subClass);
      } else {
    ...
    @Override
    public Preserved_class_subClass specification() {
     ...
     * 
     */
    public static Preserved_class_subClass.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_class_subClass.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return new Immutable(pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass);
    }
    
    private static final class Mutable extends Preserved_class_subClass.Match {
      Mutable(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
        super(pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass);
      }
    ...
    private static final class Immutable extends Preserved_class_subClass.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_subClass pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_class_subClass
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_class_subClass.Match> {
    /**
     ...
     * 
     */
    public static Preserved_class_subClass.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_class_subClass.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_class_subClass.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_class_subClass.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return rawGetAllMatches(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass});
    }
     ...
     * 
     */
    public Preserved_class_subClass.Match getOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return rawGetOneArbitraryMatch(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass});
    }
    ...
    public boolean hasMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return rawHasMatch(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass});
    }
    ...
    public int countMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return rawCountMatches(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass});
    }
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass, final IMatchProcessor<? super Preserved_class_subClass.Match> processor) {
      rawForEachMatch(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass}, processor);
    }
    ...
    public boolean forOneArbitraryMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass, final IMatchProcessor<? super Preserved_class_subClass.Match> processor) {
      return rawForOneArbitraryMatch(new Object[]{pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass}, processor);
    }
     ...
     * 
     */
    public Preserved_class_subClass.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
      return Preserved_class_subClass.Match.newMatch(pInitial_class, pCurrent_class, pInitial_subClass, pCurrent_subClass);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_class(final Preserved_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final Preserved_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_class(final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_class, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pInitial_subClass, final se.mdh.idt.benji.examples.refactorings.metamodel.Class pCurrent_subClass) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfinitial_subClass(final Preserved_class_subClass.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Class> getAllValuesOfcurrent_subClass(final Preserved_class_subClass.Match partialMatch) {
    ...
    @Override
    protected Preserved_class_subClass.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_class_subClass.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_SUBCLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_SUBCLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_class_subClass.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_class_subClass.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_CLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_INITIAL_SUBCLASS], (se.mdh.idt.benji.examples.refactorings.metamodel.Class) match[POSITION_CURRENT_SUBCLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_class_subClass.Matcher> querySpecification() {
      return Preserved_class_subClass.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_class_subClass pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_class_subClass.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_class_subClass.Match match) {
      process(match.getInitial_class(), match.getCurrent_class(), match.getInitial_subClass(), match.getCurrent_subClass());
    }
  }
  
  private Preserved_class_subClass() {
   ...
   * 
   */
  public static Preserved_class_subClass instance() {
    try{
  ...
  @Override
  protected Preserved_class_subClass.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_class_subClass.Matcher.on(engine);
  }
  
  @Override
  public Preserved_class_subClass.Matcher instantiate() {
    return Preserved_class_subClass.Matcher.create();
  }
  
  @Override
  public Preserved_class_subClass.Match newEmptyMatch() {
    return Preserved_class_subClass.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_class_subClass.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_subClass (visibility: PUBLIC, simpleName: Preserved_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_subClass (visibility: PUBLIC, simpleName: Preserved_class_subClass, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_class_subClass, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_class_subClass INSTANCE = new Preserved_class_subClass();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_class_subClass.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pInitial_class, parameter_pCurrent_class, parameter_pInitial_subClass, parameter_pCurrent_subClass);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("initial_class","current_class","initial_subClass","current_subClass");
    }
