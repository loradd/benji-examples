...
public final class $package_uri extends BaseGeneratedEMFQuerySpecification<$package_uri.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $package_uri.Match newMutableMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public static $package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
  ...
  public static class Matcher extends BaseMatcher<$package_uri.Match> {
     ...
     * 
     */
    public Collection<$package_uri.Match> getAllMatches(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public $package_uri.Match getOneArbitraryMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super $package_uri.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final String pUri, final IMatchProcessor<? super $package_uri.Match> processor) {
     ...
     * 
     */
    public $package_uri.Match newMatch(final TraceLink pPackage, final String pUri) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $package_uri.Match partialMatch) {
    ...
    protected $package_uri.Match tupleToMatch(final Tuple t) {
      try {
          return $package_uri.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (String) t.get(POSITION_URI));
    ...
    protected $package_uri.Match arrayToMatch(final Object[] match) {
      try {
          return $package_uri.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
    ...
    protected $package_uri.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $package_uri.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (String) match[POSITION_URI]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $package_uri.Match newMatch(final Object... parameters) {
    return $package_uri.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
