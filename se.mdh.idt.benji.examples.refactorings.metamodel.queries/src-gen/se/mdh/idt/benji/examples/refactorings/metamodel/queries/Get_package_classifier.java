...
public final class Get_package_classifier extends BaseGeneratedEMFQuerySpecification<Get_package_classifier.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_classifier pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_classifier";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_package_classifier.Match.parameterNames;
    }
    ...
    @Override
    public Get_package_classifier.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_package_classifier.Match)) {
          Get_package_classifier.Match other = (Get_package_classifier.Match) obj;
    ...
    @Override
    public Get_package_classifier specification() {
     ...
     * 
     */
    public static Get_package_classifier.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_package_classifier.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public static Get_package_classifier.Match newMatch(final TraceLink pPackage, final TraceLink pClassifier) {
      return new Immutable(pPackage, pClassifier);
    }
    
    private static final class Mutable extends Get_package_classifier.Match {
    ...
    private static final class Immutable extends Get_package_classifier.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_classifier pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_package_classifier
   * 
   */
  public static class Matcher extends BaseMatcher<Get_package_classifier.Match> {
    /**
     ...
     * 
     */
    public static Get_package_classifier.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_package_classifier.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_package_classifier.Matcher.class);
     ...
     * 
     */
    public Collection<Get_package_classifier.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public Get_package_classifier.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClassifier) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClassifier, final IMatchProcessor<? super Get_package_classifier.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClassifier, final IMatchProcessor<? super Get_package_classifier.Match> processor) {
     ...
     * 
     */
    public Get_package_classifier.Match newMatch(final TraceLink pPackage, final TraceLink pClassifier) {
      return Get_package_classifier.Match.newMatch(pPackage, pClassifier);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_package_classifier.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclassifier(final Get_package_classifier.Match partialMatch) {
    ...
    @Override
    protected Get_package_classifier.Match tupleToMatch(final Tuple t) {
      try {
          return Get_package_classifier.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASSIFIER));
    ...
    @Override
    protected Get_package_classifier.Match arrayToMatch(final Object[] match) {
      try {
          return Get_package_classifier.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_package_classifier.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_package_classifier.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_package_classifier.Matcher> querySpecification() {
      return Get_package_classifier.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_classifier pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_package_classifier.Match> {
    /**
    ...
    @Override
    public void process(final Get_package_classifier.Match match) {
      process(match.getPackage(), match.getClassifier());
    }
  }
  
  private Get_package_classifier() {
   ...
   * 
   */
  public static Get_package_classifier instance() {
    try{
  ...
  @Override
  protected Get_package_classifier.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_package_classifier.Matcher.on(engine);
  }
  
  @Override
  public Get_package_classifier.Matcher instantiate() {
    return Get_package_classifier.Matcher.create();
  }
  
  @Override
  public Get_package_classifier.Match newEmptyMatch() {
    return Get_package_classifier.Match.newEmptyMatch();
  }
  
  @Override
  public Get_package_classifier.Match newMatch(final Object... parameters) {
    return Get_package_classifier.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_classifier (visibility: PUBLIC, simpleName: Get_package_classifier, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_classifier, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_classifier (visibility: PUBLIC, simpleName: Get_package_classifier, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_classifier, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_package_classifier INSTANCE = new Get_package_classifier();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_package_classifier.GeneratedPQuery INSTANCE = new GeneratedPQuery();
