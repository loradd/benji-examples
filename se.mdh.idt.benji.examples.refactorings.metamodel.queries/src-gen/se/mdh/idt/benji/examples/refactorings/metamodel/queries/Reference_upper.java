...
public final class Reference_upper extends BaseGeneratedEMFQuerySpecification<Reference_upper.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public static Reference_upper.Match newMutableMatch(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public static Reference_upper.Match newMatch(final Reference pReference, final Integer pUpper) {
      return new Immutable(pReference, pUpper);
    }
    
    private static final class Mutable extends Reference_upper.Match {
      Mutable(final Reference pReference, final Integer pUpper) {
    ...
    private static final class Immutable extends Reference_upper.Match {
      Immutable(final Reference pReference, final Integer pUpper) {
        super(pReference, pUpper);
      }
  ...
  public static class Matcher extends BaseMatcher<Reference_upper.Match> {
     ...
     * 
     */
    public Collection<Reference_upper.Match> getAllMatches(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public Reference_upper.Match getOneArbitraryMatch(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public boolean hasMatch(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public int countMatches(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final Reference pReference, final Integer pUpper, final IMatchProcessor<? super Reference_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Reference pReference, final Integer pUpper, final IMatchProcessor<? super Reference_upper.Match> processor) {
     ...
     * 
     */
    public Reference_upper.Match newMatch(final Reference pReference, final Integer pUpper) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfreference(final Reference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Reference> getAllValuesOfreference(final Integer pUpper) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Reference pReference) {
    ...
    protected Reference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Reference_upper.Match.newMatch((Reference) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_UPPER));
    ...
    protected Reference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Reference_upper.Match.newMatch((Reference) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    protected Reference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Reference_upper.Match.newMutableMatch((Reference) match[POSITION_REFERENCE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public static abstract class Processor implements IMatchProcessor<Reference_upper.Match> {
     ...
     * 
     */
    public abstract void process(final Reference pReference, final Integer pUpper);
  ...
  public Reference_upper.Match newMatch(final Object... parameters) {
    return Reference_upper.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Reference) parameters[0], (java.lang.Integer) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find structuralFeature_upper (reference, upper)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_reference, var_upper), StructuralFeature_upper.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
