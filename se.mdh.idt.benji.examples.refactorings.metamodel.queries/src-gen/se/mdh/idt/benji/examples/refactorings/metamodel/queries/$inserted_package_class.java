...
public final class $inserted_package_class extends BaseGeneratedEMFQuerySpecification<$inserted_package_class.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class";
    }
    
    @Override
    public List<String> parameterNames() {
      return $inserted_package_class.Match.parameterNames;
    }
    ...
    @Override
    public $inserted_package_class.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof $inserted_package_class.Match)) {
          $inserted_package_class.Match other = ($inserted_package_class.Match) obj;
    ...
    @Override
    public $inserted_package_class specification() {
     ...
     * 
     */
    public static $inserted_package_class.Match newEmptyMatch() {
     ...
     * 
     */
    public static $inserted_package_class.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public static $inserted_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
      return new Immutable(pPackage, pClass);
    }
    
    private static final class Mutable extends $inserted_package_class.Match {
    ...
    private static final class Immutable extends $inserted_package_class.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class pattern,
   ...
   * @see Match
   *  @see Processor
   * @see $inserted_package_class
   * 
   */
  public static class Matcher extends BaseMatcher<$inserted_package_class.Match> {
    /**
     ...
     * 
     */
    public static $inserted_package_class.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static $inserted_package_class.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($inserted_package_class.Matcher.class);
     ...
     * 
     */
    public Collection<$inserted_package_class.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public $inserted_package_class.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $inserted_package_class.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super $inserted_package_class.Match> processor) {
     ...
     * 
     */
    public $inserted_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
      return $inserted_package_class.Match.newMatch(pPackage, pClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final $inserted_package_class.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final $inserted_package_class.Match partialMatch) {
    ...
    @Override
    protected $inserted_package_class.Match tupleToMatch(final Tuple t) {
      try {
          return $inserted_package_class.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASS));
    ...
    @Override
    protected $inserted_package_class.Match arrayToMatch(final Object[] match) {
      try {
          return $inserted_package_class.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected $inserted_package_class.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $inserted_package_class.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<$inserted_package_class.Matcher> querySpecification() {
      return $inserted_package_class.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$inserted_package_class.Match> {
    /**
    ...
    @Override
    public void process(final $inserted_package_class.Match match) {
      process(match.getPackage(), match.getValueOfClass());
    }
  }
  
  private $inserted_package_class() {
   ...
   * 
   */
  public static $inserted_package_class instance() {
    try{
  ...
  @Override
  protected $inserted_package_class.Matcher instantiate(final ViatraQueryEngine engine) {
    return $inserted_package_class.Matcher.on(engine);
  }
  
  @Override
  public $inserted_package_class.Matcher instantiate() {
    return $inserted_package_class.Matcher.create();
  }
  
  @Override
  public $inserted_package_class.Match newEmptyMatch() {
    return $inserted_package_class.Match.newEmptyMatch();
  }
  
  @Override
  public $inserted_package_class.Match newMatch(final Object... parameters) {
    return $inserted_package_class.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class (visibility: PUBLIC, simpleName: $inserted_package_class, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class (visibility: PUBLIC, simpleName: $inserted_package_class, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$inserted_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $inserted_package_class INSTANCE = new $inserted_package_class();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $inserted_package_class.GeneratedPQuery INSTANCE = new GeneratedPQuery();
