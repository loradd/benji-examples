...
public final class $deleted_classifier extends BaseGeneratedEMFQuerySpecification<$deleted_classifier.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_classifier.Match newMutableMatch(final TraceLink pClassifier) {
     ...
     * 
     */
    public static $deleted_classifier.Match newMatch(final TraceLink pClassifier) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_classifier.Match> {
     ...
     * 
     */
    public Collection<$deleted_classifier.Match> getAllMatches(final TraceLink pClassifier) {
     ...
     * 
     */
    public $deleted_classifier.Match getOneArbitraryMatch(final TraceLink pClassifier) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClassifier, final IMatchProcessor<? super $deleted_classifier.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClassifier, final IMatchProcessor<? super $deleted_classifier.Match> processor) {
     ...
     * 
     */
    public $deleted_classifier.Match newMatch(final TraceLink pClassifier) {
      return $deleted_classifier.Match.newMatch(pClassifier);
    }
    ...
    protected $deleted_classifier.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_classifier.Match.newMatch((TraceLink) t.get(POSITION_CLASSIFIER));
    ...
    protected $deleted_classifier.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_classifier.Match.newMatch((TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_classifier.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_classifier.Match.newMutableMatch((TraceLink) match[POSITION_CLASSIFIER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_classifier.Match newMatch(final Object... parameters) {
    return $deleted_classifier.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
