...
public final class Get_reference_owner extends BaseGeneratedEMFQuerySpecification<Get_reference_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_reference_owner.Match.parameterNames;
    }
    ...
    @Override
    public Get_reference_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_reference_owner.Match)) {
          Get_reference_owner.Match other = (Get_reference_owner.Match) obj;
    ...
    @Override
    public Get_reference_owner specification() {
     ...
     * 
     */
    public static Get_reference_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_reference_owner.Match newMutableMatch(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public static Get_reference_owner.Match newMatch(final TraceLink pReference, final TraceLink pOwner) {
      return new Immutable(pReference, pOwner);
    }
    
    private static final class Mutable extends Get_reference_owner.Match {
    ...
    private static final class Immutable extends Get_reference_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_reference_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Get_reference_owner.Match> {
    /**
     ...
     * 
     */
    public static Get_reference_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_reference_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_reference_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Get_reference_owner.Match> getAllMatches(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public Get_reference_owner.Match getOneArbitraryMatch(final TraceLink pReference, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final TraceLink pOwner, final IMatchProcessor<? super Get_reference_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final TraceLink pOwner, final IMatchProcessor<? super Get_reference_owner.Match> processor) {
     ...
     * 
     */
    public Get_reference_owner.Match newMatch(final TraceLink pReference, final TraceLink pOwner) {
      return Get_reference_owner.Match.newMatch(pReference, pOwner);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final Get_reference_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final Get_reference_owner.Match partialMatch) {
    ...
    @Override
    protected Get_reference_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Get_reference_owner.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (TraceLink) t.get(POSITION_OWNER));
    ...
    @Override
    protected Get_reference_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Get_reference_owner.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_reference_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_reference_owner.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_reference_owner.Matcher> querySpecification() {
      return Get_reference_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_reference_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_reference_owner.Match> {
    /**
    ...
    @Override
    public void process(final Get_reference_owner.Match match) {
      process(match.getReference(), match.getOwner());
    }
  }
  
  private Get_reference_owner() {
   ...
   * 
   */
  public static Get_reference_owner instance() {
    try{
  ...
  @Override
  protected Get_reference_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_reference_owner.Matcher.on(engine);
  }
  
  @Override
  public Get_reference_owner.Matcher instantiate() {
    return Get_reference_owner.Matcher.create();
  }
  
  @Override
  public Get_reference_owner.Match newEmptyMatch() {
    return Get_reference_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Get_reference_owner.Match newMatch(final Object... parameters) {
    return Get_reference_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_owner (visibility: PUBLIC, simpleName: Get_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_owner (visibility: PUBLIC, simpleName: Get_reference_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_reference_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_reference_owner INSTANCE = new Get_reference_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_reference_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
