...
public final class Preserved_package_superPackage extends BaseGeneratedEMFQuerySpecification<Preserved_package_superPackage.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_package_superPackage pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_package_superPackage";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_package_superPackage.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_package_superPackage.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_package_superPackage.Match)) {
          Preserved_package_superPackage.Match other = (Preserved_package_superPackage.Match) obj;
    ...
    @Override
    public Preserved_package_superPackage specification() {
     ...
     * 
     */
    public static Preserved_package_superPackage.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_package_superPackage.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_superPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_superPackage) {
      return new Immutable(pInitial_package, pCurrent_package, pInitial_superPackage, pCurrent_superPackage);
    }
    
    private static final class Mutable extends Preserved_package_superPackage.Match {
    ...
    private static final class Immutable extends Preserved_package_superPackage.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_package_superPackage pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // package - superPackage - preserved
   * pattern preserved_package_superPackage (initial_package : Package, current_package : Package, initial_superPackage : Package, current_superPackage : Package) {
   * 	find preserved_package (initial_package, current_package); 
   * 	find preserved_package (initial_superPackage, current_superPackage); 
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_package_superPackage
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_package_superPackage.Match> {
    /**
     ...
     * 
     */
    public static Preserved_package_superPackage.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_package_superPackage.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_package_superPackage.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_package_superPackage.Match> getAllMatches(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_superPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_superPackage) {
     ...
     * 
     */
    public void forEachMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_superPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_superPackage, final IMatchProcessor<? super Preserved_package_superPackage.Match> processor) {
     ...
     */
    public Preserved_package_superPackage.Match newMatch(final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_package, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pInitial_superPackage, final se.mdh.idt.benji.examples.refactorings.metamodel.Package pCurrent_superPackage) {
      return Preserved_package_superPackage.Match.newMatch(pInitial_package, pCurrent_package, pInitial_superPackage, pCurrent_superPackage);
    }
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_package(final Preserved_package_superPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_package(final Preserved_package_superPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfinitial_superPackage(final Preserved_package_superPackage.Match partialMatch) {
     ...
     * 
     */
    public Set<se.mdh.idt.benji.examples.refactorings.metamodel.Package> getAllValuesOfcurrent_superPackage(final Preserved_package_superPackage.Match partialMatch) {
    ...
    @Override
    protected Preserved_package_superPackage.Match arrayToMatch(final Object[] match) {
      try {
    ...
    @Override
    protected Preserved_package_superPackage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_package_superPackage.Match.newMutableMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_PACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_INITIAL_SUPERPACKAGE], (se.mdh.idt.benji.examples.refactorings.metamodel.Package) match[POSITION_CURRENT_SUPERPACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_package_superPackage.Matcher> querySpecification() {
      return Preserved_package_superPackage.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.preserved_package_superPackage pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_package_superPackage.Match> {
    /**
   ...
   * 
   */
  public static Preserved_package_superPackage instance() {
    try{
  ...
  @Override
  protected Preserved_package_superPackage.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_package_superPackage.Matcher.on(engine);
  }
  
  @Override
  public Preserved_package_superPackage.Matcher instantiate() {
    return Preserved_package_superPackage.Matcher.create();
  }
  
  @Override
  public Preserved_package_superPackage.Match newEmptyMatch() {
    return Preserved_package_superPackage.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_package_superPackage.Match newMatch(final Object... parameters) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_package_superPackage (visibility: PUBLIC, simpleName: Preserved_package_superPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_package_superPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_package_superPackage (visibility: PUBLIC, simpleName: Preserved_package_superPackage, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Preserved_package_superPackage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_package_superPackage INSTANCE = new Preserved_package_superPackage();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_package_superPackage.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	find preserved_package (initial_superPackage, current_superPackage)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_superPackage, var_current_superPackage), Preserved_package.instance().getInternalQueryRepresentation());
          //  	find package_superPackage (initial_package, initial_superPackage)
