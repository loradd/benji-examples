...
public final class Get_attribute_upper extends BaseGeneratedEMFQuerySpecification<Get_attribute_upper.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_upper pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_upper";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_attribute_upper.Match.parameterNames;
    }
    ...
    @Override
    public Get_attribute_upper.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_attribute_upper.Match)) {
          Get_attribute_upper.Match other = (Get_attribute_upper.Match) obj;
    ...
    @Override
    public Get_attribute_upper specification() {
     ...
     * 
     */
    public static Get_attribute_upper.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_attribute_upper.Match newMutableMatch(final TraceLink pAttribute, final Integer pUpper) {
     ...
     * 
     */
    public static Get_attribute_upper.Match newMatch(final TraceLink pAttribute, final Integer pUpper) {
      return new Immutable(pAttribute, pUpper);
    }
    
    private static final class Mutable extends Get_attribute_upper.Match {
    ...
    private static final class Immutable extends Get_attribute_upper.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_upper pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_attribute_upper
   * 
   */
  public static class Matcher extends BaseMatcher<Get_attribute_upper.Match> {
    /**
     ...
     * 
     */
    public static Get_attribute_upper.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_attribute_upper.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_attribute_upper.Matcher.class);
     ...
     * 
     */
    public Collection<Get_attribute_upper.Match> getAllMatches(final TraceLink pAttribute, final Integer pUpper) {
     ...
     * 
     */
    public Get_attribute_upper.Match getOneArbitraryMatch(final TraceLink pAttribute, final Integer pUpper) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final Integer pUpper, final IMatchProcessor<? super Get_attribute_upper.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final Integer pUpper, final IMatchProcessor<? super Get_attribute_upper.Match> processor) {
     ...
     * 
     */
    public Get_attribute_upper.Match newMatch(final TraceLink pAttribute, final Integer pUpper) {
      return Get_attribute_upper.Match.newMatch(pAttribute, pUpper);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfattribute(final Get_attribute_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfupper(final Get_attribute_upper.Match partialMatch) {
    ...
    @Override
    protected Get_attribute_upper.Match tupleToMatch(final Tuple t) {
      try {
          return Get_attribute_upper.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE), (Integer) t.get(POSITION_UPPER));
    ...
    @Override
    protected Get_attribute_upper.Match arrayToMatch(final Object[] match) {
      try {
          return Get_attribute_upper.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_attribute_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_attribute_upper.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE], (Integer) match[POSITION_UPPER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_attribute_upper.Matcher> querySpecification() {
      return Get_attribute_upper.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_attribute_upper pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_attribute_upper.Match> {
    /**
    ...
    @Override
    public void process(final Get_attribute_upper.Match match) {
      process(match.getAttribute(), match.getUpper());
    }
  }
  
  private Get_attribute_upper() {
   ...
   * 
   */
  public static Get_attribute_upper instance() {
    try{
  ...
  @Override
  protected Get_attribute_upper.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_attribute_upper.Matcher.on(engine);
  }
  
  @Override
  public Get_attribute_upper.Matcher instantiate() {
    return Get_attribute_upper.Matcher.create();
  }
  
  @Override
  public Get_attribute_upper.Match newEmptyMatch() {
    return Get_attribute_upper.Match.newEmptyMatch();
  }
  
  @Override
  public Get_attribute_upper.Match newMatch(final Object... parameters) {
    return Get_attribute_upper.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_upper (visibility: PUBLIC, simpleName: Get_attribute_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_upper (visibility: PUBLIC, simpleName: Get_attribute_upper, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_attribute_upper, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_attribute_upper INSTANCE = new Get_attribute_upper();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_attribute_upper.GeneratedPQuery INSTANCE = new GeneratedPQuery();
