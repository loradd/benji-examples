...
public final class $attribute extends BaseGeneratedEMFQuerySpecification<$attribute.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute";
    }
     ...
     * 
     */
    public static $attribute.Match newMutableMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public static $attribute.Match newMatch(final TraceLink pAttribute) {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute pattern,
  ...
  public static class Matcher extends BaseMatcher<$attribute.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger($attribute.Matcher.class);
     ...
     * 
     */
    public Collection<$attribute.Match> getAllMatches(final TraceLink pAttribute) {
     ...
     * 
     */
    public $attribute.Match getOneArbitraryMatch(final TraceLink pAttribute) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pAttribute, final IMatchProcessor<? super $attribute.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pAttribute, final IMatchProcessor<? super $attribute.Match> processor) {
     ...
     * 
     */
    public $attribute.Match newMatch(final TraceLink pAttribute) {
      return $attribute.Match.newMatch(pAttribute);
    }
    ...
    protected $attribute.Match tupleToMatch(final Tuple t) {
      try {
          return $attribute.Match.newMatch((TraceLink) t.get(POSITION_ATTRIBUTE));
    ...
    protected $attribute.Match arrayToMatch(final Object[] match) {
      try {
          return $attribute.Match.newMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
    ...
    protected $attribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $attribute.Match.newMutableMatch((TraceLink) match[POSITION_ATTRIBUTE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<$attribute.Match> {
    /**
    ...
    @Override
    public void process(final $attribute.Match match) {
  ...
  public $attribute.Match newMatch(final Object... parameters) {
    return $attribute.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute (visibility: PUBLIC, simpleName: $attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute (visibility: PUBLIC, simpleName: $attribute, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.$attribute, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static $attribute INSTANCE = new $attribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static $attribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
