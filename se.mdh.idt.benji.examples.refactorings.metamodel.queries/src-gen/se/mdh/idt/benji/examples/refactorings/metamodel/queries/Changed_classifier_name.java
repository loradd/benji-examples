...
public final class Changed_classifier_name extends BaseGeneratedEMFQuerySpecification<Changed_classifier_name.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Changed_classifier_name.Match.parameterNames;
    }
    ...
    @Override
    public Changed_classifier_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Changed_classifier_name.Match)) {
          Changed_classifier_name.Match other = (Changed_classifier_name.Match) obj;
    ...
    @Override
    public Changed_classifier_name specification() {
     ...
     * 
     */
    public static Changed_classifier_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Changed_classifier_name.Match newMutableMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public static Changed_classifier_name.Match newMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name) {
      return new Immutable(pInitial_classifier, pCurrent_classifier, pInitial_name, pCurrent_name);
    }
    
    private static final class Mutable extends Changed_classifier_name.Match {
    ...
    private static final class Immutable extends Changed_classifier_name.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_name pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Changed_classifier_name
   * 
   */
  public static class Matcher extends BaseMatcher<Changed_classifier_name.Match> {
    /**
     ...
     * 
     */
    public static Changed_classifier_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Changed_classifier_name.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Changed_classifier_name.Matcher.class);
     ...
     * 
     */
    public Collection<Changed_classifier_name.Match> getAllMatches(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public Changed_classifier_name.Match getOneArbitraryMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name) {
     ...
     * 
     */
    public void forEachMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_classifier_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name, final IMatchProcessor<? super Changed_classifier_name.Match> processor) {
     ...
     * 
     */
    public Changed_classifier_name.Match newMatch(final Classifier pInitial_classifier, final Classifier pCurrent_classifier, final String pInitial_name, final String pCurrent_name) {
      return Changed_classifier_name.Match.newMatch(pInitial_classifier, pCurrent_classifier, pInitial_name, pCurrent_name);
    }
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfinitial_classifier(final Changed_classifier_name.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfcurrent_classifier(final Changed_classifier_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfinitial_name(final Changed_classifier_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfcurrent_name(final Changed_classifier_name.Match partialMatch) {
    ...
    @Override
    protected Changed_classifier_name.Match tupleToMatch(final Tuple t) {
      try {
          return Changed_classifier_name.Match.newMatch((Classifier) t.get(POSITION_INITIAL_CLASSIFIER), (Classifier) t.get(POSITION_CURRENT_CLASSIFIER), (String) t.get(POSITION_INITIAL_NAME), (String) t.get(POSITION_CURRENT_NAME));
    ...
    @Override
    protected Changed_classifier_name.Match arrayToMatch(final Object[] match) {
      try {
          return Changed_classifier_name.Match.newMatch((Classifier) match[POSITION_INITIAL_CLASSIFIER], (Classifier) match[POSITION_CURRENT_CLASSIFIER], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Changed_classifier_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Changed_classifier_name.Match.newMutableMatch((Classifier) match[POSITION_INITIAL_CLASSIFIER], (Classifier) match[POSITION_CURRENT_CLASSIFIER], (String) match[POSITION_INITIAL_NAME], (String) match[POSITION_CURRENT_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Changed_classifier_name.Matcher> querySpecification() {
      return Changed_classifier_name.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.changed_classifier_name pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Changed_classifier_name.Match> {
    /**
   ...
   * 
   */
  public static Changed_classifier_name instance() {
    try{
  ...
  @Override
  protected Changed_classifier_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Changed_classifier_name.Matcher.on(engine);
  }
  
  @Override
  public Changed_classifier_name.Matcher instantiate() {
    return Changed_classifier_name.Matcher.create();
  }
  
  @Override
  public Changed_classifier_name.Match newEmptyMatch() {
    return Changed_classifier_name.Match.newEmptyMatch();
  }
  
  @Override
  public Changed_classifier_name.Match newMatch(final Object... parameters) {
    return Changed_classifier_name.Match.newMatch((se.mdh.idt.benji.examples.refactorings.metamodel.Classifier) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.Classifier) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_name (visibility: PUBLIC, simpleName: Changed_classifier_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_name (visibility: PUBLIC, simpleName: Changed_classifier_name, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Changed_classifier_name, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Changed_classifier_name INSTANCE = new Changed_classifier_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Changed_classifier_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find changed_modelElement_name (initial_classifier, current_classifier, initial_name, current_name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_initial_classifier, var_current_classifier, var_initial_name, var_current_name), Changed_modelElement_name.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
