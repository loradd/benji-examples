...
public final class Get_datatype_package extends BaseGeneratedEMFQuerySpecification<Get_datatype_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_datatype_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_datatype_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_datatype_package.Match.parameterNames;
    }
    ...
    @Override
    public Get_datatype_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_datatype_package.Match)) {
          Get_datatype_package.Match other = (Get_datatype_package.Match) obj;
    ...
    @Override
    public Get_datatype_package specification() {
     ...
     * 
     */
    public static Get_datatype_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_datatype_package.Match newMutableMatch(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public static Get_datatype_package.Match newMatch(final TraceLink pDatatype, final TraceLink pPackage) {
      return new Immutable(pDatatype, pPackage);
    }
    
    private static final class Mutable extends Get_datatype_package.Match {
    ...
    private static final class Immutable extends Get_datatype_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_datatype_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_datatype_package
   * 
   */
  public static class Matcher extends BaseMatcher<Get_datatype_package.Match> {
    /**
     ...
     * 
     */
    public static Get_datatype_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_datatype_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_datatype_package.Matcher.class);
     ...
     * 
     */
    public Collection<Get_datatype_package.Match> getAllMatches(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public Get_datatype_package.Match getOneArbitraryMatch(final TraceLink pDatatype, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pDatatype, final TraceLink pPackage, final IMatchProcessor<? super Get_datatype_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pDatatype, final TraceLink pPackage, final IMatchProcessor<? super Get_datatype_package.Match> processor) {
     ...
     * 
     */
    public Get_datatype_package.Match newMatch(final TraceLink pDatatype, final TraceLink pPackage) {
      return Get_datatype_package.Match.newMatch(pDatatype, pPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final Get_datatype_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_datatype_package.Match partialMatch) {
    ...
    @Override
    protected Get_datatype_package.Match tupleToMatch(final Tuple t) {
      try {
          return Get_datatype_package.Match.newMatch((TraceLink) t.get(POSITION_DATATYPE), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    @Override
    protected Get_datatype_package.Match arrayToMatch(final Object[] match) {
      try {
          return Get_datatype_package.Match.newMatch((TraceLink) match[POSITION_DATATYPE], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_datatype_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_datatype_package.Match.newMutableMatch((TraceLink) match[POSITION_DATATYPE], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_datatype_package.Matcher> querySpecification() {
      return Get_datatype_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_datatype_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_datatype_package.Match> {
    /**
    ...
    @Override
    public void process(final Get_datatype_package.Match match) {
      process(match.getDatatype(), match.getPackage());
    }
  }
  
  private Get_datatype_package() {
   ...
   * 
   */
  public static Get_datatype_package instance() {
    try{
  ...
  @Override
  protected Get_datatype_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_datatype_package.Matcher.on(engine);
  }
  
  @Override
  public Get_datatype_package.Matcher instantiate() {
    return Get_datatype_package.Matcher.create();
  }
  
  @Override
  public Get_datatype_package.Match newEmptyMatch() {
    return Get_datatype_package.Match.newEmptyMatch();
  }
  
  @Override
  public Get_datatype_package.Match newMatch(final Object... parameters) {
    return Get_datatype_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_datatype_package (visibility: PUBLIC, simpleName: Get_datatype_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_datatype_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_datatype_package (visibility: PUBLIC, simpleName: Get_datatype_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_datatype_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_datatype_package INSTANCE = new Get_datatype_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_datatype_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
