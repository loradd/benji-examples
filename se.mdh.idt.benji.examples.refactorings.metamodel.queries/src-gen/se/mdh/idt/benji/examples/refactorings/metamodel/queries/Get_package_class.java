...
public final class Get_package_class extends BaseGeneratedEMFQuerySpecification<Get_package_class.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_class pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_class";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_package_class.Match.parameterNames;
    }
    ...
    @Override
    public Get_package_class.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_package_class.Match)) {
          Get_package_class.Match other = (Get_package_class.Match) obj;
    ...
    @Override
    public Get_package_class specification() {
     ...
     * 
     */
    public static Get_package_class.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_package_class.Match newMutableMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public static Get_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
      return new Immutable(pPackage, pClass);
    }
    
    private static final class Mutable extends Get_package_class.Match {
    ...
    private static final class Immutable extends Get_package_class.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_class pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_package_class
   * 
   */
  public static class Matcher extends BaseMatcher<Get_package_class.Match> {
    /**
     ...
     * 
     */
    public static Get_package_class.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_package_class.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_package_class.Matcher.class);
     ...
     * 
     */
    public Collection<Get_package_class.Match> getAllMatches(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public Get_package_class.Match getOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super Get_package_class.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pPackage, final TraceLink pClass, final IMatchProcessor<? super Get_package_class.Match> processor) {
     ...
     * 
     */
    public Get_package_class.Match newMatch(final TraceLink pPackage, final TraceLink pClass) {
      return Get_package_class.Match.newMatch(pPackage, pClass);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_package_class.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_package_class.Match partialMatch) {
    ...
    @Override
    protected Get_package_class.Match tupleToMatch(final Tuple t) {
      try {
          return Get_package_class.Match.newMatch((TraceLink) t.get(POSITION_PACKAGE), (TraceLink) t.get(POSITION_CLASS));
    ...
    @Override
    protected Get_package_class.Match arrayToMatch(final Object[] match) {
      try {
          return Get_package_class.Match.newMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_package_class.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_package_class.Match.newMutableMatch((TraceLink) match[POSITION_PACKAGE], (TraceLink) match[POSITION_CLASS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_package_class.Matcher> querySpecification() {
      return Get_package_class.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_package_class pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_package_class.Match> {
    /**
    ...
    @Override
    public void process(final Get_package_class.Match match) {
      process(match.getPackage(), match.getValueOfClass());
    }
  }
  
  private Get_package_class() {
   ...
   * 
   */
  public static Get_package_class instance() {
    try{
  ...
  @Override
  protected Get_package_class.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_package_class.Matcher.on(engine);
  }
  
  @Override
  public Get_package_class.Matcher instantiate() {
    return Get_package_class.Matcher.create();
  }
  
  @Override
  public Get_package_class.Match newEmptyMatch() {
    return Get_package_class.Match.newEmptyMatch();
  }
  
  @Override
  public Get_package_class.Match newMatch(final Object... parameters) {
    return Get_package_class.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_class (visibility: PUBLIC, simpleName: Get_package_class, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_class (visibility: PUBLIC, simpleName: Get_package_class, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_package_class, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_package_class INSTANCE = new Get_package_class();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_package_class.GeneratedPQuery INSTANCE = new GeneratedPQuery();
