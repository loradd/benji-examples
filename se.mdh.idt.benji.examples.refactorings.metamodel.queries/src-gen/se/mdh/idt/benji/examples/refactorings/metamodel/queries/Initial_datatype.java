...
public final class Initial_datatype extends BaseGeneratedEMFQuerySpecification<Initial_datatype.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_datatype pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pDatatype, final DataType pInitial_datatype) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_datatype";
    }
     ...
     * 
     */
    public static Initial_datatype.Match newMutableMatch(final TraceLink pDatatype, final DataType pInitial_datatype) {
     ...
     * 
     */
    public static Initial_datatype.Match newMatch(final TraceLink pDatatype, final DataType pInitial_datatype) {
      return new Immutable(pDatatype, pInitial_datatype);
    }
    
    private static final class Mutable extends Initial_datatype.Match {
      Mutable(final TraceLink pDatatype, final DataType pInitial_datatype) {
    ...
    private static final class Immutable extends Initial_datatype.Match {
      Immutable(final TraceLink pDatatype, final DataType pInitial_datatype) {
        super(pDatatype, pInitial_datatype);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_datatype pattern,
  ...
  public static class Matcher extends BaseMatcher<Initial_datatype.Match> {
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_datatype.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_datatype.Match> getAllMatches(final TraceLink pDatatype, final DataType pInitial_datatype) {
      return rawGetAllMatches(new Object[]{pDatatype, pInitial_datatype});
    }
     ...
     * 
     */
    public Initial_datatype.Match getOneArbitraryMatch(final TraceLink pDatatype, final DataType pInitial_datatype) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pDatatype, final DataType pInitial_datatype) {
     ...
     * 
     */
    public int countMatches(final TraceLink pDatatype, final DataType pInitial_datatype) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pDatatype, final DataType pInitial_datatype, final IMatchProcessor<? super Initial_datatype.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pDatatype, final DataType pInitial_datatype, final IMatchProcessor<? super Initial_datatype.Match> processor) {
     ...
     * 
     */
    public Initial_datatype.Match newMatch(final TraceLink pDatatype, final DataType pInitial_datatype) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final Initial_datatype.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfdatatype(final DataType pInitial_datatype) {
     ...
     * 
     */
    public Set<DataType> getAllValuesOfinitial_datatype(final TraceLink pDatatype) {
    ...
    protected Initial_datatype.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_datatype.Match.newMatch((TraceLink) t.get(POSITION_DATATYPE), (DataType) t.get(POSITION_INITIAL_DATATYPE));
    ...
    protected Initial_datatype.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_datatype.Match.newMatch((TraceLink) match[POSITION_DATATYPE], (DataType) match[POSITION_INITIAL_DATATYPE]);
      } catch(ClassCastException e) {
    ...
    protected Initial_datatype.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_datatype.Match.newMutableMatch((TraceLink) match[POSITION_DATATYPE], (DataType) match[POSITION_INITIAL_DATATYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.initial_datatype pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_datatype.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pDatatype, final DataType pInitial_datatype);
    
    @Override
    public void process(final Initial_datatype.Match match) {
      process(match.getDatatype(), match.getInitial_datatype());
    }
  }
  ...
  public Initial_datatype.Match newMatch(final Object... parameters) {
    return Initial_datatype.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.metamodel.DataType) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_datatype (visibility: PUBLIC, simpleName: Initial_datatype, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_datatype, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_datatype (visibility: PUBLIC, simpleName: Initial_datatype, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Initial_datatype, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_datatype INSTANCE = new Initial_datatype();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_datatype.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pDatatype, parameter_pInitial_datatype);
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find initial_classifier (datatype, initial_datatype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_datatype, var_initial_datatype), Initial_classifier.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
