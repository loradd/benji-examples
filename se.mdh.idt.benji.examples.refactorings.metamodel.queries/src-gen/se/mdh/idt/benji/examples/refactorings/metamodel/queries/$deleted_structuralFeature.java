...
public final class $deleted_structuralFeature extends BaseGeneratedEMFQuerySpecification<$deleted_structuralFeature.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $deleted_structuralFeature.Match newMutableMatch(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public static $deleted_structuralFeature.Match newMatch(final TraceLink pStructuralFeature) {
  ...
  public static class Matcher extends BaseMatcher<$deleted_structuralFeature.Match> {
     ...
     * 
     */
    public Collection<$deleted_structuralFeature.Match> getAllMatches(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public $deleted_structuralFeature.Match getOneArbitraryMatch(final TraceLink pStructuralFeature) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final IMatchProcessor<? super $deleted_structuralFeature.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final IMatchProcessor<? super $deleted_structuralFeature.Match> processor) {
     ...
     * 
     */
    public $deleted_structuralFeature.Match newMatch(final TraceLink pStructuralFeature) {
      return $deleted_structuralFeature.Match.newMatch(pStructuralFeature);
    }
    ...
    protected $deleted_structuralFeature.Match tupleToMatch(final Tuple t) {
      try {
          return $deleted_structuralFeature.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE));
    ...
    protected $deleted_structuralFeature.Match arrayToMatch(final Object[] match) {
      try {
          return $deleted_structuralFeature.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
    ...
    protected $deleted_structuralFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $deleted_structuralFeature.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $deleted_structuralFeature.Match newMatch(final Object... parameters) {
    return $deleted_structuralFeature.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
