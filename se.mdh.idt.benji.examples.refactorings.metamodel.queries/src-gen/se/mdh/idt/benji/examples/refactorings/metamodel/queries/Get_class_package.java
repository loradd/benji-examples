...
public final class Get_class_package extends BaseGeneratedEMFQuerySpecification<Get_class_package.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_package pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_package";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_class_package.Match.parameterNames;
    }
    ...
    @Override
    public Get_class_package.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_class_package.Match)) {
          Get_class_package.Match other = (Get_class_package.Match) obj;
    ...
    @Override
    public Get_class_package specification() {
     ...
     * 
     */
    public static Get_class_package.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_class_package.Match newMutableMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public static Get_class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
      return new Immutable(pClass, pPackage);
    }
    
    private static final class Mutable extends Get_class_package.Match {
    ...
    private static final class Immutable extends Get_class_package.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_package pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_class_package
   * 
   */
  public static class Matcher extends BaseMatcher<Get_class_package.Match> {
    /**
     ...
     * 
     */
    public static Get_class_package.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_class_package.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_class_package.Matcher.class);
     ...
     * 
     */
    public Collection<Get_class_package.Match> getAllMatches(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public Get_class_package.Match getOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super Get_class_package.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pClass, final TraceLink pPackage, final IMatchProcessor<? super Get_class_package.Match> processor) {
     ...
     * 
     */
    public Get_class_package.Match newMatch(final TraceLink pClass, final TraceLink pPackage) {
      return Get_class_package.Match.newMatch(pClass, pPackage);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfclass(final Get_class_package.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfpackage(final Get_class_package.Match partialMatch) {
    ...
    @Override
    protected Get_class_package.Match tupleToMatch(final Tuple t) {
      try {
          return Get_class_package.Match.newMatch((TraceLink) t.get(POSITION_CLASS), (TraceLink) t.get(POSITION_PACKAGE));
    ...
    @Override
    protected Get_class_package.Match arrayToMatch(final Object[] match) {
      try {
          return Get_class_package.Match.newMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_class_package.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_class_package.Match.newMutableMatch((TraceLink) match[POSITION_CLASS], (TraceLink) match[POSITION_PACKAGE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_class_package.Matcher> querySpecification() {
      return Get_class_package.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.get_class_package pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_class_package.Match> {
    /**
    ...
    @Override
    public void process(final Get_class_package.Match match) {
      process(match.getValueOfClass(), match.getPackage());
    }
  }
  
  private Get_class_package() {
   ...
   * 
   */
  public static Get_class_package instance() {
    try{
  ...
  @Override
  protected Get_class_package.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_class_package.Matcher.on(engine);
  }
  
  @Override
  public Get_class_package.Matcher instantiate() {
    return Get_class_package.Matcher.create();
  }
  
  @Override
  public Get_class_package.Match newEmptyMatch() {
    return Get_class_package.Match.newEmptyMatch();
  }
  
  @Override
  public Get_class_package.Match newMatch(final Object... parameters) {
    return Get_class_package.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_package (visibility: PUBLIC, simpleName: Get_class_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_package (visibility: PUBLIC, simpleName: Get_class_package, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Get_class_package, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_class_package INSTANCE = new Get_class_package();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_class_package.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find current_class_package (class, _current_class, ^package, _current_package)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_class, var__current_class, var_package, var__current_package), Current_class_package.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
