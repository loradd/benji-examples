...
public final class Set_structuralFeature_owner extends BaseGeneratedEMFQuerySpecification<Set_structuralFeature_owner.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_owner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_owner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_structuralFeature_owner.Match.parameterNames;
    }
    ...
    @Override
    public Set_structuralFeature_owner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_structuralFeature_owner.Match)) {
          Set_structuralFeature_owner.Match other = (Set_structuralFeature_owner.Match) obj;
    ...
    @Override
    public Set_structuralFeature_owner specification() {
     ...
     * 
     */
    public static Set_structuralFeature_owner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Set_structuralFeature_owner.Match newMutableMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public static Set_structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
      return new Immutable(pStructuralFeature, pOwner);
    }
    
    private static final class Mutable extends Set_structuralFeature_owner.Match {
    ...
    private static final class Immutable extends Set_structuralFeature_owner.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_owner pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_structuralFeature_owner
   * 
   */
  public static class Matcher extends BaseMatcher<Set_structuralFeature_owner.Match> {
    /**
     ...
     * 
     */
    public static Set_structuralFeature_owner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_structuralFeature_owner.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_structuralFeature_owner.Matcher.class);
     ...
     * 
     */
    public Collection<Set_structuralFeature_owner.Match> getAllMatches(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public Set_structuralFeature_owner.Match getOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super Set_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pStructuralFeature, final TraceLink pOwner, final IMatchProcessor<? super Set_structuralFeature_owner.Match> processor) {
     ...
     * 
     */
    public Set_structuralFeature_owner.Match newMatch(final TraceLink pStructuralFeature, final TraceLink pOwner) {
      return Set_structuralFeature_owner.Match.newMatch(pStructuralFeature, pOwner);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfstructuralFeature(final Set_structuralFeature_owner.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfowner(final Set_structuralFeature_owner.Match partialMatch) {
    ...
    @Override
    protected Set_structuralFeature_owner.Match tupleToMatch(final Tuple t) {
      try {
          return Set_structuralFeature_owner.Match.newMatch((TraceLink) t.get(POSITION_STRUCTURALFEATURE), (TraceLink) t.get(POSITION_OWNER));
    ...
    @Override
    protected Set_structuralFeature_owner.Match arrayToMatch(final Object[] match) {
      try {
          return Set_structuralFeature_owner.Match.newMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Set_structuralFeature_owner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_structuralFeature_owner.Match.newMutableMatch((TraceLink) match[POSITION_STRUCTURALFEATURE], (TraceLink) match[POSITION_OWNER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Set_structuralFeature_owner.Matcher> querySpecification() {
      return Set_structuralFeature_owner.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.metamodel.queries.set_structuralFeature_owner pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_structuralFeature_owner.Match> {
    /**
    ...
    @Override
    public void process(final Set_structuralFeature_owner.Match match) {
      process(match.getStructuralFeature(), match.getOwner());
    }
  }
  
  private Set_structuralFeature_owner() {
   ...
   * 
   */
  public static Set_structuralFeature_owner instance() {
    try{
  ...
  @Override
  protected Set_structuralFeature_owner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_structuralFeature_owner.Matcher.on(engine);
  }
  
  @Override
  public Set_structuralFeature_owner.Matcher instantiate() {
    return Set_structuralFeature_owner.Matcher.create();
  }
  
  @Override
  public Set_structuralFeature_owner.Match newEmptyMatch() {
    return Set_structuralFeature_owner.Match.newEmptyMatch();
  }
  
  @Override
  public Set_structuralFeature_owner.Match newMatch(final Object... parameters) {
    return Set_structuralFeature_owner.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_owner (visibility: PUBLIC, simpleName: Set_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_owner (visibility: PUBLIC, simpleName: Set_structuralFeature_owner, identifier: se.mdh.idt.benji.examples.refactorings.metamodel.queries.Set_structuralFeature_owner, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.metamodel.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_structuralFeature_owner INSTANCE = new Set_structuralFeature_owner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Set_structuralFeature_owner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_structuralFeature_owner (structuralFeature, _initial_structuralFeature, owner, _initial_owner)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_structuralFeature, var__initial_structuralFeature, var_owner, var__initial_owner), Initial_structuralFeature_owner.instance().getInternalQueryRepresentation());
          // 	find current_structuralFeature_owner (structuralFeature, _current_structuralFeature, owner, _current_owner)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_structuralFeature, var__current_structuralFeature, var_owner, var__current_owner), Current_structuralFeature_owner.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
