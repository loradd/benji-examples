...
public final class $reference_lower extends BaseGeneratedEMFQuerySpecification<$reference_lower.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static $reference_lower.Match newMutableMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public static $reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
  ...
  public static class Matcher extends BaseMatcher<$reference_lower.Match> {
     ...
     * 
     */
    public Collection<$reference_lower.Match> getAllMatches(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public $reference_lower.Match getOneArbitraryMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super $reference_lower.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pReference, final Integer pLower, final IMatchProcessor<? super $reference_lower.Match> processor) {
     ...
     * 
     */
    public $reference_lower.Match newMatch(final TraceLink pReference, final Integer pLower) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfreference(final $reference_lower.Match partialMatch) {
    ...
    protected $reference_lower.Match tupleToMatch(final Tuple t) {
      try {
          return $reference_lower.Match.newMatch((TraceLink) t.get(POSITION_REFERENCE), (Integer) t.get(POSITION_LOWER));
    ...
    protected $reference_lower.Match arrayToMatch(final Object[] match) {
      try {
          return $reference_lower.Match.newMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
    ...
    protected $reference_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return $reference_lower.Match.newMutableMatch((TraceLink) match[POSITION_REFERENCE], (Integer) match[POSITION_LOWER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public $reference_lower.Match newMatch(final Object... parameters) {
    return $reference_lower.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.Integer) parameters[1]);
  }
