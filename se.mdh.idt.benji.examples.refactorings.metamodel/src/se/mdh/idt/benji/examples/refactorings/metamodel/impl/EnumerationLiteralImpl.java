 ...
 * </p>
 * <ul>
 *   <li>{@link se.mdh.idt.benji.examples.refactorings.metamodel.impl.EnumerationLiteralImpl#getEnumeration <em>Enumeration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationLiteralImpl extends ModelElementImpl implements EnumerationLiteral {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.ENUMERATION_LITERAL;
	}
	...
	public Enumeration getEnumeration() {
		if (eContainerFeatureID() != MetamodelPackage.ENUMERATION_LITERAL__ENUMERATION) return null;
	...
	public NotificationChain basicSetEnumeration(Enumeration newEnumeration, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEnumeration, MetamodelPackage.ENUMERATION_LITERAL__ENUMERATION, msgs);
		return msgs;
	}
	...
	public void setEnumeration(Enumeration newEnumeration) {
		if (newEnumeration != eInternalContainer() || (eContainerFeatureID() != MetamodelPackage.ENUMERATION_LITERAL__ENUMERATION && newEnumeration != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ENUMERATION_LITERAL__ENUMERATION, newEnumeration, newEnumeration));
	}
