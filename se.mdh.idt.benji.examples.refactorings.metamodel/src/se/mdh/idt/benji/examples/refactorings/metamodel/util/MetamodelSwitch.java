...
public class MetamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MetamodelPackage.CLASS: {
				se.mdh.idt.benji.examples.refactorings.metamodel.Class class_ = (se.mdh.idt.benji.examples.refactorings.metamodel.Class)theEObject;
			...
			case MetamodelPackage.ENUMERATION_LITERAL: {
			...
			case MetamodelPackage.STRUCTURAL_FEATURE: {
	 ...
	 * @generated
	 */
	public T casePackage(se.mdh.idt.benji.examples.refactorings.metamodel.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(se.mdh.idt.benji.examples.refactorings.metamodel.Class object) {
		return null;
	}
