...
public final class Remove_word_synset extends BaseGeneratedEMFQuerySpecification<Remove_word_synset.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_word_synset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_word_synset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Remove_word_synset.Match.parameterNames;
    }
    ...
    @Override
    public Remove_word_synset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Remove_word_synset.Match)) {
          Remove_word_synset.Match other = (Remove_word_synset.Match) obj;
    ...
    @Override
    public Remove_word_synset specification() {
     ...
     * 
     */
    public static Remove_word_synset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Remove_word_synset.Match newMutableMatch(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public static Remove_word_synset.Match newMatch(final TraceLink pWord, final TraceLink pSynset) {
      return new Immutable(pWord, pSynset);
    }
    
    private static final class Mutable extends Remove_word_synset.Match {
    ...
    private static final class Immutable extends Remove_word_synset.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_word_synset pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Remove_word_synset
   * 
   */
  public static class Matcher extends BaseMatcher<Remove_word_synset.Match> {
    /**
     ...
     * 
     */
    public static Remove_word_synset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Remove_word_synset.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Remove_word_synset.Matcher.class);
     ...
     * 
     */
    public Collection<Remove_word_synset.Match> getAllMatches(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public Remove_word_synset.Match getOneArbitraryMatch(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pWord, final TraceLink pSynset, final IMatchProcessor<? super Remove_word_synset.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pWord, final TraceLink pSynset, final IMatchProcessor<? super Remove_word_synset.Match> processor) {
     ...
     * 
     */
    public Remove_word_synset.Match newMatch(final TraceLink pWord, final TraceLink pSynset) {
      return Remove_word_synset.Match.newMatch(pWord, pSynset);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Remove_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Remove_word_synset.Match partialMatch) {
    ...
    @Override
    protected Remove_word_synset.Match tupleToMatch(final Tuple t) {
      try {
          return Remove_word_synset.Match.newMatch((TraceLink) t.get(POSITION_WORD), (TraceLink) t.get(POSITION_SYNSET));
    ...
    @Override
    protected Remove_word_synset.Match arrayToMatch(final Object[] match) {
      try {
          return Remove_word_synset.Match.newMatch((TraceLink) match[POSITION_WORD], (TraceLink) match[POSITION_SYNSET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Remove_word_synset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Remove_word_synset.Match.newMutableMatch((TraceLink) match[POSITION_WORD], (TraceLink) match[POSITION_SYNSET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Remove_word_synset.Matcher> querySpecification() {
      return Remove_word_synset.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_word_synset pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Remove_word_synset.Match> {
    /**
    ...
    @Override
    public void process(final Remove_word_synset.Match match) {
      process(match.getWord(), match.getSynset());
    }
  }
  
  private Remove_word_synset() {
   ...
   * 
   */
  public static Remove_word_synset instance() {
    try{
  ...
  @Override
  protected Remove_word_synset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Remove_word_synset.Matcher.on(engine);
  }
  
  @Override
  public Remove_word_synset.Matcher instantiate() {
    return Remove_word_synset.Matcher.create();
  }
  
  @Override
  public Remove_word_synset.Match newEmptyMatch() {
    return Remove_word_synset.Match.newEmptyMatch();
  }
  
  @Override
  public Remove_word_synset.Match newMatch(final Object... parameters) {
    return Remove_word_synset.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_word_synset (visibility: PUBLIC, simpleName: Remove_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_word_synset (visibility: PUBLIC, simpleName: Remove_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Remove_word_synset INSTANCE = new Remove_word_synset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Remove_word_synset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_word_synset (word, _current_word, synset, _current_synset)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_word, var__current_word, var_synset, var__current_synset), Current_word_synset.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
