...
public final class Initial_word_synset extends BaseGeneratedEMFQuerySpecification<Initial_word_synset.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_word_synset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
      this.fWord = pWord;
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_word_synset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Initial_word_synset.Match.parameterNames;
    }
    ...
    @Override
    public Initial_word_synset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Initial_word_synset.Match)) {
          Initial_word_synset.Match other = (Initial_word_synset.Match) obj;
    ...
    @Override
    public Initial_word_synset specification() {
     ...
     * 
     */
    public static Initial_word_synset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Initial_word_synset.Match newMutableMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public static Initial_word_synset.Match newMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
      return new Immutable(pWord, pInitial_word, pSynset, pInitial_synset);
    }
    
    private static final class Mutable extends Initial_word_synset.Match {
      Mutable(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
    ...
    private static final class Immutable extends Initial_word_synset.Match {
      Immutable(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
        super(pWord, pInitial_word, pSynset, pInitial_synset);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_word_synset pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Initial_word_synset
   * 
   */
  public static class Matcher extends BaseMatcher<Initial_word_synset.Match> {
    /**
     ...
     * 
     */
    public static Initial_word_synset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Initial_word_synset.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_word_synset.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_word_synset.Match> getAllMatches(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public Initial_word_synset.Match getOneArbitraryMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public int countMatches(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset, final IMatchProcessor<? super Initial_word_synset.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset, final IMatchProcessor<? super Initial_word_synset.Match> processor) {
     ...
     * 
     */
    public Initial_word_synset.Match newMatch(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
      return Initial_word_synset.Match.newMatch(pWord, pInitial_word, pSynset, pInitial_synset);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Initial_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfinitial_word(final Initial_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfinitial_word(final TraceLink pWord, final TraceLink pSynset, final Synset pInitial_synset) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Initial_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final TraceLink pWord, final Word pInitial_word, final Synset pInitial_synset) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Initial_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset) {
    ...
    @Override
    protected Initial_word_synset.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_word_synset.Match.newMatch((TraceLink) t.get(POSITION_WORD), (Word) t.get(POSITION_INITIAL_WORD), (TraceLink) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_INITIAL_SYNSET));
    ...
    @Override
    protected Initial_word_synset.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_word_synset.Match.newMatch((TraceLink) match[POSITION_WORD], (Word) match[POSITION_INITIAL_WORD], (TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Initial_word_synset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_word_synset.Match.newMutableMatch((TraceLink) match[POSITION_WORD], (Word) match[POSITION_INITIAL_WORD], (TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Initial_word_synset.Matcher> querySpecification() {
      return Initial_word_synset.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_word_synset pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_word_synset.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pWord, final Word pInitial_word, final TraceLink pSynset, final Synset pInitial_synset);
    
    @Override
    public void process(final Initial_word_synset.Match match) {
      process(match.getWord(), match.getInitial_word(), match.getSynset(), match.getInitial_synset());
    }
  }
  
  private Initial_word_synset() {
   ...
   * 
   */
  public static Initial_word_synset instance() {
    try{
  ...
  @Override
  protected Initial_word_synset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Initial_word_synset.Matcher.on(engine);
  }
  
  @Override
  public Initial_word_synset.Matcher instantiate() {
    return Initial_word_synset.Matcher.create();
  }
  
  @Override
  public Initial_word_synset.Match newEmptyMatch() {
    return Initial_word_synset.Match.newEmptyMatch();
  }
  
  @Override
  public Initial_word_synset.Match newMatch(final Object... parameters) {
    return Initial_word_synset.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Word) parameters[1], (se.mdh.idt.benji.trace.TraceLink) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_word_synset (visibility: PUBLIC, simpleName: Initial_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_word_synset (visibility: PUBLIC, simpleName: Initial_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_word_synset INSTANCE = new Initial_word_synset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_word_synset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
