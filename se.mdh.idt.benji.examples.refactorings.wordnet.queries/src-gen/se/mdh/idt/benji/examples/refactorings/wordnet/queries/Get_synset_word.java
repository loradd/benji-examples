...
public final class Get_synset_word extends BaseGeneratedEMFQuerySpecification<Get_synset_word.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_word pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_word";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_synset_word.Match.parameterNames;
    }
    ...
    @Override
    public Get_synset_word.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_synset_word.Match)) {
          Get_synset_word.Match other = (Get_synset_word.Match) obj;
    ...
    @Override
    public Get_synset_word specification() {
     ...
     * 
     */
    public static Get_synset_word.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_synset_word.Match newMutableMatch(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public static Get_synset_word.Match newMatch(final TraceLink pSynset, final TraceLink pWord) {
      return new Immutable(pSynset, pWord);
    }
    
    private static final class Mutable extends Get_synset_word.Match {
    ...
    private static final class Immutable extends Get_synset_word.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_word pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Get_synset_word.Match> {
    /**
     ...
     * 
     */
    public static Get_synset_word.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_synset_word.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_synset_word.Matcher.class);
     ...
     * 
     */
    public Collection<Get_synset_word.Match> getAllMatches(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public Get_synset_word.Match getOneArbitraryMatch(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final TraceLink pWord, final IMatchProcessor<? super Get_synset_word.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final TraceLink pWord, final IMatchProcessor<? super Get_synset_word.Match> processor) {
     ...
     * 
     */
    public Get_synset_word.Match newMatch(final TraceLink pSynset, final TraceLink pWord) {
      return Get_synset_word.Match.newMatch(pSynset, pWord);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Get_synset_word.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Get_synset_word.Match partialMatch) {
    ...
    @Override
    protected Get_synset_word.Match tupleToMatch(final Tuple t) {
      try {
          return Get_synset_word.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (TraceLink) t.get(POSITION_WORD));
    ...
    @Override
    protected Get_synset_word.Match arrayToMatch(final Object[] match) {
      try {
          return Get_synset_word.Match.newMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_synset_word.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_synset_word.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_synset_word.Matcher> querySpecification() {
      return Get_synset_word.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_word pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_synset_word.Match> {
    /**
    ...
    @Override
    public void process(final Get_synset_word.Match match) {
      process(match.getSynset(), match.getWord());
    }
  }
  
  private Get_synset_word() {
   ...
   * 
   */
  public static Get_synset_word instance() {
    try{
  ...
  @Override
  protected Get_synset_word.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_synset_word.Matcher.on(engine);
  }
  
  @Override
  public Get_synset_word.Matcher instantiate() {
    return Get_synset_word.Matcher.create();
  }
  
  @Override
  public Get_synset_word.Match newEmptyMatch() {
    return Get_synset_word.Match.newEmptyMatch();
  }
  
  @Override
  public Get_synset_word.Match newMatch(final Object... parameters) {
    return Get_synset_word.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_word (visibility: PUBLIC, simpleName: Get_synset_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_word (visibility: PUBLIC, simpleName: Get_synset_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_synset_word INSTANCE = new Get_synset_word();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_synset_word.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find initial_synset_word (synset, _initial_synset, word, _initial_word)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_synset, var__initial_synset, var_word, var__initial_word), Initial_synset_word.instance().getInternalQueryRepresentation());
          // 	find current_synset_word (synset, _current_synset, word, _current_word)
