...
public final class Set_synset_gloss extends BaseGeneratedEMFQuerySpecification<Set_synset_gloss.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.set_synset_gloss";
    }
    
    @Override
    public List<String> parameterNames() {
      return Set_synset_gloss.Match.parameterNames;
    }
    ...
    @Override
    public Set_synset_gloss.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Set_synset_gloss.Match)) {
          Set_synset_gloss.Match other = (Set_synset_gloss.Match) obj;
    ...
    @Override
    public Set_synset_gloss specification() {
     ...
     * 
     */
    public static Set_synset_gloss.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.set_synset_gloss pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Set_synset_gloss
   * 
   */
  public static class Matcher extends BaseMatcher<Set_synset_gloss.Match> {
    /**
     ...
     * 
     */
    public static Set_synset_gloss.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Set_synset_gloss.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Set_synset_gloss.Matcher.class);
     ...
     * 
     */
    public Set<String> getAllValuesOfgloss(final Set_synset_gloss.Match partialMatch) {
     ...
     * 
     */
    public static IQuerySpecification<Set_synset_gloss.Matcher> querySpecification() {
      return Set_synset_gloss.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.set_synset_gloss pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Set_synset_gloss.Match> {
    /**
   ...
   * 
   */
  public static Set_synset_gloss instance() {
    try{
  ...
  @Override
  protected Set_synset_gloss.Matcher instantiate(final ViatraQueryEngine engine) {
    return Set_synset_gloss.Matcher.on(engine);
  }
  
  @Override
  public Set_synset_gloss.Matcher instantiate() {
    return Set_synset_gloss.Matcher.create();
  }
  
  @Override
  public Set_synset_gloss.Match newEmptyMatch() {
    return Set_synset_gloss.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Set_synset_gloss (visibility: PUBLIC, simpleName: Set_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Set_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Set_synset_gloss (visibility: PUBLIC, simpleName: Set_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Set_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Set_synset_gloss INSTANCE = new Set_synset_gloss();
