...
public final class Insert_synset_hyponym extends BaseGeneratedEMFQuerySpecification<Insert_synset_hyponym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_synset_hyponym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_synset_hyponym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Insert_synset_hyponym.Match.parameterNames;
    }
    ...
    @Override
    public Insert_synset_hyponym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Insert_synset_hyponym.Match)) {
          Insert_synset_hyponym.Match other = (Insert_synset_hyponym.Match) obj;
    ...
    @Override
    public Insert_synset_hyponym specification() {
     ...
     * 
     */
    public static Insert_synset_hyponym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Insert_synset_hyponym.Match newMutableMatch(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public static Insert_synset_hyponym.Match newMatch(final TraceLink pSynset, final TraceLink pHyponym) {
      return new Immutable(pSynset, pHyponym);
    }
    
    private static final class Mutable extends Insert_synset_hyponym.Match {
    ...
    private static final class Immutable extends Insert_synset_hyponym.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_synset_hyponym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Insert_synset_hyponym
   * 
   */
  public static class Matcher extends BaseMatcher<Insert_synset_hyponym.Match> {
    /**
     ...
     * 
     */
    public static Insert_synset_hyponym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Insert_synset_hyponym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Insert_synset_hyponym.Matcher.class);
     ...
     * 
     */
    public Collection<Insert_synset_hyponym.Match> getAllMatches(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public Insert_synset_hyponym.Match getOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final TraceLink pHyponym, final IMatchProcessor<? super Insert_synset_hyponym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHyponym, final IMatchProcessor<? super Insert_synset_hyponym.Match> processor) {
     ...
     * 
     */
    public Insert_synset_hyponym.Match newMatch(final TraceLink pSynset, final TraceLink pHyponym) {
      return Insert_synset_hyponym.Match.newMatch(pSynset, pHyponym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Insert_synset_hyponym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfhyponym(final Insert_synset_hyponym.Match partialMatch) {
    ...
    @Override
    protected Insert_synset_hyponym.Match tupleToMatch(final Tuple t) {
      try {
          return Insert_synset_hyponym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (TraceLink) t.get(POSITION_HYPONYM));
    ...
    @Override
    protected Insert_synset_hyponym.Match arrayToMatch(final Object[] match) {
      try {
          return Insert_synset_hyponym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HYPONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Insert_synset_hyponym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Insert_synset_hyponym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HYPONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Insert_synset_hyponym.Matcher> querySpecification() {
      return Insert_synset_hyponym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_synset_hyponym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Insert_synset_hyponym.Match> {
    /**
    ...
    @Override
    public void process(final Insert_synset_hyponym.Match match) {
      process(match.getSynset(), match.getHyponym());
    }
  }
  
  private Insert_synset_hyponym() {
   ...
   * 
   */
  public static Insert_synset_hyponym instance() {
    try{
  ...
  @Override
  protected Insert_synset_hyponym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Insert_synset_hyponym.Matcher.on(engine);
  }
  
  @Override
  public Insert_synset_hyponym.Matcher instantiate() {
    return Insert_synset_hyponym.Matcher.create();
  }
  
  @Override
  public Insert_synset_hyponym.Match newEmptyMatch() {
    return Insert_synset_hyponym.Match.newEmptyMatch();
  }
  
  @Override
  public Insert_synset_hyponym.Match newMatch(final Object... parameters) {
    return Insert_synset_hyponym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_synset_hyponym (visibility: PUBLIC, simpleName: Insert_synset_hyponym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_synset_hyponym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_synset_hyponym (visibility: PUBLIC, simpleName: Insert_synset_hyponym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_synset_hyponym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Insert_synset_hyponym INSTANCE = new Insert_synset_hyponym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Insert_synset_hyponym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_synset_hyponym (synset, _initial_synset, hyponym, _initial_hyponym)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_synset, var__initial_synset, var_hyponym, var__initial_hyponym), Initial_synset_hyponym.instance().getInternalQueryRepresentation());
          // 	find current_synset_hyponym (synset, _current_synset, hyponym, _current_hyponym)
