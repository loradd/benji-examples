...
public final class Current_word_synsets extends BaseGeneratedEMFQuerySpecification<Current_word_synsets.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_word_synsets pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
      this.fWord = pWord;
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_word_synsets";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_word_synsets.Match.parameterNames;
    }
    ...
    @Override
    public Current_word_synsets.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_word_synsets.Match)) {
          Current_word_synsets.Match other = (Current_word_synsets.Match) obj;
    ...
    @Override
    public Current_word_synsets specification() {
     ...
     * 
     */
    public static Current_word_synsets.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_word_synsets.Match newMutableMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public static Current_word_synsets.Match newMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
      return new Immutable(pWord, pCurrent_word, pSynset, pCurrent_synset);
    }
    
    private static final class Mutable extends Current_word_synsets.Match {
      Mutable(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
    ...
    private static final class Immutable extends Current_word_synsets.Match {
      Immutable(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
        super(pWord, pCurrent_word, pSynset, pCurrent_synset);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_word_synsets pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Current_word_synsets
   * 
   */
  public static class Matcher extends BaseMatcher<Current_word_synsets.Match> {
    /**
     ...
     * 
     */
    public static Current_word_synsets.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_word_synsets.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_word_synsets.Matcher.class);
     ...
     * 
     */
    public Collection<Current_word_synsets.Match> getAllMatches(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public Current_word_synsets.Match getOneArbitraryMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public int countMatches(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public void forEachMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset, final IMatchProcessor<? super Current_word_synsets.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset, final IMatchProcessor<? super Current_word_synsets.Match> processor) {
     ...
     * 
     */
    public Current_word_synsets.Match newMatch(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
      return Current_word_synsets.Match.newMatch(pWord, pCurrent_word, pSynset, pCurrent_synset);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Current_word_synsets.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfcurrent_word(final Current_word_synsets.Match partialMatch) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfcurrent_word(final Trace pWord, final Trace pSynset, final Synset pCurrent_synset) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Current_word_synsets.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Trace pWord, final Word pCurrent_word, final Synset pCurrent_synset) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_word_synsets.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Trace pWord, final Word pCurrent_word, final Trace pSynset) {
    ...
    @Override
    protected Current_word_synsets.Match tupleToMatch(final Tuple t) {
      try {
          return Current_word_synsets.Match.newMatch((Trace) t.get(POSITION_WORD), (Word) t.get(POSITION_CURRENT_WORD), (Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET));
    ...
    @Override
    protected Current_word_synsets.Match arrayToMatch(final Object[] match) {
      try {
          return Current_word_synsets.Match.newMatch((Trace) match[POSITION_WORD], (Word) match[POSITION_CURRENT_WORD], (Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_word_synsets.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_word_synsets.Match.newMutableMatch((Trace) match[POSITION_WORD], (Word) match[POSITION_CURRENT_WORD], (Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_word_synsets.Matcher> querySpecification() {
      return Current_word_synsets.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_word_synsets pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_word_synsets.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pWord, final Word pCurrent_word, final Trace pSynset, final Synset pCurrent_synset);
    
    @Override
    public void process(final Current_word_synsets.Match match) {
      process(match.getWord(), match.getCurrent_word(), match.getSynset(), match.getCurrent_synset());
    }
  }
  
  private Current_word_synsets() {
   ...
   * 
   */
  public static Current_word_synsets instance() {
    try{
  ...
  @Override
  protected Current_word_synsets.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_word_synsets.Matcher.on(engine);
  }
  
  @Override
  public Current_word_synsets.Matcher instantiate() {
    return Current_word_synsets.Matcher.create();
  }
  
  @Override
  public Current_word_synsets.Match newEmptyMatch() {
    return Current_word_synsets.Match.newEmptyMatch();
  }
  
  @Override
  public Current_word_synsets.Match newMatch(final Object... parameters) {
    return Current_word_synsets.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Word) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_word_synsets (visibility: PUBLIC, simpleName: Current_word_synsets, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_word_synsets, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_word_synsets (visibility: PUBLIC, simpleName: Current_word_synsets, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_word_synsets, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_word_synsets INSTANCE = new Current_word_synsets();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_word_synsets.GeneratedPQuery INSTANCE = new GeneratedPQuery();
