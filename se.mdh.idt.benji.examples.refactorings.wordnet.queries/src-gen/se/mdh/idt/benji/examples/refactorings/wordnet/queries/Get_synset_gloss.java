...
public final class Get_synset_gloss extends BaseGeneratedEMFQuerySpecification<Get_synset_gloss.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_gloss pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_gloss";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_synset_gloss.Match.parameterNames;
    }
    ...
    @Override
    public Get_synset_gloss.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_synset_gloss.Match)) {
          Get_synset_gloss.Match other = (Get_synset_gloss.Match) obj;
    ...
    @Override
    public Get_synset_gloss specification() {
     ...
     * 
     */
    public static Get_synset_gloss.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_synset_gloss.Match newMutableMatch(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public static Get_synset_gloss.Match newMatch(final TraceLink pSynset, final String pGloss) {
      return new Immutable(pSynset, pGloss);
    }
    
    private static final class Mutable extends Get_synset_gloss.Match {
    ...
    private static final class Immutable extends Get_synset_gloss.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_gloss pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_synset_gloss
   * 
   */
  public static class Matcher extends BaseMatcher<Get_synset_gloss.Match> {
    /**
     ...
     * 
     */
    public static Get_synset_gloss.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_synset_gloss.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_synset_gloss.Matcher.class);
     ...
     * 
     */
    public Collection<Get_synset_gloss.Match> getAllMatches(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public Get_synset_gloss.Match getOneArbitraryMatch(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final String pGloss, final IMatchProcessor<? super Get_synset_gloss.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final String pGloss, final IMatchProcessor<? super Get_synset_gloss.Match> processor) {
     ...
     * 
     */
    public Get_synset_gloss.Match newMatch(final TraceLink pSynset, final String pGloss) {
      return Get_synset_gloss.Match.newMatch(pSynset, pGloss);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Get_synset_gloss.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfgloss(final Get_synset_gloss.Match partialMatch) {
    ...
    @Override
    protected Get_synset_gloss.Match tupleToMatch(final Tuple t) {
      try {
          return Get_synset_gloss.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (String) t.get(POSITION_GLOSS));
    ...
    @Override
    protected Get_synset_gloss.Match arrayToMatch(final Object[] match) {
      try {
          return Get_synset_gloss.Match.newMatch((TraceLink) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_synset_gloss.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_synset_gloss.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_synset_gloss.Matcher> querySpecification() {
      return Get_synset_gloss.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_gloss pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_synset_gloss.Match> {
    /**
    ...
    @Override
    public void process(final Get_synset_gloss.Match match) {
      process(match.getSynset(), match.getGloss());
    }
  }
  
  private Get_synset_gloss() {
   ...
   * 
   */
  public static Get_synset_gloss instance() {
    try{
  ...
  @Override
  protected Get_synset_gloss.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_synset_gloss.Matcher.on(engine);
  }
  
  @Override
  public Get_synset_gloss.Matcher instantiate() {
    return Get_synset_gloss.Matcher.create();
  }
  
  @Override
  public Get_synset_gloss.Match newEmptyMatch() {
    return Get_synset_gloss.Match.newEmptyMatch();
  }
  
  @Override
  public Get_synset_gloss.Match newMatch(final Object... parameters) {
    return Get_synset_gloss.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_gloss (visibility: PUBLIC, simpleName: Get_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_gloss (visibility: PUBLIC, simpleName: Get_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_synset_gloss INSTANCE = new Get_synset_gloss();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_synset_gloss.GeneratedPQuery INSTANCE = new GeneratedPQuery();
