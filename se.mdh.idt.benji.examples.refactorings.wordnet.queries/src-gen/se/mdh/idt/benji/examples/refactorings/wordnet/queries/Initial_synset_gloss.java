...
public final class Initial_synset_gloss extends BaseGeneratedEMFQuerySpecification<Initial_synset_gloss.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public static Initial_synset_gloss.Match newMutableMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public static Initial_synset_gloss.Match newMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
      return new Immutable(pSynset, pInitial_synset, pGloss);
    }
    
    private static final class Mutable extends Initial_synset_gloss.Match {
      Mutable(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
    ...
    private static final class Immutable extends Initial_synset_gloss.Match {
      Immutable(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
        super(pSynset, pInitial_synset, pGloss);
      }
   ...
   * pattern initial_synset_gloss (synset : Trace, initial_synset : Synset, gloss : java String) {
  ...
  public static class Matcher extends BaseMatcher<Initial_synset_gloss.Match> {
     ...
     * 
     */
    public Collection<Initial_synset_gloss.Match> getAllMatches(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public Initial_synset_gloss.Match getOneArbitraryMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss, final IMatchProcessor<? super Initial_synset_gloss.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss, final IMatchProcessor<? super Initial_synset_gloss.Match> processor) {
     ...
     * 
     */
    public Initial_synset_gloss.Match newMatch(final Trace pSynset, final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Initial_synset_gloss.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pInitial_synset, final String pGloss) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Trace pSynset, final String pGloss) {
     ...
     * 
     */
    public Set<String> getAllValuesOfgloss(final Trace pSynset, final Synset pInitial_synset) {
    ...
    protected Initial_synset_gloss.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_synset_gloss.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_INITIAL_SYNSET), (String) t.get(POSITION_GLOSS));
    ...
    protected Initial_synset_gloss.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_synset_gloss.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
    ...
    protected Initial_synset_gloss.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_synset_gloss.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public static abstract class Processor implements IMatchProcessor<Initial_synset_gloss.Match> {
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pInitial_synset, final String pGloss);
  ...
  public Initial_synset_gloss.Match newMatch(final Object... parameters) {
    return Initial_synset_gloss.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (java.lang.String) parameters[2]);
  }
