...
public final class Current_synset_holonyms extends BaseGeneratedEMFQuerySpecification<Current_synset_holonyms.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_holonyms pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_holonyms";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_synset_holonyms.Match.parameterNames;
    }
    ...
    @Override
    public Current_synset_holonyms.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_synset_holonyms.Match)) {
          Current_synset_holonyms.Match other = (Current_synset_holonyms.Match) obj;
    ...
    @Override
    public Current_synset_holonyms specification() {
     ...
     * 
     */
    public static Current_synset_holonyms.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_synset_holonyms.Match newMutableMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public static Current_synset_holonyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
      return new Immutable(pSynset, pCurrent_synset, pHolonym, pCurrent_holonym);
    }
    
    private static final class Mutable extends Current_synset_holonyms.Match {
      Mutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
    ...
    private static final class Immutable extends Current_synset_holonyms.Match {
      Immutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
        super(pSynset, pCurrent_synset, pHolonym, pCurrent_holonym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_holonyms pattern,
   ...
   * pattern current_synset_holonyms (synset : Trace, current_synset : Synset, holonym : Trace, current_holonym : Synset) {
   ...
   * @see Match
   *  @see Processor
   * @see Current_synset_holonyms
   * 
   */
  public static class Matcher extends BaseMatcher<Current_synset_holonyms.Match> {
    /**
     ...
     * 
     */
    public static Current_synset_holonyms.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_synset_holonyms.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_synset_holonyms.Matcher.class);
     ...
     * 
     */
    public Collection<Current_synset_holonyms.Match> getAllMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public Current_synset_holonyms.Match getOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym, final IMatchProcessor<? super Current_synset_holonyms.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym, final IMatchProcessor<? super Current_synset_holonyms.Match> processor) {
     ...
     * 
     */
    public Current_synset_holonyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
      return Current_synset_holonyms.Match.newMatch(pSynset, pCurrent_synset, pHolonym, pCurrent_holonym);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Current_synset_holonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_synset_holonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Trace pSynset, final Trace pHolonym, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfholonym(final Current_synset_holonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfholonym(final Trace pSynset, final Synset pCurrent_synset, final Synset pCurrent_holonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_holonym(final Current_synset_holonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_holonym(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym) {
    ...
    @Override
    protected Current_synset_holonyms.Match tupleToMatch(final Tuple t) {
      try {
          return Current_synset_holonyms.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET), (Trace) t.get(POSITION_HOLONYM), (Synset) t.get(POSITION_CURRENT_HOLONYM));
    ...
    @Override
    protected Current_synset_holonyms.Match arrayToMatch(final Object[] match) {
      try {
          return Current_synset_holonyms.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HOLONYM], (Synset) match[POSITION_CURRENT_HOLONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_synset_holonyms.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_synset_holonyms.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HOLONYM], (Synset) match[POSITION_CURRENT_HOLONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_synset_holonyms.Matcher> querySpecification() {
      return Current_synset_holonyms.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_holonyms pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_synset_holonyms.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pCurrent_synset, final Trace pHolonym, final Synset pCurrent_holonym);
    
    @Override
    public void process(final Current_synset_holonyms.Match match) {
      process(match.getSynset(), match.getCurrent_synset(), match.getHolonym(), match.getCurrent_holonym());
    }
  }
  
  private Current_synset_holonyms() {
   ...
   * 
   */
  public static Current_synset_holonyms instance() {
    try{
  ...
  @Override
  protected Current_synset_holonyms.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_synset_holonyms.Matcher.on(engine);
  }
  
  @Override
  public Current_synset_holonyms.Matcher instantiate() {
    return Current_synset_holonyms.Matcher.create();
  }
  
  @Override
  public Current_synset_holonyms.Match newEmptyMatch() {
    return Current_synset_holonyms.Match.newEmptyMatch();
  }
  
  @Override
  public Current_synset_holonyms.Match newMatch(final Object... parameters) {
    return Current_synset_holonyms.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_holonyms (visibility: PUBLIC, simpleName: Current_synset_holonyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_holonyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_holonyms (visibility: PUBLIC, simpleName: Current_synset_holonyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_holonyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_synset_holonyms INSTANCE = new Current_synset_holonyms();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_synset_holonyms.GeneratedPQuery INSTANCE = new GeneratedPQuery();
