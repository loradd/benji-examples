...
public final class Set_word_name extends BaseGeneratedEMFQuerySpecification<Set_word_name.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Set_word_name.Match newMutableMatch(final TraceLink pWord, final String pName) {
     ...
     * 
     */
    public static Set_word_name.Match newMatch(final TraceLink pWord, final String pName) {
  ...
  public static class Matcher extends BaseMatcher<Set_word_name.Match> {
     ...
     * 
     */
    public Collection<Set_word_name.Match> getAllMatches(final TraceLink pWord, final String pName) {
     ...
     * 
     */
    public Set_word_name.Match getOneArbitraryMatch(final TraceLink pWord, final String pName) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pWord, final String pName, final IMatchProcessor<? super Set_word_name.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pWord, final String pName, final IMatchProcessor<? super Set_word_name.Match> processor) {
     ...
     * 
     */
    public Set_word_name.Match newMatch(final TraceLink pWord, final String pName) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Set_word_name.Match partialMatch) {
    ...
    protected Set_word_name.Match tupleToMatch(final Tuple t) {
      try {
          return Set_word_name.Match.newMatch((TraceLink) t.get(POSITION_WORD), (String) t.get(POSITION_NAME));
    ...
    protected Set_word_name.Match arrayToMatch(final Object[] match) {
      try {
          return Set_word_name.Match.newMatch((TraceLink) match[POSITION_WORD], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
    ...
    protected Set_word_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Set_word_name.Match.newMutableMatch((TraceLink) match[POSITION_WORD], (String) match[POSITION_NAME]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Set_word_name.Match newMatch(final Object... parameters) {
    return Set_word_name.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
