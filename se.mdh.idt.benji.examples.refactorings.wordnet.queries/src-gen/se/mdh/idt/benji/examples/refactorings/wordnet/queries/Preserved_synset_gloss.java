...
public final class Preserved_synset_gloss extends BaseGeneratedEMFQuerySpecification<Preserved_synset_gloss.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.preserved_synset_gloss pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.preserved_synset_gloss";
    }
    
    @Override
    public List<String> parameterNames() {
      return Preserved_synset_gloss.Match.parameterNames;
    }
    ...
    @Override
    public Preserved_synset_gloss.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Preserved_synset_gloss.Match)) {
          Preserved_synset_gloss.Match other = (Preserved_synset_gloss.Match) obj;
    ...
    @Override
    public Preserved_synset_gloss specification() {
     ...
     * 
     */
    public static Preserved_synset_gloss.Match newEmptyMatch() {
     ...
     * 
     */
    public static Preserved_synset_gloss.Match newMutableMatch(final Trace pSynset, final String pGloss) {
     ...
     * 
     */
    public static Preserved_synset_gloss.Match newMatch(final Trace pSynset, final String pGloss) {
      return new Immutable(pSynset, pGloss);
    }
    
    private static final class Mutable extends Preserved_synset_gloss.Match {
    ...
    private static final class Immutable extends Preserved_synset_gloss.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.preserved_synset_gloss pattern,
   ...
   * <p>Original source:
   * <code><pre>
   * // synset - gloss - preserved
   * pattern preserved_synset_gloss (synset : Trace, gloss : java String) {
   ...
   * @see Match
   *  @see Processor
   * @see Preserved_synset_gloss
   * 
   */
  public static class Matcher extends BaseMatcher<Preserved_synset_gloss.Match> {
    /**
     ...
     * 
     */
    public static Preserved_synset_gloss.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Preserved_synset_gloss.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Preserved_synset_gloss.Matcher.class);
     ...
     * 
     */
    public Collection<Preserved_synset_gloss.Match> getAllMatches(final Trace pSynset, final String pGloss) {
     ...
     * 
     */
    public Preserved_synset_gloss.Match getOneArbitraryMatch(final Trace pSynset, final String pGloss) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final String pGloss, final IMatchProcessor<? super Preserved_synset_gloss.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final String pGloss, final IMatchProcessor<? super Preserved_synset_gloss.Match> processor) {
     ...
     * 
     */
    public Preserved_synset_gloss.Match newMatch(final Trace pSynset, final String pGloss) {
      return Preserved_synset_gloss.Match.newMatch(pSynset, pGloss);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Preserved_synset_gloss.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfgloss(final Preserved_synset_gloss.Match partialMatch) {
    ...
    @Override
    protected Preserved_synset_gloss.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved_synset_gloss.Match.newMatch((Trace) t.get(POSITION_SYNSET), (String) t.get(POSITION_GLOSS));
    ...
    @Override
    protected Preserved_synset_gloss.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved_synset_gloss.Match.newMatch((Trace) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Preserved_synset_gloss.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved_synset_gloss.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Preserved_synset_gloss.Matcher> querySpecification() {
      return Preserved_synset_gloss.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.preserved_synset_gloss pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Preserved_synset_gloss.Match> {
    /**
    ...
    @Override
    public void process(final Preserved_synset_gloss.Match match) {
      process(match.getSynset(), match.getGloss());
    }
  }
  
  private Preserved_synset_gloss() {
   ...
   * 
   */
  public static Preserved_synset_gloss instance() {
    try{
  ...
  @Override
  protected Preserved_synset_gloss.Matcher instantiate(final ViatraQueryEngine engine) {
    return Preserved_synset_gloss.Matcher.on(engine);
  }
  
  @Override
  public Preserved_synset_gloss.Matcher instantiate() {
    return Preserved_synset_gloss.Matcher.create();
  }
  
  @Override
  public Preserved_synset_gloss.Match newEmptyMatch() {
    return Preserved_synset_gloss.Match.newEmptyMatch();
  }
  
  @Override
  public Preserved_synset_gloss.Match newMatch(final Object... parameters) {
    return Preserved_synset_gloss.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Preserved_synset_gloss (visibility: PUBLIC, simpleName: Preserved_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Preserved_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Preserved_synset_gloss (visibility: PUBLIC, simpleName: Preserved_synset_gloss, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Preserved_synset_gloss, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Preserved_synset_gloss INSTANCE = new Preserved_synset_gloss();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Preserved_synset_gloss.GeneratedPQuery INSTANCE = new GeneratedPQuery();
