...
public final class Current_synset_words extends BaseGeneratedEMFQuerySpecification<Current_synset_words.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_words pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_words";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_synset_words.Match.parameterNames;
    }
    ...
    @Override
    public Current_synset_words.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_synset_words.Match)) {
          Current_synset_words.Match other = (Current_synset_words.Match) obj;
    ...
    @Override
    public Current_synset_words specification() {
     ...
     * 
     */
    public static Current_synset_words.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_synset_words.Match newMutableMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public static Current_synset_words.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
      return new Immutable(pSynset, pCurrent_synset, pWord, pCurrent_word);
    }
    
    private static final class Mutable extends Current_synset_words.Match {
      Mutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
    ...
    private static final class Immutable extends Current_synset_words.Match {
      Immutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
        super(pSynset, pCurrent_synset, pWord, pCurrent_word);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_words pattern,
   ...
   * pattern current_synset_words (synset : Trace, current_synset : Synset, word : Trace, current_word : Word) {
   ...
   * @see Match
   *  @see Processor
   * @see Current_synset_words
   * 
   */
  public static class Matcher extends BaseMatcher<Current_synset_words.Match> {
    /**
     ...
     * 
     */
    public static Current_synset_words.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_synset_words.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_synset_words.Matcher.class);
     ...
     * 
     */
    public Collection<Current_synset_words.Match> getAllMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public Current_synset_words.Match getOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word, final IMatchProcessor<? super Current_synset_words.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word, final IMatchProcessor<? super Current_synset_words.Match> processor) {
     ...
     * 
     */
    public Current_synset_words.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
      return Current_synset_words.Match.newMatch(pSynset, pCurrent_synset, pWord, pCurrent_word);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Current_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Trace pSynset, final Trace pWord, final Word pCurrent_word) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Current_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Trace pSynset, final Synset pCurrent_synset, final Word pCurrent_word) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfcurrent_word(final Current_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfcurrent_word(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord) {
    ...
    @Override
    protected Current_synset_words.Match tupleToMatch(final Tuple t) {
      try {
          return Current_synset_words.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET), (Trace) t.get(POSITION_WORD), (Word) t.get(POSITION_CURRENT_WORD));
    ...
    @Override
    protected Current_synset_words.Match arrayToMatch(final Object[] match) {
      try {
          return Current_synset_words.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_WORD], (Word) match[POSITION_CURRENT_WORD]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_synset_words.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_synset_words.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_WORD], (Word) match[POSITION_CURRENT_WORD]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_synset_words.Matcher> querySpecification() {
      return Current_synset_words.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_words pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_synset_words.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pCurrent_synset, final Trace pWord, final Word pCurrent_word);
    
    @Override
    public void process(final Current_synset_words.Match match) {
      process(match.getSynset(), match.getCurrent_synset(), match.getWord(), match.getCurrent_word());
    }
  }
  
  private Current_synset_words() {
   ...
   * 
   */
  public static Current_synset_words instance() {
    try{
  ...
  @Override
  protected Current_synset_words.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_synset_words.Matcher.on(engine);
  }
  
  @Override
  public Current_synset_words.Matcher instantiate() {
    return Current_synset_words.Matcher.create();
  }
  
  @Override
  public Current_synset_words.Match newEmptyMatch() {
    return Current_synset_words.Match.newEmptyMatch();
  }
  
  @Override
  public Current_synset_words.Match newMatch(final Object... parameters) {
    return Current_synset_words.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Word) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_words (visibility: PUBLIC, simpleName: Current_synset_words, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_words, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_words (visibility: PUBLIC, simpleName: Current_synset_words, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_words, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_synset_words INSTANCE = new Current_synset_words();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_synset_words.GeneratedPQuery INSTANCE = new GeneratedPQuery();
