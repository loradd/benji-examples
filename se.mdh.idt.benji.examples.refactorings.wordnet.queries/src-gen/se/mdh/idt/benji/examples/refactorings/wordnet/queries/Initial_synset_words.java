...
public final class Initial_synset_words extends BaseGeneratedEMFQuerySpecification<Initial_synset_words.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_words pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_words";
    }
    
    @Override
    public List<String> parameterNames() {
      return Initial_synset_words.Match.parameterNames;
    }
    ...
    @Override
    public Initial_synset_words.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Initial_synset_words.Match)) {
          Initial_synset_words.Match other = (Initial_synset_words.Match) obj;
    ...
    @Override
    public Initial_synset_words specification() {
     ...
     * 
     */
    public static Initial_synset_words.Match newEmptyMatch() {
     ...
     * 
     */
    public static Initial_synset_words.Match newMutableMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public static Initial_synset_words.Match newMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
      return new Immutable(pSynset, pInitial_synset, pWord, pInitial_word);
    }
    
    private static final class Mutable extends Initial_synset_words.Match {
      Mutable(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
    ...
    private static final class Immutable extends Initial_synset_words.Match {
      Immutable(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
        super(pSynset, pInitial_synset, pWord, pInitial_word);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_words pattern,
   ...
   * pattern initial_synset_words (synset : Trace, initial_synset : Synset, word : Trace, initial_word : Word) {
   ...
   * @see Match
   *  @see Processor
   * @see Initial_synset_words
   * 
   */
  public static class Matcher extends BaseMatcher<Initial_synset_words.Match> {
    /**
     ...
     * 
     */
    public static Initial_synset_words.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Initial_synset_words.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_synset_words.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_synset_words.Match> getAllMatches(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public Initial_synset_words.Match getOneArbitraryMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word, final IMatchProcessor<? super Initial_synset_words.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word, final IMatchProcessor<? super Initial_synset_words.Match> processor) {
     ...
     * 
     */
    public Initial_synset_words.Match newMatch(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
      return Initial_synset_words.Match.newMatch(pSynset, pInitial_synset, pWord, pInitial_word);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Initial_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pInitial_synset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Initial_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Trace pSynset, final Trace pWord, final Word pInitial_word) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Initial_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfword(final Trace pSynset, final Synset pInitial_synset, final Word pInitial_word) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfinitial_word(final Initial_synset_words.Match partialMatch) {
     ...
     * 
     */
    public Set<Word> getAllValuesOfinitial_word(final Trace pSynset, final Synset pInitial_synset, final Trace pWord) {
    ...
    @Override
    protected Initial_synset_words.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_synset_words.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_INITIAL_SYNSET), (Trace) t.get(POSITION_WORD), (Word) t.get(POSITION_INITIAL_WORD));
    ...
    @Override
    protected Initial_synset_words.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_synset_words.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (Trace) match[POSITION_WORD], (Word) match[POSITION_INITIAL_WORD]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Initial_synset_words.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_synset_words.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (Trace) match[POSITION_WORD], (Word) match[POSITION_INITIAL_WORD]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Initial_synset_words.Matcher> querySpecification() {
      return Initial_synset_words.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_words pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_synset_words.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pInitial_synset, final Trace pWord, final Word pInitial_word);
    
    @Override
    public void process(final Initial_synset_words.Match match) {
      process(match.getSynset(), match.getInitial_synset(), match.getWord(), match.getInitial_word());
    }
  }
  
  private Initial_synset_words() {
   ...
   * 
   */
  public static Initial_synset_words instance() {
    try{
  ...
  @Override
  protected Initial_synset_words.Matcher instantiate(final ViatraQueryEngine engine) {
    return Initial_synset_words.Matcher.on(engine);
  }
  
  @Override
  public Initial_synset_words.Matcher instantiate() {
    return Initial_synset_words.Matcher.create();
  }
  
  @Override
  public Initial_synset_words.Match newEmptyMatch() {
    return Initial_synset_words.Match.newEmptyMatch();
  }
  
  @Override
  public Initial_synset_words.Match newMatch(final Object... parameters) {
    return Initial_synset_words.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Word) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_words (visibility: PUBLIC, simpleName: Initial_synset_words, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_words, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_words (visibility: PUBLIC, simpleName: Initial_synset_words, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_words, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_synset_words INSTANCE = new Initial_synset_words();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_synset_words.GeneratedPQuery INSTANCE = new GeneratedPQuery();
