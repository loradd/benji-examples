...
public final class Get_synset_holonym extends BaseGeneratedEMFQuerySpecification<Get_synset_holonym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_holonym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_holonym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_synset_holonym.Match.parameterNames;
    }
    ...
    @Override
    public Get_synset_holonym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_synset_holonym.Match)) {
          Get_synset_holonym.Match other = (Get_synset_holonym.Match) obj;
    ...
    @Override
    public Get_synset_holonym specification() {
     ...
     * 
     */
    public static Get_synset_holonym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_synset_holonym.Match newMutableMatch(final TraceLink pSynset, final TraceLink pHolonym) {
     ...
     * 
     */
    public static Get_synset_holonym.Match newMatch(final TraceLink pSynset, final TraceLink pHolonym) {
      return new Immutable(pSynset, pHolonym);
    }
    
    private static final class Mutable extends Get_synset_holonym.Match {
    ...
    private static final class Immutable extends Get_synset_holonym.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_holonym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Get_synset_holonym
   * 
   */
  public static class Matcher extends BaseMatcher<Get_synset_holonym.Match> {
    /**
     ...
     * 
     */
    public static Get_synset_holonym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_synset_holonym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_synset_holonym.Matcher.class);
     ...
     * 
     */
    public Collection<Get_synset_holonym.Match> getAllMatches(final TraceLink pSynset, final TraceLink pHolonym) {
     ...
     * 
     */
    public Get_synset_holonym.Match getOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHolonym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final TraceLink pHolonym, final IMatchProcessor<? super Get_synset_holonym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHolonym, final IMatchProcessor<? super Get_synset_holonym.Match> processor) {
     ...
     * 
     */
    public Get_synset_holonym.Match newMatch(final TraceLink pSynset, final TraceLink pHolonym) {
      return Get_synset_holonym.Match.newMatch(pSynset, pHolonym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Get_synset_holonym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfholonym(final Get_synset_holonym.Match partialMatch) {
    ...
    @Override
    protected Get_synset_holonym.Match tupleToMatch(final Tuple t) {
      try {
          return Get_synset_holonym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (TraceLink) t.get(POSITION_HOLONYM));
    ...
    @Override
    protected Get_synset_holonym.Match arrayToMatch(final Object[] match) {
      try {
          return Get_synset_holonym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HOLONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_synset_holonym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_synset_holonym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HOLONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_synset_holonym.Matcher> querySpecification() {
      return Get_synset_holonym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_synset_holonym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_synset_holonym.Match> {
    /**
    ...
    @Override
    public void process(final Get_synset_holonym.Match match) {
      process(match.getSynset(), match.getHolonym());
    }
  }
  
  private Get_synset_holonym() {
   ...
   * 
   */
  public static Get_synset_holonym instance() {
    try{
  ...
  @Override
  protected Get_synset_holonym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_synset_holonym.Matcher.on(engine);
  }
  
  @Override
  public Get_synset_holonym.Matcher instantiate() {
    return Get_synset_holonym.Matcher.create();
  }
  
  @Override
  public Get_synset_holonym.Match newEmptyMatch() {
    return Get_synset_holonym.Match.newEmptyMatch();
  }
  
  @Override
  public Get_synset_holonym.Match newMatch(final Object... parameters) {
    return Get_synset_holonym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_holonym (visibility: PUBLIC, simpleName: Get_synset_holonym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_holonym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_holonym (visibility: PUBLIC, simpleName: Get_synset_holonym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_synset_holonym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_synset_holonym INSTANCE = new Get_synset_holonym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_synset_holonym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
