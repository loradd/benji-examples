...
public final class Unset_synset_gloss extends BaseGeneratedEMFQuerySpecification<Unset_synset_gloss.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Unset_synset_gloss.Match newMutableMatch(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public static Unset_synset_gloss.Match newMatch(final TraceLink pSynset, final String pGloss) {
  ...
  public static class Matcher extends BaseMatcher<Unset_synset_gloss.Match> {
     ...
     * 
     */
    public Collection<Unset_synset_gloss.Match> getAllMatches(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public Unset_synset_gloss.Match getOneArbitraryMatch(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final String pGloss, final IMatchProcessor<? super Unset_synset_gloss.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final String pGloss, final IMatchProcessor<? super Unset_synset_gloss.Match> processor) {
     ...
     * 
     */
    public Unset_synset_gloss.Match newMatch(final TraceLink pSynset, final String pGloss) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Unset_synset_gloss.Match partialMatch) {
    ...
    protected Unset_synset_gloss.Match tupleToMatch(final Tuple t) {
      try {
          return Unset_synset_gloss.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (String) t.get(POSITION_GLOSS));
    ...
    protected Unset_synset_gloss.Match arrayToMatch(final Object[] match) {
      try {
          return Unset_synset_gloss.Match.newMatch((TraceLink) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
    ...
    protected Unset_synset_gloss.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unset_synset_gloss.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (String) match[POSITION_GLOSS]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Unset_synset_gloss.Match newMatch(final Object... parameters) {
    return Unset_synset_gloss.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (java.lang.String) parameters[1]);
  }
