...
public final class Initial_synset_hyperonym extends BaseGeneratedEMFQuerySpecification<Initial_synset_hyperonym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_hyperonym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_hyperonym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Initial_synset_hyperonym.Match.parameterNames;
    }
    ...
    @Override
    public Initial_synset_hyperonym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Initial_synset_hyperonym.Match)) {
          Initial_synset_hyperonym.Match other = (Initial_synset_hyperonym.Match) obj;
    ...
    @Override
    public Initial_synset_hyperonym specification() {
     ...
     * 
     */
    public static Initial_synset_hyperonym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Initial_synset_hyperonym.Match newMutableMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public static Initial_synset_hyperonym.Match newMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
      return new Immutable(pSynset, pInitial_synset, pHyperonym, pInitial_hyperonym);
    }
    
    private static final class Mutable extends Initial_synset_hyperonym.Match {
      Mutable(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
    ...
    private static final class Immutable extends Initial_synset_hyperonym.Match {
      Immutable(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
        super(pSynset, pInitial_synset, pHyperonym, pInitial_hyperonym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_hyperonym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Initial_synset_hyperonym
   * 
   */
  public static class Matcher extends BaseMatcher<Initial_synset_hyperonym.Match> {
    /**
     ...
     * 
     */
    public static Initial_synset_hyperonym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Initial_synset_hyperonym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_synset_hyperonym.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_synset_hyperonym.Match> getAllMatches(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public Initial_synset_hyperonym.Match getOneArbitraryMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public int countMatches(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym, final IMatchProcessor<? super Initial_synset_hyperonym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym, final IMatchProcessor<? super Initial_synset_hyperonym.Match> processor) {
     ...
     * 
     */
    public Initial_synset_hyperonym.Match newMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
      return Initial_synset_hyperonym.Match.newMatch(pSynset, pInitial_synset, pHyperonym, pInitial_hyperonym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Initial_synset_hyperonym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Initial_synset_hyperonym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final TraceLink pSynset, final TraceLink pHyperonym, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfhyperonym(final Initial_synset_hyperonym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfhyperonym(final TraceLink pSynset, final Synset pInitial_synset, final Synset pInitial_hyperonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_hyperonym(final Initial_synset_hyperonym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_hyperonym(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym) {
    ...
    @Override
    protected Initial_synset_hyperonym.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_synset_hyperonym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_INITIAL_SYNSET), (TraceLink) t.get(POSITION_HYPERONYM), (Synset) t.get(POSITION_INITIAL_HYPERONYM));
    ...
    @Override
    protected Initial_synset_hyperonym.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_synset_hyperonym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (TraceLink) match[POSITION_HYPERONYM], (Synset) match[POSITION_INITIAL_HYPERONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Initial_synset_hyperonym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_synset_hyperonym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (TraceLink) match[POSITION_HYPERONYM], (Synset) match[POSITION_INITIAL_HYPERONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Initial_synset_hyperonym.Matcher> querySpecification() {
      return Initial_synset_hyperonym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_hyperonym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_synset_hyperonym.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pHyperonym, final Synset pInitial_hyperonym);
    
    @Override
    public void process(final Initial_synset_hyperonym.Match match) {
      process(match.getSynset(), match.getInitial_synset(), match.getHyperonym(), match.getInitial_hyperonym());
    }
  }
  
  private Initial_synset_hyperonym() {
   ...
   * 
   */
  public static Initial_synset_hyperonym instance() {
    try{
  ...
  @Override
  protected Initial_synset_hyperonym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Initial_synset_hyperonym.Matcher.on(engine);
  }
  
  @Override
  public Initial_synset_hyperonym.Matcher instantiate() {
    return Initial_synset_hyperonym.Matcher.create();
  }
  
  @Override
  public Initial_synset_hyperonym.Match newEmptyMatch() {
    return Initial_synset_hyperonym.Match.newEmptyMatch();
  }
  
  @Override
  public Initial_synset_hyperonym.Match newMatch(final Object... parameters) {
    return Initial_synset_hyperonym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.TraceLink) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_hyperonym (visibility: PUBLIC, simpleName: Initial_synset_hyperonym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_hyperonym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_hyperonym (visibility: PUBLIC, simpleName: Initial_synset_hyperonym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_hyperonym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_synset_hyperonym INSTANCE = new Initial_synset_hyperonym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_synset_hyperonym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
