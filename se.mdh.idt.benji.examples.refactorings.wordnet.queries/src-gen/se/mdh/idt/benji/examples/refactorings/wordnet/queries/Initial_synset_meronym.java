...
public final class Initial_synset_meronym extends BaseGeneratedEMFQuerySpecification<Initial_synset_meronym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_meronym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
    ...
    public boolean set(final String parameterName, final Object newValue) {
      ...
      if ("meronym".equals(parameterName) ) {
          this.fMeronym = (TraceLink) newValue;
          return true;
      }
    ...
    public void setMeronym(final TraceLink pMeronym) {
      if (!isMutable()) throw new java.lang.UnsupportedOperationException();
      this.fMeronym = pMeronym;
    }
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_meronym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Initial_synset_meronym.Match.parameterNames;
    }
    ...
    @Override
    public Initial_synset_meronym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Initial_synset_meronym.Match)) {
          Initial_synset_meronym.Match other = (Initial_synset_meronym.Match) obj;
    ...
    @Override
    public Initial_synset_meronym specification() {
     ...
     * 
     */
    public static Initial_synset_meronym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Initial_synset_meronym.Match newMutableMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public static Initial_synset_meronym.Match newMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
      return new Immutable(pSynset, pInitial_synset, pMeronym, pInitial_meronym);
    }
    
    private static final class Mutable extends Initial_synset_meronym.Match {
      Mutable(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
    ...
    private static final class Immutable extends Initial_synset_meronym.Match {
      Immutable(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
        super(pSynset, pInitial_synset, pMeronym, pInitial_meronym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_meronym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Initial_synset_meronym
   * 
   */
  public static class Matcher extends BaseMatcher<Initial_synset_meronym.Match> {
    /**
     ...
     * 
     */
    public static Initial_synset_meronym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Initial_synset_meronym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Initial_synset_meronym.Matcher.class);
     ...
     * 
     */
    public Collection<Initial_synset_meronym.Match> getAllMatches(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public Initial_synset_meronym.Match getOneArbitraryMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public int countMatches(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym, final IMatchProcessor<? super Initial_synset_meronym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym, final IMatchProcessor<? super Initial_synset_meronym.Match> processor) {
     ...
     * 
     */
    public Initial_synset_meronym.Match newMatch(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
      return Initial_synset_meronym.Match.newMatch(pSynset, pInitial_synset, pMeronym, pInitial_meronym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Initial_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final Initial_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_synset(final TraceLink pSynset, final TraceLink pMeronym, final Synset pInitial_meronym) {
     ...
     * 
     */
    protected Set<TraceLink> rawAccumulateAllValuesOfmeronym(final Object[] parameters) {
      Set<TraceLink> results = new HashSet<TraceLink>();
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmeronym() {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmeronym(final Initial_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmeronym(final TraceLink pSynset, final Synset pInitial_synset, final Synset pInitial_meronym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_meronym(final Initial_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfinitial_meronym(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym) {
    ...
    @Override
    protected Initial_synset_meronym.Match tupleToMatch(final Tuple t) {
      try {
          return Initial_synset_meronym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_INITIAL_SYNSET), (TraceLink) t.get(POSITION_MERONYM), (Synset) t.get(POSITION_INITIAL_MERONYM));
    ...
    @Override
    protected Initial_synset_meronym.Match arrayToMatch(final Object[] match) {
      try {
          return Initial_synset_meronym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (TraceLink) match[POSITION_MERONYM], (Synset) match[POSITION_INITIAL_MERONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Initial_synset_meronym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial_synset_meronym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_INITIAL_SYNSET], (TraceLink) match[POSITION_MERONYM], (Synset) match[POSITION_INITIAL_MERONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Initial_synset_meronym.Matcher> querySpecification() {
      return Initial_synset_meronym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.initial_synset_meronym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Initial_synset_meronym.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pSynset, final Synset pInitial_synset, final TraceLink pMeronym, final Synset pInitial_meronym);
    
    @Override
    public void process(final Initial_synset_meronym.Match match) {
      process(match.getSynset(), match.getInitial_synset(), match.getMeronym(), match.getInitial_meronym());
    }
  }
  
  private Initial_synset_meronym() {
   ...
   * 
   */
  public static Initial_synset_meronym instance() {
    try{
  ...
  @Override
  protected Initial_synset_meronym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Initial_synset_meronym.Matcher.on(engine);
  }
  
  @Override
  public Initial_synset_meronym.Matcher instantiate() {
    return Initial_synset_meronym.Matcher.create();
  }
  
  @Override
  public Initial_synset_meronym.Match newEmptyMatch() {
    return Initial_synset_meronym.Match.newEmptyMatch();
  }
  
  @Override
  public Initial_synset_meronym.Match newMatch(final Object... parameters) {
    return Initial_synset_meronym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.TraceLink) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_meronym (visibility: PUBLIC, simpleName: Initial_synset_meronym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_meronym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_meronym (visibility: PUBLIC, simpleName: Initial_synset_meronym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Initial_synset_meronym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Initial_synset_meronym INSTANCE = new Initial_synset_meronym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Initial_synset_meronym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final PParameter parameter_pMeronym = new PParameter("meronym", "se.mdh.idt.benji.trace.TraceLink", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.mdh.se/idt/benji/trace/Trace", "TraceLink")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_meronym), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.mdh.se/idt/benji/trace/Trace", "TraceLink")));
