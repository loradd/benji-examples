...
public final class Insert_word_synset extends BaseGeneratedEMFQuerySpecification<Insert_word_synset.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_word_synset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_word_synset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Insert_word_synset.Match.parameterNames;
    }
    ...
    @Override
    public Insert_word_synset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Insert_word_synset.Match)) {
          Insert_word_synset.Match other = (Insert_word_synset.Match) obj;
    ...
    @Override
    public Insert_word_synset specification() {
     ...
     * 
     */
    public static Insert_word_synset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Insert_word_synset.Match newMutableMatch(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public static Insert_word_synset.Match newMatch(final TraceLink pWord, final TraceLink pSynset) {
      return new Immutable(pWord, pSynset);
    }
    
    private static final class Mutable extends Insert_word_synset.Match {
    ...
    private static final class Immutable extends Insert_word_synset.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_word_synset pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Insert_word_synset
   * 
   */
  public static class Matcher extends BaseMatcher<Insert_word_synset.Match> {
    /**
     ...
     * 
     */
    public static Insert_word_synset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Insert_word_synset.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Insert_word_synset.Matcher.class);
     ...
     * 
     */
    public Collection<Insert_word_synset.Match> getAllMatches(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public Insert_word_synset.Match getOneArbitraryMatch(final TraceLink pWord, final TraceLink pSynset) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pWord, final TraceLink pSynset, final IMatchProcessor<? super Insert_word_synset.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pWord, final TraceLink pSynset, final IMatchProcessor<? super Insert_word_synset.Match> processor) {
     ...
     * 
     */
    public Insert_word_synset.Match newMatch(final TraceLink pWord, final TraceLink pSynset) {
      return Insert_word_synset.Match.newMatch(pWord, pSynset);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Insert_word_synset.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Insert_word_synset.Match partialMatch) {
    ...
    @Override
    protected Insert_word_synset.Match tupleToMatch(final Tuple t) {
      try {
          return Insert_word_synset.Match.newMatch((TraceLink) t.get(POSITION_WORD), (TraceLink) t.get(POSITION_SYNSET));
    ...
    @Override
    protected Insert_word_synset.Match arrayToMatch(final Object[] match) {
      try {
          return Insert_word_synset.Match.newMatch((TraceLink) match[POSITION_WORD], (TraceLink) match[POSITION_SYNSET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Insert_word_synset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Insert_word_synset.Match.newMutableMatch((TraceLink) match[POSITION_WORD], (TraceLink) match[POSITION_SYNSET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Insert_word_synset.Matcher> querySpecification() {
      return Insert_word_synset.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.insert_word_synset pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Insert_word_synset.Match> {
    /**
    ...
    @Override
    public void process(final Insert_word_synset.Match match) {
      process(match.getWord(), match.getSynset());
    }
  }
  
  private Insert_word_synset() {
   ...
   * 
   */
  public static Insert_word_synset instance() {
    try{
  ...
  @Override
  protected Insert_word_synset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Insert_word_synset.Matcher.on(engine);
  }
  
  @Override
  public Insert_word_synset.Matcher instantiate() {
    return Insert_word_synset.Matcher.create();
  }
  
  @Override
  public Insert_word_synset.Match newEmptyMatch() {
    return Insert_word_synset.Match.newEmptyMatch();
  }
  
  @Override
  public Insert_word_synset.Match newMatch(final Object... parameters) {
    return Insert_word_synset.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_word_synset (visibility: PUBLIC, simpleName: Insert_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_word_synset (visibility: PUBLIC, simpleName: Insert_word_synset, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Insert_word_synset, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Insert_word_synset INSTANCE = new Insert_word_synset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Insert_word_synset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find initial_word_synset (word, _initial_word, synset, _initial_synset)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_word, var__initial_word, var_synset, var__initial_synset), Initial_word_synset.instance().getInternalQueryRepresentation());
          // 	find current_word_synset (word, _current_word, synset, _current_synset)
