...
public final class Get_word extends BaseGeneratedEMFQuerySpecification<Get_word.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_word pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_word";
    }
    
    @Override
    public List<String> parameterNames() {
      return Get_word.Match.parameterNames;
    }
    ...
    @Override
    public Get_word.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Get_word.Match)) {
          Get_word.Match other = (Get_word.Match) obj;
     ...
     * 
     */
    public static Get_word.Match newEmptyMatch() {
     ...
     * 
     */
    public static Get_word.Match newMutableMatch(final TraceLink pWord) {
     ...
     * 
     */
    public static Get_word.Match newMatch(final TraceLink pWord) {
      return new Immutable(pWord);
    }
    
    private static final class Mutable extends Get_word.Match {
    ...
    private static final class Immutable extends Get_word.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_word pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Get_word.Match> {
    /**
     ...
     * 
     */
    public static Get_word.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Get_word.Matcher create() {
      return new Matcher();
    }
    
    private final static int POSITION_WORD = 0;
    
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Get_word.Matcher.class);
     ...
     * 
     */
    public Collection<Get_word.Match> getAllMatches(final TraceLink pWord) {
     ...
     * 
     */
    public Get_word.Match getOneArbitraryMatch(final TraceLink pWord) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pWord, final IMatchProcessor<? super Get_word.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pWord, final IMatchProcessor<? super Get_word.Match> processor) {
     ...
     * 
     */
    public Get_word.Match newMatch(final TraceLink pWord) {
      return Get_word.Match.newMatch(pWord);
    }
    ...
    @Override
    protected Get_word.Match tupleToMatch(final Tuple t) {
      try {
          return Get_word.Match.newMatch((TraceLink) t.get(POSITION_WORD));
    ...
    @Override
    protected Get_word.Match arrayToMatch(final Object[] match) {
      try {
          return Get_word.Match.newMatch((TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Get_word.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Get_word.Match.newMutableMatch((TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Get_word.Matcher> querySpecification() {
      return Get_word.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.get_word pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Get_word.Match> {
    /**
    ...
    @Override
    public void process(final Get_word.Match match) {
   ...
   * 
   */
  public static Get_word instance() {
    try{
  ...
  @Override
  protected Get_word.Matcher instantiate(final ViatraQueryEngine engine) {
    return Get_word.Matcher.on(engine);
  }
  
  @Override
  public Get_word.Matcher instantiate() {
    return Get_word.Matcher.create();
  }
  
  @Override
  public Get_word.Match newEmptyMatch() {
    return Get_word.Match.newEmptyMatch();
  }
  
  @Override
  public Get_word.Match newMatch(final Object... parameters) {
    return Get_word.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_word (visibility: PUBLIC, simpleName: Get_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_word (visibility: PUBLIC, simpleName: Get_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Get_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Get_word INSTANCE = new Get_word();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Get_word.GeneratedPQuery INSTANCE = new GeneratedPQuery();
