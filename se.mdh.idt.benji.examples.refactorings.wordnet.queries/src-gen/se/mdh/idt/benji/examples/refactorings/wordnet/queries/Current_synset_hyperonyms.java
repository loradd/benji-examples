...
public final class Current_synset_hyperonyms extends BaseGeneratedEMFQuerySpecification<Current_synset_hyperonyms.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyperonyms pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyperonyms";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_synset_hyperonyms.Match.parameterNames;
    }
    ...
    @Override
    public Current_synset_hyperonyms.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_synset_hyperonyms.Match)) {
          Current_synset_hyperonyms.Match other = (Current_synset_hyperonyms.Match) obj;
    ...
    @Override
    public Current_synset_hyperonyms specification() {
     ...
     * 
     */
    public static Current_synset_hyperonyms.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_synset_hyperonyms.Match newMutableMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public static Current_synset_hyperonyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
      return new Immutable(pSynset, pCurrent_synset, pHyperonym, pCurrent_hyperonym);
    }
    
    private static final class Mutable extends Current_synset_hyperonyms.Match {
      Mutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
    ...
    private static final class Immutable extends Current_synset_hyperonyms.Match {
      Immutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
        super(pSynset, pCurrent_synset, pHyperonym, pCurrent_hyperonym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyperonyms pattern,
   ...
   * pattern current_synset_hyperonyms (synset : Trace, current_synset : Synset, hyperonym : Trace, current_hyperonym : Synset) {
   ...
   * @see Match
   *  @see Processor
   * @see Current_synset_hyperonyms
   * 
   */
  public static class Matcher extends BaseMatcher<Current_synset_hyperonyms.Match> {
    /**
     ...
     * 
     */
    public static Current_synset_hyperonyms.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_synset_hyperonyms.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_synset_hyperonyms.Matcher.class);
     ...
     * 
     */
    public Collection<Current_synset_hyperonyms.Match> getAllMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public Current_synset_hyperonyms.Match getOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym, final IMatchProcessor<? super Current_synset_hyperonyms.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym, final IMatchProcessor<? super Current_synset_hyperonyms.Match> processor) {
     ...
     * 
     */
    public Current_synset_hyperonyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
      return Current_synset_hyperonyms.Match.newMatch(pSynset, pCurrent_synset, pHyperonym, pCurrent_hyperonym);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Current_synset_hyperonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_synset_hyperonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Trace pSynset, final Trace pHyperonym, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfhyperonym(final Current_synset_hyperonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfhyperonym(final Trace pSynset, final Synset pCurrent_synset, final Synset pCurrent_hyperonym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_hyperonym(final Current_synset_hyperonyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_hyperonym(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym) {
    ...
    @Override
    protected Current_synset_hyperonyms.Match tupleToMatch(final Tuple t) {
      try {
          return Current_synset_hyperonyms.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET), (Trace) t.get(POSITION_HYPERONYM), (Synset) t.get(POSITION_CURRENT_HYPERONYM));
    ...
    @Override
    protected Current_synset_hyperonyms.Match arrayToMatch(final Object[] match) {
      try {
          return Current_synset_hyperonyms.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HYPERONYM], (Synset) match[POSITION_CURRENT_HYPERONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_synset_hyperonyms.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_synset_hyperonyms.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HYPERONYM], (Synset) match[POSITION_CURRENT_HYPERONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_synset_hyperonyms.Matcher> querySpecification() {
      return Current_synset_hyperonyms.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyperonyms pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_synset_hyperonyms.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyperonym, final Synset pCurrent_hyperonym);
    
    @Override
    public void process(final Current_synset_hyperonyms.Match match) {
      process(match.getSynset(), match.getCurrent_synset(), match.getHyperonym(), match.getCurrent_hyperonym());
    }
  }
  
  private Current_synset_hyperonyms() {
   ...
   * 
   */
  public static Current_synset_hyperonyms instance() {
    try{
  ...
  @Override
  protected Current_synset_hyperonyms.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_synset_hyperonyms.Matcher.on(engine);
  }
  
  @Override
  public Current_synset_hyperonyms.Matcher instantiate() {
    return Current_synset_hyperonyms.Matcher.create();
  }
  
  @Override
  public Current_synset_hyperonyms.Match newEmptyMatch() {
    return Current_synset_hyperonyms.Match.newEmptyMatch();
  }
  
  @Override
  public Current_synset_hyperonyms.Match newMatch(final Object... parameters) {
    return Current_synset_hyperonyms.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyperonyms (visibility: PUBLIC, simpleName: Current_synset_hyperonyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyperonyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyperonyms (visibility: PUBLIC, simpleName: Current_synset_hyperonyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyperonyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_synset_hyperonyms INSTANCE = new Current_synset_hyperonyms();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_synset_hyperonyms.GeneratedPQuery INSTANCE = new GeneratedPQuery();
