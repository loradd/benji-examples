...
public final class Remove_synset_word extends BaseGeneratedEMFQuerySpecification<Remove_synset_word.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_word pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_word";
    }
    
    @Override
    public List<String> parameterNames() {
      return Remove_synset_word.Match.parameterNames;
    }
    ...
    @Override
    public Remove_synset_word.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Remove_synset_word.Match)) {
          Remove_synset_word.Match other = (Remove_synset_word.Match) obj;
    ...
    @Override
    public Remove_synset_word specification() {
     ...
     * 
     */
    public static Remove_synset_word.Match newEmptyMatch() {
     ...
     * 
     */
    public static Remove_synset_word.Match newMutableMatch(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public static Remove_synset_word.Match newMatch(final TraceLink pSynset, final TraceLink pWord) {
      return new Immutable(pSynset, pWord);
    }
    
    private static final class Mutable extends Remove_synset_word.Match {
    ...
    private static final class Immutable extends Remove_synset_word.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_word pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Remove_synset_word
   * 
   */
  public static class Matcher extends BaseMatcher<Remove_synset_word.Match> {
    /**
     ...
     * 
     */
    public static Remove_synset_word.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Remove_synset_word.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Remove_synset_word.Matcher.class);
     ...
     * 
     */
    public Collection<Remove_synset_word.Match> getAllMatches(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public Remove_synset_word.Match getOneArbitraryMatch(final TraceLink pSynset, final TraceLink pWord) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final TraceLink pWord, final IMatchProcessor<? super Remove_synset_word.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final TraceLink pWord, final IMatchProcessor<? super Remove_synset_word.Match> processor) {
     ...
     * 
     */
    public Remove_synset_word.Match newMatch(final TraceLink pSynset, final TraceLink pWord) {
      return Remove_synset_word.Match.newMatch(pSynset, pWord);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Remove_synset_word.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfword(final Remove_synset_word.Match partialMatch) {
    ...
    @Override
    protected Remove_synset_word.Match tupleToMatch(final Tuple t) {
      try {
          return Remove_synset_word.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (TraceLink) t.get(POSITION_WORD));
    ...
    @Override
    protected Remove_synset_word.Match arrayToMatch(final Object[] match) {
      try {
          return Remove_synset_word.Match.newMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Remove_synset_word.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Remove_synset_word.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_WORD]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Remove_synset_word.Matcher> querySpecification() {
      return Remove_synset_word.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_word pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Remove_synset_word.Match> {
    /**
    ...
    @Override
    public void process(final Remove_synset_word.Match match) {
      process(match.getSynset(), match.getWord());
    }
  }
  
  private Remove_synset_word() {
   ...
   * 
   */
  public static Remove_synset_word instance() {
    try{
  ...
  @Override
  protected Remove_synset_word.Matcher instantiate(final ViatraQueryEngine engine) {
    return Remove_synset_word.Matcher.on(engine);
  }
  
  @Override
  public Remove_synset_word.Matcher instantiate() {
    return Remove_synset_word.Matcher.create();
  }
  
  @Override
  public Remove_synset_word.Match newEmptyMatch() {
    return Remove_synset_word.Match.newEmptyMatch();
  }
  
  @Override
  public Remove_synset_word.Match newMatch(final Object... parameters) {
    return Remove_synset_word.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_word (visibility: PUBLIC, simpleName: Remove_synset_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_word (visibility: PUBLIC, simpleName: Remove_synset_word, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_word, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Remove_synset_word INSTANCE = new Remove_synset_word();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Remove_synset_word.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_synset_word (synset, _current_synset, word, _current_word)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_synset, var__current_synset, var_word, var__current_word), Current_synset_word.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
