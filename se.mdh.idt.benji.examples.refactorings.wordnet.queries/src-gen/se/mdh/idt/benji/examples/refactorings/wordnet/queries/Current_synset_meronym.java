...
public final class Current_synset_meronym extends BaseGeneratedEMFQuerySpecification<Current_synset_meronym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_meronym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_meronym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_synset_meronym.Match.parameterNames;
    }
    ...
    @Override
    public Current_synset_meronym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_synset_meronym.Match)) {
          Current_synset_meronym.Match other = (Current_synset_meronym.Match) obj;
    ...
    @Override
    public Current_synset_meronym specification() {
     ...
     * 
     */
    public static Current_synset_meronym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_synset_meronym.Match newMutableMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public static Current_synset_meronym.Match newMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
      return new Immutable(pSynset, pCurrent_synset, pMeronym, pCurrent_meronym);
    }
    
    private static final class Mutable extends Current_synset_meronym.Match {
      Mutable(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
    ...
    private static final class Immutable extends Current_synset_meronym.Match {
      Immutable(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
        super(pSynset, pCurrent_synset, pMeronym, pCurrent_meronym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_meronym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Current_synset_meronym
   * 
   */
  public static class Matcher extends BaseMatcher<Current_synset_meronym.Match> {
    /**
     ...
     * 
     */
    public static Current_synset_meronym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_synset_meronym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_synset_meronym.Matcher.class);
     ...
     * 
     */
    public Collection<Current_synset_meronym.Match> getAllMatches(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public Current_synset_meronym.Match getOneArbitraryMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public boolean hasMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public int countMatches(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym, final IMatchProcessor<? super Current_synset_meronym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym, final IMatchProcessor<? super Current_synset_meronym.Match> processor) {
     ...
     * 
     */
    public Current_synset_meronym.Match newMatch(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
      return Current_synset_meronym.Match.newMatch(pSynset, pCurrent_synset, pMeronym, pCurrent_meronym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Current_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final TraceLink pSynset, final TraceLink pMeronym, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmeronym(final Current_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfmeronym(final TraceLink pSynset, final Synset pCurrent_synset, final Synset pCurrent_meronym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_meronym(final Current_synset_meronym.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_meronym(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym) {
    ...
    @Override
    protected Current_synset_meronym.Match tupleToMatch(final Tuple t) {
      try {
          return Current_synset_meronym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET), (TraceLink) t.get(POSITION_MERONYM), (Synset) t.get(POSITION_CURRENT_MERONYM));
    ...
    @Override
    protected Current_synset_meronym.Match arrayToMatch(final Object[] match) {
      try {
          return Current_synset_meronym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (TraceLink) match[POSITION_MERONYM], (Synset) match[POSITION_CURRENT_MERONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_synset_meronym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_synset_meronym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (TraceLink) match[POSITION_MERONYM], (Synset) match[POSITION_CURRENT_MERONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_synset_meronym.Matcher> querySpecification() {
      return Current_synset_meronym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_meronym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_synset_meronym.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final TraceLink pSynset, final Synset pCurrent_synset, final TraceLink pMeronym, final Synset pCurrent_meronym);
    
    @Override
    public void process(final Current_synset_meronym.Match match) {
      process(match.getSynset(), match.getCurrent_synset(), match.getMeronym(), match.getCurrent_meronym());
    }
  }
  
  private Current_synset_meronym() {
   ...
   * 
   */
  public static Current_synset_meronym instance() {
    try{
  ...
  @Override
  protected Current_synset_meronym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_synset_meronym.Matcher.on(engine);
  }
  
  @Override
  public Current_synset_meronym.Matcher instantiate() {
    return Current_synset_meronym.Matcher.create();
  }
  
  @Override
  public Current_synset_meronym.Match newEmptyMatch() {
    return Current_synset_meronym.Match.newEmptyMatch();
  }
  
  @Override
  public Current_synset_meronym.Match newMatch(final Object... parameters) {
    return Current_synset_meronym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.TraceLink) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_meronym (visibility: PUBLIC, simpleName: Current_synset_meronym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_meronym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_meronym (visibility: PUBLIC, simpleName: Current_synset_meronym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_meronym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_synset_meronym INSTANCE = new Current_synset_meronym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_synset_meronym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
