...
public final class Current_synset_hyponyms extends BaseGeneratedEMFQuerySpecification<Current_synset_hyponyms.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyponyms pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyponyms";
    }
    
    @Override
    public List<String> parameterNames() {
      return Current_synset_hyponyms.Match.parameterNames;
    }
    ...
    @Override
    public Current_synset_hyponyms.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Current_synset_hyponyms.Match)) {
          Current_synset_hyponyms.Match other = (Current_synset_hyponyms.Match) obj;
    ...
    @Override
    public Current_synset_hyponyms specification() {
     ...
     * 
     */
    public static Current_synset_hyponyms.Match newEmptyMatch() {
     ...
     * 
     */
    public static Current_synset_hyponyms.Match newMutableMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public static Current_synset_hyponyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
      return new Immutable(pSynset, pCurrent_synset, pHyponym, pCurrent_hyponym);
    }
    
    private static final class Mutable extends Current_synset_hyponyms.Match {
      Mutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
    ...
    private static final class Immutable extends Current_synset_hyponyms.Match {
      Immutable(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
        super(pSynset, pCurrent_synset, pHyponym, pCurrent_hyponym);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyponyms pattern,
   ...
   * pattern current_synset_hyponyms (synset : Trace, current_synset : Synset, hyponym : Trace, current_hyponym : Synset) {
   ...
   * @see Match
   *  @see Processor
   * @see Current_synset_hyponyms
   * 
   */
  public static class Matcher extends BaseMatcher<Current_synset_hyponyms.Match> {
    /**
     ...
     * 
     */
    public static Current_synset_hyponyms.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Current_synset_hyponyms.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Current_synset_hyponyms.Matcher.class);
     ...
     * 
     */
    public Collection<Current_synset_hyponyms.Match> getAllMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public Current_synset_hyponyms.Match getOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public boolean hasMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public int countMatches(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public void forEachMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym, final IMatchProcessor<? super Current_synset_hyponyms.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym, final IMatchProcessor<? super Current_synset_hyponyms.Match> processor) {
     ...
     * 
     */
    public Current_synset_hyponyms.Match newMatch(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
      return Current_synset_hyponyms.Match.newMatch(pSynset, pCurrent_synset, pHyponym, pCurrent_hyponym);
    }
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Current_synset_hyponyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfsynset(final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Current_synset_hyponyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_synset(final Trace pSynset, final Trace pHyponym, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfhyponym(final Current_synset_hyponyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Trace> getAllValuesOfhyponym(final Trace pSynset, final Synset pCurrent_synset, final Synset pCurrent_hyponym) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_hyponym(final Current_synset_hyponyms.Match partialMatch) {
     ...
     * 
     */
    public Set<Synset> getAllValuesOfcurrent_hyponym(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym) {
    ...
    @Override
    protected Current_synset_hyponyms.Match tupleToMatch(final Tuple t) {
      try {
          return Current_synset_hyponyms.Match.newMatch((Trace) t.get(POSITION_SYNSET), (Synset) t.get(POSITION_CURRENT_SYNSET), (Trace) t.get(POSITION_HYPONYM), (Synset) t.get(POSITION_CURRENT_HYPONYM));
    ...
    @Override
    protected Current_synset_hyponyms.Match arrayToMatch(final Object[] match) {
      try {
          return Current_synset_hyponyms.Match.newMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HYPONYM], (Synset) match[POSITION_CURRENT_HYPONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Current_synset_hyponyms.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current_synset_hyponyms.Match.newMutableMatch((Trace) match[POSITION_SYNSET], (Synset) match[POSITION_CURRENT_SYNSET], (Trace) match[POSITION_HYPONYM], (Synset) match[POSITION_CURRENT_HYPONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Current_synset_hyponyms.Matcher> querySpecification() {
      return Current_synset_hyponyms.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.current_synset_hyponyms pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Current_synset_hyponyms.Match> {
    /**
     ...
     * 
     */
    public abstract void process(final Trace pSynset, final Synset pCurrent_synset, final Trace pHyponym, final Synset pCurrent_hyponym);
    
    @Override
    public void process(final Current_synset_hyponyms.Match match) {
      process(match.getSynset(), match.getCurrent_synset(), match.getHyponym(), match.getCurrent_hyponym());
    }
  }
  
  private Current_synset_hyponyms() {
   ...
   * 
   */
  public static Current_synset_hyponyms instance() {
    try{
  ...
  @Override
  protected Current_synset_hyponyms.Matcher instantiate(final ViatraQueryEngine engine) {
    return Current_synset_hyponyms.Matcher.on(engine);
  }
  
  @Override
  public Current_synset_hyponyms.Matcher instantiate() {
    return Current_synset_hyponyms.Matcher.create();
  }
  
  @Override
  public Current_synset_hyponyms.Match newEmptyMatch() {
    return Current_synset_hyponyms.Match.newEmptyMatch();
  }
  
  @Override
  public Current_synset_hyponyms.Match newMatch(final Object... parameters) {
    return Current_synset_hyponyms.Match.newMatch((se.mdh.idt.benji.trace.Trace) parameters[0], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[1], (se.mdh.idt.benji.trace.Trace) parameters[2], (se.mdh.idt.benji.examples.refactorings.wordnet.Synset) parameters[3]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyponyms (visibility: PUBLIC, simpleName: Current_synset_hyponyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyponyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyponyms (visibility: PUBLIC, simpleName: Current_synset_hyponyms, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Current_synset_hyponyms, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Current_synset_hyponyms INSTANCE = new Current_synset_hyponyms();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Current_synset_hyponyms.GeneratedPQuery INSTANCE = new GeneratedPQuery();
