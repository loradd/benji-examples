...
public final class Remove_synset_hyponym extends BaseGeneratedEMFQuerySpecification<Remove_synset_hyponym.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_hyponym pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_hyponym";
    }
    
    @Override
    public List<String> parameterNames() {
      return Remove_synset_hyponym.Match.parameterNames;
    }
    ...
    @Override
    public Remove_synset_hyponym.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Remove_synset_hyponym.Match)) {
          Remove_synset_hyponym.Match other = (Remove_synset_hyponym.Match) obj;
    ...
    @Override
    public Remove_synset_hyponym specification() {
     ...
     * 
     */
    public static Remove_synset_hyponym.Match newEmptyMatch() {
     ...
     * 
     */
    public static Remove_synset_hyponym.Match newMutableMatch(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public static Remove_synset_hyponym.Match newMatch(final TraceLink pSynset, final TraceLink pHyponym) {
      return new Immutable(pSynset, pHyponym);
    }
    
    private static final class Mutable extends Remove_synset_hyponym.Match {
    ...
    private static final class Immutable extends Remove_synset_hyponym.Match {
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_hyponym pattern,
   ...
   * @see Match
   *  @see Processor
   * @see Remove_synset_hyponym
   * 
   */
  public static class Matcher extends BaseMatcher<Remove_synset_hyponym.Match> {
    /**
     ...
     * 
     */
    public static Remove_synset_hyponym.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Remove_synset_hyponym.Matcher create() {
      return new Matcher();
    }
    ...
    private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Remove_synset_hyponym.Matcher.class);
     ...
     * 
     */
    public Collection<Remove_synset_hyponym.Match> getAllMatches(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public Remove_synset_hyponym.Match getOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHyponym) {
     ...
     * 
     */
    public void forEachMatch(final TraceLink pSynset, final TraceLink pHyponym, final IMatchProcessor<? super Remove_synset_hyponym.Match> processor) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pSynset, final TraceLink pHyponym, final IMatchProcessor<? super Remove_synset_hyponym.Match> processor) {
     ...
     * 
     */
    public Remove_synset_hyponym.Match newMatch(final TraceLink pSynset, final TraceLink pHyponym) {
      return Remove_synset_hyponym.Match.newMatch(pSynset, pHyponym);
    }
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfsynset(final Remove_synset_hyponym.Match partialMatch) {
     ...
     * 
     */
    public Set<TraceLink> getAllValuesOfhyponym(final Remove_synset_hyponym.Match partialMatch) {
    ...
    @Override
    protected Remove_synset_hyponym.Match tupleToMatch(final Tuple t) {
      try {
          return Remove_synset_hyponym.Match.newMatch((TraceLink) t.get(POSITION_SYNSET), (TraceLink) t.get(POSITION_HYPONYM));
    ...
    @Override
    protected Remove_synset_hyponym.Match arrayToMatch(final Object[] match) {
      try {
          return Remove_synset_hyponym.Match.newMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HYPONYM]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Remove_synset_hyponym.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Remove_synset_hyponym.Match.newMutableMatch((TraceLink) match[POSITION_SYNSET], (TraceLink) match[POSITION_HYPONYM]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Remove_synset_hyponym.Matcher> querySpecification() {
      return Remove_synset_hyponym.instance();
    }
  }
  
  /**
   * A match processor tailored for the se.mdh.idt.benji.examples.refactorings.wordnet.queries.remove_synset_hyponym pattern.
   * 
   * Clients should derive an (anonymous) class that implements the abstract process().
   * 
   */
  public static abstract class Processor implements IMatchProcessor<Remove_synset_hyponym.Match> {
    /**
    ...
    @Override
    public void process(final Remove_synset_hyponym.Match match) {
      process(match.getSynset(), match.getHyponym());
    }
  }
  
  private Remove_synset_hyponym() {
   ...
   * 
   */
  public static Remove_synset_hyponym instance() {
    try{
  ...
  @Override
  protected Remove_synset_hyponym.Matcher instantiate(final ViatraQueryEngine engine) {
    return Remove_synset_hyponym.Matcher.on(engine);
  }
  
  @Override
  public Remove_synset_hyponym.Matcher instantiate() {
    return Remove_synset_hyponym.Matcher.create();
  }
  
  @Override
  public Remove_synset_hyponym.Match newEmptyMatch() {
    return Remove_synset_hyponym.Match.newEmptyMatch();
  }
  
  @Override
  public Remove_synset_hyponym.Match newMatch(final Object... parameters) {
    return Remove_synset_hyponym.Match.newMatch((se.mdh.idt.benji.trace.TraceLink) parameters[0], (se.mdh.idt.benji.trace.TraceLink) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_hyponym (visibility: PUBLIC, simpleName: Remove_synset_hyponym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_hyponym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_hyponym (visibility: PUBLIC, simpleName: Remove_synset_hyponym, identifier: se.mdh.idt.benji.examples.refactorings.wordnet.queries.Remove_synset_hyponym, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.examples.refactorings.wordnet.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Remove_synset_hyponym INSTANCE = new Remove_synset_hyponym();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Remove_synset_hyponym.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find current_synset_hyponym (synset, _current_synset, hyponym, _current_hyponym)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_synset, var__current_synset, var_hyponym, var__current_hyponym), Current_synset_hyponym.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
